...
#+ Modifier...: 02295(2015-12-11 15:53:51) -SD/PR- topdev(2016-02-29 15:04:53)
 
{</section>}
 
{<section id="apjt302.global" >}
#應用 t01 樣板自動產生(Version:50)
...
PRIVATE TYPE type_g_pjdb_d        RECORD
   ...
   pjdb003 LIKE pjdb_t.pjdb003, 
   pjdb003_desc LIKE type_t.chr500, 
   pjdb004 LIKE pjdb_t.pjdb004, 
   pjdb004_desc LIKE type_t.chr500, 
   pjdb005 LIKE pjdb_t.pjdb005, 
   pjdb005_desc LIKE type_t.chr500, 
   pjdb006 LIKE pjdb_t.pjdb006, 
   pjdb007 LIKE pjdb_t.pjdb007, 
   pjdb007_desc LIKE type_t.chr500, 
   pjdb008 LIKE pjdb_t.pjdb008, 
   pjdb009 LIKE pjdb_t.pjdb009, 
...
MAIN
   ...
   LET g_sql = " SELECT UNIQUE t0.pjdadocno,t0.pjdadocdt,t0.pjdasite,t0.pjda001,t0.pjda002,t0.pjdastus, 
...
PRIVATE FUNCTION apjt302_browser_fill(ps_page_action)
   ...
   IF g_wc2 <> " 1=1" THEN
      #單身有輸入搜尋條件                      
      LET l_sub_sql = " SELECT UNIQUE pjdadocno ",
                      " FROM pjda_t ",
                      " ",
                      " LEFT JOIN pjdb_t ON pjdbent = pjdaent AND pjdadocno = pjdbdocno ", "  ",
                      #add-point:browser_fill段sql(pjdb_t1)
   ...
   DIALOG ATTRIBUTES(UNBUFFERED,FIELD ORDER FORM)
      ...
      CONSTRUCT BY NAME g_wc ON pjdadocno,pjdadocdt,pjdasite,pjda001,pjda002,pjdastus,pjdaownid,pjdaowndp, 
         ...
         ON ACTION controlp INFIELD pjdadocno
            #add-point:ON ACTION controlp INFIELD pjdadocno
         ...
         BEFORE FIELD pjdadocno
            #add-point:BEFORE FIELD pjdadocno
         ...
         AFTER FIELD pjdadocno
            ...
            #add-point:AFTER FIELD pjdadocno
         ...
         BEFORE FIELD pjdadocdt
            #add-point:BEFORE FIELD pjdadocdt
         ...
         AFTER FIELD pjdadocdt
            ...
            #add-point:AFTER FIELD pjdadocdt
...
#         #應用 a03 樣板自動產生(Version:2)
         ON ACTION controlp INFIELD pjdadocdt
            #add-point:ON ACTION controlp INFIELD pjdadocdt
            
            #END add-point
 
         #應用 a01 樣板自動產生(Version:1)
         BEFORE FIELD pjdasite
            #add-point:BEFORE FIELD pjdasite
         ...
         AFTER FIELD pjdasite
            ...
            #add-point:AFTER FIELD pjdasite
...
#         #應用 a03 樣板自動產生(Version:2)
         ON ACTION controlp INFIELD pjdasite
            #add-point:ON ACTION controlp INFIELD pjdasite
         ...
         ON ACTION controlp INFIELD pjda001
            #add-point:ON ACTION controlp INFIELD pjda001
            #應用 a08 樣板自動產生(Version:2)
            #開窗c段
            INITIALIZE g_qryparam.* TO NULL
            LET g_qryparam.state = 'c' 
         ...
         BEFORE FIELD pjda001
            #add-point:BEFORE FIELD pjda001
         ...
         ON ACTION controlp INFIELD pjda002
            #add-point:ON ACTION controlp INFIELD pjda002
            #應用 a08 樣板自動產生(Version:2)
            #開窗c段
            INITIALIZE g_qryparam.* TO NULL
            LET g_qryparam.state = 'c' 
         ...
         BEFORE FIELD pjda002
            #add-point:BEFORE FIELD pjda002
         ...
         BEFORE FIELD pjdastus
            #add-point:BEFORE FIELD pjdastus
         ...
         AFTER FIELD pjdastus
            ...
            #add-point:AFTER FIELD pjdastus
...
#         #應用 a03 樣板自動產生(Version:2)
         ON ACTION controlp INFIELD pjdastus
            #add-point:ON ACTION controlp INFIELD pjdastus
         ...
         ON ACTION controlp INFIELD pjdaownid
            #add-point:ON ACTION controlp INFIELD pjdaownid
            #應用 a08 樣板自動產生(Version:2)
            #開窗c段
            INITIALIZE g_qryparam.* TO NULL
            LET g_qryparam.state = 'c' 
         ...
         BEFORE FIELD pjdaownid
            #add-point:BEFORE FIELD pjdaownid
         ...
         AFTER FIELD pjdaownid
            ...
            #add-point:AFTER FIELD pjdaownid
         ...
         ON ACTION controlp INFIELD pjdaowndp
            #add-point:ON ACTION controlp INFIELD pjdaowndp
            #應用 a08 樣板自動產生(Version:2)
            #開窗c段
            INITIALIZE g_qryparam.* TO NULL
            LET g_qryparam.state = 'c' 
         ...
         BEFORE FIELD pjdaowndp
            #add-point:BEFORE FIELD pjdaowndp
         ...
         AFTER FIELD pjdaowndp
            ...
            #add-point:AFTER FIELD pjdaowndp
         ...
         ON ACTION controlp INFIELD pjdacrtid
            #add-point:ON ACTION controlp INFIELD pjdacrtid
            #應用 a08 樣板自動產生(Version:2)
            #開窗c段
            INITIALIZE g_qryparam.* TO NULL
            LET g_qryparam.state = 'c' 
         ...
         BEFORE FIELD pjdacrtid
            #add-point:BEFORE FIELD pjdacrtid
         ...
         AFTER FIELD pjdacrtid
            ...
            #add-point:AFTER FIELD pjdacrtid
         ...
         ON ACTION controlp INFIELD pjdacrtdp
            #add-point:ON ACTION controlp INFIELD pjdacrtdp
            #應用 a08 樣板自動產生(Version:2)
            #開窗c段
            INITIALIZE g_qryparam.* TO NULL
            LET g_qryparam.state = 'c' 
         ...
         BEFORE FIELD pjdacrtdp
            #add-point:BEFORE FIELD pjdacrtdp
         ...
         AFTER FIELD pjdacrtdp
            ...
            #add-point:AFTER FIELD pjdacrtdp
         ...
         BEFORE FIELD pjdacrtdt
            #add-point:BEFORE FIELD pjdacrtdt
         ...
         ON ACTION controlp INFIELD pjdamodid
            #add-point:ON ACTION controlp INFIELD pjdamodid
            #應用 a08 樣板自動產生(Version:2)
            #開窗c段
            INITIALIZE g_qryparam.* TO NULL
            LET g_qryparam.state = 'c' 
         ...
         BEFORE FIELD pjdamodid
            #add-point:BEFORE FIELD pjdamodid
         ...
         AFTER FIELD pjdamodid
            ...
            #add-point:AFTER FIELD pjdamodid
         ...
         BEFORE FIELD pjdamoddt
            #add-point:BEFORE FIELD pjdamoddt
         ...
         ON ACTION controlp INFIELD pjdacnfid
            #add-point:ON ACTION controlp INFIELD pjdacnfid
            #應用 a08 樣板自動產生(Version:2)
            #開窗c段
            INITIALIZE g_qryparam.* TO NULL
            LET g_qryparam.state = 'c' 
         ...
         BEFORE FIELD pjdacnfid
            #add-point:BEFORE FIELD pjdacnfid
         ...
         AFTER FIELD pjdacnfid
            ...
            #add-point:AFTER FIELD pjdacnfid
         ...
         BEFORE FIELD pjdacnfdt
            #add-point:BEFORE FIELD pjdacnfdt
         ...
         ON ACTION controlp INFIELD pjdapstid
            #add-point:ON ACTION controlp INFIELD pjdapstid
            #應用 a08 樣板自動產生(Version:2)
            #開窗c段
            INITIALIZE g_qryparam.* TO NULL
            LET g_qryparam.state = 'c' 
         ...
         BEFORE FIELD pjdapstid
            #add-point:BEFORE FIELD pjdapstid
         ...
         AFTER FIELD pjdapstid
            ...
            #add-point:AFTER FIELD pjdapstid
         ...
         BEFORE FIELD pjdapstdt
            #add-point:BEFORE FIELD pjdapstdt
      ...
      CONSTRUCT g_wc2_table1 ON pjdbseq,pjdb001,pjdb002,pjdb003,pjdb004,pjdb005,pjdb006,pjdb007,pjdb008, 
          pjdb009,pjdb012,pjdb013,pjdb014,pjdb010,pjdb011,pjdb015,pjdb016,pjdb026,pjdb027,pjdb028,pjdb030, 
          pjdb031,pjdb032,pjdb033,pjdb034,pjdb035,pjdb036,pjdb037,pjdb038,pjdb039,pjdb040,pjdb041,pjdb042, 
          pjdb043,pjdb044,pjdb045,pjdb046,pjdb047,pjdb048,pjdb049,pjdb050,pjdbsite
           FROM s_detail1[1].pjdbseq,s_detail1[1].pjdb001,s_detail1[1].pjdb002,s_detail1[1].pjdb003, 
               s_detail1[1].pjdb004,s_detail1[1].pjdb005,s_detail1[1].pjdb006,s_detail1[1].pjdb007,s_detail1[1].pjdb008, 
               s_detail1[1].pjdb009,s_detail1[1].pjdb012,s_detail1[1].pjdb013,s_detail1[1].pjdb014,s_detail1[1].pjdb010, 
               s_detail1[1].pjdb011,s_detail1[1].pjdb015,s_detail1[1].pjdb016,s_detail1[1].pjdb026,s_detail1[1].pjdb027, 
               s_detail1[1].pjdb028,s_detail1[1].pjdb030,s_detail1[1].pjdb031,s_detail1[1].pjdb032,s_detail1[1].pjdb033, 
               s_detail1[1].pjdb034,s_detail1[1].pjdb035,s_detail1[1].pjdb036,s_detail1[1].pjdb037,s_detail1[1].pjdb038, 
               s_detail1[1].pjdb039,s_detail1[1].pjdb040,s_detail1[1].pjdb041,s_detail1[1].pjdb042,s_detail1[1].pjdb043, 
               s_detail1[1].pjdb044,s_detail1[1].pjdb045,s_detail1[1].pjdb046,s_detail1[1].pjdb047,s_detail1[1].pjdb048, 
               s_detail1[1].pjdb049,s_detail1[1].pjdb050,s_detail1[1].pjdbsite
       ...
       #單身一般欄位開窗相關處理
         ...
         BEFORE FIELD pjdbseq
            #add-point:BEFORE FIELD pjdbseq
...
#         #應用 a03 樣板自動產生(Version:2)
         ON ACTION controlp INFIELD pjdbseq
            #add-point:ON ACTION controlp INFIELD pjdbseq
         ...
         ON ACTION controlp INFIELD pjdb001
            #add-point:ON ACTION controlp INFIELD pjdb001
            #應用 a08 樣板自動產生(Version:2)
            #開窗c段
            INITIALIZE g_qryparam.* TO NULL
            LET g_qryparam.state = 'c' 
         ...
         BEFORE FIELD pjdb001
            #add-point:BEFORE FIELD pjdb001
         ...
         ON ACTION controlp INFIELD pjdb002
            #add-point:ON ACTION controlp INFIELD pjdb002
            #應用 a08 樣板自動產生(Version:2)
            #開窗c段
            INITIALIZE g_qryparam.* TO NULL
            LET g_qryparam.state = 'c' 
         ...
         BEFORE FIELD pjdb002
            #add-point:BEFORE FIELD pjdb002
         ...
         AFTER FIELD pjdb002
            ...
            #add-point:AFTER FIELD pjdb002
            
            #END add-point
            
 
         #Ctrlp:construct.c.page1.pjdb003
         #應用 a03 樣板自動產生(Version:2)
         ON ACTION controlp INFIELD pjdb003
            #add-point:ON ACTION controlp INFIELD pjdb003
            #應用 a08 樣板自動產生(Version:2)
            #開窗c段
            INITIALIZE g_qryparam.* TO NULL
            LET g_qryparam.state = 'c' 
         ...
         BEFORE FIELD pjdb003
            #add-point:BEFORE FIELD pjdb003
         ...
         AFTER FIELD pjdb003
            ...
            #add-point:AFTER FIELD pjdb003
            
            #END add-point
            
 
         #Ctrlp:construct.c.page1.pjdb004
         #應用 a03 樣板自動產生(Version:2)
         ON ACTION controlp INFIELD pjdb004
            #add-point:ON ACTION controlp INFIELD pjdb004
            #應用 a08 樣板自動產生(Version:2)
            #開窗c段
            INITIALIZE g_qryparam.* TO NULL
            LET g_qryparam.state = 'c' 
         ...
         BEFORE FIELD pjdb004
            #add-point:BEFORE FIELD pjdb004
         ...
         AFTER FIELD pjdb004
            ...
            #add-point:AFTER FIELD pjdb004
            
            #END add-point
            
 
         #Ctrlp:construct.c.page1.pjdb005
         #應用 a03 樣板自動產生(Version:2)
         ON ACTION controlp INFIELD pjdb005
            #add-point:ON ACTION controlp INFIELD pjdb005
            #應用 a08 樣板自動產生(Version:2)
            #開窗c段
            INITIALIZE g_qryparam.* TO NULL
            LET g_qryparam.state = 'c' 
         ...
         BEFORE FIELD pjdb005
            #add-point:BEFORE FIELD pjdb005
         ...
         AFTER FIELD pjdb005
            ...
            #add-point:AFTER FIELD pjdb005
            
            #END add-point
            
 
         #Ctrlp:construct.c.page1.pjdb006
         #應用 a03 樣板自動產生(Version:2)
         ON ACTION controlp INFIELD pjdb006
            #add-point:ON ACTION controlp INFIELD pjdb006
            #應用 a08 樣板自動產生(Version:2)
            #開窗c段
            INITIALIZE g_qryparam.* TO NULL
            LET g_qryparam.state = 'c' 
         ...
         BEFORE FIELD pjdb006
            #add-point:BEFORE FIELD pjdb006
         ...
         AFTER FIELD pjdb006
            ...
            #add-point:AFTER FIELD pjdb006
            
            #END add-point
            
 
         #Ctrlp:construct.c.page1.pjdb007
         #應用 a03 樣板自動產生(Version:2)
         ON ACTION controlp INFIELD pjdb007
            #add-point:ON ACTION controlp INFIELD pjdb007
            #應用 a08 樣板自動產生(Version:2)
            #開窗c段
            INITIALIZE g_qryparam.* TO NULL
            LET g_qryparam.state = 'c' 
         ...
         BEFORE FIELD pjdb007
            #add-point:BEFORE FIELD pjdb007
         ...
         BEFORE FIELD pjdb008
            #add-point:BEFORE FIELD pjdb008
         ...
         AFTER FIELD pjdb008
            ...
            #add-point:AFTER FIELD pjdb008
            
            #END add-point
            
 
         #Ctrlp:construct.c.page1.pjdb008
#         #應用 a03 樣板自動產生(Version:2)
         ON ACTION controlp INFIELD pjdb008
            #add-point:ON ACTION controlp INFIELD pjdb008
            
            #END add-point
 
         #應用 a01 樣板自動產生(Version:1)
         BEFORE FIELD pjdb009
            #add-point:BEFORE FIELD pjdb009
         ...
         AFTER FIELD pjdb009
            ...
            #add-point:AFTER FIELD pjdb009
            
            #END add-point
            
 
         #Ctrlp:construct.c.page1.pjdb009
#         #應用 a03 樣板自動產生(Version:2)
         ON ACTION controlp INFIELD pjdb009
            #add-point:ON ACTION controlp INFIELD pjdb009
            
            #END add-point
 
         #應用 a01 樣板自動產生(Version:1)
         BEFORE FIELD pjdb012
            #add-point:BEFORE FIELD pjdb012
...
#         #應用 a03 樣板自動產生(Version:2)
         ON ACTION controlp INFIELD pjdb012
            #add-point:ON ACTION controlp INFIELD pjdb012
            
            #END add-point
 
         #應用 a01 樣板自動產生(Version:1)
         BEFORE FIELD pjdb013
            #add-point:BEFORE FIELD pjdb013
...
#         #應用 a03 樣板自動產生(Version:2)
         ON ACTION controlp INFIELD pjdb013
            #add-point:ON ACTION controlp INFIELD pjdb013
            
            #END add-point
 
         #應用 a01 樣板自動產生(Version:1)
         BEFORE FIELD pjdb014
            #add-point:BEFORE FIELD pjdb014
...
#         #應用 a03 樣板自動產生(Version:2)
         ON ACTION controlp INFIELD pjdb014
            #add-point:ON ACTION controlp INFIELD pjdb014
            
            #END add-point
 
         #應用 a01 樣板自動產生(Version:1)
         BEFORE FIELD pjdb010
            #add-point:BEFORE FIELD pjdb010
...
#         #應用 a03 樣板自動產生(Version:2)
         ON ACTION controlp INFIELD pjdb010
            #add-point:ON ACTION controlp INFIELD pjdb010
            
            #END add-point
 
         #應用 a01 樣板自動產生(Version:1)
         BEFORE FIELD pjdb011
            #add-point:BEFORE FIELD pjdb011
...
#         #應用 a03 樣板自動產生(Version:2)
         ON ACTION controlp INFIELD pjdb011
            #add-point:ON ACTION controlp INFIELD pjdb011
            
            #END add-point
 
         #應用 a01 樣板自動產生(Version:1)
         BEFORE FIELD pjdb015
            #add-point:BEFORE FIELD pjdb015
...
#         #應用 a03 樣板自動產生(Version:2)
         ON ACTION controlp INFIELD pjdb015
            #add-point:ON ACTION controlp INFIELD pjdb015
            
            #END add-point
 
         #應用 a01 樣板自動產生(Version:1)
         BEFORE FIELD pjdb016
            #add-point:BEFORE FIELD pjdb016
...
#         #應用 a03 樣板自動產生(Version:2)
         ON ACTION controlp INFIELD pjdb016
            #add-point:ON ACTION controlp INFIELD pjdb016
            
            #END add-point
 
         #應用 a01 樣板自動產生(Version:1)
         BEFORE FIELD pjdb026
            #add-point:BEFORE FIELD pjdb026
         ...
         AFTER FIELD pjdb026
            ...
            #add-point:AFTER FIELD pjdb026
            
            #END add-point
            
 
         #Ctrlp:construct.c.page1.pjdb026
#         #應用 a03 樣板自動產生(Version:2)
         ON ACTION controlp INFIELD pjdb026
            #add-point:ON ACTION controlp INFIELD pjdb026
            
            #END add-point
 
         #應用 a01 樣板自動產生(Version:1)
         BEFORE FIELD pjdb027
            #add-point:BEFORE FIELD pjdb027
         ...
         AFTER FIELD pjdb027
            ...
            #add-point:AFTER FIELD pjdb027
            
            #END add-point
            
 
         #Ctrlp:construct.c.page1.pjdb027
#         #應用 a03 樣板自動產生(Version:2)
         ON ACTION controlp INFIELD pjdb027
            #add-point:ON ACTION controlp INFIELD pjdb027
            
            #END add-point
 
         #應用 a01 樣板自動產生(Version:1)
         BEFORE FIELD pjdb028
            #add-point:BEFORE FIELD pjdb028
         ...
         AFTER FIELD pjdb028
            ...
            #add-point:AFTER FIELD pjdb028
            
            #END add-point
            
 
         #Ctrlp:construct.c.page1.pjdb028
#         #應用 a03 樣板自動產生(Version:2)
         ON ACTION controlp INFIELD pjdb028
            #add-point:ON ACTION controlp INFIELD pjdb028
            
            #END add-point
 
         #應用 a01 樣板自動產生(Version:1)
         BEFORE FIELD pjdb030
            #add-point:BEFORE FIELD pjdb030
         ...
         AFTER FIELD pjdb030
            ...
            #add-point:AFTER FIELD pjdb030
            
            #END add-point
            
 
         #Ctrlp:construct.c.page1.pjdb030
#         #應用 a03 樣板自動產生(Version:2)
         ON ACTION controlp INFIELD pjdb030
            #add-point:ON ACTION controlp INFIELD pjdb030
            
            #END add-point
 
         #應用 a01 樣板自動產生(Version:1)
         BEFORE FIELD pjdb031
            #add-point:BEFORE FIELD pjdb031
         ...
         AFTER FIELD pjdb031
            ...
            #add-point:AFTER FIELD pjdb031
            
            #END add-point
            
 
         #Ctrlp:construct.c.page1.pjdb031
#         #應用 a03 樣板自動產生(Version:2)
         ON ACTION controlp INFIELD pjdb031
            #add-point:ON ACTION controlp INFIELD pjdb031
            
            #END add-point
 
         #應用 a01 樣板自動產生(Version:1)
         BEFORE FIELD pjdb032
            #add-point:BEFORE FIELD pjdb032
         ...
         AFTER FIELD pjdb032
            ...
            #add-point:AFTER FIELD pjdb032
            
            #END add-point
            
 
         #Ctrlp:construct.c.page1.pjdb032
#         #應用 a03 樣板自動產生(Version:2)
         ON ACTION controlp INFIELD pjdb032
            #add-point:ON ACTION controlp INFIELD pjdb032
            
            #END add-point
 
         #應用 a01 樣板自動產生(Version:1)
         BEFORE FIELD pjdb033
            #add-point:BEFORE FIELD pjdb033
         ...
         AFTER FIELD pjdb033
            ...
            #add-point:AFTER FIELD pjdb033
            
            #END add-point
            
 
         #Ctrlp:construct.c.page1.pjdb033
#         #應用 a03 樣板自動產生(Version:2)
         ON ACTION controlp INFIELD pjdb033
            #add-point:ON ACTION controlp INFIELD pjdb033
            
            #END add-point
 
         #應用 a01 樣板自動產生(Version:1)
         BEFORE FIELD pjdb034
            #add-point:BEFORE FIELD pjdb034
         ...
         AFTER FIELD pjdb034
            ...
            #add-point:AFTER FIELD pjdb034
            
            #END add-point
            
 
         #Ctrlp:construct.c.page1.pjdb034
#         #應用 a03 樣板自動產生(Version:2)
         ON ACTION controlp INFIELD pjdb034
            #add-point:ON ACTION controlp INFIELD pjdb034
            
            #END add-point
 
         #應用 a01 樣板自動產生(Version:1)
         BEFORE FIELD pjdb035
            #add-point:BEFORE FIELD pjdb035
         ...
         AFTER FIELD pjdb035
            ...
            #add-point:AFTER FIELD pjdb035
            
            #END add-point
            
 
         #Ctrlp:construct.c.page1.pjdb035
#         #應用 a03 樣板自動產生(Version:2)
         ON ACTION controlp INFIELD pjdb035
            #add-point:ON ACTION controlp INFIELD pjdb035
            
            #END add-point
 
         #應用 a01 樣板自動產生(Version:1)
         BEFORE FIELD pjdb036
            #add-point:BEFORE FIELD pjdb036
         ...
         AFTER FIELD pjdb036
            ...
            #add-point:AFTER FIELD pjdb036
            
            #END add-point
            
 
         #Ctrlp:construct.c.page1.pjdb036
#         #應用 a03 樣板自動產生(Version:2)
         ON ACTION controlp INFIELD pjdb036
            #add-point:ON ACTION controlp INFIELD pjdb036
            
            #END add-point
 
         #應用 a01 樣板自動產生(Version:1)
         BEFORE FIELD pjdb037
            #add-point:BEFORE FIELD pjdb037
         ...
         AFTER FIELD pjdb037
            ...
            #add-point:AFTER FIELD pjdb037
            
            #END add-point
            
 
         #Ctrlp:construct.c.page1.pjdb037
#         #應用 a03 樣板自動產生(Version:2)
         ON ACTION controlp INFIELD pjdb037
            #add-point:ON ACTION controlp INFIELD pjdb037
            
            #END add-point
 
         #應用 a01 樣板自動產生(Version:1)
         BEFORE FIELD pjdb038
            #add-point:BEFORE FIELD pjdb038
         ...
         AFTER FIELD pjdb038
            ...
            #add-point:AFTER FIELD pjdb038
            
            #END add-point
            
 
         #Ctrlp:construct.c.page1.pjdb038
#         #應用 a03 樣板自動產生(Version:2)
         ON ACTION controlp INFIELD pjdb038
            #add-point:ON ACTION controlp INFIELD pjdb038
            
            #END add-point
 
         #應用 a01 樣板自動產生(Version:1)
         BEFORE FIELD pjdb039
            #add-point:BEFORE FIELD pjdb039
         ...
         AFTER FIELD pjdb039
            ...
            #add-point:AFTER FIELD pjdb039
            
            #END add-point
            
 
         #Ctrlp:construct.c.page1.pjdb039
#         #應用 a03 樣板自動產生(Version:2)
         ON ACTION controlp INFIELD pjdb039
            #add-point:ON ACTION controlp INFIELD pjdb039
            
            #END add-point
 
         #應用 a01 樣板自動產生(Version:1)
         BEFORE FIELD pjdb040
            #add-point:BEFORE FIELD pjdb040
         ...
         AFTER FIELD pjdb040
            ...
            #add-point:AFTER FIELD pjdb040
            
            #END add-point
            
 
         #Ctrlp:construct.c.page1.pjdb040
#         #應用 a03 樣板自動產生(Version:2)
         ON ACTION controlp INFIELD pjdb040
            #add-point:ON ACTION controlp INFIELD pjdb040
            
            #END add-point
 
         #應用 a01 樣板自動產生(Version:1)
         BEFORE FIELD pjdb041
            #add-point:BEFORE FIELD pjdb041
         ...
         AFTER FIELD pjdb041
            ...
            #add-point:AFTER FIELD pjdb041
            
            #END add-point
            
 
         #Ctrlp:construct.c.page1.pjdb041
#         #應用 a03 樣板自動產生(Version:2)
         ON ACTION controlp INFIELD pjdb041
            #add-point:ON ACTION controlp INFIELD pjdb041
            
            #END add-point
 
         #應用 a01 樣板自動產生(Version:1)
         BEFORE FIELD pjdb042
            #add-point:BEFORE FIELD pjdb042
         ...
         AFTER FIELD pjdb042
            ...
            #add-point:AFTER FIELD pjdb042
            
            #END add-point
            
 
         #Ctrlp:construct.c.page1.pjdb042
#         #應用 a03 樣板自動產生(Version:2)
         ON ACTION controlp INFIELD pjdb042
            #add-point:ON ACTION controlp INFIELD pjdb042
            
            #END add-point
 
         #應用 a01 樣板自動產生(Version:1)
         BEFORE FIELD pjdb043
            #add-point:BEFORE FIELD pjdb043
         ...
         AFTER FIELD pjdb043
            ...
            #add-point:AFTER FIELD pjdb043
            
            #END add-point
            
 
         #Ctrlp:construct.c.page1.pjdb043
#         #應用 a03 樣板自動產生(Version:2)
         ON ACTION controlp INFIELD pjdb043
            #add-point:ON ACTION controlp INFIELD pjdb043
            
            #END add-point
 
         #應用 a01 樣板自動產生(Version:1)
         BEFORE FIELD pjdb044
            #add-point:BEFORE FIELD pjdb044
         ...
         AFTER FIELD pjdb044
            ...
            #add-point:AFTER FIELD pjdb044
            
            #END add-point
            
 
         #Ctrlp:construct.c.page1.pjdb044
#         #應用 a03 樣板自動產生(Version:2)
         ON ACTION controlp INFIELD pjdb044
            #add-point:ON ACTION controlp INFIELD pjdb044
            
            #END add-point
 
         #應用 a01 樣板自動產生(Version:1)
         BEFORE FIELD pjdb045
            #add-point:BEFORE FIELD pjdb045
         ...
         AFTER FIELD pjdb045
            ...
            #add-point:AFTER FIELD pjdb045
            
            #END add-point
            
 
         #Ctrlp:construct.c.page1.pjdb045
#         #應用 a03 樣板自動產生(Version:2)
         ON ACTION controlp INFIELD pjdb045
            #add-point:ON ACTION controlp INFIELD pjdb045
            
            #END add-point
 
         #應用 a01 樣板自動產生(Version:1)
         BEFORE FIELD pjdb046
            #add-point:BEFORE FIELD pjdb046
         ...
         AFTER FIELD pjdb046
            ...
            #add-point:AFTER FIELD pjdb046
            
            #END add-point
            
 
         #Ctrlp:construct.c.page1.pjdb046
#         #應用 a03 樣板自動產生(Version:2)
         ON ACTION controlp INFIELD pjdb046
            #add-point:ON ACTION controlp INFIELD pjdb046
            
            #END add-point
 
         #應用 a01 樣板自動產生(Version:1)
         BEFORE FIELD pjdb047
            #add-point:BEFORE FIELD pjdb047
         ...
         AFTER FIELD pjdb047
            ...
            #add-point:AFTER FIELD pjdb047
            
            #END add-point
            
 
         #Ctrlp:construct.c.page1.pjdb047
#         #應用 a03 樣板自動產生(Version:2)
         ON ACTION controlp INFIELD pjdb047
            #add-point:ON ACTION controlp INFIELD pjdb047
            
            #END add-point
 
         #應用 a01 樣板自動產生(Version:1)
         BEFORE FIELD pjdb048
            #add-point:BEFORE FIELD pjdb048
         ...
         AFTER FIELD pjdb048
            ...
            #add-point:AFTER FIELD pjdb048
            
            #END add-point
            
 
         #Ctrlp:construct.c.page1.pjdb048
#         #應用 a03 樣板自動產生(Version:2)
         ON ACTION controlp INFIELD pjdb048
            #add-point:ON ACTION controlp INFIELD pjdb048
            
            #END add-point
 
         #應用 a01 樣板自動產生(Version:1)
         BEFORE FIELD pjdb049
            #add-point:BEFORE FIELD pjdb049
         ...
         AFTER FIELD pjdb049
            ...
            #add-point:AFTER FIELD pjdb049
            
            #END add-point
            
 
         #Ctrlp:construct.c.page1.pjdb049
#         #應用 a03 樣板自動產生(Version:2)
         ON ACTION controlp INFIELD pjdb049
            #add-point:ON ACTION controlp INFIELD pjdb049
            
            #END add-point
 
         #應用 a01 樣板自動產生(Version:1)
         BEFORE FIELD pjdb050
            #add-point:BEFORE FIELD pjdb050
         ...
         ON ACTION controlp INFIELD pjdb050
            #add-point:ON ACTION controlp INFIELD pjdb050
            #此段落由子樣板a08產生
            #開窗c段
   			INITIALIZE g_qryparam.* TO NULL
            LET g_qryparam.state = 'c'
         ...
         BEFORE FIELD pjdbsite
            #add-point:BEFORE FIELD pjdbsite
         ...
         AFTER FIELD pjdbsite
            ...
            #add-point:AFTER FIELD pjdbsite
...
#         #應用 a03 樣板自動產生(Version:2)
         ON ACTION controlp INFIELD pjdbsite
            #add-point:ON ACTION controlp INFIELD pjdbsite
...
PRIVATE FUNCTION apjt302_insert()
   ...
   INITIALIZE g_pjda_m.* LIKE pjda_t.*             #DEFAULT 設定
...
LET g_pjda_m.pjdamodid_desc = cl_get_username(g_pjda_m.pjdamodid)
      ...
      #若單頭key欄位有變更
      IF g_pjda_m.pjdadocno != g_pjdadocno_t 
...
PRIVATE FUNCTION apjt302_input(p_cmd)
   ...
   #end add-point 
   LET g_forupd_sql = "SELECT pjdbseq,pjdb001,pjdb002,pjdb003,pjdb004,pjdb005,pjdb006,pjdb007,pjdb008, 
       pjdb009,pjdb012,pjdb013,pjdb014,pjdb010,pjdb011,pjdb015,pjdb016,pjdb026,pjdb027,pjdb028,pjdb029, 
       pjdb030,pjdb031,pjdb032,pjdb033,pjdb034,pjdb035,pjdb036,pjdb037,pjdb038,pjdb039,pjdb040,pjdb041, 
       pjdb042,pjdb043,pjdb044,pjdb045,pjdb046,pjdb047,pjdb048,pjdb049,pjdb050,pjdbsite FROM pjdb_t  
       WHERE pjdbent=? AND pjdbdocno=? AND pjdbseq=? FOR UPDATE"
   #add-point:input段define_sql
      ...
      INPUT BY NAME g_pjda_m.pjdadocno,g_pjda_m.pjdadocdt,g_pjda_m.pjdasite,g_pjda_m.pjda001,g_pjda_m.pjda002, 
         ...
         AFTER FIELD pjda001
            ...
            IF NOT cl_null(g_pjda_m.pjda001) THEN
               IF p_cmd = 'a' OR ( p_cmd = 'u' AND (g_pjda_m.pjda001 != g_pjda_m_t.pjda001 OR cl_null(g_pjda_m_t.pjda001))) THEN            
                  #此段落由子樣板a19產生
 ...
 #欄位開窗
         ...
         AFTER INPUT
            ...
            IF p_cmd <> 'u' THEN
               ...
               IF SQLCA.sqlcode THEN
                  INITIALIZE g_errparam TO NULL 
                  LET g_errparam.extend = "g_pjda_m" 
                  LET g_errparam.code   = SQLCA.sqlcode 
                  LET g_errparam.popup  = TRUE 
                  CALL cl_err()
                  CALL s_transaction_end('N','0')
...
{<section id="apjt302.input.body" >}
            ...
            THEN
               ...
               ELSE
                  FETCH apjt302_bcl INTO g_pjdb_d[l_ac].pjdbseq,g_pjdb_d[l_ac].pjdb001,g_pjdb_d[l_ac].pjdb002, 
                      g_pjdb_d[l_ac].pjdb003,g_pjdb_d[l_ac].pjdb004,g_pjdb_d[l_ac].pjdb005,g_pjdb_d[l_ac].pjdb006, 
                      g_pjdb_d[l_ac].pjdb007,g_pjdb_d[l_ac].pjdb008,g_pjdb_d[l_ac].pjdb009,g_pjdb_d[l_ac].pjdb012, 
                      g_pjdb_d[l_ac].pjdb013,g_pjdb_d[l_ac].pjdb014,g_pjdb_d[l_ac].pjdb010,g_pjdb_d[l_ac].pjdb011, 
                      g_pjdb_d[l_ac].pjdb015,g_pjdb_d[l_ac].pjdb016,g_pjdb_d[l_ac].pjdb026,g_pjdb_d[l_ac].pjdb027, 
                      g_pjdb_d[l_ac].pjdb028,g_pjdb_d[l_ac].pjdb029,g_pjdb_d[l_ac].pjdb030,g_pjdb_d[l_ac].pjdb031, 
                      g_pjdb_d[l_ac].pjdb032,g_pjdb_d[l_ac].pjdb033,g_pjdb_d[l_ac].pjdb034,g_pjdb_d[l_ac].pjdb035, 
                      g_pjdb_d[l_ac].pjdb036,g_pjdb_d[l_ac].pjdb037,g_pjdb_d[l_ac].pjdb038,g_pjdb_d[l_ac].pjdb039, 
                      g_pjdb_d[l_ac].pjdb040,g_pjdb_d[l_ac].pjdb041,g_pjdb_d[l_ac].pjdb042,g_pjdb_d[l_ac].pjdb043, 
                      g_pjdb_d[l_ac].pjdb044,g_pjdb_d[l_ac].pjdb045,g_pjdb_d[l_ac].pjdb046,g_pjdb_d[l_ac].pjdb047, 
                      g_pjdb_d[l_ac].pjdb048,g_pjdb_d[l_ac].pjdb049,g_pjdb_d[l_ac].pjdb050,g_pjdb_d[l_ac].pjdbsite 
 
                  IF SQLCA.sqlcode THEN
                     INITIALIZE g_errparam TO NULL 
                     LET g_errparam.extend = g_pjdb_d_t.pjdbseq 
                     LET g_errparam.code   = SQLCA.sqlcode 
                     LET g_errparam.popup  = TRUE 
                     CALL cl_err()
                     LET l_lock_sw = "Y"
      ...
      LET g_pjdb_d[l_ac].pjdb042 = "0"
      LET g_pjdb_d[l_ac].pjdb043 = "0"
      LET g_pjdb_d[l_ac].pjdb044 = "0"
      LET g_pjdb_d[l_ac].pjdb045 = "0"
      LET g_pjdb_d[l_ac].pjdb046 = "0"
      LET g_pjdb_d[l_ac].pjdb047 = "0"
      LET g_pjdb_d[l_ac].pjdb048 = "0"
      LET g_pjdb_d[l_ac].pjdb049 = "0"
         ...
         AFTER FIELD pjdb003
            ...
            LET g_ref_fields[1] = g_pjdb_d[l_ac].pjdb003
            ...
            LET g_pjdb_d[l_ac].pjdb003_desc = '', g_rtn_fields[1] , ''
            DISPLAY BY NAME g_pjdb_d[l_ac].pjdb003_desc
         ...
         AFTER FIELD pjdb004
            ...
            #add-point:AFTER FIELD pjdb004
            INITIALIZE g_ref_fields TO NULL
            LET g_ref_fields[1] = g_pjdb_d[l_ac].pjdb004
            ...
            LET g_pjdb_d[l_ac].pjdb004_desc = '', g_rtn_fields[1] , ''
            DISPLAY BY NAME g_pjdb_d[l_ac].pjdb004_desc
         ...
         AFTER FIELD pjdb005
            ...
            #add-point:AFTER FIELD pjdb005
            INITIALIZE g_ref_fields TO NULL
            LET g_ref_fields[1] = g_pjdb_d[l_ac].pjdb005
            CALL ap_ref_array2(g_ref_fields,"SELECT ooail003 FROM ooail_t WHERE ooailent='"||g_enterprise||"' AND ooail001=? AND ooail002='"||g_dlang||"'","") RETURNING g_rtn_fields
            LET g_pjdb_d[l_ac].pjdb005_desc = '', g_rtn_fields[1] , ''
            DISPLAY BY NAME g_pjdb_d[l_ac].pjdb005_desc
         ...
         AFTER FIELD pjdb007
            ...
            #add-point:AFTER FIELD pjdb007
            INITIALIZE g_ref_fields TO NULL
            LET g_ref_fields[1] = g_pjdb_d[l_ac].pjdb007
            ...
            LET g_pjdb_d[l_ac].pjdb007_desc = '', g_rtn_fields[1] , ''
            DISPLAY BY NAME g_pjdb_d[l_ac].pjdb007_desc
...
#         #應用 a03 樣板自動產生(Version:2)
         ...
         ON ACTION controlp INFIELD pjdb003
            ...
            LET g_qryparam.default1 = g_pjdb_d[l_ac].pjdb003             #給予default值
            ...
            LET g_pjdb_d[l_ac].pjdb003 = g_qryparam.return1              

            DISPLAY g_pjdb_d[l_ac].pjdb003 TO pjdb003              #
         ...
         ON ACTION controlp INFIELD pjdb004
            ...
            LET g_qryparam.default1 = g_pjdb_d[l_ac].pjdb004             #給予default值
            LET g_qryparam.default2 = "" #g_pjdb_d[l_ac].oocql004 #說明
            #給予arg
            LET g_qryparam.arg1 = "" #s
            ...
            LET g_pjdb_d[l_ac].pjdb004 = g_qryparam.return1              
            #LET g_pjdb_d[l_ac].oocql004 = g_qryparam.return2 
            DISPLAY g_pjdb_d[l_ac].pjdb004 TO pjdb004              #
            #DISPLAY g_pjdb_d[l_ac].oocql004 TO oocql004 #說明
            NEXT FIELD pjdb004                          #返回原欄位


            #END add-point
 
         #Ctrlp:input.c.page1.pjdb005
         #應用 a03 樣板自動產生(Version:2)
         ON ACTION controlp INFIELD pjdb005
            #add-point:ON ACTION controlp INFIELD pjdb005
            #應用 a07 樣板自動產生(Version:2)   
            ...
            LET g_qryparam.default1 = g_pjdb_d[l_ac].pjdb005             #給予default值
            LET g_qryparam.default2 = "" #g_pjdb_d[l_ac].ooaj002 #使用幣別
            #給予arg
            LET g_qryparam.arg1 = "" #s
            ...
            LET g_pjdb_d[l_ac].pjdb005 = g_qryparam.return1              
            #LET g_pjdb_d[l_ac].ooaj002 = g_qryparam.return2 
            DISPLAY g_pjdb_d[l_ac].pjdb005 TO pjdb005              #
            #DISPLAY g_pjdb_d[l_ac].ooaj002 TO ooaj002 #使用幣別
            NEXT FIELD pjdb005                          #返回原欄位


            #END add-point
 
         #Ctrlp:input.c.page1.pjdb006
         #應用 a03 樣板自動產生(Version:2)
         ON ACTION controlp INFIELD pjdb006
            #add-point:ON ACTION controlp INFIELD pjdb006
            #應用 a07 樣板自動產生(Version:2)   
            ...
            LET g_qryparam.default1 = g_pjdb_d[l_ac].pjdb006             #給予default值
            LET g_qryparam.default2 = "" #g_pjdb_d[l_ac].oodbl004 #說明
            #給予arg
            LET g_qryparam.arg1 = "" #s
            ...
            LET g_pjdb_d[l_ac].pjdb006 = g_qryparam.return1              
            #LET g_pjdb_d[l_ac].oodbl004 = g_qryparam.return2 
            DISPLAY g_pjdb_d[l_ac].pjdb006 TO pjdb006              #
            #DISPLAY g_pjdb_d[l_ac].oodbl004 TO oodbl004 #說明
            NEXT FIELD pjdb006                          #返回原欄位


            #END add-point
 
         #Ctrlp:input.c.page1.pjdb007
#         #應用 a03 樣板自動產生(Version:2)
         ON ACTION controlp INFIELD pjdb007
            #add-point:ON ACTION controlp INFIELD pjdb007
...
#         #應用 a03 樣板自動產生(Version:2)
         ...
         ON ROW CHANGE
            ...
            ELSE
               ...
               UPDATE pjdb_t SET (pjdbdocno,pjdbseq,pjdb001,pjdb002,pjdb003,pjdb004,pjdb005,pjdb006, 
                   pjdb007,pjdb008,pjdb009,pjdb012,pjdb013,pjdb014,pjdb010,pjdb011,pjdb015,pjdb016,pjdb026, 
                   pjdb027,pjdb028,pjdb029,pjdb030,pjdb031,pjdb032,pjdb033,pjdb034,pjdb035,pjdb036,pjdb037, 
                   pjdb038,pjdb039,pjdb040,pjdb041,pjdb042,pjdb043,pjdb044,pjdb045,pjdb046,pjdb047,pjdb048, 
                   pjdb049,pjdb050,pjdbsite) = (g_pjda_m.pjdadocno,g_pjdb_d[l_ac].pjdbseq,g_pjdb_d[l_ac].pjdb001, 
                   g_pjdb_d[l_ac].pjdb002,g_pjdb_d[l_ac].pjdb003,g_pjdb_d[l_ac].pjdb004,g_pjdb_d[l_ac].pjdb005, 
                   g_pjdb_d[l_ac].pjdb006,g_pjdb_d[l_ac].pjdb007,g_pjdb_d[l_ac].pjdb008,g_pjdb_d[l_ac].pjdb009, 
                   g_pjdb_d[l_ac].pjdb012,g_pjdb_d[l_ac].pjdb013,g_pjdb_d[l_ac].pjdb014,g_pjdb_d[l_ac].pjdb010, 
                   g_pjdb_d[l_ac].pjdb011,g_pjdb_d[l_ac].pjdb015,g_pjdb_d[l_ac].pjdb016,g_pjdb_d[l_ac].pjdb026, 
                   g_pjdb_d[l_ac].pjdb027,g_pjdb_d[l_ac].pjdb028,g_pjdb_d[l_ac].pjdb029,g_pjdb_d[l_ac].pjdb030, 
                   g_pjdb_d[l_ac].pjdb031,g_pjdb_d[l_ac].pjdb032,g_pjdb_d[l_ac].pjdb033,g_pjdb_d[l_ac].pjdb034, 
                   g_pjdb_d[l_ac].pjdb035,g_pjdb_d[l_ac].pjdb036,g_pjdb_d[l_ac].pjdb037,g_pjdb_d[l_ac].pjdb038, 
                   g_pjdb_d[l_ac].pjdb039,g_pjdb_d[l_ac].pjdb040,g_pjdb_d[l_ac].pjdb041,g_pjdb_d[l_ac].pjdb042, 
                   g_pjdb_d[l_ac].pjdb043,g_pjdb_d[l_ac].pjdb044,g_pjdb_d[l_ac].pjdb045,g_pjdb_d[l_ac].pjdb046, 
                   g_pjdb_d[l_ac].pjdb047,g_pjdb_d[l_ac].pjdb048,g_pjdb_d[l_ac].pjdb049,g_pjdb_d[l_ac].pjdb050, 
                   g_pjdb_d[l_ac].pjdbsite)
                WHERE pjdbent = g_enterprise AND pjdbdocno = g_pjda_m.pjdadocno 
...
PRIVATE FUNCTION apjt302_reproduce()
   ...
   DEFINE l_master    RECORD LIKE pjda_t.*
   DEFINE l_detail    RECORD LIKE pjdb_t.*
   ...
   IF apjt302_fill_chk(1) THEN
      ...
      IF g_action_choice <> 'fetch' OR cl_null(g_action_choice) THEN
         LET g_sql = "SELECT  UNIQUE pjdbseq,pjdb001,pjdb002,pjdb003,pjdb004,pjdb005,pjdb006,pjdb007, 
             ...
             pjdb050,pjdbsite ,t1.pjbal003 ,t2.pmaal004 ,t3.ooibl004 ,t4.oocql004 ,t5.ooail003 ,t6.oodbl004 FROM pjdb_t", 
                
                     " INNER JOIN pjda_t ON pjdadocno = pjdbdocno ",
               ...
               " LEFT JOIN oodbl_t t6 ON t6.oodblent='"||g_enterprise||"' AND t6.oodbl002=pjdb007 AND t6.oodbl003='"||g_dlang||"' ",
      ...
      OPEN b_fill_cs USING g_enterprise,g_pjda_m.pjdadocno
                                               
      FOREACH b_fill_cs INTO g_pjdb_d[l_ac].pjdbseq,g_pjdb_d[l_ac].pjdb001,g_pjdb_d[l_ac].pjdb002,g_pjdb_d[l_ac].pjdb003, 
          g_pjdb_d[l_ac].pjdb004,g_pjdb_d[l_ac].pjdb005,g_pjdb_d[l_ac].pjdb006,g_pjdb_d[l_ac].pjdb007, 
          g_pjdb_d[l_ac].pjdb008,g_pjdb_d[l_ac].pjdb009,g_pjdb_d[l_ac].pjdb012,g_pjdb_d[l_ac].pjdb013, 
          g_pjdb_d[l_ac].pjdb014,g_pjdb_d[l_ac].pjdb010,g_pjdb_d[l_ac].pjdb011,g_pjdb_d[l_ac].pjdb015, 
          g_pjdb_d[l_ac].pjdb016,g_pjdb_d[l_ac].pjdb026,g_pjdb_d[l_ac].pjdb027,g_pjdb_d[l_ac].pjdb028, 
          g_pjdb_d[l_ac].pjdb029,g_pjdb_d[l_ac].pjdb030,g_pjdb_d[l_ac].pjdb031,g_pjdb_d[l_ac].pjdb032, 
          g_pjdb_d[l_ac].pjdb033,g_pjdb_d[l_ac].pjdb034,g_pjdb_d[l_ac].pjdb035,g_pjdb_d[l_ac].pjdb036, 
          g_pjdb_d[l_ac].pjdb037,g_pjdb_d[l_ac].pjdb038,g_pjdb_d[l_ac].pjdb039,g_pjdb_d[l_ac].pjdb040, 
          g_pjdb_d[l_ac].pjdb041,g_pjdb_d[l_ac].pjdb042,g_pjdb_d[l_ac].pjdb043,g_pjdb_d[l_ac].pjdb044, 
          g_pjdb_d[l_ac].pjdb045,g_pjdb_d[l_ac].pjdb046,g_pjdb_d[l_ac].pjdb047,g_pjdb_d[l_ac].pjdb048, 
          g_pjdb_d[l_ac].pjdb049,g_pjdb_d[l_ac].pjdb050,g_pjdb_d[l_ac].pjdbsite,g_pjdb_d[l_ac].pjdb001_desc, 
          g_pjdb_d[l_ac].pjdb002_desc,g_pjdb_d[l_ac].pjdb003_desc,g_pjdb_d[l_ac].pjdb004_desc,g_pjdb_d[l_ac].pjdb005_desc, 
          g_pjdb_d[l_ac].pjdb007_desc
         IF SQLCA.sqlcode THEN
            INITIALIZE g_errparam TO NULL 
            LET g_errparam.extend = "FOREACH:" 
            LET g_errparam.code   = SQLCA.sqlcode 
   ...
   IF ls_group.getIndexOf(ps_page,1) > 0 THEN
      ...
      INSERT INTO pjdb_t
                  (pjdbent,
                   pjdbdocno,
                   pjdbseq
                   ,pjdb001,pjdb002,pjdb003,pjdb004,pjdb005,pjdb006,pjdb007,pjdb008,pjdb009,pjdb012,pjdb013,pjdb014,pjdb010,pjdb011,pjdb015,pjdb016,pjdb026,pjdb027,pjdb028,pjdb029,pjdb030,pjdb031,pjdb032,pjdb033,pjdb034,pjdb035,pjdb036,pjdb037,pjdb038,pjdb039,pjdb040,pjdb041,pjdb042,pjdb043,pjdb044,pjdb045,pjdb046,pjdb047,pjdb048,pjdb049,pjdb050,pjdbsite) 
            VALUES(g_enterprise,
                   ps_keys[1],ps_keys[2]
                   ,g_pjdb_d[g_detail_idx].pjdb001,g_pjdb_d[g_detail_idx].pjdb002,g_pjdb_d[g_detail_idx].pjdb003, 
                       g_pjdb_d[g_detail_idx].pjdb004,g_pjdb_d[g_detail_idx].pjdb005,g_pjdb_d[g_detail_idx].pjdb006, 
                       g_pjdb_d[g_detail_idx].pjdb007,g_pjdb_d[g_detail_idx].pjdb008,g_pjdb_d[g_detail_idx].pjdb009, 
                       g_pjdb_d[g_detail_idx].pjdb012,g_pjdb_d[g_detail_idx].pjdb013,g_pjdb_d[g_detail_idx].pjdb014, 
                       g_pjdb_d[g_detail_idx].pjdb010,g_pjdb_d[g_detail_idx].pjdb011,g_pjdb_d[g_detail_idx].pjdb015, 
                       g_pjdb_d[g_detail_idx].pjdb016,g_pjdb_d[g_detail_idx].pjdb026,g_pjdb_d[g_detail_idx].pjdb027, 
                       g_pjdb_d[g_detail_idx].pjdb028,g_pjdb_d[g_detail_idx].pjdb029,g_pjdb_d[g_detail_idx].pjdb030, 
                       g_pjdb_d[g_detail_idx].pjdb031,g_pjdb_d[g_detail_idx].pjdb032,g_pjdb_d[g_detail_idx].pjdb033, 
                       g_pjdb_d[g_detail_idx].pjdb034,g_pjdb_d[g_detail_idx].pjdb035,g_pjdb_d[g_detail_idx].pjdb036, 
                       g_pjdb_d[g_detail_idx].pjdb037,g_pjdb_d[g_detail_idx].pjdb038,g_pjdb_d[g_detail_idx].pjdb039, 
                       g_pjdb_d[g_detail_idx].pjdb040,g_pjdb_d[g_detail_idx].pjdb041,g_pjdb_d[g_detail_idx].pjdb042, 
                       g_pjdb_d[g_detail_idx].pjdb043,g_pjdb_d[g_detail_idx].pjdb044,g_pjdb_d[g_detail_idx].pjdb045, 
                       g_pjdb_d[g_detail_idx].pjdb046,g_pjdb_d[g_detail_idx].pjdb047,g_pjdb_d[g_detail_idx].pjdb048, 
                       g_pjdb_d[g_detail_idx].pjdb049,g_pjdb_d[g_detail_idx].pjdb050,g_pjdb_d[g_detail_idx].pjdbsite) 
...
PRIVATE FUNCTION apjt302_lock_b(ps_table,ps_page)
   ...
   IF ls_group.getIndexOf(ps_table,1) THEN
      ...
      IF SQLCA.sqlcode THEN
         INITIALIZE g_errparam TO NULL 
         LET g_errparam.extend = "apjt302_bcl" 
         LET g_errparam.code   = SQLCA.sqlcode 
         LET g_errparam.popup  = TRUE 
         CALL cl_err()
         RETURN FALSE
...
DEFINE l_xmdcdocno  LIKE xmdc_t.xmdcdocno
   ...
   SELECT DISTINCT xmdadocno
    ...
    WHERE xmdaent = xmdcent 
      ...
      AND xmdastus = 'Y'
      AND xmda005<>'X'   #add by zhangyu 160229
      
   SELECT xmda004,pmaal003,xmda009,ooibl004,xmda010,oocql004,
          xmda015,ooail003,xmda016
     INTO g_pjdb_d[l_ac].pjdb002,g_pjdb_d[l_ac].pjdb002_desc,g_pjdb_d[l_ac].pjdb003,g_pjdb_d[l_ac].pjdb003_desc,
   ...
   SELECT xmdc016,oodbl004,oodb005,xmdc017,xmdc046,xmdc047
     INTO g_pjdb_d[l_ac].pjdb007,g_pjdb_d[l_ac].pjdb007_desc,g_pjdb_d[l_ac].pjdb008,
          g_pjdb_d[l_ac].pjdb009,g_pjdb_d[l_ac].pjdb010,g_pjdb_d[l_ac].pjdb011
     FROM xmdc_t
   ...
   SELECT SUM(pjdb014),SUM(pjdb042),SUM(pjdb043),SUM(pjdb044),SUM(pjdb045),
     ...
     INTO g_pjdb_d[l_ac].pjdb012,g_pjdb_d[l_ac].pjdb034,g_pjdb_d[l_ac].pjdb035,g_pjdb_d[l_ac].pjdb036,g_pjdb_d[l_ac].pjdb037,
          g_pjdb_d[l_ac].pjdb038,g_pjdb_d[l_ac].pjdb039,g_pjdb_d[l_ac].pjdb040,g_pjdb_d[l_ac].pjdb041
     FROM pjdb_t,pjda_t
