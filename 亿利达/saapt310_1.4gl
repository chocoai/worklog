       ...
       AFTER FIELD apg05f
          IF NOT cl_null(g_apg[l_ac].apg05f) THEN
             ...
             IF g_apg[l_ac].apg05f = g_apg_t.apg05f THEN ELSE
                ...
                END IF 
             END IF
            #add by cjy 20141230  预防汇率为1原币本币不相等
            IF NOT cl_null(g_apg[l_ac].apg05) THEN
             LET l_apa14 = ''
             SELECT apa14 INTO l_apa14 FROM apa_file WHERE apa01= g_apg[l_ac].apg04
             IF l_apa14 = '1' THEN
                IF g_apg[l_ac].apg05f * l_apa14 <> g_apg[l_ac].apg05 THEN
                    CALL  cl_err ('','原币乘以汇率不等于本币!',2)
                    NEXT FIELD apg05f
                END IF
             END IF
            END IF
           #end add by cjy 20141230
          END IF
...
#   LET l_nme.nme14=''
   ...
   END IF                                                                                                                           
   #LET l_nme.nme24='9' 
   LET l_nme.nme24='99'  #modify by sunar151019                                                                           
...
FUNCTION t3101()
  ...
  #IF g_apf.apf10 = g_apf.apf08 THEN RETURN END IF               #TQC-B10199 mark
  #-TQC-B10199-add-
   LET l_cnt = 0
   SELECT COUNT(*) INTO l_cnt 
