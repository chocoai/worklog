# Prog. Version..: '5.25.02-11.04.26(00008)'     #
#
...
# Modify.........: No:15/10/07 By gaozk add sfb96 字段
...
DEFINE g_sfb1    DYNAMIC ARRAY OF RECORD
             ...
             #     ima03     LIKE ima_file.ima03,
                  ...
                  sfbud08   LIKE sfb_file.sfb96,
                  sfbud01   LIKE sfb_file.sfb96,
...
FUNCTION p200_q()
   ...
   CONSTRUCT g_wc2 ON sfb98,sfb82,
                      sfb01,sfb81,sfb02,sfb221,sfb05,sfb44,sfb08,sfb919,sfb13, #FUN-840121     #FUN-A80150 add sfb919
                      sfb15,sfb25,sfb081,sfb09,sfb12,sfb87,sfb04,sfb96,sfbud08,sfbud01,sfb86  #FUN-840121
                 FROM FORMONLY.sfb98,FORMONLY.sfb82,
                      s_sfb[1].sfb01,s_sfb[1].sfb81,s_sfb[1].sfb02,s_sfb[1].sfb221, #FUN-840121 
                      s_sfb[1].sfb05,s_sfb[1].sfb44,s_sfb[1].sfb08,s_sfb[1].sfb919,s_sfb[1].sfb13,s_sfb[1].sfb15,  #FUN-840121  #FUN-A80150 add sfb919
                      s_sfb[1].sfb25,s_sfb[1].sfb081,s_sfb[1].sfb09,s_sfb[1].sfb12, #FUN-840121
                      s_sfb[1].sfb87,s_sfb[1].sfb04,s_sfb[1].sfb96,s_sfb[1].sfbud08,s_sfb[1].sfbud01,s_sfb[1].sfb86                                 #FUN-840121
         BEFORE CONSTRUCT
            CALL cl_qbe_init()
...
FUNCTION p200_b1_fill(p_wc2)
   ...
   LET g_sql = " SELECT 'N',sfb01,sfb81,sfb02,sfb221,sfb05,'','',sfb44,'','', ", # 
               "            sfb08,sfb919,sfb13,sfb15,sfb25 ,sfb081,sfb09,",    #FUN-A80150 add sfb919
               "            sfb12,sfb87,sfb04,sfb96,",
               " decode(sfbud08,'0','0:一般','1','1:加急','2','2:特急') sfbud08,sfbud01,sfb86 ",  
               "  FROM sfb_file ",
               "  WHERE ",p_wc2 CLIPPED,
   ...
   FOREACH sfb_curs INTO g_sfb1[g_cnt].*
      ...
      SELECT MAX(sfu14) INTO  g_sfb1[g_cnt].sfu14 FROM sfu_file,sfv_file 
        WHERE sfu01=sfv01 and sfv11 = g_sfb1[g_cnt].sfb01    
      SELECT MAX(sfu02) INTO  g_sfb1[g_cnt].sfu02 FROM sfu_file,sfv_file 
        WHERE sfu01=sfv01 and sfv11 = g_sfb1[g_cnt].sfb01 
