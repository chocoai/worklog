...
# Modify.........: No:CHI-D50039 13/05/28 By apo 將本次新增之單號存入temp table用以比對,避免抓到非本次產生的資料
# Modify.........: No:FUN-D60041 13/06/08 By zhangweib 資料拋轉應收後,根據單別判斷是否需要自動拋轉總帳
# Modify.........: No:CHI-D70016 13/07/11 By apo 拋轉單號重覆時,應給予單別用於後續重編號
# Modify.........: No:FUN-D40065 13/06/22 By Lori 取消ooz64,改用s_tax_invoice()
# Modify.........: No:MOD-DA0137 13/10/21 By yuhuabao 将AFTER FIELD oma01的判断提前至BEFORE FIELD oma01
# Modify.........: No:FUN-DA0093 13/10/24 By joyce 支援電子發票功能
# Modify.........: No.MOD-DB0002 13/11/01 By yuhuabao 調用axrp590的時候 增加傳參gl_summary='Y'
# Modify.........: No.TQC-DB0045 13/11/20 By yuhuabao axmt620ACTION轉應收,應收單號應等於出貨單號
# Modify.........: No:FUN-DA0127 13/11/27 By joyce 支援ERP開立電子發票功能
# Modify.........: No:TQC-DC0102 13/12/26 By Reanna oar_file已不使用，調整程式
# Modify.........: No:FUN-E10004 14/01/06 By apo 自動開立發票,開放發票別可允許空白
# Modify.........: No:CHI-E20004 14/02/07 By apo 日期不可等於關帳日
# Modify.........: No:MOD-E20022 14/02/07 By apo 取消-263錯誤訊息,已於後面彙總訊息處理
# Modify.........: NO:MOD-E20020 14/02/10 By yihsuan 開立三聯式發票時應檢查客戶基本資料是否有輸入統編
# Modify.........: No:MOD-E40044 14/04/10 By yihsuan 修正拋轉至axrt300後,帳款客戶簡稱(oma032)及收款客戶簡稱(oma69)欄位顯示"空白"
# Modify.........: No:MOD-E40137 14/04/24 By yihsuan 當選擇立出貨應收時,單別若為拋轉傳票(ooydmy1)
#                                                    但出貨金額為 0 且畫面出貨金額為0 選項為 Y (amt0_sw)時,則不做 s_chknpq 檢核
# Modify.........: No:TQC-E60008 14/06/12 By johnson 修正axrt310/axrt311呼叫電子發票列印作業為axrr304
# Modify.........: No:MOD-E70039 14/07/09 By yihsuan FOREACH p310_cs 最後 IF NOT cl_null(g_start1) THEN LET g_start = g_start1 END IF 調整為
#                                                    改為當營運中心不同時將 g_start1 更新為 g_start,否則才走目前處理方式
# Mofidy.........: No:CHI-E50009 14/07/18 By yihsuan 改用 array 紀錄 oma01 資料,並將以 array 方式讀取更新 oga10
# Modify.........: No:MOD-E80066 14/08/19 By doris 將 axrg 程式改用 axrr 程式
# Modify.........: No:TQC-E90011 14/09/25 By doris 修正當有限額發票而拆單時,若需立刻自動確認都只會自動確認第一張單之問題
# Modify.........: No:MOD-E90137 14/10/02 By yihsuan 外銷有 invoce no 時,如為出貨單產生 invioce no 應改串 oga01a;
# Modify.........: No:MOD-EA0112 14/10/23 By yihsuan axrp310 取消 oha09 為 3 時,更新 oha10 動作
# Modify.........: No:TQC-EA0022 14/10/28 By yihsuan 參考 PREPARE sel_oga1_pre 放在 PREPARE sel_oga3_pre 段落中
# Modify.........: No:FUN-EB0006 14/11/14 By Charles4m 如果 occb02='Y', 則發票聯數一定要為7,並控卡若為N則不得為7.
# Modify.........: No:MOD-F10019 15/01/09 By yihsuan 取消gec05 為 6 的條件
# Modify.........: No:CHI-EC0033 15/02/02 By Hungli 需判斷 cl_null(oaz92)、cl_null(oaz93)、cl_null(oaz94)、cl_null(oaz108) 需走等於 N 的程式段。
# Modify.........: No:MOD-F40142 15/04/30 By yihsuan 當選擇帳款種類異動時,請將 ar_slip 清空
# Modify.........: No:MOD-F60007 15/06/02 By yihsuan 當產生預收待抵時,如有發票編號需一併更新
# Modify.........: No:MOD-F60098 15/06/17 By yihsuan 若不存在 occ11 時,需再確認是否存在 occm_file 中
# Modify.........: No:MOD-F80031 15/08/31 By yihsuan 產生訂金或尾款時,不做ooyconf判斷
# Modify.........: No:FUN-F60042 15/09/10 By TsungYung 二次折讓單優化
# Modify.........: No:MOD-F90124 15/09/24 By yihsuan 多筆確認起始條件問題調整
# Modify.........: No:MOD-FA0071 15/10/14 By yihsuan FOREACH oma01_cur1 應改為 USING g_start1,g_end INTO l_oma01
# Modify.........: No:FUN-FB0005 15/11/02 By yihsuan 將相關呼叫CALL cl_replace_sqldb/CALL cl_parse_qry_sql的CURSOR移至FOREACH外宣告
# Modify.........: No:MOD-FB0029 15/11/06 By yihsuan 將營運中心條件納入背景參數執行
# Modify.........: No:MOD-FB0136 15/11/23 By yihsuan 拋轉產生axrt300時就回寫oga10，刪除axrt300時則清空oga10
# Modify.........: No:FUN-G20002 16/02/15 By TsungYung B2B電子發票沒有註銷歷程。
# Modify.........: No:MOD-G50009 16/05/04 By TsungYung 拋轉訂金/出貨/尾款帳款時，增加判斷不可小於前端單據日期。
# Modify.........: No:MOD-G70136 16/07/26 By edison 修改PREPARE gec05_pre中的 SQL 為occ01 = oga18(收款客戶編號)
# Modify.........: No:MOD-G80049 16/08/12 By yihsuan FOREACH oma01_cur1 移至下方END FOREACH 之後 
# Modify.........: No:MOD-G80059 16/08/12 By yihsuan 外銷以簽收單拋轉帳款，若結關日期未維護時，增加控卡並提示錯誤訊息且單據不可拋轉。
# Modify.........: No:MOD-G90056 16/09/09 By yihsuan FUNCTION oma10_chk中，aza26='2'撈取oom_file調整為oom15=g_oma.oma212
# Modify.........: No.FUN-H40007 17/12/06 By TSD.james 1.增加執行aivr200的邏輯
...
DEFINE ar_type_t        LIKE type_file.chr1          #MOD-F40142 add
...
DEFINE g_change_lang        LIKE type_file.chr1      # Prog. Version..: '5.30.27-19.04.12(01)   #是否有做語言切換 No.FUN-570156
...
# No:FUN-DA0127 ---start---
DEFINE ls_ome    RECORD
                 ome83              LIKE ome_file.ome83,    # 發票使用類型
                 print_einv         LIKE type_file.chr1,    # 列印發票證明聯
                 vehicle            LIKE type_file.chr1,    # 載具託管
                 inv_donate         LIKE type_file.chr1,    # 發票捐贈
                 ome042             LIKE ome_file.ome042,   # 客戶統一編號
                 ome23              LIKE ome_file.ome23,    # 載具代碼
                 ome24              LIKE ome_file.ome24,    # 載具顯碼ID
                 print_einv_vehicle LIKE type_file.chr1,    # 列印發票證明聯(載具)
                 ome25              LIKE ome_file.ome25     # 愛心碼
                 END RECORD
DEFINE g_print_code  LIKE type_file.chr1                    # 是否列印發票
DEFINE g_occb03      LIKE occb_file.occb03                  # 客戶預設發票類型
DEFINE g_einv        LIKE oom_file.oom17                    # 電子發票否
DEFINE g_forupd_sql  STRING                     #SELECT ... FOR UPDATE SQL
DEFINE g_ome83       LIKE ome_file.ome83
DEFINE g_str         STRING
DEFINE g_occ11       LIKE occ_file.occ11
DEFINE g_ome042      LIKE ome_file.ome042
# No:FUN-DA0127 --- end ---
...
MAIN
   ...
   DEFINE l_status  LIKE type_file.chr1          #No:FUN-DA0127 add
   ...
   LET g_wc1    = ARG_VAL(17)            #MOD-FB0029 add   #來源營運中心   
   ...
   IF NOT cl_null(g_argv1) THEN
     ...
     #LET g_date2=g_date         #MOD-A80242 mark
      ...
      ELSE
         ...
         #FUN-B10004--add----end---
          ...
          INPUT g_argv1,g_oma05 WITHOUT DEFAULTS FROM oma01,oma05
             AFTER FIELD oma05
               #IF g_oaz.oaz92 != 'Y' OR g_aza.aza26 !='2' THEN #FUN-C60036--add #CHI-EC0033 mark
                IF g_oaz.oaz92 != 'Y' OR cl_null(g_oaz.oaz92)  OR g_aza.aza26 !='2' THEN #CHI-EC0033 add 
             ...
             BEFORE FIELD oma01
                IF NOT cl_null(g_argv1) THEN
                   ...
                   IF l_cnt > 0 THEN
                      CALL cl_err('','sub-144',0)   #TQC-DB0045
                      LET g_argv1 = NULL
                   END IF
                   LET l_ooyacti = NULL
             ...
             AFTER FIELD oma01
                IF NOT cl_null(g_argv1) THEN
                   ...
                   SELECT COUNT(*) INTO l_cnt FROM oma_file WHERE oma01=g_argv1
                   IF l_cnt > 0 THEN
                     #CALL cl_err('','sub-144',0)   #CHI-D70016 mark
                     #NEXT FIELD oma01              #CHI-D70016 mark
                     #-CHI-D70016-str--
                      IF cl_confirm('afa-367') THEN 
                         CALL s_get_doc_no(g_argv1) RETURNING g_argv1  
                      END IF   
                     #-CHI-D70016-end--
                   END IF
                  #No.MOD-C30425   ---start---   Add
         ...
         #IF g_oaz92 !='Y' OR g_aza.aza26 != '2'  THEN#FUN-C60036 add #CHI-EC0033 mark
          IF g_oaz92 !='Y' OR cl_null(g_oaz92) OR g_aza.aza26 != '2'  THEN #CHI-EC0033 add 
      ...
      IF g_success = "Y" THEN
         COMMIT WORK
         CALL p310_carry_voucher()   #No.FUN-D60041   Add 

         # No:FUN-DA0127 ---start---
         # 單張發票且有勾選要列印才可列印
         IF g_aza.aza26 = '0' AND g_start = g_end AND g_einv = 'Y' THEN
            IF NOT cl_null(g_oma.oma10) AND g_print_code = 'Y' THEN
               WHILE TRUE
               #  CALL g310(g_oma.oma10,'0','Y')                    # 發票列印
#                  LET g_str = "axrg310 '",g_oma.oma10,"' '0' 'Y'"   # 發票列印    #TQC-E60008 mark
                   #FUN-H40007 171206 By TSD.james---(S)
                   IF g_ome83 MATCHES '[78]' THEN
                      CALL p310_print(g_oma.oma10,g_oma.oma09)
                   ELSE
                   #FUN-H40007 171206 By TSD.james---(E)
                   LET g_str = "axrr304 '",g_oma.oma10,"' '0' 'Y'"   # 發票列印    #TQC-E60008 add   
                  CALL cl_cmdrun_wait(g_str)
                  END IF #FUN-H40007 171206 By TSD.james
                  IF cl_confirm('axr-857') THEN
                     EXIT WHILE
                  ELSE
                     IF g_ome83 NOT MATCHES '[12345]' THEN    #FUN-G20002 add
                        CALL s_einv_cancel('1',g_oma.oma10,g_oma.oma75)   # 若列印失敗須將原發票註銷再重新開立發票
                     END IF     #FUN-G20002 add
                     CONTINUE WHILE
                  END IF
               END WHILE
            END IF
            ...
            IF g_success = 'Y' THEN
               ...
               IF g_aza.aza26 = '0' AND g_start = g_end AND g_einv = 'Y' THEN
                  IF NOT cl_null(g_oma.oma10) AND g_print_code = 'Y' THEN
                     WHILE TRUE
                     #  CALL g310(g_oma.oma10,'0','Y')                    # 發票列印
#                        LET g_str = "axrg310 '",g_oma.oma10,"' '0' 'Y'"     #TQC-E60008 mark
                         #FUN-H40007 171206 By TSD.james---(S)
                         IF g_ome83 MATCHES '[78]' THEN
                            CALL p310_print(g_oma.oma10,g_oma.oma09)
                         ELSE
                         #FUN-H40007 171206 By TSD.james---(E)
                         LET g_str = "axrr304 '",g_oma.oma10,"' '0' 'Y'"     #TQC-E60008 add
                         CALL cl_cmdrun_wait(g_str)
                         END IF #FUN-H40007 171206 By TSD.james
                        IF cl_confirm('axr-857') THEN
                           EXIT WHILE
...
FUNCTION p310()
   ...
   #FUN-C60036--add--str
     #IF g_oaz92 !='Y' OR g_aza.aza26 != '2'  THEN #CHI-EC0033 mark
      IF g_oaz92 !='Y' OR cl_null(g_oaz92) OR g_aza.aza26 != '2'  THEN #CHI-EC0033 add 
   ...
   #FUN-C60036--add--end
      ...
      INPUT BY NAME ar_type,s_date,e_date,ar_slip,ar_slip1,g_date,conf_sw,open_sw,     #No:FUN-A50103 #FUN-B10058 add ar_slip1
         ...
         AFTER FIELD ar_type
            ...
            IF ar_type NOT MATCHES "[123]" THEN
               NEXT FIELD ar_type
            END IF
            #--MOD-F40142 add start--
            IF cl_null(ar_type_t) OR ar_type <> ar_type_t THEN
               LET ar_slip = ''
               LET ar_type_t = ar_type
      ...
      IF g_bgjob = "Y" THEN
         ...
         ELSE
            ...
            LET g_wc1 = cl_replace_str(g_wc1, "'", "\"")   #MOD-FB0029 add
...
FUNCTION p310_p()
  ...
  #DEFINE l_oea919   LIKE oea_file.oea919       #FUN-8C0078 #MOD-AA0063 mark
   ...
   DEFINE l_cnt2     LIKE type_file.num5        #CHI-D50039
   DEFINE l_tax_invoice LIKE type_file.chr1     #FUN-D40065 add
   DEFINE l_gec05    LIKE gec_file.gec05        #MOD-E20020 add
   DEFINE l_occ11    LIKE occ_file.occ11        #MOD-E20020 add
   DEFINE l_ogb14    LIKE ogb_file.ogb14        #MOD-E40137 add
   DEFINE l_azp_chg  LIKE azp_file.azp01        #MOD-E70039 add
   DEFINE l_oma01    LIKE oma_file.oma01        #TQC-E90011 add
   DEFINE l_oma01_arr   DYNAMIC ARRAY OF RECORD          #CHI-E50009 add
                           oma01   LIKE oma_file.oma01   #CHI-E50009 add
                        END RECORD                       #CHI-E50009 add
   DEFINE l_oma_i    LIKE type_file.num5                 #CHI-E50009 add
   DEFINE l_i        LIKE type_file.num5                 #CHI-E50009 add             
   DEFINE l_oma19    LIKE oma_file.oma19   #MOD-F60007 add
   DEFINE l_occm02   LIKE occm_file.occm02 #MOD-F60098 add
   DEFINE l_msg      STRING                #MOD-G50009 add
   DEFINE l_oga08    LIKE oga_file.oga08   #MOD-G80059 add

   CALL l_oma01_arr.clear()   #CHI-E50009 add
   LET l_oma_i = 1            #CHI-E50009 add
  #TQC-E90011---add---str---
   LET g_sql = "SELECT oma01 ",
               "  FROM oma_file ",
               " WHERE oma01 BETWEEN ? AND ? "
   PREPARE oma01_pre1 FROM g_sql
   DECLARE oma01_cur1 CURSOR FOR oma01_pre1
  #TQC-E90011---add---end--- 
...
#No.FUN-B90130 --begin
   LET g_forupd_sql = "SELECT * FROM oom_file ", 
                      ...
                      "   AND (oom08>oom09 OR oom09 IS NULL)  "
   IF g_aza.aza26 ='2' THEN  
      LET g_forupd_sql = g_forupd_sql," AND oom15 = ? AND oom17 = ? FOR UPDATE "   #FUN-DA0127 add oom17
      LET g_forupd_sql = cl_forupd_sql(g_forupd_sql)
   ELSE
      LET g_forupd_sql = g_forupd_sql," AND oom04 = ? AND oom17 = ? FOR UPDATE "   #FUN-DA0127 add oom17
      LET g_forupd_sql = cl_forupd_sql(g_forupd_sql)
   END IF  
#   LET g_forupd_sql = "SELECT * FROM oom_file ", 
#                      " WHERE oom01 = ? AND ? BETWEEN oom02 AND oom021 ",
...
#No.FUN-B90130 --end   LET g_forupd_sql = cl_forupd_sql(g_forupd_sql)
  ...
  #-CHI-D50039--end
   ...
   FOREACH sel_azp03_cs INTO l_azp01,l_dbs
      ...
      LET g_sql = "SELECT gec05,occ11",
                  "  FROM ",cl_get_target_table(l_azp01,'oga_file'),",",
                            cl_get_target_table(l_azp01,'gec_file'),",",
                            cl_get_target_table(l_azp01,'occ_file'),
                  " WHERE oga01 = ?",
                  "   AND gec01 = oga21 ",
                 #"   AND occ01 = oga03 "   #MOD-G70136 mark
                  "   AND occ01 = oga18 "   #MOD-G70136 add
      CALL cl_replace_sqldb(g_sql) RETURNING g_sql
      CALL cl_parse_qry_sql(g_sql,l_azp01) RETURNING g_sql
      PREPARE gec05_pre FROM g_sql 

      LET g_sql = "SELECT occm02 ",
                  "  FROM ",cl_get_target_table(l_azp01,'oga_file'),",",
                            cl_get_target_table(l_azp01,'oea_file'),",",
                            cl_get_target_table(l_azp01,'occm_file'),
                  " WHERE oga01 = ? ",
                  "   AND oga16 = oea01 ",
                  "   AND occm01 = oea01 "
      CALL cl_replace_sqldb(g_sql) RETURNING g_sql
      CALL cl_parse_qry_sql(g_sql,l_azp01) RETURNING g_sql
      PREPARE occm_pre FROM g_sql

      LET g_sql = "SELECT poz01,poz18,poz19 ",
                  "  FROM ",cl_get_target_table(l_azp01,'ogb_file'),",", 
                            cl_get_target_table(l_azp01,'oea_file'),",", 
                            cl_get_target_table(l_azp01,'poz_file'),     
                  " WHERE oea904 = poz01",
                  "   AND ogb01  = ? ",
                  "   AND ogb31 = oea01"
      CALL cl_replace_sqldb(g_sql) RETURNING g_sql                         
      ...
      LET g_sql = " SELECT COUNT(*) FROM ",cl_get_target_table(l_azp01,'poy_file'),
                  "  WHERE poy01 = ? ",
                  "    AND poy04 = ? "
      CALL cl_replace_sqldb(g_sql) RETURNING g_sql             
      CALL cl_parse_qry_sql(g_sql,l_azp01) RETURNING g_sql 
      ...
      LET g_sql = " SELECT * FROM ",cl_get_target_table(l_azp01,'oay_file'), 
                  " WHERE oayslip = ? "
      CALL cl_replace_sqldb(g_sql) RETURNING g_sql              
      CALL cl_parse_qry_sql(g_sql,l_azp01) RETURNING g_sql      
      ...
      LET g_sql= "SELECT oeaa03 ",
                 "  FROM ",cl_get_target_table(l_azp01,'oeaa_file'), 
                 " WHERE oeaa01 = ? ",
                 "   AND oeaa02 = '1' "
      ...
      LET g_sql = "SELECT COUNT(*) FROM ",cl_get_target_table(l_azp01,'oeb_file'), 
                  " WHERE oeb01 = ? ",  
                  "   AND oeb13<>0 "
      CALL cl_replace_sqldb(g_sql) RETURNING g_sql        
      CALL cl_parse_qry_sql(g_sql,l_azp01) RETURNING g_sql 
      ...
      LET g_sql = "SELECT oga909,oga09 FROM ",cl_get_target_table(l_azp01,'oga_file'), 
                  " WHERE oga01= ? ",
                  "   AND oga09 NOT IN ('1','9','A')"
      CALL cl_replace_sqldb(g_sql) RETURNING g_sql          
      CALL cl_parse_qry_sql(g_sql,l_azp01) RETURNING g_sql 
      PREPARE sel_oeb_pre1 FROM g_sql

      LET g_sql = "SELECT COUNT(*) FROM ",cl_get_target_table(l_azp01,'oga_file'),",", 
                                          cl_get_target_table(l_azp01,'ofa_file'), 
                  " WHERE oga01= ?",
                  "   AND oga27=ofa01 ",
                  "   AND ofaconf = 'Y'"
      CALL cl_replace_sqldb(g_sql) RETURNING g_sql          
      ...
      LET g_sql = "SELECT COUNT(*)",
                  "  FROM ",cl_get_target_table(l_azp01,'oga_file a'),",", 
                            cl_get_target_table(l_azp01,'oga_file b'),",", 
                            cl_get_target_table(l_azp01,'ofa_file'), 
                  " WHERE a.oga01 = ?",
                  "   AND a.oga011=b.oga01 ",
                  "   AND b.oga011=ofa011 ",
                  "   AND ofaconf = 'Y'"
      CALL cl_replace_sqldb(g_sql) RETURNING g_sql           
      CALL cl_parse_qry_sql(g_sql,l_azp01) RETURNING g_sql
      ...
      CALL cl_replace_sqldb(g_sql) RETURNING g_sql
      CALL cl_parse_qry_sql(g_sql,l_azp01) RETURNING g_sql
      PREPARE sel_oga5_pre FROM g_sql
      ...
      LET g_sql = "SELECT ogb14 FROM ",cl_get_target_table(l_azp01,'ogb_file'),
                  " WHERE ogb01 = ?"
      CALL cl_replace_sqldb(g_sql) RETURNING g_sql
      CALL cl_parse_qry_sql(g_sql,l_azp01) RETURNING g_sql
      PREPARE ogb_pr FROM g_sql
      #--FUN-FB0005 add end--

      #--MOD-G80059 add start--
      LET g_sql = "SELECT oga08,oga09 FROM ",cl_get_target_table(l_azp01,'oga_file'),
                  " WHERE oga01= ? "
      CALL cl_replace_sqldb(g_sql) RETURNING g_sql
      CALL cl_parse_qry_sql(g_sql,l_azp01) RETURNING g_sql
      PREPARE sel_oga_pre2 FROM g_sql
      #--MOD-G80059 add end--

      LET g_start = NULL     #FUN-960140 add
      LET begin_no  = NULL
      LET l_cnt = 0   #MOD-F90124 add
     #-MOD-AA0133-mark- 
     #DROP TABLE p310_tmp
     #CREATE TEMP TABLE p310_tmp(
     ...
     #-MOD-AA0133-end- 
      DELETE FROM p310_tmp   #CHI-D50039
      FOREACH p310_cs INTO g_omf00,g_omf01,g_omf02,g_oga01, g_oga02,g_oga021,t_azi03,   #MOD-760078#FUN-C60036 add g_omf01,g_omf02,#minpp add-g_omf00
         ...
         #MOD-G50009 --- add start ---
         IF g_date < g_oga02 THEN
            LET l_msg = g_date,' < ',g_oga02
            IF ar_type = '1' OR ar_type = '3' THEN
               CALL s_errmsg('oea02',g_oga01,l_msg,'axr-430',1)
            END IF
            IF ar_type = '2' THEN
               CALL s_errmsg('oga02',g_oga01,l_msg,'axr-431',1)
            END IF
            LET g_success = 'N'
            EXIT FOREACH
         END IF
         ...
         IF NOT cl_null(g_oga01) THEN
           ...
           #--FUN-FB0005 mark end--
            EXECUTE sel_oay11_pre INTO l_oay11 USING l_slip   #FUN-FB0005 add
        ...
        # CALL cl_parse_qry_sql(g_sql,l_azp01) RETURNING g_sql
        # PREPARE gec05_pre FROM g_sql
        # EXECUTE gec05_pre INTO l_gec05,l_occ11
        #--FUN-FB0005 mark end --        
          EXECUTE gec05_pre INTO l_gec05,l_occ11 USING g_oga01   #FUN-FB0005 add 
 
         #IF l_gec05 = '3' OR l_gec05 = '6' THEN   #MOD-F10019 mark
          IF l_gec05 = '3' THEN                    #MOD-F10019 add
             IF cl_null(l_occ11) THEN
               #--FUN-FB0005 mark start--
               ##--MOD-F60098 add start--
               #LET g_sql = "SELECT occm02 ",
               #            "  FROM ",cl_get_target_table(l_azp01,'oga_file'),",",
               #                      cl_get_target_table(l_azp01,'oea_file'),",",
               #                      cl_get_target_table(l_azp01,'occm_file'),
               ...
               #CALL cl_parse_qry_sql(g_sql,l_azp01) RETURNING g_sql
               #PREPARE occm_pre FROM g_sql
               #EXECUTE occm_pre INTO l_occm02 
               ##--MOD-F60098 add end--
               #--FUN-FB0005 mark end--
                EXECUTE occm_pre INTO l_occm02 USING g_oga01   #FUN-FB0005 add

                IF cl_null(l_occm02) THEN   #MOD-F60098 add
                   CALL s_errmsg('oga01',g_oga01,'','occ-11',1)
                   LET g_success = 'N'
                   CONTINUE FOREACH
                END IF   #MOD-F60098 add
             END IF
          END IF
         #--MOD-E20020 add end--
	...
	#CALL cl_parse_qry_sql(g_sql,l_azp01) RETURNING g_sql      #FUN-A50102            
        ...
        #--FUN-FB0005 mark end--       
         EXECUTE sel_poz01_pre INTO l_poz01,l_poz18,l_poz19 USING g_oga01   #FUN-FB0005 add
         ...
         IF NOT cl_null(l_poz01) THEN
	      ...
	      #    CALL cl_parse_qry_sql(g_sql,l_azp01) RETURNING g_sql #FUN-A50102            
              ...
              #--FUN-FB0005 mark end--
              #--FUN-FB0005 add start--
              EXECUTE sel_poz18_pre INTO l_c USING l_poz01,l_poz18 
              IF cl_null(l_c) THEN
                 LET l_c = 0
              END IF 
              #--FUN-FB0005 add end--
	...
	#CALL cl_parse_qry_sql(g_sql,l_azp01) RETURNING g_sql      #FUN-A50102
        ...
        #--FUN-FB0005 mark end--
         EXECUTE sel_oay_pre INTO g_oay.* USING g_t1   #FUN-FB0005 add
         ...
         IF cl_null(t_date2) THEN
            #--MOD-G80059 add start--
            EXECUTE sel_oga_pre2 INTO l_oga08,l_oga09 USING g_oga01
            IF l_oga08 = '2' AND l_oga09 = '8' THEN
               CALL s_errmsg('oga01',g_oga01,'','axr-340',1)
               CONTINUE FOREACH
            ELSE
            #--MOD-G80059 add end--
               LET t_date2 = t_date
            END IF   #MOD-G80059 add
         END IF 
         ...
         CASE
            WHEN ar_type='1'
              ...
              #--FUN-FB0005 mark end--
               ...
               IF g_enter_account='N' AND g_azw.azw04 <> '2'THEN     #TQC-C80083  add g_azw.azw04 <> '2'
                 ...
                 #--FUN-FB0005 add start--
                  LET g_cnt = 0
                  EXECUTE sel_oeb_pre INTO g_cnt USING g_oga01  
                 ...
                 #--FUN-FB0005 add end--
                  IF g_cnt=0 THEN                                                                                                      
                     CONTINUE FOREACH                                                                                                  
                  ELSE                                                                                                                 
                    #LET l_cnt = 0   #TQC-B60089   #MOD-F90124 mark
                    #FOREACH p310_oeaa1 INTO l_oeaa03                 #FUN-FB0005 mark
                     FOREACH p310_oeaa1 USING g_oga01 INTO l_oeaa03   #FUN-FB0005 add
                        #訂單期別已產生訂金不可重複產生
            ...
            WHEN ar_type='2'
               ...
               IF g_oga08='2' THEN #外銷
                 ...
                 #--FUN-FB0005 mark end--
                  EXECUTE sel_oeb_pre1 INTO l_oga909,l_oga09 USING g_oga01   #FUN-FB0005 add
                  IF l_oga909 IS NOT NULL AND l_oga909='Y' THEN  #MOD-9A0205
                    ...
                    #--FUN-FB0005 add start--
                     LET l_n = 0
                     EXECUTE sel_oga_pre INTO l_n USING g_oga01 
                     IF cl_null(l_n) THEN
                        LET l_n = 0
                     END IF
                    #--FUN-FB0005 add end--
                  ELSE
                     ...
                     IF l_oaz67='1' THEN
                       ...
                       #要抓到出通單號的話,得串回出貨單頭的oga011
                        IF l_oga09 IS NOT NULL AND l_oga09='8' THEN    #MOD-960173 
                          ...
                          #--FUN-FB0005 add start--
                           LET l_n = 0
                           EXECUTE sel_oga1_pre INTO l_n USING g_oga01  
                           IF cl_null(l_n) THEN
                              LET l_n = 0
                           END IF 
                          #--FUN-FB0005 add end--
                        ELSE
                          ...
                          #--FUN-FB0005 add start--
                           LET l_n = 0
                           EXECUTE sel_oga2_pre INTO l_n USING g_oga01
                           IF cl_null(l_n) THEN
                              LET l_n = 0
                           END IF
                          #--FUN-FB0005 add end--
                     ...
                     ELSE
                        ...
                        IF l_oga09='8' THEN
                          ...
                          #CALL cl_parse_qry_sql(g_sql,l_azp01) RETURNING g_sql
                          #PREPARE sel_oga5_pre FROM g_sql
                          #EXECUTE sel_oga5_pre INTO l_n
                          #--FUN-FB0005 mark end--
                          #--FUN-FB0005 add start--
                           LET l_n = 0
                           EXECUTE sel_oga5_pre INTO l_n USING g_oga01 
                           IF cl_null(l_n) THEN
                              LET l_n = 0
                           END IF
                          #--FUN-FB0005 add end--
                        ...
                        #--TQC-EA0022 add end--
                          ...
                          #                      cl_get_target_table(l_azp01,'ofa_file'),     #FUN-A50102
                          #            " WHERE oga01='",g_oga01,"'",
                          #            "   AND oga01=ofa011",   #MOD-E90137 mark   #TQC-EA0022 remark
                          #           #"   AND oga011=ofa011",  #MOD-E90137 add    #TQC-EA0022 mark
                          #            "   AND ofaconf = 'Y'"
                          #CALL cl_replace_sqldb(g_sql) RETURNING g_sql              #FUN-A50102							
                          #CALL cl_parse_qry_sql(g_sql,l_azp01) RETURNING g_sql #FUN-A50102              
                          #PREPARE sel_oga3_pre FROM g_sql
                          ...
                          #--FUN-FB0005 add start--
                           LET l_n = 0
                           EXECUTE sel_oga3_pre INTO l_n USING g_oga01
                           IF cl_null(l_n) THEN
                              LET l_n = 0
                           END IF 
                          #--FUN-FB0005 add end--
                        END IF   #TQC-EA0022 add
                     END IF 
                  END IF
                  IF l_n=0 AND noin_sw='N' THEN
                     CALL s_errmsg('oga01',g_oga01,'','axr-205',1)   #TQC-EA0022 add
                     CONTINUE FOREACH
               ...
               IF NOT (g_aza.aza26 = '2' AND g_oaz92 = 'Y' AND g_omf00 = l_omf00) OR cl_null(l_omf00) THEN #FUN-CB0057 add
                  IF g_enter_account='N' AND g_azw.azw04 <> '2' THEN   #TQC-C80083  add g_azw.azw04 <> '2'
                    ...
                    #--FUN-FB0005 add start--
                     LET g_cnt = 0
                     EXECUTE sel_ogb_pre INTO g_cnt USING g_oga01  
                     IF cl_null(g_cnt) THEN
                        LET g_cnt = 0
                     END IF 
                    #--FUN-FB0005 add end--
            ...
            WHEN ar_type='3'
              ...
              #--FUN-FB0005 mark end--
               ...
               IF g_enter_account='N' AND g_azw.azw04 <> '2' THEN  #TQC-C80083  add g_azw.azw04 <> '2'
                 ...
                 #--FUN-FB0005 add start--
                  LET g_cnt = 0
                  EXECUTE sel_oeb1_pre INTO g_cnt USING g_oga01  
                  IF cl_null(g_cnt) THEN
                     LET g_cnt = 0
                  END IF
                 #--FUN-FB0005 add end--
                  ...
                  ELSE                                                                                                                 
                    #LET l_cnt = 0   #TQC-B60089   #MOD-F90124 mark
                    #FOREACH p310_oeaa2 INTO l_oeaa03                 #FUN-FB0005 mark
                     FOREACH p310_oeaa2 USING g_oga01 INTO l_oeaa03   #FUN-FB0005 add 
                        #訂單期別已產生訂金不可重複產生
                        SELECT COUNT(*) INTO g_cnt FROM oma_file
                         WHERE oma16 = g_oga01 AND omavoid='N'
                           AND oma165 = l_oeaa03
        ...
        #TQC-E90011---mark---str---
        #INSERT INTO p310_tmp VALUES(g_n_oma01)   #CHI-D50039

        #--CHI-E50009 add start--
        #LET l_oma01_arr[l_oma_i].oma01 = g_n_oma01
        #LET l_oma_i = l_oma_i + 1
        #--CHI-E50009 add end--
        #TQC-E90011---mark---end---

       #--MOD-FB0136 mark start--
       ##TQC-E90011---add---str---
       ##FOREACH oma01_cur1 USING g_start,g_end INTO l_oma01   #MOD-FA0071 mark
       # FOREACH oma01_cur1 USING g_start1,g_end INTO l_oma01  #MOD-FA0071 add
       #    INSERT INTO p310_tmp VALUES(l_oma01)  
       #    LET l_oma01_arr[l_oma_i].oma01 = l_oma01
       #    LET l_oma_i = l_oma_i + 1 
       # END FOREACH
       ##TQC-E90011---add---end---
       #--MOD-FB0136 mark end-- 

        #--MOD-E70039 mark start--
        ##--TQC-B60089 add start-- 
        #IF NOT cl_null(g_start1) THEN 
        #   LET g_start = g_start1 
        #END IF 
        ##--TQC-B60089 add end--
        #--MOD-E70039 add end--

         #--MOD-E70039 add start--
         IF cl_null(l_azp_chg) THEN 
            LET l_azp_chg = l_azp01 
         END IF
         IF l_azp_chg <> l_azp01 THEN
            LET g_start1 = g_start
            LET l_azp_chg = l_azp01
         ELSE
            IF NOT cl_null(g_start1) THEN 
         ...
         IF cl_null(g_start1) AND NOT cl_null(g_start) THEN
            LET g_start1 = g_start
         END IF
      END FOREACH   #MOD-G80049 add      
 
      #--MOD-FB0136 add start--
      FOREACH oma01_cur1 USING g_start1,g_end INTO l_oma01  
         INSERT INTO p310_tmp VALUES(l_oma01)
         LET l_oma01_arr[l_oma_i].oma01 = l_oma01
         LET l_oma_i = l_oma_i + 1
      END FOREACH
      #--MOD-FB0136 add end--
     #END FOREACH   #MOD-BB0230   #MOD-G80049 mark
      ...
      #--FUN-FB0005 add start--
      LET g_sql = "SELECT oga16,oga909 FROM ",cl_get_target_table(l_azp01,'oga_file'), 
                  " WHERE oga01= ? "
      CALL cl_replace_sqldb(g_sql) RETURNING g_sql            
      CALL cl_parse_qry_sql(g_sql,l_azp01) RETURNING g_sql 
      ...
      FOREACH p310_c INTO g_oma.*
        ...
        #-CHI-D50039--str
         LET l_cnt2 = 0
         SELECT COUNT(*) INTO l_cnt2 FROM p310_tmp 
          WHERE tmp01 = g_oma.oma01
         IF l_cnt2 = 0 THEN CONTINUE FOREACH END IF
        #-CHI-D50039--end
        #--MOD-E40044 add start--
        IF cl_null(g_oma.oma032) THEN
           SELECT occ02 INTO g_oma.oma032
             FROM occ_file
            WHERE occ01 = g_oma.oma03
        END IF
        IF cl_null(g_oma.oma69) THEN
           SELECT occ02 INTO g_oma.oma69
             FROM occ_file
            WHERE occ01 = g_oma.oma68
        END IF
        UPDATE oma_file 
           SET oma032 = g_oma.oma032,oma69 = g_oma.oma69
         WHERE oma01 = g_oma.oma01 
        #--MOD-E40044 add end--
        #-MOD-AA0133-add-
        #IF g_oma.oma02 < g_ooz.ooz09 THEN   #CHI-E20004 mark
         IF g_oma.oma02 <=g_ooz.ooz09 THEN   #CHI-E20004 
         ...
         IF cl_null(g_occ73) THEN LET g_occ73 = 'N' END IF
            ...
            #No.TQC-CC0107  --End  
               IF ar_type ='1' OR ar_type = '3' THEN #訂金/尾款    #CHI-A50040
                 #IF g_ooy.ooyconf='Y' AND conf_sw='Y' THEN   #MOD-F80031 mark
                  IF conf_sw='Y' THEN                         #MOD-F80031 add
            ...
            ELSE  #出貨 for 參數及此次是否要立即確認(conf_sw='Y')
               #IF g_ooz.ooz13 MATCHES '[12]' OR conf_sw='Y' THEN    #MOD-940408    #MOD-B30185
                IF g_ooz.ooz13='1' OR (g_ooz.ooz13='2' AND conf_sw='Y') THEN  #MOD-B30185   
                  IF g_ooz.ooz13='1' OR g_quick='Y' THEN   #FUN-570188 add                  
                    #--FUN-FB0005 mark start--
                    ##--MOD-E40137 add start--
                    #LET g_sql = "SELECT ogb14 FROM ",cl_get_target_table(l_azp01,'ogb_file'), 
                    #            " WHERE ogb01='",g_oga01,"'"
                    #CALL cl_replace_sqldb(g_sql) RETURNING g_sql          
                    #CALL cl_parse_qry_sql(g_sql,l_azp01) RETURNING g_sql 
                    #PREPARE ogb_pr FROM g_sql
                    #EXECUTE ogb_pr INTO l_ogb14
                    ##--MOD-E40137 add end--
                    #--FUN-FB0005 mark end--
                     EXECUTE ogb_pr INTO l_ogb14 USING g_oga01   #FUN-FB0005 add
                  
                    #直接確認前先確定是否要check分錄底稿
                    #IF g_ooy.ooydmy1='Y' THEN   #MOD-E40137 mark
                     IF g_ooy.ooydmy1='Y' AND l_ogb14 <> 0 AND amt0_sw <> 'Y' THEN   #MOD-E40137 add
                        CALL s_chknpq(g_oma.oma01,'AR',1,'0',g_bookno1)  #FUN-740009
                        IF g_aza.aza63 = 'Y' AND g_success = 'Y' THEN
                           CALL s_chknpq(g_oma.oma01,'AR',1,'1',g_bookno2)  #FUN-740009
                        END IF
...
#---FUN-AB0110 end---
           ...
           #MOD-C40153---s---
           #IF g_ooz.ooz64 = 'N' AND g_oma.oma08 = '2' AND g_aza.aza26 = '0' THEN     #FUN-D40065 mark
            CALL s_tax_invoice(g_oma.oma21) RETURNING l_tax_invoice                    #FUN-D40065 add 
            IF l_tax_invoice = 'N' AND g_oma.oma08 = '2' AND g_aza.aza26 = '0' THEN   #FUN-D40065 add
               LET open_sw = 'N'
            END IF
           #MOD-C40153---e---
           ...
           #IF open_sw='Y' AND l_omaconfchk = 'Y' THEN                          #MOD-AA0013      #TQC-AC0272 mark
             #99.05.25 add for 三角貿易
               ...
               IF g_oma.oma00='12' THEN
                 ...
                 #--FUN-FB0005 mark end--
                  EXECUTE sel_oga4_pre INTO l_oga16,l_oga909 USING g_oma.oma16   #FUN-FB0005 add
              ...
              #---取得發票號碼
               ...
               IF g_aza.aza26 = '0' THEN
                  LET g_occb03 = NULL
                  SELECT CASE WHEN occb02 = 'N' THEN '0' ELSE occb03 END occb03 INTO g_occb03
                    FROM occb_file
                   WHERE occb01 = g_oma.oma04
                     AND occb04 <= g_oma.oma09
                  IF cl_null(g_occb03) THEN
                     LET g_occb03 = '0'
                  END IF
               ELSE
                  LET g_occb03 = '0'
               ...
               #FUN-EB0006 ---begin add---
               IF g_einv = 'Y' THEN
                  IF g_oma.oma212 <> '7' THEN
                     CALL s_errmsg('oga01',g_oga01,'','axr1021',1) 
                     LET g_success = 'N'
                  END IF
               END IF
               IF g_einv = 'N' THEN
              ...
              # 取客戶統編
               LET g_occ11 = ''
               SELECT occ11 INTO g_occ11 FROM occ_file
                WHERE occ01 = g_oma.oma04
               # No:FUN-DA0127 --- end ---

              #-MOD-B10033-add-
               LET l_yy=YEAR(t_date2) LET l_mm=MONTH(t_date2)  
               OPEN oom_lock_cl USING l_yy,l_mm,g_oma.oma05,g_oma.oma212,g_einv    #FUN-DA0127 add g_einv
               IF STATUS THEN
                  LET l_lock_sw = 'Y'
               ...
               END IF
               IF l_lock_sw = 'Y' THEN
                 #CALL cl_err(g_oma.oma10,-263,1)   #MOD-E20022 mark
                  LET g_oma.oma10 = '' 
              ...
              #-MOD-B10033-end-
                 #99.01.25 三角貿易
                  ...
                  #  CALL s_guiauno1(g_oma.oma10,t_date2,g_oma.oma05,g_oma.oma212,l_dbs) #No.FUN-9C0014 #No.FUN-A10104
                     CALL s_guiauno1(g_oma.oma10,g_oma.oma75,t_date2,g_oma.oma05,g_oma.oma212,l_azp01,g_einv) #No.FUN-A10104 #No.FUN-B90130 add oma75 #FUN-DA0127 add g_einv
                  ...
                  #  CALL s_guiauno1(g_oma.oma10,t_date2,g_oma.oma05,g_gec.gec05,l_dbs)  #No.FUN-9C0014 #No.FUN-A10104
                     CALL s_guiauno1(g_oma.oma10,g_oma.oma75,t_date2,g_oma.oma05,g_gec.gec05,l_azp01,g_einv) #No.FUN-A10104  #No.FUN-B90130 add oma75 #FUN-DA0127 add g_einv
                     RETURNING g_i,g_oma.oma10,g_oma.oma75  #No.FUN-B90130 add oma75
                  END IF

                  # No:FUN-DA0127 ---start---
                  IF g_aza.aza26 = '0' AND g_einv = 'Y' THEN
                     # 取電子發票相關資訊
                     CALL p310_chk_einv_info()
                     IF g_success = 'N' THEN
                        CONTINUE FOREACH
                     END IF
                  ELSE       # 傳統發票
                     INITIALIZE ls_ome.* TO NULL
                     LET g_print_code = 'N'
                  END IF
                  # No:FUN-DA0127 --- end ---
                  ...
                  ELSE
                     ...
                     #--MOD-F60007 add start--
                     #有預收待抵時，發票編號需一併更新
                     SELECT oma19 INTO l_oma19
                       FROM oma_file
                      WHERE oma01 = g_oma.oma01

                     IF NOT cl_null(l_oma19) THEN
                        UPDATE oma_file
                           SET oma10 = g_oma.oma10,
                               oma71 = g_oma.oma71,
                               oma75 = g_oma.oma75
                          WHERE oma01 = l_oma19
                            AND omavoid='N'
                        IF SQLCA.sqlcode THEN
                           CALL s_errmsg(l_oma19,'','update oma_file',SQLCA.sqlcode,1)
                        END IF
                     END IF
                     #--MOD-F60007 add end--
                  END IF
                  ...
                  IF g_unikey='N' THEN
                    ...
                    #CALL s_insome(g_oma.oma01,g_oma.oma21,l_dbs)#No.FUN-9C0014 #No.FUN-A10104
                     # No:FUN-DA0127 ---modify start---
                  #  CALL s_insome(g_oma.oma01,g_oma.oma21,l_azp01) #No.FUN-A10104   #FUN-DA0127 mark
                     IF g_aza.aza26 = '0' AND g_einv = 'Y' THEN
                        CALL s_insome(g_oma.oma01,g_oma.oma21,l_azp01,g_ome83,g_ome042,ls_ome.ome23,ls_ome.ome24,ls_ome.ome25,g_print_code) #No.FUN-A10104   #FUN-DA0127 modify
                     ELSE
                        CALL s_insome(g_oma.oma01,g_oma.oma21,l_azp01,'0','','','','',g_print_code) #No.FUN-A10104   #FUN-DA0127 modify
                     END IF
                     # No:FUN-DA0127 --- modify end ---
                  ELSE
                     IF cl_null(g_oma.oma10) THEN     #MOD-AC0348
                     #  CALL s_guiauno1(g_oma.oma10,t_date2,g_oma.oma05,g_gec.gec05,l_dbs) #No.FUN-9C0014 #No.FUN-A10104
                        CALL s_guiauno1(g_oma.oma10,g_oma.oma75,t_date2,g_oma.oma05,g_gec.gec05,l_azp01,g_einv) #No.FUN-A10104 #No.FUN-B90130 add oma75  #FUN-DA0127 add g_einv
                    ...
                    #CALL s_insome(g_oma.oma01,g_gec.gec01,l_dbs)#No.FUN-9C0014 #No.FUN-A10104
                     # No:FUN-DA0127 ---modify start---
                  #  CALL s_insome(g_oma.oma01,g_gec.gec01,l_azp01) #No.FUN-A10104   #FUN-DA0127 mark
                     IF g_aza.aza26 = '0' AND g_einv = 'Y' THEN
                        CALL s_insome(g_oma.oma01,g_gec.gec01,l_azp01,g_ome83,g_ome042,ls_ome.ome23,ls_ome.ome24,ls_ome.ome25,g_print_code) #No.FUN-A10104   #FUN-DA0127 modify
                     ELSE
                        CALL s_insome(g_oma.oma01,g_gec.gec01,l_azp01,'0','','','','',g_print_code) #No.FUN-A10104   #FUN-DA0127 modify
                     END IF
                     # No:FUN-DA0127 --- modify end ---
                  END IF
                 #-MOD-AC0348-add-
...
#                 IF STATUS OR SQLCA.SQLERRD[3]=0 THEN
        ...
        LET g_sql = "SELECT *",
                    "  FROM oma_file",
                    " WHERE oma01 IN ( "
        FOR l_i = 1 TO l_oma01_arr.getLength() 
            LET g_sql = g_sql ,"'",l_oma01_arr[l_i].oma01,"'"
            IF l_i < l_oma01_arr.getLength() THEN
               LET g_sql = g_sql,","
            ELSE
               LET g_sql = g_sql,")"
            END IF
        END FOR
        PREPARE oma01_pre FROM g_sql
        DECLARE p310_upd_oga CURSOR FOR oma01_pre 
        #--CHI-E50009 add end--i

        #--FUN-FB0005 add start--
        LET g_sql = "UPDATE ",cl_get_target_table(l_azp01,'oga_file'), 
                   #" SET oga10 = ? ",   #MOD-FB0136 mark
                    " SET oga10 = ? ,",  #MOD-FB0136 add
                    "     oga05 = ? ",
                    " WHERE oga01 IN (SELECT omb31 FROM omb_file WHERE omb01 = ? )"
        CALL cl_replace_sqldb(g_sql) RETURNING g_sql             
        CALL cl_parse_qry_sql(g_sql,l_azp01) RETURNING g_sql 
        ...
        FOREACH p310_upd_oga INTO g_oma.* 
           ...
           #IF ar_type = '2' OR (ar_type='3' AND g_oma.oma162=0) THEN  #出貨/尾款   #CHI-A50040 mark
            IF ar_type = '2' THEN  #出貨                                            #CHI-A50040
              ...
              #EXECUTE upd_oga_pre
              #--FUN-FB0005 mark end--
               EXECUTE upd_oga_pre USING g_oma.oma01,g_oma.oma05,g_oma.oma01   #FUN-FB0005 add
   ...
   IF NOT cl_null(g_argv1) AND g_einv = 'N' THEN   # 外部程式串過來   #FUN-DA0127 add g_einv
      ...
      IF open_sw='Y' AND  NOT cl_null(g_argv1) THEN
         ...
         #LET g_msg = "axrg300 '' '' '",g_lang,"' 'Y' '' '' ",  #FUN-C30085   #MOD-E80066 mark
          LET g_msg = "axrr300 '' '' '",g_lang,"' 'Y' '' '' ",                #MOD-E80066 add
                      "'ome01 =\"",g_oma.oma10,"\"'"
         ...
         IF g_aza.aza26 = '2' THEN                                      #MOD-BC0229
            SELECT * INTO l_oom.* FROM oom_file
             WHERE oom07 <= g_oma.oma10 AND g_oma.oma10 <= oom08
              #AND oom04 = g_oma.oma212   #MOD-G90056 mark
               AND oom15 = g_oma.oma212   #MOD-G90056 add
               AND oom01   = l_yy
               AND oom02  <= l_mm
            ...
            IF g_ooz.ooz11='Y' AND l_ome.omevoid='N' AND
              ...
              #合併開發票時,發票檔的帳款編號要清空,發票檔的金額要累加
               ELSE
                  ...
                  LET l_omee.omee84   = 1        #FUN-F60042 add
...
#No.FUN-D60041 ---Add--- Start
FUNCTION p310_carry_voucher()
   DEFINE l_cmd          LIKE type_file.chr1
   DEFINE l_str          STRING
   DEFINE l_ooygslp      LIKE ooy_file.ooygslp
   DEFINE l_buser        LIKE oma_file.omauser
   DEFINE l_euser        LIKE oma_file.omauser
   DEFINE l_cnt          LIKE type_file.num5   #MOD-E40137 add
   DEFINE l_sql          STRING                #MOD-E40137 add
   ...
   IF ar_type = '1' OR ar_type = '3' THEN
     #IF g_ooy.ooyconf='Y' AND conf_sw='Y' THEN   #MOD-F80031 mark
      IF conf_sw='Y' THEN                         #MOD-F80031 add
         IF (g_ooz.ooz13='1' OR g_quick='Y') AND g_ooy.ooyglcr = 'Y' THEN
            LET l_cmd = 'Y'
         END IF
      END IF
   ELSE
      IF g_ooz.ooz13 = '1' OR (g_ooz.ooz13 = '2' AND conf_sw = 'Y') THEN
         IF (g_ooz.ooz13='1' OR g_quick='Y') AND g_ooy.ooyglcr = 'Y' THEN
            LET l_cmd = 'Y'
         END IF
      END IF
   ...
   SELECT ooygslp INTO l_ooygslp FROM ooy_file WHERE ooyslip = g_ooy.ooyslip

   #--MOD-E40137 add start--
   LET l_sql = "SELECT COUNT(*)",
               "  FROM npq_file",
               " WHERE npq01 BETWEEN '",g_start,"'" ,
               "  AND '",g_end,"'",
               "  AND  npq011 = 1"
   DECLARE npp_cnt CURSOR FROM l_sql
   OPEN npp_cnt
   FETCH npp_cnt INTO l_cnt
   CLOSE npp_cnt 
  
   #--MOD-E40137 add end--
  #IF l_cmd = 'Y' THEN                 #MOD-E40137 mark
   IF l_cmd = 'Y' AND l_cnt > 0 THEN   #MOD-E40137 add
      LET l_str = 'npp01 BETWEEN "',g_start,'" AND "',g_end,'" AND npp011 = 1' 
      LET l_str="axrp590 '",l_str CLIPPED,"' '",l_buser,"' '",l_euser,"' '",g_ooz.ooz02p,"' '",g_ooz.ooz02b,"' '",l_ooygslp,"' '",g_oma.oma02,"' 'Y' '1' 'Y' '",g_ooz.ooz02c,"' '",g_ooy.ooygslp1,"' 'Y'"  #MOD-DB0002 add 'Y'
      CALL cl_cmdrun(l_str)
   END IF

END FUNCTION
#No.FUN-D60041 ---Add--- End

# No:FUN-DA0127 ---start---
FUNCTION p310_chk_einv_info()

   INITIALIZE ls_ome.* TO NULL
   LET g_print_code = 'N'
   LET g_ome83 = g_occb03
   LET g_ome042 = g_occ11

   # 若是單張的話，可以轉B2C的發票，若是多張就不行，
   # 因為B2C要輸入一些必要資訊，若是每一張都開窗讓使用者輸入，這樣就失去批次的意義了
   IF g_start = g_end THEN     # 表示為單張的狀況
      # 若是電子發票需輸入必要資訊
      CALL s_get_einv_info(g_oma.oma04,g_occb03) RETURNING ls_ome.*
      IF cl_null(ls_ome.ome83) THEN
         LET g_oma.oma10 = NULL
         CALL s_errmsg('oma01',g_oma.oma01,'get einvoice data err:','axr-849',1)
         LET g_success = 'N'
      ELSE
         # 若是B2C發票，列印、載具託管、發票捐贈要三擇一
         #FUN-H40007 171206 By TSD.james---(S)
         #IF ls_ome.ome83 = '6' AND ls_ome.print_einv = 'N' AND ls_ome.vehicle = 'N' AND ls_ome.inv_donate = 'N' THEN
         IF ls_ome.ome83 MATCHES '[68]' AND ls_ome.print_einv = 'N' AND ls_ome.vehicle = 'N' AND ls_ome.inv_donate = 'N' THEN
         #FUN-H40007 171206 By TSD.james---(E)
            LET g_oma.oma10 = NULL
            CALL s_errmsg('oma01',g_oma.oma01,'get einvoice data err:','axr-849',1)
            LET g_success = 'N'
         END IF
      END IF
      IF ls_ome.print_einv = 'Y' OR ls_ome.print_einv_vehicle = 'Y' THEN
         LET g_print_code = 'Y'
      ELSE
         LET g_print_code = 'N'
      END IF
      LET g_ome83 = ls_ome.ome83
      LET g_ome042 = ls_ome.ome042
   ELSE          # 多張(批次)
      # B2C發票不可批次產生
      #FUN-H40007 171206 By TSD.james---(S)
      #IF g_occb03 = '6' THEN
      IF g_occb03 MATCHES '[68]'  THEN
      #FUN-H40007 171206 By TSD.james---(E)
         LET g_oma.oma10 = NULL
         CALL s_errmsg('oma01',g_oma.oma01,'get einvoice data err:','axr-866',1)
         LET g_success = 'N'
      ELSE
         # B2B發票在此預設不列印
         LET g_print_code = 'N'
...
#FUN-H40007 171206 By TSD.james---(S)
#執行aivr200
FUNCTION p310_print(p_ome01,p_ome02)
   DEFINE p_ome01       LIKE ome_file.ome01
   DEFINE p_ome02       LIKE ome_file.ome02
   DEFINE l_ome60       LIKE ome_file.ome60
   DEFINE l_sql         STRING
   DEFINE l_cmd         STRING
   DEFINE l_ama01       LIKE ama_file.ama01
   DEFINE l_date        LIKE type_file.chr8
   ...
   WHILE TRUE
      #抓申報統編
      LET l_sql = " SELECT DISTINCT ome60 ",
                  "   FROM ome_file ",
                  "  WHERE ome01 = '",p_ome01,"'",
                  "    AND ome02 = '",p_ome02,"'",
                  "  ORDER BY ome60 "
      DECLARE p310_sel_ome_cs CURSOR FROM l_sql

      #抓申報部門
      LET l_sql = " SELECT ama01 ",
                  "   FROM ama_file,DSC_TRFDB.avb_file ",
                  "  WHERE ama01 = avb01 ",
                  "    AND avb02 = 'Y' ",
                  "    AND ama02 = ? ",
                  "  ORDER BY ama01 "
      DECLARE p310_sel_ama_cs CURSOR FROM l_sql

      LET l_ome60 = NULL 
      OPEN  p310_sel_ome_cs 
      FETCH p310_sel_ome_cs INTO l_ome60
      CLOSE p310_sel_ome_cs

      LET l_ama01 = NULL
      OPEN p310_sel_ama_cs USING l_ome60
      FETCH p310_sel_ama_cs INTO l_ama01
      CLOSE p310_sel_ama_cs

      #部門沒有勾加值中心服務 不用做
      IF cl_null(l_ama01) THEN
         EXIT WHILE
      END IF

      LET l_date = p_ome02 USING 'YYYYMMDD'

      LET l_yy = l_date[1,4]

      LET l_mm = l_date[5,6]

      IF(l_mm MOD 2) = 0 THEN
         LET l_bm = l_mm - 1
         LET l_em = l_mm
      ELSE
         LET l_bm = l_mm 
      ...
      #CALL AIVP200
      LET l_cmd = " aivp200 'avg04 = ",'"',l_ama01,'"',"' '",l_yy,"' '",l_bm,"' '",l_em,"' '3' 'N' '1' 'Y' " 
      CALL cl_cmdrun_wait(l_cmd)

      #CALL AIVR200
      LET l_cmd = " aivr200 'ome01 = ",'"',p_ome01,'"',"' '0' 'Y' " 
      CALL cl_cmdrun_wait(l_cmd)
