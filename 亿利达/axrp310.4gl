...
GLOBALS "../../../tiptop/sub/4gl/s_g_ar.global"      #No.FUN-860006  add 
 
DEFINE g_wc,g_sql       LIKE type_file.chr1000       #No.FUN-680123 VARCHAR(1000)
DEFINE g_wc1            LIKE type_file.chr1000       #No.FUN-9C0014 Add
               ...
               IF ls_n > 0 THEN 
                  ...
                  END IF
                   ...
                   LET g_sql = g_sql CLIPPED," ) ",
                             ...
                             "    ON  oga01 like ltrim(rtrim(oayslip)) || '-%' AND oay11='Y'",
...
#---FUN-AB0110 end---
           ...
           #-TQC-AC0272-end-
            #---------------------------------------------------- 開立發票
            IF open_sw='Y' THEN                               #MOD-A80169 mark                   #TQC-AC0272 remark
              ...
              #-MOD-B10033-end-
                 #99.01.25 三角貿易
                  ...
                  #  CALL s_guiauno1(g_oma.oma10,t_date2,g_oma.oma05,g_oma.oma212,l_dbs) #No.FUN-9C0014 #No.FUN-A10104
                     CALL s_guiauno1(g_oma.oma10,t_date2,g_oma.oma05,g_oma.oma212,l_azp01) #No.FUN-A10104
                     RETURNING g_i,g_oma.oma10
                  ELSE
                  #  CALL s_guiauno1(g_oma.oma10,t_date2,g_oma.oma05,g_gec.gec05,l_dbs)  #No.FUN-9C0014 #No.FUN-A10104
                     CALL s_guiauno1(g_oma.oma10,t_date2,g_oma.oma05,g_gec.gec05,l_azp01) #No.FUN-A10104
                     RETURNING g_i,g_oma.oma10
                  END IF
                  IF NOT cl_null(g_argv1) THEN
                  ...
                  SELECT ta_omf01 INTO g_oma.omaud02 FROM omf_file
                   WHERE omf04= g_oma.oma01
                  UPDATE oma_file SET omaud02=g_oma.omaud02 
