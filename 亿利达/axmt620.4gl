...
MAIN
   ...
   IF g_bgjob='N' OR cl_null(g_bgjob) THEN #FUN-840012
      #OPEN WINDOW t620_w AT p_row,p_col WITH FORM "axm/42f/axmt620"   #NO.120912 mark
      OPEN WINDOW t620_w AT p_row,p_col WITH FORM "cxm/42f/axmt620"   #NO.120912 modify
      ...
      CALL cl_ui_init()
       ...
       CASE g_sma.sma124  
          ...
          WHEN 'slk'
             CALL cl_reset_qry_btn("oga011,oga16,ogb31","axmt610,axmt410_slk,axmt410_slk")
       END CASE
       #CHI-A40068 add --end--
   END IF
