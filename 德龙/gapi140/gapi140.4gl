...
# Modify.........: No:MOD-160613 16/06/14 By xueyh 修改发票号码报错问题处理
# Modify.........: No:2016061511 16/06/15 By xueyh 单头添加备注栏位
...
DEFINE
   g_head_1      RECORD
                 ...
                 ta_rvw01   LIKE rvw_file.ta_rvw01,      #NO.160520 add
                 ta_rvw04   LIKE rvw_file.ta_rvw04,     # xueyh160615 add
...
MAIN
   ...
   LET g_forupd_sql = "SELECT rvw01,rvw07,rvw02,rvw18,rvw19,rvw03,rvw04,rvw11,rvw12,ta_rvw01,ta_rvw04 ",    #MOD-DC0088 add rvw18  #160615xueyh add ta_rvw04#NO.160520 add ta_rvw01
...
DEFINE  lc_qbe_sn       LIKE    gbm_file.gbm01   #No.FUN-580031  HCN
   ...
   CONSTRUCT BY NAME g_wc ON                               # 螢幕上取單頭條件
               ...
               ,ta_rvw01,rvw18,ta_rvw04             #xueyh160615 add ta_rvw04                             #No.FUN-CB0048   Add  #NO.160520 add ta_rvw01
...
#No.MOD-B50003 --end
   ...
   END CONSTRUCT
   LET g_sql = "SELECT UNIQUE rvw01,rvw07,rvw02,rvw19,rvw03,rvw04,rvw11,rvw12",   #No.FUN-CB0053   Add rvw19  #NO.160520 add ta_rvw01
...
#No.MOD-B50003 --end
   ...
   LET g_sql = "SELECT rvw01,rvw02,rvw19,rvv06,'',rvw03,rvw04,",
               ...
               " GROUP BY rvw01,rvw07,rvw02,rvw19,rvw03,rvw04,rvw11,rvw12,rvv06,rvw18 ",  #NO.160520 add ta_rvw01
...
DEFINE
   ...
   END IF
      ...
      SELECT UNIQUE rvw01,rvw07,rvw02,rvw19,rvw03,rvw04,rvw11,rvw12,ta_rvw01,ta_rvw04,rvv06, #No.MOD-B50003 add rvv06   #No.FUN-CB0053   Add rvw19  #NO.160520 add ta_rvw01 # 160516xueyh add ta_rvw04
      ...
      #      '',SUM(rvw05f),SUM(rvw06f),'',SUM(rvw05f),SUM(rvw06f),''  #FUN-C80027 add 2'' #No.FUN-CB0048   Mark
       ...
       GROUP BY rvw01,rvw07,rvw02,rvw19,rvw03,rvw04,rvw11,rvw12,ta_rvw01,ta_rvw04,rvv06,rvw18    #No.MOD-B50003  #No.FUN-CB0048   Add rvw18 #No.FUN-CB0053  Add rvw19  #NO.160520 add ta_rvw01# 160516xueyh add ta_rvw04
...
DEFINE l_rvw05f_s  LIKE rvw_file.rvw05,     #NO.160520 add
       l_rvv39t    LIKE rvv_file.rvv39t,     #NO.160520 add
       l_rvv39     LIKE rvv_file.rvv39
DEFINE l_temp      LIKE rvw_file.rvw05f   #add by maoyy20160622
DEFINE l_sum1_s    LIKE rvw_file.rvw05f   #add by lixwz 10171026

   LET g_action_choice = ""
   IF cl_null(g_head_1.rvw01) THEN RETURN END IF
    #LET l_temp = g_rvw[l_ac].rvw05f      #add by maoyy20160622
 ...
 # LET g_forupd_sql = "SELECT rvw99,rvw08,rvw09,'','',rvw02,rvw10,rvw17,rvw05f,rvw06f,rvw05,rvw06",    #FUN-9B0130 add rvw99  #FUN-C80027 mark
   ...
   LET g_head_t.*=g_head_1.*  #add by dengsy160701
         ...
         IF g_rec_b >= l_ac THEN
            ...
            OPEN i140_bcl USING g_head_1.rvw01,g_rvw_t.rvw08,g_rvw_t.rvw09               #表示更改狀態
               ...
               ELSE
                  ...
                  LET g_rvw[l_ac].sum1 = g_rvw_t.sum1  #xueyh160810 add
                  LET g_rvw[l_ac].sum2 = g_rvw_t.sum2   #xueyh1660810 add
                  IF SQLCA.sqlcode THEN
                      CALL cl_err(g_rvw_t.rvw09,SQLCA.sqlcode,1)
                      LET l_lock_sw = "Y"
                  END IF
...
#                     AND apk28 = g_head_1.rvw07                  #CHI-B30082 add
      ...
      AFTER INSERT
        ...
        #LET g_rvw[l_ac].rvw17 = cl_digcut(g_rvw[l_ac].rvw17,t_azi04)    #MOD-CB0281 mark
         ...
         LET l_rvv39t=NULL
         LET l_rvw05f_s=0
         CALL i140_check_rvw05f()  RETURNING l_rvv39t
                                            ,l_rvw05f_s  #add by dengsy160701
                                            ,l_rvv39

       #  LET l_rvw05f_s= g_head_1.rvw05f_s + g_head_1.rvw06f_s - l_rvv39t #mark by maoyy20160621
       #  LET l_rvw05f_s= g_head_1.rvw05f_s  - l_rvv39t #add by maoyy20160621  #mark by dengsy160701
         LET l_rvw05f_s= l_rvw05f_s - l_rvv39t  #add by dengsy160701  #含税金额比较
         SELECT ABS(l_rvw05f_s) INTO l_rvw05f_s FROM DUAL
         IF l_rvw05f_s>10 THEN
         	  CALL cl_err('','cap-001',1)
             CANCEL INSERT
         END IF
         #NO.160520 add ----E-----

         INSERT INTO rvw_file(rvw01,rvw02,rvw03,rvw04,rvw07,rvw11,rvw12,   #MOD-640405
                              ta_rvw01,      #NO.160520 add ta_rvw01
                              ta_rvw04,      # 160516xueyh add ta_rvw04
                              rvwacti,rvwuser,rvwgrup,rvwmodu,rvwdate,rvworiu,rvworig, #FUN-D10064
                       ...
                       VALUES(g_head_1.rvw01,g_head_1.rvw02,g_head_1.rvw03,
                              ...
                              g_head_1.ta_rvw01,    #NO.160520 add ta_rvw01
                              g_head_1.ta_rvw04,    # 160516xueyh add ta_rvw04
...
#######################add by maoyy20160621
            ...
            IF p_cmd='u' AND g_rec_b>0 THEN
               ...
               CALL i140_check_rvw05f()  RETURNING l_rvv39t
                                                    ,l_rvw05f_s  #add by  dengsy160701
                                                    ,l_rvv39 #add by xueyh160809
              # LET l_rvw05f_s= g_head_1.rvw05f_s + g_head_1.rvw06f_s - l_rvv39t  #mark by maoyy20160621
               #  LET l_rvw05f_s= g_head_1.rvw05f_s  - l_rvv39t #add by maoyy20160621  #mark by dengsy160701
            #zhouxm160803 add start
            #   SELECT SUM(rvw05f) INTO l_rvw05f_s FROM rvw_file WHERE rvw01=g_head_1.rvw01 #xueyh160810 mark
           #         AND not  (rvw08=g_rvw[l_ac].rvw08 AND rvw09=g_rvw[l_ac].rvw09)  #xueyh160810 mark
            #zhouxm160803 add end
             #  LET l_rvw05f_s= l_rvw05f_s  - l_rvv39t + g_rvw[l_ac].rvw05f #zhouxm160803 add + g_rvw[l_ac].rvw05f  #add by dengsy160701  #含税金额比较 #xueyh160810 add
              # LET l_rvw05f_s= l_rvw05f_s  - l_rvv39t -g_rvw_t.sum1 + g_rvw[l_ac].sum1 #zhouxm160803 add + g_rvw[l_ac].rvw05f  #add by dengsy160701  #含税金额比较 #xueyh160810 add
                                                                                   # mark by lixwz 171026
               # add by lixwz 171026 s
               LET l_sum1_s = 0
               FOR l_i = 1 TO g_rvw.getLength()
                    IF NOT cl_null(g_rvw[l_i].sum1) THEN
                        LET l_sum1_s = l_sum1_s + g_rvw[l_i].sum1
                    END IF
               END FOR
               LET l_rvw05f_s= l_rvw05f_s  - l_rvv39t - l_rvv39 + l_sum1_s
               # add by lixwz 171026 e
               SELECT ABS(l_rvw05f_s) INTO l_rvw05f_s FROM DUAL
               IF l_rvw05f_s>10 THEN
                  CALL cl_err('','cap-001',1)
                  LET     g_rvw[l_ac].rvw05f = l_temp    #add bymaoyy20160622
                  #LET g_head_1.rvw05f_s = g_head_t.rvw05f_s #mark by dengsy160701
                 #NEXT FIELD rvw05f_s  #mark by dengsy160701
                 NEXT FIELD CURRENT #add by dengsy160701
               END IF
            END IF

      #NO.160520 add ----E-----
#######################add by maoyy20160621
##########################add by maoyy20160622
...
#         END IF
      AFTER FIELD rvw10
         ...
         ELSE
            ...
            #yinhy131108  --Begin
            ELSE
             IF l_rvu116 !='1' THEN #add if by wangxu170320
               IF g_rvw[l_ac].rvw10 = 0 THEN
            ...
            IF g_type = '2' AND g_rvw[l_ac].rvw05f > 0 THEN
               ...
               END IF
            END IF
          IF cl_null(g_rvw[l_ac].rvw05f) THEN #zhouxm160803 add
            LET g_rvw[l_ac].rvw05f = cl_digcut(g_rvw[l_ac].rvw05f,t_azi04)
          END IF #zhouxm160803 add
          IF cl_null(g_rvw[l_ac].rvw06f) THEN #zhouxm160803 add
            LET g_rvw[l_ac].rvw06f = g_rvw[l_ac].rvw05f * g_head_1.rvw04 / 100              #原幣稅額
            LET g_rvw[l_ac].rvw06f = cl_digcut(g_rvw[l_ac].rvw06f,t_azi04)
          END IF #zhouxm160803 add
            LET g_rvw[l_ac].rvw05  = g_rvw[l_ac].rvw05f*g_head_1.rvw12 #本幣金額   #MOD-640405                     #MOD-870285
...
#MOD-B70073--mark--end
      ...
      AFTER FIELD rvw17
        ...
        END IF #zhouxm160803 add
        IF cl_null(g_rvw[l_ac].rvw06) THEN #zhouxm160803 add
            LET g_rvw[l_ac].rvw06  = g_rvw[l_ac].rvw05 * g_head_1.rvw04 / 100                #本幣稅額    rvw04:稅率
        END IF #zhouxm160803 add
            LET g_rvw[l_ac].rvw05  = cl_digcut(g_rvw[l_ac].rvw05,g_azi04)
            LET g_rvw[l_ac].rvw06  = cl_digcut(g_rvw[l_ac].rvw06,g_azi04)
...
#                  AND apk28 = g_head_1.rvw07                  #CHI-B30082 add
            ...
            ELSE
             ...
             #  LET l_rvw05f_s= g_head_1.rvw05f_s  - l_rvv39t #add by maoyy20160621  #mark by dengsy160701
              #zhouxm160803 add start
              # SELECT SUM(rvw05f) INTO l_rvw05f_s FROM rvw_file WHERE rvw01=g_head_1.rvw01  #xueyh160810 mark
                 #   AND (rvw08<>g_rvw[l_ac].rvw08 AND rvw09<>g_rvw[l_ac].rvw09) #xueyh160809 mark
            #zhouxm160803 add end
               # LET l_rvw05f_s= l_rvw05f_s  - l_rvv39t + g_rvw[l_ac].sum1 #zhouxm160803 add rvw09<>g_rvw[l_ac].rvw05f  #add by dengsy160701  #含税金额比较 #xueyh160809 mark
               # LET l_rvw05f_s= l_rvw05f_s  - l_rvv39t - g_rvw_t.sum1 + g_rvw[l_ac].sum1 #zhouxm160803 add rvw09<>g_rvw[l_ac].rvw05f  #add by dengsy160701  #含税金额比较 #xueyh160809 add
               # add by lixwz 171026 s                                                                           # mark by lixwz171026
               ...
               IF l_rvw05f_s>10 THEN
                  ...
                  LET g_rvw[l_ac].* = g_rvw_t.*
                  #CLOSE i140_bcl  #mark by dengsy160701
                  ROLLBACK WORK
                  #EXIT INPUT   #mark by dengsy160701
               END IF
              #NO.160520 add ----E-----
...
#No.MOD-C60217 --end
   ...
   DEFINE l_slip   LIKE smy_file.smyslip  #add by guanyao160701
...
#No.MOD-C60217 --end
   IF g_type = '1' OR (g_type = '2' AND l_rvv03 = '1') THEN  #No.TQC-760013
      ...
      END IF
      #str----add by guanyao160701
      LET l_slip = ''
      CALL s_get_doc_no(g_rvw[l_ac].rvw08) RETURNING l_slip
      IF  l_slip != 'PM75' THEN
      #end----add by guanyao160701
...
#  END IF                          #No.MOD-A70133  mark
  ...
  #所以rvu00='3'時,不做數量(rvw10)的管控
   ...
   IF l_rvu00 != '3' OR (l_rvu116 != '3' AND l_rvu116 !='1') THEN #modify by wangxu170320
      #str---add by guanyao160630
      #IF g_rvv39t > 0 AND g_rvw[l_ac].rvw10 =0  THEN
      #ELSE
      #end---add by guanyao160630
      #str-----add by guanyao160701
      LET l_slip = ''
      CALL s_get_doc_no(g_rvw[l_ac].rvw08) RETURNING l_slip
      IF l_slip != 'PM75' THEN
      ...
      END IF
      END IF #add by guanyao160701
      #END IF #add by guanyao160630
   END IF   #MOD-870285 add
...
DEFINE  l_rvw05f_s  LIKE rvw_file.rvw05,
   ...
   ELSE
      FETCH i140_cl INTO
            ...
            g_head_1.rvw04,g_head_1.rvw11,g_head_1.rvw12,g_head_1.ta_rvw01,g_head_1.ta_rvw04               # 鎖住將被更改或取消的資料   #MOD-640405  #NO.160520 add g_head_1.ta_rvw01# 160516xueyh add ta_rvw04
   ...
   WHILE TRUE
     ...
     #  LET l_rvw05f_s= g_head_1.rvw05f_s  - l_rvv39t #add by maoyy20160621  #mark by dengsy160701
      ...
      UPDATE rvw_file SET rvw_file.rvw01 = g_head_1.rvw01,
                         ...
                         ,rvw_file.ta_rvw01=g_head_1.ta_rvw01  #NO.160520 add
                         ,rvw_file.ta_rvw04=g_head_1.ta_rvw04  # 160516xueyh add ta_rvw04
...
DEFINE l_temp      LIKE rvw_file.rvw05f   #add by maoyy20160622
 ...
 #LET l_temp = g_rvw[l_ac].rvw05f  #zhouxm160623 mark    #add by maoyy20160622
   CALL cl_set_head_visible("","YES")       #No.FUN-6A0092
   ...
   INPUT BY NAME g_type,g_head_1.rvw01,g_head_1.rvw02,g_head_1.rvw19,g_head_1.rvw07,   #No.FUN-CB0053   Add g_head_1.rvw19
                 ...
                 ,g_head_1.ta_rvw01,g_head_1.ta_rvw04  #NO.160520 add   #xueyh160615 add
...
#               AND apk28 = g_head_1.rvw07                              #CHI-B30082 add
      ...
      #NO.160520 add ----B-----
            IF p_cmd='u' AND g_rec_b>0 THEN
              ...
              # LET l_rvw05f_s= g_head_1.rvw05f_s + g_head_1.rvw06f_s - l_rvv39t  #mark by maoyy20160621
              #  LET l_rvw05f_s= g_head_1.rvw05f_s  - l_rvv39t #add by maoyy20160621  #mark by dengsy160701
               #LET l_rvw05f_s= l_rvw05f_s - l_rvv39t  #add by dengsy160701  #含税金额比较  #mark by dengsy160701
               LET l_rvw05f_s=0  #add by dengsy160701
               LET l_rvw05f_s=g_head_1.rvw05f_s + g_head_1.rvw06f_s - l_rvv39t  #add by dengsy160701
               SELECT ABS(l_rvw05f_s) INTO l_rvw05f_s FROM DUAL
               IF l_rvw05f_s>10 THEN
                  CALL cl_err('','cap-001',1)
      ...
      #NO.160520 add ----E-----
	 END IF
     DISPLAY BY NAME g_head_1.rvw05f_s  #add by dengsy160701
            ...
            IF p_cmd='u' AND g_rec_b>0 THEN
              ...
              # LET l_rvw05f_s= g_head_1.rvw05f_s + g_head_1.rvw06f_s - l_rvv39t  #mark by maoyy20160621
               ...
               IF l_rvw05f_s>10 THEN
                  ...
                  LET g_head_1.rvw06f_s = g_head_t.rvw06f_s
                  NEXT FIELD rvw06f_s
               END IF
            END IF
      #NO.160520 add ----E-----
  ...
  # CALL i140_show() #add by maoyy20160621
...
FUNCTION i140_r()
   ...
   ELSE
      FETCH i140_cl INTO g_head_1.rvw01,g_head_1.rvw07,g_head_1.rvw02,    #鎖住將被更改或取消的數據
                         ...
                         g_head_1.rvw12   #MOD-640405
                         ,g_head_1.ta_rvw01,g_head_1.ta_rvw04    #NO.160520 add # 160516xueyh add ta_rvw04
                        ,g_head_1.rvwacti,g_head_1.rvwuser,g_head_1.rvwgrup,g_head_1.rvwmodu, #FUN-D10064
                         g_head_1.rvwdate,g_head_1.rvworiu,g_head_1.rvworig  #FUN-D10064
...
DEFINE l_rvw RECORD LIKE rvw_file.*,
       ...
       l_rvw05f_s   LIKE rvw_file.rvw05,
       l_rvv39t     LIKE rvv_file.rvv39t,    #NO.160520 add
       l_rvv39      LIKE rvv_file.rvv39
   ...
   LET l_rvw.ta_rvw01=g_head_1.ta_rvw01  #NO.160520 add
   LET l_rvw.ta_rvw04=g_head_1.ta_rvw04  # 160516xueyh add ta_rvw04
...
FUNCTION i140_x()
   ...
   ELSE
      FETCH i140_cl INTO
            ...
            g_head_1.rvw04,g_head_1.rvw11,g_head_1.rvw12,g_head_1.ta_rvw01,g_head_1.ta_rvw04,g_head_1.rvwacti,   #NO.160520 add ta_rvw01  # 160516xueyh add ta_rvw04
...
#NO.160520----B-----
FUNCTION i140_check_rvw05f()
DEFINE   i        LIKE type_file.num5
DEFINE   l_rvv39t,p_rvv39t,p_rvv39t_1 LIKE rvv_file.rvv39t
DEFINE   l_rvv17    LIKE rvv_file.rvv17 #add by dengsy160701
DEFINE l_rvv38t      LIKE rvv_file.rvv38   #add by dengsy160701
DEFINE l_rvv38       LIKE rvv_file.rvv38 #xueyh160809 add
DEFINE l_rvv39,p_rvv39    LIKE rvv_file.rvv39  #xueh160809 add

    LET p_rvv39t_1=0
	LET p_rvv39t=0
    LET p_rvv39 = 0  #xueh160809 add
	FOR i=1 TO g_rec_b
	 ##   LET l_rvv39t=NULL
	   # SELECT rvv39t INTO l_rvv39t FROM rvv_file WHERE rvv01=g_rvw[i].rvw08 AND rvv02=g_rvw[i].rvw09#mark by maoyy20160621

      #SELECT rvw05 INTO l_rvv39t FROM rvw_file,rvv_file WHERE rvv01=g_rvw[i].rvw08 AND rvv02=g_rvw[i].rvw09  #add by maoyy20160621  #mark by dengsy160701
     # AND rvw08=rvv01 AND rvw09=rvv02 #add by maoyy20160621  #mark by dengsy160701
        LET l_rvv39t=0
        LET l_rvv39=0  #xueh160809 add
    LET l_rvv38t=0   #add by dengsy160701
    LET l_rvv38 = 0
    LET l_rvv17=0   #add by dengsy160701
        SELECT rvv39t,rvv17,rvv38t,rvv39,l_rvv38 INTO l_rvv39t,l_rvv17,l_rvv38t,l_rvv39,l_rvv38  #add by dengsy160701 #xueyh160809  add rvv39
        FROM rvv_file WHERE rvv01=g_rvw[i].rvw08 AND rvv02=g_rvw[i].rvw09  #add by dengsy160701
        #str------ mark by dengsy160701
	    #IF cl_null(p_rvv39t) THEN
	    # 	 LET p_rvv39t=l_rvv39t
	    #ELSE
	    # 	 LET p_rvv39t=p_rvv39t+l_rvv39t
	    #END IF
        #end------ mark by dengsy160701
        #str------- add by dengsy160701
        IF l_rvv17=g_rvw[i].rvw10 OR (l_rvv17=0 AND g_rvw[i].rvw10=0)THEN
         if g_rvw[i].rvw05f>0 then #xueyh160812 add

           LET p_rvv39t=p_rvv39t+l_rvv39t
           LET p_rvv39 = p_rvv39 + l_rvv39t  # add by lixwz 20171026

         else LET p_rvv39t=p_rvv39t+l_rvv39t*-1 #xueyh160812 add
              LET p_rvv39 = p_rvv39 + g_rvw_t.sum1*-1  # add by lixwz 20171026
         end if #xueyh160812 add
        ELSE
          if g_rvw[i].rvw05f>0 then  #xueyh160812 add
           # LET p_rvv39t=p_rvv39t+l_rvv17*l_rvv38t mark by lixwz 171026
           # add by lixwz 20171026 s
           # 改为用改动后数量比较
           LET p_rvv39t = p_rvv39t + g_rvw[i].rvw10 * l_rvv38t
           LET p_rvv39 = p_rvv39 + g_rvw[i].sum1 / g_rvw[i].rvw10 * g_rvw[i].rvw10
           # add by lixwz 20171026 e
          else let  p_rvv39t=p_rvv39t+l_rvv17*l_rvv38t*-1  #xueyh160812 add
          end if #xueyh160812 add
        END IF
        LET p_rvv39t_1=p_rvv39t_1+g_rvw[i].sum1
        #end------- add by dengsy160701
	END FOR

	IF cl_null(p_rvv39t) THEN LET p_rvv39t=0 END IF
    IF cl_null(p_rvv39t_1) THEN LET p_rvv39t_1=0 END IF  #add by dengsy160701
    IF cl_null(p_rvv39) THEN LET p_rvv39 = 0 END IF
   # LET p_rvv39t = p_rvv39  #xueyh160809 add
	#LET l_rvv39t = l_rvv39  #xueyh160809 add
	RETURN p_rvv39t
           ,p_rvv39t_1    #add by dengsy160701
           ,p_rvv39
