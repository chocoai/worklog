...
# Modify.........: No.2015030299 15/09/30 By renjj 回收p_sser-流水号:2015030299:可以查询到作废的凭证，去掉作废的凭证
...
FUNCTION gglq301v()
   ...
   LET l_sql = " SELECT SUM(abb07),SUM(abb07f) ",
               ...
               "    AND aba03 =  ",yy,
               "    AND aba04 =  ",mm,
               "    AND aba19 <> 'X' ",    #add by renjj 150930
               "    AND aba02 < '",tm.bdate,"'",
               "    AND abb03 LIKE ? ",
               "    AND abb06 = ? ",
               "    AND abaacti ='Y' "
...
FUNCTION q301_out_2()
  ...
  LET g_sql = " SELECT aea05, aag02, aba04, type , aea02, ",
                ...
                "   FROM gglq301_tmp "
  #LET g_sql = " SELECT aea05, aag02,aba04, type , aea02, ",
  #            "        aea03, aea04, CASE abb06 WHEN '0' then '前期结转' WHEN '3' then '本期合计:' WHEN '4' then '本年合计:' else abb04 END, abb24, abb06,bal, balf,  abb07_d , abb07f_d, 1, ",
  #            "        abb07_c , abb07f_d, 1, ' ',      bal,balf, 1, 1, 2,   2,2 ",
