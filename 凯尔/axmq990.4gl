...
# Modify.........: No.MOD-E10176 14/01/24 By SunLM 未開票數量的merge中加入出貨單項次條件
# Modify.........: No.MOD-E10182 14/01/26 By fengmy g_ogb_excel賦值前未清空,導致匯出excel錯誤
# Modify.........: No.MOD-E20061 14/02/13 By SunLM 添加ui.interface.refresh()函數
...
GLOBALS "../../config/top.global"
   ...
   DEFINE tm  RECORD
                 ...
                 d      LIKE type_file.chr1,    #jolly170823
   ...
   DEFINE g_oga          DYNAMIC ARRAY OF RECORD
    ...
    DEFINE g_ogb          DYNAMIC ARRAY OF RECORD
                ...
                ogb14t_3    LIKE ogb_file.ogb14t,  #本币未税金额jolly171214
                ...
                ta_oeb01    LIKE oeb_file.ta_oeb01, # jolly add 170706
                oga27       LIKE oga_file.oga27,    # jolly add 170706
   ...
   DEFINE g_ogb_excel    DYNAMIC ARRAY OF RECORD
                ...
                ogb14t      LIKE ogb_file.ogb14t,  #原币含税金额
                ogb14t_2    LIKE ogb_file.ogb14t,  #本币含税金额
                ogb14t_3    LIKE ogb_file.ogb14t,  #本币未税金额  jolly171214
                ogb12       LIKE ogb_file.ogb12,
                ogb60       LIKE ogb_file.ogb60,
                ogb1013_1   LIKE ogb_file.ogb1013,
                ogb1013     LIKE ogb_file.ogb1013,
...
FUNCTION q990_cs()
   ...
   LET tm.b = 'Y'
   LET tm.c = 'Y'
   LET tm.d = 'N'   #jolly170823 勾选只显示未开票明细
   LET tm.sty ='1'
   SELECT (YEAR(sysdate)||'/'||Month(sysdate)||'/01') INTO tm.bdate FROM DUAL
   LET tm.edate = g_today
   DIALOG ATTRIBUTE(UNBUFFERED)
      INPUT tm.bdate,tm.edate,tm.a,tm.b,tm.c,tm.d,tm.sty FROM bdate,edate,a,b,c,d,sty ATTRIBUTE(WITHOUT DEFAULTS)   #jolly170823 add d
         BEFORE INPUT
...
FUNCTION q990_show()
   DISPLAY tm.bdate,tm.edate,tm.a,tm.b,tm.c,tm.d,tm.sty TO bdate,edate,a,b,c,d,sty      #jolly170823 add d
   CALL q990_b_fill_2()
   CALL q990_b_fill()
   LET g_action_choice = "page1"
   ...
   CALL cl_show_fld_cont()
   CALL ui.interface.refresh() #DSC test MOD-E20061 add
END FUNCTION
...
DEFINE l_type     LIKE type_file.chr1
   ...
   #jolly170823---str---
   IF tm.d = 'Y' THEN
      LET p_wc = "ogb917-ogb60<>'0'"
      LET p_wc1= "ohb917-ohb60<>'0'"
   END IF
   IF tm.d = 'N' THEN
      LET p_wc = " 1=1 "
      LET p_wc1= " 1=1 "
   ...
   LET l_sql = "SELECT DISTINCT oga03,oga032,oga18,'' occ18,oga02,ogb01,ogb03,ogb04,ogb06,ima021, ",
               ...
               "       ogb14,ogb14t-ogb14 ogb14_t_2,ogb14t,'' ogb14t_2,'' ogb14t_3,'' ogb12,ogb60,'' ogb1013_1,ogb1013,'' ogb12_1,'' ogb60_1, ",
               "       '' ogb60_2,occ03,oca02,oga15,gem02,oga14,gen02,ogb1012,oea10,ogb11,ta_oeb01,oga27, ",    #jolly add 170706
               ...
               " WHERE oga01 = ogb01 ",
               "   AND ogapost = 'Y' ",    #add by lili 170818
               "   AND ",l_wc CLIPPED,
               "   AND ",p_wc CLIPPED,          #jolly170823
               "   AND ",tm.wc2 CLIPPED,
               ...
               "        '',occ03,oca02,oha15,gem02,oha14,gen02,ohb1004,oea10,ohb11,'','', ",  #jolly add 170706 2个''
               "        oha99,ohb33,ohb34,'','B'",
               ...
               "                 LEFT OUTER JOIN oeb_file ON oeb01 = ohb31 AND oeb03=ohb34 ",
               "                 LEFT OUTER JOIN ima_file ON ima01 = ohb04 ",
               " WHERE oha01 = ohb01 ",
               "   AND ohapost='Y' ",    #add by lili 170818
               "   AND ",l_wc1 CLIPPED,
               "   AND ",p_wc1 CLIPPED,          #jolly170823
               "   AND ",g_wc CLIPPED,
   ...
   LET l_sql = " UPDATE axmq990_tmp  ",
               ...
               "        ogb14t_3 = ogb14 * oga24 "   #jolly171214
              ,"       ,ogb1013 = ogb13 * ogb60 "    #add by lili 170824
   PREPARE q003_pre3 FROM l_sql
   EXECUTE q003_pre3

   #mark by lili 170722 ---s---
#   LET l_sql = " MERGE INTO axmq990_tmp o ",
...
#   EXECUTE q003_pre4
   ...
   LET l_sql = " UPDATE axmq990_tmp  ",
               ...
               "        ogb14t_1 = ogb14t_1 * -1, ",
               #"        ogb13 = ogb13 * -1, ",    #mark by lili 170817
               "        ogb14 = ogb14 * -1, ",
               "        ogb14_t_2 = ogb14_t_2 * -1, ",
               "        ogb14t = ogb14t * -1, ",
               "        ogb14t_2 = ogb14t_2 * -1, ",
               "        ogb14t_3 = ogb14t_3 * -1, ",   #jolly171214
               "        ogb12 = 0, ",
               #"        ogb60 = 0, ",    #mark by lili 170815
               "        ogb1013_1 = 0, ",
               #"        ogb1013 = 0, ",   #mark by lili 170815
               "        ogb12_1 = 0, ",
               "        ogb60_1 = 0, ",
               "        ogb60_2 = 0  ",
               "  WHERE type = 'B' "
   ...
   LET l_sql = " MERGE INTO axmq990_tmp o ",
               "      USING (SELECT ogb31,ogb32,SUM(ogb12) ogb12_sum FROM oga_file,ogb_file ", #MOD-E10176 and o.ogb03 = n.ogb03
               "              WHERE oga01=ogb01 AND ogapost = 'Y' AND oga09 = '8'  ",
               "              GROUP BY ogb31,ogb32 ) n ",
               "         ON (o.ogb31 = n.ogb31 AND o.ogb32 = n.ogb32 and o.ogb03 = n.ogb03) ", #MOD-E10176 and o.ogb03 = n.ogb03
               " WHEN MATCHED ",
               " THEN ",
               "    UPDATE ",
   ...
   #mod by lili 170731 ---s---
#   LET l_sql = " MERGE INTO axmq990_tmp o ",
#               "      USING (SELECT ogb31,ogb32,ogb03,SUM(ogb12) ogb12_sum FROM oga_file,ogb_file ", #MOD-E10176 and o.ogb03 = n.ogb03
#               "              WHERE oga01=ogb01 AND ogapost='Y' AND oga09 IN ('2','4','6') ",
#               "              GROUP BY ogb31,ogb32,ogb03 ) n ",
#               "         ON (o.ogb31 = n.ogb31 AND o.ogb32 = n.ogb32 and o.ogb03 = n.ogb03 ) ",  #MOD-E10176 and o.ogb03 = n.ogb03
#               " WHEN MATCHED ",
#               " THEN ",
#               "    UPDATE ",
...
#   EXECUTE q003_pre8
   ...
   LET l_sql = " MERGE INTO axmq990_tmp o ",
               "      USING (SELECT ogb01,ogb03,SUM(ogb12) ogb12_sum FROM oga_file,ogb_file ", #MOD-E10176 and o.ogb03 = n.ogb03
               "              WHERE oga01=ogb01 AND ogapost='Y' AND oga09 IN ('2','4','6') ",
               "              GROUP BY ogb01,ogb03 ) n ",
               "         ON (o.ogb01 = n.ogb01 and o.ogb03 = n.ogb03 ) ",  #MOD-E10176 and o.ogb03 = n.ogb03
               " WHEN MATCHED ",
               " THEN ",
               "    UPDATE ",
               "       SET o.ogb12 = 0, ",
   ...
   PREPARE q003_pre8 FROM l_sql
   EXECUTE q003_pre8
   #mod by lili 170731 ---e---

   #add by lili 170812 ---s---
   LET l_sql = " MERGE INTO axmq990_tmp o ",
               "      USING (SELECT ohb01,ohb03,SUM(ohb12) ohb12_sum FROM oha_file,ohb_file ",
               "              WHERE oha01=ohb01 AND ohapost='Y' ",
               "              GROUP BY ohb01,ohb03 ) n ",
               "         ON (o.ogb01 = n.ohb01 and o.ogb03 = n.ohb03 ) ",
               " WHEN MATCHED ",
               " THEN ",
               "    UPDATE ",
               "       SET o.ogb12 = 0, ",
               "           o.ogb12_1 = NVL(NVL(n.ohb12_sum,0)-o.ogb60,0)*(-1) ",
               "     WHERE o.type = 'B' "
   PREPARE q003_pre10 FROM l_sql
   EXECUTE q003_pre10
   #add by lili 170812 ---e---

   LET l_sql = " UPDATE axmq990_tmp  ",
               ##"    SET ogb1013_1 = NVL(ogb1013 * oga24,0), ",
               "    SET ogb1013_1 = ( CASE ogb917 when 0 THEN 0 ELSE NVL(ogb14t_3/ogb917*ogb60,0) END), ", # mod by lixwz180717
               #"    SET ogb1013_1 = NVL(ogb14t_3/ogb917*ogb60,0), ",
               "        ogb60_1 = NVL(ogb12_1 * ogb13_1,0), ",
               #"        ogb60_2 = NVL(ogb12_1 * ogb14t_3/ogb917,0) "
               "        ogb60_2 = (CASE ogb917 when 0 then 0 else NVL(ogb12_1 * ogb14t_3/ogb917,0) end) " # mod by lixwz180717
   PREPARE q003_pre9 FROM l_sql
   EXECUTE q003_pre9
   #free--mark--str--

   #add by lili 170815 ---s---
   LET l_sql = " UPDATE axmq990_tmp  ",
               "    SET ogb60 = ogb60 * -1 ",
               "       ,ogb1013 = ogb13 * ogb60 *-1 ",   #add by lili 170824
               #"       ,ogb1013_1 = ogb14t_3/ogb917*ogb60 *-1 ",
               "       ,ogb1013_1 = (case ogb917 when 0 then 0 else  ogb14t_3/ogb917*ogb60 *-1  end )",
               "  WHERE type = 'B' "
   PREPARE q003_pre11 FROM l_sql
   EXECUTE q003_pre11
   #add by lili 170815 ---e---
...
FUNCTION q990_get_sum()
   ...
   LET l_sql = "SELECT oga03,oga032,oga18,occ18,oga02,ogb01,ogb03,ogb04,ogb06,ima021, ",
               "       oga211,ogb916,ogb917,ogb13_1,ogb14_1,ogb14_t_1,ogb14t_1,oga23,oga24,ogb13,",
               "       ogb14,ogb14_t_2,ogb14t,ogb14t_2,ogb14t_3,ogb12,ogb60,ogb1013_1,ogb1013,ogb12_1,ogb60_1,",
               "       ogb60_2,occ03,oca02,oga15,gem02,oga14,gen02,ogb1012,oea10,ogb11,ta_oeb01,oga27,",    #jolly add 170706
               "       oga99,ogb31 ",
               " FROM axmq990_tmp "
...
#               "   AND oga14 = '",g_oga[p_ac].oga14a,"'",  #人员编号
   ...
   CALL g_ogb.clear()
   CALL g_ogb_excel.clear()  #MOD-E10182 add
   LET g_cnt = 1
   LET g_rec_b = 0
...
FUNCTION q990_set_visible()
   ...
   CALL cl_set_comp_visible("ogb13_1,ogb14_1,ogb14_t_1,ogb14t_1,oga23,oga24,
                             ogb13,ogb14,ogb14_t_2,ogb14t,ogb14t_2,ogb14t_3,oea10,ogb11,ogb1013_1,ogb60_1,ogb1013,ogb60_2,ogb1013_1",TRUE)
   CALL cl_set_comp_visible("ogb13_1,ogb14_1,ogb14_t_1,ogb14t_1,ogb60_1",tm.a='N')
   CALL cl_set_comp_visible("oga23,oga24,ogb13,ogb14,ogb14_t_2,ogb14t,ogb14t_2,ogb14t_3,ogb1013,ogb60_2",tm.a='Y')
