   ...
   END IF    #No.FUN-850109
    ...
    #    ORDER BY sfa01
     LET l_sql =" SELECT sfa03,ima02,sfa01 FROM ima_file,sfa_file,sfb_file ",
                ...
                "  AND (sfb38 >= '",l_bdate,"' OR sfb38 IS NULL) ",
                "  AND ",tm.wc CLIPPED,
                "  AND sfa26 != 'S' ", # add by lixwz180508
                #"  AND NOT EXISTS (SELECT 1 FROM sfa_file a,sfb_file b WHERE a.sfa01 =b.sfb01 AND a.sfa27 = sfa03 AND (SFB38 >= '",l_bdate,"'OR SFB38 IS NULL))",
                " ORDER BY sfa01 "
