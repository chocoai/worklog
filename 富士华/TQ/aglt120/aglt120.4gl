# Prog. Version..: '5.25.08-12.05.10(00009)'     #
#
...
# Modify.........: No.FUN-BB0116 11/12/13 By Lori 帳套拋轉時提供整批確認功能,以利於IFRS帳套與ROC帳套併行使用兩套帳的拋轉
...
DEFINE l_cnt       LIKE type_file.num5        #MOD-920353 add
    ...
    WHILE TRUE
        ...
        IF SQLCA.sqlerrd[3]= 0 THEN
           ROLLBACK WORK   #No.7875
           CALL cl_err(g_aba.aba01,SQLCA.sqlcode,1)
           CONTINUE WHILE
        END IF
        COMMIT WORK #No.7875
...
FUNCTION t120_show()
    ...
    CALL cl_set_field_pic(g_aba.aba19,g_aba.abamksg,g_aba.abapost,"","",g_aba.abaacti)
...
DEFINE
    ...
    LET g_forupd_sql= " SELECT abb02,abb03,' ',abb05,' ',abb06,abb24,",
    ...
    INPUT ARRAY g_abb WITHOUT DEFAULTS FROM s_abb.*  #No.MOD-470592
        ...
        ON ROW CHANGE
            ...
            LET g_abb[l_ac].abb07 = cl_numfor(g_abb[l_ac].abb07,15,g_azi04)         #No.CHI-6A0004 g_azi-->t_azi #No.TQC-BB0246 modify:t_azi->g_azi 
...
DEFINE p_wc2   LIKE type_file.chr1000   #No.FUN-680098  VARCHAR(200)
    ...
    LET g_sql =
        " SELECT abb02,abb03,aag02,abb05,gem02,abb06,abb24, ",
       ...
       #"        abb31,abb32,abb33,abb34,abb35,abb36,abb37,",        #MOD-BB0234 mark
        ...
        "        abb04,abbud01,abbud02,abbud03,abbud04,abbud05, ",
        "        abbud06,abbud07,abbud08,abbud09,abbud10,",
        "        abbud11,abbud12,abbud13,abbud14,abbud15", 
