...
# Modify.........: No.TQC-B90132 11/09/20 By wujie  删除后要刷新画面
# Modify.........: No.FUN-B90062 11/09/26 By wujie 产生nme_file时同时产生tic_file
# Modify.........: No.TQC-BB0246 11/12/02 By qirl mod
...
# Modify.........: No:CHI-C50002 12/05/02 By yinhy 增加控卡，出賬類不可存入
...
#  CALL cl_set_comp_visible("npk073",g_aza.aza63='Y')
   ...
   END IF
#No.MOD-A80067 --end
CALL cl_set_comp_visible("npkud02",TRUE)   # add by lixwz180201
   # 先以g_argv2判斷直接執行哪種功能，
   # 執行I時，g_argv1是單號
...
DEFINE  lc_qbe_sn       LIKE    gbm_file.gbm01    #No.FUN-580031  HCN
   ...
   INITIALIZE g_nmg.* TO NULL    #No.FUN-750051
     #CONSTRUCT BY NAME g_wc ON nmg00,nmg01,nmg11,nmg17,nmg20,nmg18,nmg19,nmg21, #CHI-A70019 mark
      CONSTRUCT BY NAME g_wc ON nmg00,nmg01,nmg11,nmg20,nmg18,nmg19,nmg21,       #CHI-A70019
                                nmgconf,nmg29,nmg30,nmg301,nmg13,nmg14,nmg23,nmg05,nmg24,      #No.FUN-680034 add nmg301
 ...
 #查詢時開窗功能
      ...
      CONSTRUCT g_wc1 ON npk01,npk03,npk02,npk04,npk05,npk06,npk08,npk09,npk07,npk071,npk072,npk073,npk10     #No.FUN-680034 add npk071,npk072
...
FUNCTION t302_show()
  ...
  #DISPLAY BY NAME g_nmg.nmg00,g_nmg.nmg01,g_nmg.nmg11,g_nmg.nmg17,g_nmg.nmg20, g_nmg.nmgoriu,g_nmg.nmgorig, #CHI-A70019 mark
   DISPLAY BY NAME g_nmg.nmg00,g_nmg.nmg01,g_nmg.nmg11,g_nmg.nmg20, g_nmg.nmgoriu,g_nmg.nmgorig, #CHI-A70019
                   ...
                   g_nmg.nmg30,g_nmg.nmg301,g_nmg.nmgconf,g_nmg.nmg24,g_nmg.nmguser,               #No.FUN-680034 add g_nmg.nmg301
...
FUNCTION t302_i(p_cmd)
   ...
   #INPUT BY NAME g_nmg.nmg00,g_nmg.nmg01,g_nmg.nmg11,g_nmg.nmg17,g_nmg.nmg20, g_nmg.nmgoriu,g_nmg.nmgorig, #CHI-A70019 mark
    INPUT BY NAME g_nmg.nmg00,g_nmg.nmg01,g_nmg.nmg11,g_nmg.nmg20, g_nmg.nmgoriu,g_nmg.nmgorig, #CHI-A70019
                  g_nmg.nmg18,g_nmg.nmg19,g_nmg.nmg21,g_nmg.nmgconf,
      ...
      BEFORE INPUT
        ...
        AFTER FIELD nmg00
            #FUN-B90075 add 更改状态下也要控制
            IF NOT cl_null(g_nmg.nmg00) THEN
        ...
        ON ACTION CONTROLP
           CASE
              ...
              WHEN INFIELD(nmg11)
                 ...
                 DISPLAY BY NAME g_nmg.nmg11 NEXT FIELD nmg11
             #CHI-A70019 mark --start--
             # WHEN INFIELD(nmg17) #變動碼
             #    CALL cl_init_qry_var()
             #    LET g_qryparam.form = "q_nml"
...
DEFINE
   ...
   INPUT ARRAY g_npk WITHOUT DEFAULTS FROM s_npk.*
       ...
       BEFORE INPUT
         ...
         CALL cl_set_comp_entry("npkud02",TRUE)
      ...
      #AFTER FIELD npk03 #MOD-AC0293 mark
       ON CHANGE npk03   #MOD-AC0293
         IF NOT cl_null(g_npk[l_ac].npk03) THEN
           ...
           #-------------------------MOD-C30081 ------------------------------end
           #No.CHI-C50002  --Begin
           IF g_nmg.nmg20 = '1' and g_npk[l_ac].npk03 MATCHES '[1]' THEN
               CALL cl_err('','anm-359',0)
               LET g_npk[l_ac].npk03 = ''
               NEXT FIELD npk03
            END IF
            #No.CHI-C50002  --End
           ...
           #IF NOT cl_null(g_npk[l_ac].npk02) THEN                                         #MOD-C30070 mark
            IF NOT cl_null(g_npk[l_ac].npk02) OR g_npk[l_ac].npk02 <> g_npk_t.npk02  THEN  #MOD-C30070 add
               CALL t302_nmc(g_npk[l_ac].npk02,g_npk[l_ac].npk03)
               IF NOT cl_null(g_errno) THEN
	 ...
	 DISPLAY BY NAME g_npk[l_ac].npk06
       ...
       AFTER FIELD npk07
         IF NOT cl_null(g_npk[l_ac].npk07) THEN
            ...
            # add by lixwz 180201 s
            IF NOT cl_null(g_nmg.nmg11) THEN
                SELECT tc_afc04
                  INTO g_npk[l_ac].npkud02
                  FROM tc_afc_file
                 WHERE tc_afc01 = g_nmg.nmg11
                   AND tc_afc02 = g_npk[l_ac].npk07
                DISPLAY BY NAME g_npk[l_ac].npkud02
            END IF
            # add by lixwz 180201 e
            IF NOT cl_null(g_errno) THEN
#FUN-B20073 --begin--
...
FUNCTION t302_nmc(p_nmc01,p_key)
   ...
   LET g_errno = ' '
   IF p_key='3' OR p_key='5' THEN LET p_key='1' END IF
   IF p_key='4' OR p_key='6' THEN LET p_key='2' END IF
...
DEFINE l_wc2  LIKE type_file.chr1000 #No.FUN-680107 VARCHAR(200)
   ...
   CONSTRUCT g_wc1 ON npk01,npk03,npk02,npk04,npk05,npk06,npk08,npk09,
                      npk07,npk071,npk072,npk073,npk10                           #No.FUN-680034 add npk072,npk073
                      ,npkud01,npkud02,npkud03,npkud04,npkud05
                      ,npkud06,npkud07,npkud08,npkud09,npkud10
                      ,npkud11,npkud12,npkud13,npkud14,npkud15
                 FROM s_npk[1].npk01,s_npk[1].npk03,s_npk[1].npk02,
...
DEFINE p_wc2  LIKE type_file.chr1000 #No.FUN-680107 VARCHAR(300)
   ...
   LET g_sql = "SELECT npk01,npk03,npk02,nmc02,npk04,npk05,npk06,npk08, ",
               "       npk09,npk07,npk071,npk072,npk073,npk10, ",             #No.FUN-680034 add npk072,npk073
               "       npkud01,npkud02,npkud03,npkud04,npkud05,",
               "       npkud06,npkud07,npkud08,npkud09,npkud10,",
               "       npkud11,npkud12,npkud13,npkud14,npkud15 ",
...
FUNCTION t302_x()
   ...
   LET g_nmg_t.* = g_nmg.*
   CALL t302_show()
   IF cl_void(0,0,g_nmg.nmgconf) THEN
      IF g_nmg.nmgconf='N' THEN    #切換為作廢
         DELETE FROM npp_file
          WHERE nppsys= 'NM'
            AND npp00=3
            AND npp01 = g_nmg.nmg00
      ...
      IF g_nmg.nmg20 = '22' THEN
         ...
         SELECT SUM(npk08) INTO l_s_npk08
          ...
          LET l_s_npk08 =  g_nmg.nmg23 + l_s_npk08
           UPDATE olc_file SET olc11=l_s_npk08 ,olc12=g_nmg.nmg01,   #MOD-730126
...
#No.MOD-B10242 --end
      ...
      SELECT COUNT(*) INTO l_cnt FROM  oob_file,ooa_file
       WHERE oob06=g_nmg.nmg00
        ...
        # AND oob03='1' AND oob04 IN ('2','3')     #MOD-AA0108   #MOD-BC0021 mark
...
FUNCTION t302_ins_oma()
   ...
   SELECT gen03 INTO g_oma.oma15 FROM gen_file WHERE gen01=g_oma.oma14
...
DEFINE l_omc   RECORD LIKE omc_file.*,
   ...
   IF g_oma.oma00[1,1] = '2' THEN
      ...
      CALL cl_digcut(l_omc.omc08,t_azi04) RETURNING l_omc.omc08   #TQC-BB0246 mod
      CALL cl_digcut(l_omc.omc09,g_azi04) RETURNING l_omc.omc09   #TQC-BB0246 mod
      CALL cl_digcut(l_omc.omc13,g_azi04) RETURNING l_omc.omc13   #TQC-BB0246 mod
...
DEFINE l_wc   STRING                             #MOD-960319 add
   ...
   MENU ""
      ...
      ON ACTION IE_Document_print
         ...
         LET g_msg =  "anmr302 '",g_today CLIPPED,"' '' '",g_lang,"' 'Y' '' '' "," '",l_wc CLIPPED,"' '3'" CLIPPED   #MOD-710170  #MOD-960319
...
DEFINE l_n  LIKE type_file.num5    #No.FUN-B30049
   INPUT BY NAME g_nmg.nmg18,g_nmg.nmg19 WITHOUT DEFAULTS
      ...
      AFTER FIELD nmg18
         ...
         WHERE oob03 = '1' AND oob04 = '3' AND oob06 = g_nmg.nmg00
         IF l_n > 0 THEN
