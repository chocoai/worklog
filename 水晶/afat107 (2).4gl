    ...
    WHILE TRUE
        ...
        IF g_fbc.fbc02 != g_fbc_t.fbc02 THEN            # 更改單號
           ...
           IF g_nmz.nmz70 = '3' THEN
              LET l_tic01=YEAR(g_fbc.fbc02)
              LET l_tic02=MONTH(g_fbc.fbc02)
...
#FUN-C30313---add---START-----
     ...
     #IF l_n = 0 THEN                                                                     #MOD-C50255 mark
      IF l_n = 0 AND                                                                      #MOD-C50255 add
         #((g_fah.fahdmy3 = 'Y')    #mark by dengsy160216
         ((g_fah.fahdmy3 = 'Y' AND g_fah.fahglcr='Y')   #add by dengsy160216 
         OR (g_faa.faa31 = 'Y' AND g_fah.fahdmy32 = 'Y' )) THEN    #MOD-C50255 add
         CALL t107_gen_glcr(g_fbc.*,g_fah.*)
      END IF
      IF g_success = 'Y' THEN
         IF g_fah.fahdmy3 = 'Y' AND g_fah.fahglcr = 'Y' THEN
