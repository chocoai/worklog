         ...
         ON ACTION controlp
            CASE
               WHEN INFIELD(sfb01) #order nubmer
                    ...
                    LET g_qryparam.where = " sfb01[1,",g_doc_len,"] NOT IN (SELECT smy69 FROM smy_file WHERE smy69 IS NOT NULL) " # add by lixwz 171117
...
#FUN-C30114---end
      ...
      LET g_wc = g_wc CLIPPED," AND sfb01[1,",g_doc_len,"] NOT IN (SELECT smy69 FROM smy_file WHERE smy69 IS NOT NULL) " # add by lixwz 171117
            ...
            IF NOT cl_null(g_sfb.sfb92) THEN
               IF p_cmd='a' AND
                 ...
                 # LET g_sfb.sfb071=l_ksg.ksg07   #有效日
                  LET g_sfb.sfb071=g_sfb.sfb81  #NO.160810 modify yang
                  #add by shids 160705 str
                  IF NOT cl_null(g_sfb.sfb13) THEN
                  	LET g_sfb.sfb071 = g_sfb.sfb13
                  END IF
                  #add by shids 160705 end
                  ...
                  END IF
                  #CHI-B50051 -----  end  -----
                  #add by zhaoxiangb 160103
                  LET g_sfb.sfb27 = l_ksg.ta_ksg01
                  LET g_sfb.sfbud02 = l_ksg.ta_ksg02
                  SELECT pja02 INTO l_pja02 FROM pja_file WHERE pja01 = l_ksg.ta_ksg01
                  DISPLAY l_pja02 TO pja02
                  DISPLAY BY NAME g_sfb.sfb27 ,g_sfb.sfbud02
                  #end add
       ...
       AFTER FIELD sfbmksg
        ...
        AFTER INPUT #判斷必要欄位之值是否有值,若無則反白顯示,並要求重新輸入
           ...
           END IF
            ...
            END IF
            IF g_cnt = 0 THEN
               IF NOT (g_sfb.sfb02='1' OR g_sfb.sfb02='5' OR g_sfb.sfb02='8'   #add 类型为1 by jiangln 170920
...
FUNCTION i301_set_no_entry(p_cmd)
  ...
  DEFINE l_t1       LIKE smy_file.smyslip #CHI-910055
   ...
   END IF
    ...
    IF NOT cl_null(g_sfb.sfb22) AND NOT cl_null(g_sfb.sfb221)  THEN
      #CALL cl_set_comp_entry("sfb27,sfb271,sfb50,sfb51",FALSE) #mark by gaunyao20151026
      CALL cl_set_comp_entry("sfb271,sfb50,sfb51",FALSE)        #add by gaunyao20151026
    END IF
...
FUNCTION i301_out()
    ...
    #mark by zhangyu 151207---end
    LET g_wc = 'sfb01 = "',l_no,'"'
   # LET g_sql = "asfr102 ",  #FUN-C30085 mark  #mark by zhangyu 151207
   # LET g_sql = "asfg102 ",  #FUN-C30085 add  #mark by zhangyu 151207
   LET g_sql = "csfr301 ",     #add by zhangyu 151207
                " '",g_today,"'",
                " '",g_user,"'",
                ...
                " '1'",
                " '",g_wc clipped,"'"
                #" 'Y'",           #mark by zhangyu 151207
                #" 'N'",           #mark by zhangyu 151207
                #" '",l_memo,"'",  #mark by zhangyu 151207
                #" '",l_mark,"'",  #mark by zhangyu 151207
                #" 'Y'"             #TQC-630013  #mark by zhangyu 151207
