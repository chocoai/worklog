...
DEFINE l_n      LIKE type_file.num5   #FUN-B60045   Add
   DEFINE l_name     LIKE type_file.chr20,             # External(Disk) file name       #No.FUN-680070 VARCHAR(20)
          ...
          sr           RECORD order1 LIKE faj_file.faj06,  #No.FUN-680070 VARCHAR(30)
                              ...
                              faj20  LIKE type_file.chr100,    # 保管部門
   ...
   #FUN-C90088--E--
     ...
     IF tm.d = '1' THEN                #No.FUN-B50133  ADD
        LET l_sql = "SELECT '','','',",
                    ...
                    " faj02,faj022,gem02,faj21,faf02,",  # mod by lixwz180621
                    ...
                    "  ,gem_file ", # add by lixwz180621
                    " WHERE fajconf='Y' AND ",tm.wc CLIPPED,
                    " AND faj26 <='",g_edate,"'",
                    " AND faj_file.faj19 = gen_file.gen01 ",
                    " AND faj_file.faj20 = gem_file.gem01(+) ",  # add by lixwz180621
...
#FUN-B60045   ---end     Add
    ...
    #                   ,sr.tmp07    #CHI-C70003 Add
     EXECUTE insert_prep USING
                         sr.faj04,sr.faj02,sr.faj022,sr.faj20,sr.gen02,sr.faj07,  # mod by lixwz180621 faj19-->gen02
