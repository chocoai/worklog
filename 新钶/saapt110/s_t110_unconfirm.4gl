...
FUNCTION s_t110_unconfirm(p_aptype,p_apa01,p_apa41,p_apb06,p_apb37,p_plant)
   ...
   FOREACH sel_apa_cs INTO g_apa.*
      ...
      IF p_aptype = '13' AND g_apa.apa37f > 0 THEN
         CALL s_t110_del_nme()
      END IF
      #UPDATE apa_file SET apa41 = 'N',apa63 = '1'  #新钶使用BPM，单据取消审核后apa63不应更新为0。 mod by likl171030
      # WHERE apa01=g_apa.apa01                    # mark by lixwz 171101
      UPDATE apa_file SET apa41 = 'N',apa63 = '0'  #bpm修改的功能有取消状态码完成，恢复正常取消审核  add by lixwz 171101
       WHERE apa01=g_apa.apa01
      IF SQLCA.sqlcode OR SQLCA.sqlerrd[3] = 0 THEN
         IF only_one='1' THEN
