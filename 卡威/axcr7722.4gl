...
MAIN
   ...
   LET g_sql = "tlf031.tlf_file.tlf031,tlf06.tlf_file.tlf06,",
              ...
              #"tlf930.tlf_file.tlf930"     #No:110614  Modify <<--yangjian--
               ...
               ",sfvud03.sfv_file.sfcud03,",
               "sfvud04.sfv_file.sfvud04,",
               "sfvud13.sfv_file.sfvud13,",
               "sfvud14.sfv_file.sfvud14"
   ...
   LET g_sql = "INSERT INTO ",g_cr_db_str CLIPPED,l_table CLIPPED,
              ...
              #"        ?,?,?,?,?,?)"            #No.FUN-7C0101 add               #FUN-9A0050 Add ?,?,?   #No:110614  Add ?  <<-yangjian--
               "        ?,?,?,?,? ,?,?,?,?,? ,?)"            #No.FUN-7C0101 add               #FUN-9A0050 Add ?,?,?  # add ,?,?,?,? by lixwz180604
...
DEFINE lc_qbe_sn         LIKE gbm_file.gbm01,          #No.FUN-580031
 ...
 WHILE TRUE
   ...
   INPUT BY NAME tm.bdate,tm.edate,tm.type,tm.a,tm.more   #No.FUN-7C0101 add tm.type
      WITHOUT DEFAULTS
...
DEFINE     l_sfvud13  LIKE sfv_file.sfvud13
DEFINE     l_sfvud14  LIKE sfv_file.sfvud14
# add by lixwz180604 e---
     ...
     LET l_sql = "SELECT '',ima12,ima01,ima02,ima021,tlfccost,",      #No.FUN-7C0101 add tlfccost   #MOD-840342 mod
                 ...
                 "  FROM tlf_file left join sfv_file on sfv01 = TLF027 and sfv02 = tlf027",  # add by lixwz180604 leftjoin on sfv_file
                 " LEFT OUTER JOIN tlfc_file ON tlf01=tlfc01 AND tlf06=tlfc06 AND tlf02=tlfc02 AND tlf03 = tlfc03 AND tlf13=tlfc13 AND tlf13=tlfc13 AND tlf902=tlfc902 AND tlf903=tlfc903 AND tlf904=tlfc904 AND tlf907=tlfc907 AND tlf905=tlfc905 AND tlf906=tlfc906,ima_file,sfb_file  ",          #No.FUN-7C0101
                 " WHERE ima01 = tlf01 and tlf62=sfb01",
                 "   AND sfb02!=11",   #FUN-670058 mark    #No.MOD-7C0192 del mark
                 "   AND (tlf13 = 'asft6201' OR tlf13='asft6101' ",   #No:9586
                 "    OR  tlf13 = 'asft6231' OR tlf13='asft660' )",    #No:9586
                 "   AND ",tm.wc CLIPPED,
