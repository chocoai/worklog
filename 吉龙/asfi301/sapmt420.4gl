...
FUNCTION t420_r()
   DEFINE  l_pml      RECORD
    ...
    DEFINE tok          base.StringTokenizer  # add by lixwz 20171103
    DEFINE  l_sfa01  LIKE sfa_file.sfa01 # add by lixwz 20171103
...
#FUN-B90101--add--end--
       ...
       # add by lixwz 171103 s 删除请购单回写asfi301
       IF g_argv1[1,1] = '/' THEN
          LET tok = base.StringTokenizer.create(g_argv1,'/')
          WHILE tok.hasMoreTokens()
                LET l_sfa01 =tok.nextToken()
          END WHILE
           UPDATE sfa_file SET sfaud01 = '' WHERE sfa01 = l_sfa01 AND　sfaud01=g_pmk.pmk01
       END IF
       # add by lixwz 171103 s
#FUN-A60035 ---MARK BEGIN
##FUN-A50054 --Begin
#&ifdef SLK
