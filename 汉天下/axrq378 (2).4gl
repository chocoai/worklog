...
# Modify.........: No.FUN-D50083 13/05/23 By fengrui 添加'顯示非成本倉'checkbox
# Modify.........: No.TQC-D60039 13/06/07 By wangrr 1.抓取"部門名稱,員工姓名,品名,規格,說明內容,科目名稱"的值
#                                                   2.顯示畫面最下方的各個匯總值
#                                                   3.當雙擊匯總頁簽中資料顯示到明細頁簽不正確,沒有抓取憑證編號和憑證日期的資料
#                                                   4.當點擊匯總頁簽時,畫面最下方的匯總金額應該根據匯總頁簽金額進行匯總
# Modify.........: No.FUN-D60043 13/06/08 By lujh 1.單頭增加選項，是否包含MISC
#                                                 2.如為N,按原邏輯，如為Y,則查OMB中MISC料號，顯示在明細頁簽及匯總頁簽中。
# Modify.........: No.MOD-E40060 14/04/14 By yihsaun 銷退資料應改用扣項
# Modify.........: No.MOD-E80120 14/08/21 By qiull 計算銷貨成本及毛利時,銷售數量的單位未與庫存單位做單位轉換
# Modify.........: No.MOD-G80110 17/04/17 By yihsuan tm.c3='N'時，條件多串jce_file
# Modify.........: No.MOD-H90011 17/09/12 By yihsuan FOREACH omb_curs1 INTO g_omb_excel 前需將g_omb_excel陣列清空
...
--WHILE TRUE
      ...
      INPUT BY NAME tm.bdate,tm.edate,tm.u,tm.a,tm.d,tm.e,tm.f,tm.g,tm.b,tm.g_auto_gen,tm.c,tm.c1,tm.c3,tm.m    #FUN-C80102  add  #FUN-D50083 add tm.c3  #FUN-D60043 add tm.m
...
#No.FUN-D20032 --end 
   DEFINE l_omb16       LIKE omb_file.omb16      #MOD-E80120 add
   DEFINE l_ima25       LIKE ima_file.ima25      #MOD-E80120 add
   DEFINE l_omb05_fac   LIKE type_file.num20_6   #MOD-E80120 add
   DEFINE l_oma01       LIKE oma_file.oma01      #MOD-E80120 add
   DEFINE l_omb03       LIKE omb_file.omb03      #MOD-E80120 add
...
#                       "        omb05,omb12,oma23,oma24,omb13,omb14,oma54x,omb14t,omb15,",
                       #"        omb05,(case when omb38 ='3' then omb12*-1 else omb12 end) omb12 ,oma23,oma24,omb13,omb14,oma54x,omb14t,omb15,",   #No.FUN-D20032                                         #MOD-E40060 mark
                       #"        omb16,oma56x,omb16t,",                                                                                                                                                   #MOD-E40060 mark
                        "        omb05,(case when omb38 ='3' AND omb00 = '21' then omb12*-1 else omb12 end) omb12 ,oma23,oma24,omb13,",                                                                   #MOD-E40060 add
                        "        (case when omb38 ='3' AND omb00 = '21' then omb14*-1 else omb14 end) omb14,oma54x,(case when omb38 ='3' AND omb00 = '21' then omb14t*-1 else omb14t end) omb14t,omb15,", #MOD-E40060 add
                        "        (case when omb38 ='3' AND omb00 = '21' then omb16*-1 else omb16 end) omb16,oma56x,(case when omb38 ='3' AND omb00 = '21' then omb16t*-1 else omb16t end) omb16t,",       #MOD-E40060 add
           ...
           IF tm.e = '1' THEN 
              ...
              IF tm.c3 ='Y' THEN
                 LET l_sql = " SELECT '' azp01,oma03,oma032,oma68,oma69,oma15,'' gem02,oma14,'' gen02,",
                             ...
                             "        omb32,omb40,'' azf03,omb39,oma08,oma33,aba02,oma01,omb03,omb33,'' aag02,",  #No.FUN-D30049  Add oma33,aba02
                            #"        omb05,(case when omb38 ='3' then omb12*-1 else omb12 end) omb12,oma23,oma24,omb13,omb14,oma54x,omb14t,omb15,",  #No.FUN-D20032                                           #MOD-E40060 mark
                            #"        (case when ccc62 IS NULL then 0 else omb16 end) omb16,oma56x,omb16t,",                                                                                                   #MOD-E40060 mark
                             "        omb05,(case when omb38 ='3' AND omb00 = '21' then omb12*-1 else omb12 end) omb12 ,oma23,oma24,omb13,",                                                                   #MOD-E40060 add
                             "        (case when omb38 ='3' AND omb00 = '21' then omb14*-1 else omb14 end) omb14,oma54x,(case when omb38 ='3' AND omb00 = '21' then omb14t*-1 else omb14t end) omb14t,omb15,", #MOD-E40060 add
                             "        (case when omb38 ='3' AND omb00 = '21' then omb16*-1 else omb16 end) omb16,oma56x,(case when omb38 ='3' AND omb00 = '21' then omb16t*-1 else omb16t end) omb16t,",       #MOD-E40060 add
                             "         nvl(ccc92,0) ccc92,nvl(ccc91,0) ccc91,nvl(ccc62,0) ccc62,nvl(ccc23,0) ccc23 ",  
...
#                            "        omb05,omb12,oma23,oma24,omb13,omb14,oma54x,omb14t,omb15,",
                            ...
                            #"        omb16,oma56x,omb16t,",                                                                                                                                                   #MOD-E40060 mark
                             ...
                             "        (case when omb38 ='3' AND omb00 = '21' then omb14*-1 else omb14 end) omb14,oma54x,(case when omb38 ='3' AND omb00 = '21' then omb14t*-1 else omb14t end) omb14t,omb15,", #MOD-E40060 add
                             "        (case when omb38 ='3' AND omb00 = '21' then omb16*-1 else omb16 end) omb16,oma56x,(case when omb38 ='3' AND omb00 = '21' then omb16t*-1 else omb16t end) omb16t,",       #MOD-E40060 add
                             #" ccc92,ccc91,ccc62,ccc23",   #No.FUN-D30049   Add  ccc23 #TQC-D60039 mark
                             "  nvl(ccc92,0) ccc92,nvl(ccc91,0) ccc91,nvl(ccc62,0) ccc62,nvl(ccc23,0) ccc23 ",#TQC-D60039 
                             " FROM ",cl_get_target_table(g_ary[l_i].plant,'occ_file'),  
                             " ,",cl_get_target_table(g_ary[l_i].plant,'oga_file'),   #MOD-G80110 add
                             " ,",cl_get_target_table(g_ary[l_i].plant,'ogb_file'),   #MOD-G80110 add
                             " ,",cl_get_target_table(g_ary[l_i].plant,'oma_file'),      
                             " full join ",cl_get_target_table(g_ary[l_i].plant,'omb_file'), 
                             " on oma01 = omb01 ",    
                             " left outer join ccc_file on ccc01 = omb04  and ccc02 = YEAR(oma02)",
                             ...
                             "   AND ccc07 = '",tm.f,"'",
                             "   AND ccc08 = '",tm.g,"'"
              #--MOD-G80110 add start--
                            ,"   AND oma01 = oga10 ",
                             "   AND omb31 = ogb01 ",
                             "   AND ogb03 = omb32 ", 
                             "   AND ogb09 NOT IN (SELECT jce02 FROM ",cl_get_target_table(g_ary[l_i].plant,'jce_file'),
                             " WHERE jceacti='Y')",
                             "  UNION ",
                             " SELECT '' azp01,oma03,oma032,oma68,oma69,oma15,'' gem02,oma14,'' gen02,",
                             "        oma25,oma26,omb04,'' ima02,'' ima021,oma10,oma02,omb38,omb31,",
                             "        omb32,omb40,'' azf03,omb39,oma08,oma33,aba02,oma01,omb03,omb33,'' aag02,",  
                             "        omb05,(case when omb38 ='3' AND omb00 = '21' then omb12*-1 else omb12 end) omb12 ,oma23,oma24,omb13,",                                                   
                             "        (case when omb38 ='3' AND omb00 = '21' then omb14*-1 else omb14 end) omb14,oma54x,(case when omb38 ='3' AND omb00 = '21' then omb14t*-1 else omb14t end) omb14t,omb15,",
                             "        (case when omb38 ='3' AND omb00 = '21' then omb16*-1 else omb16 end) omb16,oma56x,(case when omb38 ='3' AND omb00 = '21' then omb16t*-1 else omb16t end) omb16t,",
                             "  nvl(ccc92,0) ccc92,nvl(ccc91,0) ccc91,nvl(ccc62,0) ccc62,nvl(ccc23,0) ccc23 ",
                             " FROM ",cl_get_target_table(g_ary[l_i].plant,'occ_file'),
                             " ,",cl_get_target_table(g_ary[l_i].plant,'oha_file'),  
                             ...
                             "   AND omb31 = ohb01 ",
                             "   AND ohb03 = omb32 ", 
                             "   AND ohb09 NOT IN (SELECT jce02 FROM ",cl_get_target_table(g_ary[l_i].plant,'jce_file'),
                             " WHERE jceacti='Y')"
                 #--MOD-G80110 add end--
              END IF 
           END IF  
...
#                            "        omb05,omb12,oma23,oma24,omb13,omb14,oma54x,omb14t,omb15,",
                            ...
                            #"        omb16,oma56x,omb16t,",                                                                                                                                                   #MOD-E40060 mark
                             ...
                             "        (case when omb38 ='3' AND omb00 = '21' then omb14*-1 else omb14 end) omb14,oma54x,(case when omb38 ='3' AND omb00 = '21' then omb14t*-1 else omb14t end) omb14t,omb15,", #MOD-E40060 add
                             "        (case when omb38 ='3' AND omb00 = '21' then omb16*-1 else omb16 end) omb16,oma56x,(case when omb38 ='3' AND omb00 = '21' then omb16t*-1 else omb16t end) omb16t,",       #MOD-E40060 add
                             #" ccc12,ccc62,ccc11", #TQC-D60039 mark
                             "  nvl(ccc12,0) ccc12,nvl(ccc62,0) ccc62,nvl(ccc11,0) ccc11 ",#TQC-D60039 
                             " FROM ",cl_get_target_table(g_ary[l_i].plant,'occ_file'),  
                             " ,",cl_get_target_table(g_ary[l_i].plant,'oga_file'),   #MOD-G80110 add
                             " ,",cl_get_target_table(g_ary[l_i].plant,'ogb_file'),   #MOD-G80110 add
                             " ,",cl_get_target_table(g_ary[l_i].plant,'oma_file'),      
...
#                         "        omb05,omb12,oma23,oma24,omb13,omb14,oma54x,omb14t,omb15,",
                         #"        omb05,(case when omb38 ='3' then omb12*-1 else omb12 end) omb12,oma23,oma24,omb13,omb14,oma54x,omb14t,omb15,",  #No.FUN-D20032         #MOD-E40060 mark
                         #"        omb16,oma56x,omb16t,",                                                                                                                 #MOD-E40060 mark
                          "        omb05,(case when omb38 ='3' then omb12*-1 else omb12 end) omb12 ,oma23,oma24,omb13,",                                                  #MOD-E40060 add
                          "        (case when omb38 ='3' then omb14*-1 else omb14 end) omb14,oma54x,(case when omb38 ='3' then omb14t*-1 else omb14t end) omb14t,omb15,", #MOD-E40060 add
                          "        (case when omb38 ='3' then omb16*-1 else omb16 end) omb16,oma56x,(case when omb38 ='3' then omb16t*-1 else omb16t end) omb16t,",       #MOD-E40060 add
...
#No.FUN-D20032 --end 
   ...
   #TQC-D60039--add--end 
#MOD-E80120---add---str---
   LET l_sql = " SELECT oma01,omb03,omb04,omb05,omb16,ccc62 ",
               "   FROM axrq378_tmp ",
               "  ORDER BY oma01,oma02,oma03 "
   PREPARE axrq378_pb_omb05 FROM l_sql
   DECLARE omb05_curs CURSOR FOR axrq378_pb_omb05
   FOREACH omb05_curs INTO l_oma01,l_omb03,l_omb04,l_omb05,l_omb16,l_ccc62
      SELECT ima25 INTO l_ima25 FROM ima_file WHERE ima01=l_omb04
      IF l_ima25 <> l_omb05 THEN
         CALL s_umfchk(l_omb04,l_omb05,l_ima25)
              RETURNING l_flag,l_omb05_fac
         IF l_flag='1' THEN
            CALL cl_err(l_omb05,'mfg1206',0)
            CONTINUE FOREACH
         END IF
         LET l_ccc62=l_ccc62*l_omb05_fac
         LET l_s1=l_omb16-l_ccc62
         IF l_omb16=0 THEN
            LET l_s2=0
         ELSE
            LET l_s2=l_s1/l_omb16*100
         END IF
         UPDATE axrq378_tmp SET ccc62=l_ccc62,
                                s1=l_s1,
                                s2=l_s2
          WHERE oma01=l_oma01
            AND omb03=l_omb03
         ...
         IF SQLCA.sqlcode THEN
            CALL cl_err('UPDATE axrq378_tmp',SQLCA.sqlcode,1)
            CONTINUE FOREACH
         END IF
      END IF
   END FOREACH
     ...
     WHEN "3"
        IF tm.c = 'Y' THEN
           LET g_sql = "SELECT '','','','','',oma15,'',oma14,'','','','','','','','','', ",  
                       " oma23,SUM(omb14),SUM(oma54x),SUM(omb14t),SUM(omb16),SUM(oma56x),SUM(omb16t),",
                       " SUM(ccc92),SUM(ccc62),SUM(s1),''", 
                       "  FROM axrq378_tmp ",
                       "  WHERE ",g_filter_wc CLIPPED
        ELSE
            LET g_sql = "SELECT '','','','','',oma15,'',oma14,'','','','','','','','','', ",  
                       " '',SUM(omb14),SUM(oma54x),SUM(omb14t),SUM(omb16),SUM(oma56x),SUM(omb16t),",
                       " SUM(ccc92),SUM(ccc62),SUM(s1),''", 
                       "  FROM axrq378_tmp ",
                       "  WHERE ",g_filter_wc CLIPPED
        END IF 
...
DEFINE l_tmp     LIKE type_file.num10
   ...
   CALL g_omb_excel.clear()   #MOD-H90011 add
   FOREACH omb_curs1 INTO g_omb_excel[g_cnt1].*
      ...
      #SELECT azf03 INTO g_omb_excel[g_cnt1].azf03 FROM azf_file WHERE azf01 = g_omb_excel[g_cnt1].omb40 #TQC-D60039 mark   
      #TQC-CC0122--add--end--
   ...
   IF g_cnt1 > g_max_rec THEN
      CALL cl_err( '', 9035, 0 )
   END IF
   SELECT SUM(omb12),SUM(omb14t),SUM(omb16t),SUM(ccc62),SUM(s1),SUM(omb16)
     INTO g_tot11,g_tot21,g_tot31,g_tot41,g_tot51,g_tot71 
     FROM axrq378_tmp
    ORDER BY oma01,oma02,oma03
