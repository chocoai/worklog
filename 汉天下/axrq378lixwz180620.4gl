...
GLOBALS "../../../tiptop/config/top.global" #add by kuangxj170213
...
MAIN
  ...
  #-CHI-B60008-end-
   ...
   IF cl_null(g_bgjob) OR g_bgjob='N' THEN                           #FUN-C80092 add
      OPEN WINDOW q378_w AT p_row,p_col WITH FORM "cxr/42f/axrq378"  #FUN-C80092 add
...
#                       "        omb05,omb12,oma23,oma24,omb13,omb14,oma54x,omb14t,omb15,",
                        "        omb05,(case when omb38 ='3' then omb12*-1 else omb12 end) omb12 ,oma23,oma24,omb13,omb14,oma54x,omb14t, omb15,", #add (case when omb38 = '3' and omb13<0 then  omb13 * -1  else  omb13 end)/(case when omb38 = '3' and omb15<0 then  omb15 * -1  else  omb15 end) by gupx 20171213  #No.FUN-D20032
                        "        (case when omb38 = '3' and omb13<0 then  omb16 * -1  else  omb16 end) omb16,oma56x,omb16t,",#add (case when omb38 = '3' and omb13<0 then  omb16 * -1  else  omb16 end) by gupx 20171213
...
#                             "        (case when ccc62 IS NULL then 0 else omb16 end) omb16,oma56x,omb16t,",   #mark by jiangln 160712
                             "        (case when omb38 = '3' and omb13<0 then  omb16 * -1  else  omb16 end) omb16,oma56x,omb16t,",  #add (case when omb38 = '3' and omb13<0 then  omb16 * -1  else  omb16 end) by gupx 20171213 #add by jiangln 160712
           ...
           IF tm.e = '2'  THEN
              ...
              IF tm.c3 ='Y' THEN
                 LET l_sql = " SELECT '' azp01,oma03,oma032,oma68,oma69,oma15,'' gem02,oma14,'' gen02,",
                             ...
                             " left outer join ccc_file on ccc01 = omb04  and ccc02 = YEAR(oma02) ",
                             #" and ccc03 = MONTH(oma02) AND ccc07 = '",tm.f,"' AND ccc08 = '",tm.g,"' ",
                             " and ccc03 = MONTH(oma02)-1 AND ccc07 = '",tm.f,"' AND ccc08 = '",tm.g,"' ", # mod by lixwz180620
                             " WHERE oma03 = occ01",
                             "   AND oma01 = omb01 ",
                             "   AND oma00 IN ('11','12','13','21') ",  #MOD-7B0142
                             "   AND omaconf = 'Y' ",
...
#                            "        omb05,omb12,oma23,oma24,omb13,omb14,oma54x,omb14t,omb15,",
                             ...
                             #" and ccc03 = MONTH(oma02) ",
                             " and ccc03 = MONTH(oma02)-1 ",     # mod by lixwz180620
                             " LEFT OUTER JOIN ",cl_get_target_table(g_ary[l_i].plant,'aba_file')," ON aba01 = oma33",      #No.FUN-D30049   Add
           ...
           IF tm.e = '3' THEN
              LET l_sql = " SELECT '' azp01,oma03,oma032,oma68,oma69,oma15,'' gem02,oma14,'' gen02,",
                          ...
                          "        omb32,omb40,'' azf03,omb39,oma08,oma33,aba02,oma01,omb03,omb33,'' aag02,",  #No.FUN-D30049   Add
#                         "        omb05,omb12,oma23,oma24,omb13,omb14,oma54x,omb14t,omb15,",
                          "        omb05,(case when omb38 ='3' then omb12*-1 else omb12 end) omb12,oma23,oma24, omb13,omb14,oma54x,omb14t, omb15,",#add (case when omb38 = '3' and omb13<0 then  omb13 * -1  else  omb13 end) (case when omb38 = '3' and omb15<0 then  omb15 * -1  else  omb15 end) by gupx20171213#No.FUN-D20032
                          "        (case when omb38 = '3' and omb13<0 then  omb16 * -1  else  omb16 end) omb16,oma56x,omb16t,",#add (case when omb38 = '3' and omb13<0 then  omb16 * -1  else  omb16 end) by gupx 20171213
            ...
            IF tm.e = '4' THEN
              IF tm.c3 ='Y' THEN
                 LET l_sql = " SELECT '' azp01,oma03,oma032,oma68,oma69,oma15,'' gem02,oma14,'' gen02,",
                             ...
                             "        omb05,(case when omb38 ='3' then omb12*-1 else omb12 end) omb12,oma23,oma24, omb13,omb14,oma54x,omb14t, omb15,",  #add (case when omb38 = '3' and omb13<0 then  omb13 * -1  else  omb13 end) (case when omb38 = '3' and omb15<0 then  omb15 * -1  else  omb15 end)by gu gupx20171213
                             "        (case when omb38 = '3' and omb13<0 then  omb16 * -1  else  omb16 end) omb16,oma56x,omb16t,",   #add (case when omb38 = '3' and omb13<0 then  omb16 * -1  else  omb16 end) by gupx 20171213
                             "         nvl(ccc92,0) ccc92,nvl(ccc91,0) ccc91,",
                             "         nvl(ccc62,0) ccc62,",
                             "         nvl(ccc23,0) ccc23 ",
                             ...
                             " full join ",cl_get_target_table(g_ary[l_i].plant,'omb_file'),
                             " on oma01 = omb01 ",
                             " LEFT JOIN oga_file ON oga01 = omb31 ",  # add by lixwz180620
                             " left outer join ccc_file on ccc01 = omb04  and ccc02 = YEAR(oma02)",
                             #" and ccc03 = MONTH(oma02) AND ccc07 = '",tm.f,"' AND ccc08 = '",tm.g,"' ",
                             " and ccc03 = MONTH(oga02) AND ccc07 = '",tm.f,"' AND ccc08 = '",tm.g,"' ", # mod by lixwz180620

                             " LEFT OUTER JOIN ",cl_get_target_table(g_ary[l_i].plant,'aba_file')," ON aba01 = oma33",
                             " WHERE oma03 = occ01",
                             "   AND oma01 = omb01 ",
                             "   AND oma00 IN ('11','12','13','21') ",
                             "   AND omaconf = 'Y' ",
                             "   AND omavoid = 'N' ",
                             "   AND oma02 BETWEEN '",tm.bdate,"' AND '",tm.edate,"'"
              ELSE
                 LET l_sql = " SELECT '' azp01,oma03,oma032,oma68,oma69,oma15,'' gem02,oma14,'' gen02,",
                             "        oma25,oma26,omb04,'' ima02,'' ima021,oma10,oma02,omb38,omb31,",
                             "        omb32,omb40,'' azf03,omb39,oma08,oma33,aba02,oma01,omb03,omb33,'' aag02,",
                             "        omb05,(case when omb38 ='3' then omb12*-1 else omb12 end) omb12,oma23,oma24,  omb13,omb14,oma54x,omb14t, omb15,",  #add (case when omb38 = '3' and omb13<0 then  omb13 * -1  else  omb13 end) (case when omb38 = '3' and omb15<0 then  omb15 * -1  else  omb15 end) by gupx 20171213
                             "       (case when omb38 = '3' and omb13<0 then  omb16 * -1  else  omb16 end)  omb16,oma56x,omb16t,",#add (case when omb38 = '3' and omb13<0 then  omb16 * -1  else  omb16 end) by gupx 20171213
                             " ccc92,ccc91,ccc62,ccc23",
                             " FROM ",cl_get_target_table(g_ary[l_i].plant,'occ_file'),
                             " ,",cl_get_target_table(g_ary[l_i].plant,'oma_file'),
                             " full join ",cl_get_target_table(g_ary[l_i].plant,'omb_file'),
                             " on oma01 = omb01 ",
                             ...
                             " left outer join ccc_file on ccc01 = omb04  and ccc02 = YEAR(oma02)",
                             #" and ccc03 = MONTH(oma02) ",
                             " and ccc03 = MONTH(oga02) ",    # mod by lixwz180620
                             " LEFT OUTER JOIN ",cl_get_target_table(g_ary[l_i].plant,'aba_file')," ON aba01 = oma33",
                             " WHERE oma03 = occ01",
                             "   AND oma01 = omb01 ",
                             "   AND oma00 IN ('11','12','13','21') ",
...
#                               l_dbs CLIPPED," omb_file ",
       ...
       IF tm.d = 'N' THEN
          LET l_sql = " INSERT INTO axrq378_tmp ",
                        ...
                        # " omb03,omb33,aag02,omb05,omb12,oma23,oma24,omb13,",#add mark by gupx 20171213
                        " omb03,omb33,aag02,omb05,omb12,oma23,oma24, omb13,",#add by gupx 20171213.
                         " omb14,oma54x,omb14t, omb15,(case when omb38 = '3' and omb13<0 then  omb16 * -1  else  omb16 end) omb16,oma56x,omb16t,",#add (case when omb38 = '3' and omb13<0 then  omb16 * -1  else  omb16 end) by gupx 20171213
                         " ccc92,ccc62,s1,s2",
       ...
       IF tm.d ='Y'THEN
          IF tm.e = '1' THEN
             LET l_sql = " INSERT INTO axrq378_tmp ",
                         ...
                         " gen02,oma25,oma26,omb04,ima02,ima021,oma10,oma02,",
                         " omb38,omb31,omb32,omb40,azf03,omb39,oma08,oma33,aba02,oma01,",   #No.FUN-D30049   Add oma33,aba02
                         " omb03,omb33,aag02,omb05,omb12,oma23,oma24, omb13,",#add (case when omb38 = '3' and omb13<0 then  omb13 * -1  else  omb13 end) by gupx 20171213
                         " omb14,oma54x,omb14t, omb15,(case when omb38 = '3' and omb13<0 then  omb16 * -1  else  omb16 end) omb16,oma56x,omb16t,",#add (case when omb38 = '3' and omb15<0 then  omb15 * -1  else  omb15 end) by gupx20171213
#No.FUN-D20032 --begin
...
#No.FUN-D20032 --end
          ...
          IF tm.e = '2' THEN
             LET l_sql = " INSERT INTO axrq378_tmp ",
                         ...
                         " omb38,omb31,omb32,omb40,azf03,omb39,oma08,oma33,aba02,oma01,",   #No.FUN-D30049   Add oma33,aba02
                         " omb03,omb33,aag02,omb05,omb12,oma23,oma24, omb13,",#add (case when omb38 = '3' and omb13<0 then  omb13 * -1  else  omb13 end) by gupx 20171213
                         " omb14,oma54x,omb14t, omb15,(case when omb38 = '3' and omb13<0 then  omb16 * -1  else  omb16 end) omb16,oma56x,omb16t,",#add (case when omb38 = '3' and omb15<0 then  omb15 * -1  else  omb15 end)by gupx 20171213
       ...
       #出货类型为2换货出货时，也需要列进销货收入表中
          LET l_sql1 =  "SELECT '' azp01,oga03,oga032,oga18,occ02,oga15,'' gem02,oga14,'' gen02,oga25,oga26,ogb04,ima02, ",
            ...
            LET l_sql1 = " INSERT INTO axrq378_tmp ",
                         ...
                         " omb14,oma54x,omb14t,omb15,(case when omb38 = '3' and omb13<0 then  omb16 * -1  else  omb16 end) omb16,oma56x,omb16t,",#add by gupx 20171213
                         " ccc92,ccc62,s1,s2",
...
#161128wudj-str  计价数量更新 成本单价
  LET l_sql1 = " MERGE INTO axrq378_tmp o   ",
             "  USING (SELECT  omf04,omf11,omf12,omf13,omf16,omf917 from omf_file where omf03 BETWEEN '",tm.bdate,"' AND '",tm.edate,"'",
             "         and omf16<>omf917      ) n  ",
             "          ON (o.oma01 = n.omf04  and o.omb31=n.omf11 and o.omb32=n.omf12 and o.omb04=n.omf13 )   ",
             "   WHEN MATCHED  ",
             "   THEN  ",
             "      UPDATE ",
             "         SET  o.ccc62=round(o.ccc62*n.omf917/n.omf16,2),s1=s1-(round(o.ccc62*n.omf917/n.omf16,2)-o.ccc62),  ",
              "   s2=round((s1-(round(o.ccc62*n.omf917/n.omf16,2)-o.ccc62))/omb16,2)  "
          PREPARE q378_www FROM l_sql1
          EXECUTE q378_www
#161128wudj-end
...
DEFINE l_s2,l_1      LIKE type_file.num20_6
...
#add by jiangln 160712 end-----
      ...
      END IF
      IF g_omb_excel[g_cnt1].omb38 = '3' THEN
         IF g_omb_excel[g_cnt1].omb16 >0  AND g_omb_excel[g_cnt1].omb13>0 THEN #add  AND g_omb_excel[g_cnt1].omb13>0 by gupx 20171213
...
#161128wudj-str  计价数量更新 成本单价
  LET l_1=0
 # select omf16 into l_1 from omf_file where omf03 between tm.bdate and tm.edate and omf04=g_omb_excel[g_cnt1].oma01  #zhouxm161216
 select omf917 into l_1 from omf_file where omf03 between tm.bdate and tm.edate and omf04=g_omb_excel[g_cnt1].oma01  #zhouxm161216
   and omf11=g_omb_excel[g_cnt1].omb31 and omf12=g_omb_excel[g_cnt1].omb32 and omf13=g_omb_excel[g_cnt1].omb04
  IF l_1>0 and tm.e = '4' THEN
    LET g_omb_excel[g_cnt1].ccc62 = g_omb_excel[g_cnt1].ccc92*l_1
    #add renjj171214--str
    IF g_omb_excel[g_cnt1].ccc62 >0 AND g_omb_excel[g_cnt1].omb38 = '3' AND g_omb_excel[g_cnt1].omb15 >0 THEN
       LET g_omb_excel[g_cnt1].ccc62 =(-1)*g_omb_excel[g_cnt1].ccc62
    END IF
    #add renjj171214--end
   END IF
#161128wudj-end
...
#add by jiangln 160712 start------
      UPDATE axrq378_tmp SET omb12 = g_omb_excel[g_cnt1].omb12,
                       ...
                       WHERE omb04 = g_omb_excel[g_cnt1].omb04
                         ...
                         AND oma01 = g_omb_excel[g_cnt1].oma01  #add by dengsy170309
                         AND omb03 = g_omb_excel[g_cnt1].omb03  #add by dengsy170309
#add by jiangln 160712 end---------
