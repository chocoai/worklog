...
# Modify.........: No.FUN-D70086 13/07/22 By bart 增加欄位
# Modify.........: No.TQC-D70093 13/07/30 By lixh1 倉庫允許負庫存時當庫存量不足時,不控管
# Modify.........: No:FUN-DA0124 13/11/05 By yihsuan 增加共用變數g_data_keyvalue給值
# Modify.........: No:TQC-DC0126 13/12/30 By yangxf 删除后未走BEFORE INSERT BUG修改
# Modify.........: No:TQC-DC0129 13/12/30 By yangxf 开窗过滤未审核资料
# Modify.........: No:CHI-E80026 14/08/27 By liliwen 檢查單身筆數需抓單據筆數,非現在單身array筆數
...
DEFINE
    ...
    g_fiw           DYNAMIC ARRAY OF RECORD              #程式變數(Prinram Variables)
                    ...
                    fiw10     LIKE fiw_file.fiw10,   #FUN-D70086
                    fiw11     LIKE fiw_file.fiw11    #FUN-D70086
                    END RECORD,
    g_fiw_t         RECORD
                    fiw02     LIKE fiw_file.fiw02,
                    fiw03     LIKE fiw_file.fiw03,
...
FUNCTION t200(p_argv1)
   ...
   LET g_argv1=p_argv1  #FUN-D70086
   CALL t200_def_form()
      ...
      CASE g_action_choice
         WHEN "insert"
            IF cl_chk_act_auth() THEN
               CALL t200_a()
               LET g_data_keyvalue = g_fiv.fiv01   #FUN-F50014 add
            END IF
         WHEN "query"
            IF cl_chk_act_auth() THEN
               CALL t200_q()
         ...
         ON ACTION CONTROLP
            CASE WHEN INFIELD(fiv01) #查詢單据
                 ...
                 WHEN INFIELD(fiv02)  #工單編號
                      CALL cl_init_qry_var()
                      LET g_qryparam.form ="q_fil"
                      LET g_qryparam.where = " filconf = 'Y' "  #TQC-DC0129 add
                      LET g_qryparam.default1 = g_fiv.fiv02
...
DEFINE
    ...
    LET g_data_keyvalue = g_fiv.fiv01  #FUN-DA0124 add
    CALL t200_show()
END FUNCTION
...
DEFINE  l_where     STRING                #No.FUN-CB0087 
    ...
    INPUT ARRAY g_fiw WITHOUT DEFAULTS FROM s_fiw.*
        ...
        AFTER INSERT
           ...
           IF cl_null(g_fiw[l_ac].fiw10) THEN LET g_fiw[l_ac].fiw10 = 0 END IF  #FUN-D70086
           IF cl_null(g_fiw[l_ac].fiw11) THEN LET g_fiw[l_ac].fiw11 = 0 END IF  #FUN-D70086
            ...
            INSERT INTO fiw_file(fiw01,fiw02,fiw03,fiw04,fiw05,
                                 ...
                                 fiwud06,fiwud07,fiwud08,fiwud09,fiwud10,
                                 fiwud11,fiwud12,fiwud13,fiwud14,fiwud15,
                                 fiw10,fiw11,fiw102,fiw103,fiw104,fiw105,fiw106,fiw107,fiw108,  #FUN-D70086
            ...
            VALUES(g_fiv.fiv01,      g_fiw[l_ac].fiw02,    g_fiw[l_ac].fiw03,
                   ...
                   g_fiw[l_ac].fiw10,g_fiw[l_ac].fiw11,0,0,0,0,0,0,0,  #FUN-D70086
        ...
        AFTER FIELD fiw06
           ...
           #IF NOT cl_null(g_fiw[l_ac].fiw06) THEN                                    #No.TQC-AC0033 add  #MOD-CA0096 mark
              ...
              IF SQLCA.sqlcode THEN
                 IF g_fiv.fiv00 = '1' THEN  
                    CALL s_inv_shrt_by_warehouse(g_fiw[l_ac].fiw04,g_plant) RETURNING l_flag    #TQC-D70093 add 
                    IF l_flag = 'N' OR l_flag IS NULL THEN    #TQC-D70093 add
                       CALL cl_err(g_fiw[l_ac].fiw03,'mfg6069',0)  
                       NEXT FIELD fiw03
                    END IF    #TQC-D70093 add
                 ELSE
                 #  IF NOT cl_conf(18,10,'mfg1401') THEN NEXT FIELD fiw03 END IF   #TQC-D70093 mark
                    IF NOT cl_confirm('mfg1401') THEN NEXT FIELD fiw03 END IF      #TQC-D70093 add    
             ...
             #TQC-D70093-------Begin---------
               SELECT img09 INTO l_img09 FROM img_file
                WHERE img01 = g_fiw[l_ac].fiw03
                  ...
                  AND img04 = g_fiw[l_ac].fiw06
             #TQC-D70093-------End-----------
               IF l_img09 IS NOT NULL THEN  #TQC-D70093  
        ...
        AFTER FIELD fiw08
           ...
           #FUN-D70086---begin
           IF NOT cl_null(g_fiw[l_ac].fiw10) THEN
             LET g_fiw[l_ac].fiw11 = g_fiw[l_ac].fiw10 * g_fiw[l_ac].fiw08
             DISPLAY BY NAME g_fiw[l_ac].fiw11
           END IF 
           #FUN-D70086---end
        ...
        #FUN-D70086---begin
        BEFORE FIELD fiw10
           IF g_fiw[l_ac].fiw10 <= 0 OR g_fiw[l_ac].fiw10 IS NULL THEN
              SELECT cfa12 INTO g_fiw[l_ac].fiw10 FROM cfa_file 
               WHERE cfa01 = g_fiw[l_ac].fiw03
                 AND cfa04 = 1
                 AND cfa02 = (SELECT MAX(cfa02) FROM cfa_file WHERE cfa01= g_fiw[l_ac].fiw03 AND cfa04=1 ) 
           END IF
           IF cl_null(g_fiw[l_ac].fiw10) THEN LET g_fiw[l_ac].fiw10 = 0 END IF
           IF cl_null(g_fiw[l_ac].fiw08) THEN LET g_fiw[l_ac].fiw08 = 0 END IF
           LET g_fiw[l_ac].fiw11 = g_fiw[l_ac].fiw10 * g_fiw[l_ac].fiw08
           DISPLAY BY NAME g_fiw[l_ac].fiw10
           DISPLAY BY NAME g_fiw[l_ac].fiw11
          
        AFTER FIELD fiw10
           IF g_fiw[l_ac].fiw10 <= 0 THEN
           ...
           IF NOT cl_null(g_fiw[l_ac].fiw23) THEN
              ...
              IF g_flag = 1 THEN
                 IF g_fiv.fiv00 = '1' THEN    #發料
                    CALL s_inv_shrt_by_warehouse(g_fiw[l_ac].fiw04,g_plant) RETURNING g_flag    #TQC-D70093 add 
                    IF g_flag = 'N' OR g_flag IS NULL THEN     #TQC-D70093 add 
       ...
       AFTER FIELD fiwud15
            ...
            ELSE
              ...
              END IF
               UPDATE fiw_file SET fiw02     = g_fiw[l_ac].fiw02,
                                   ...
                                   fiw10     = g_fiw[l_ac].fiw10,  #FUN-D70086
                                   fiw11     = g_fiw[l_ac].fiw11   #FUN-D70086
                WHERE fiw01=g_fiv.fiv01 AND fiw02=g_fiw_t.fiw02
               IF SQLCA.sqlcode THEN
        ...
        AFTER ROW
            ...
            #FUN-D70086---begin
            ELSE
              #IF g_ccz.ccz28 = '6' AND g_argv1  = '2' AND NOT cl_null(g_fiw[l_ac].fiw03) THEN   #TQC-DC0126 MARK 
               IF g_ccz.ccz28 = '6' AND g_argv1  = '2' AND g_rec_b >= l_ac THEN                  #TQC-DC0126 add
                  IF cl_null(g_fiw[l_ac].fiw10) OR g_fiw[l_ac].fiw10 <=0 THEN 
                     CALL cl_err('','aim-031',0)
                     NEXT FIELD fiw10
                  END IF
               END IF 
...
FUNCTION t200_delHeader()
   ...
   SELECT COUNT(*) INTO l_n FROM fiw_file WHERE fiw01 = g_fiv.fiv01  #CHI-E80026 add
...
FUNCTION t200_s1()
   ...
   FOREACH t200_s1_c1 INTO b_fiw.*
      ...
      SELECT COUNT(*) INTO l_cnt_img
       ...
       SELECT ima906 INTO l_ima906 FROM ima_file WHERE ima01 = b_fiw.fiw03   #MOD-EB0112---ADD
...
FUNCTION t200_y() #確認
    ...
    DEFINE l_fiw10 LIKE fiw_file.fiw10   #FUN-D70086
...
#   IF NOT cl_confirm('axm-108') THEN RETURN END IF      #TQC-750219 mod #CHI-C30107 mark
    ...
    DECLARE t200_y_c2 CURSOR FOR
     SELECT fiw04,fiw10 FROM fiw_file WHERE fiw01=g_fiv.fiv01  #FUN-D70086
     FOREACH t200_y_c2 INTO l_fiw04,l_fiw10  #FUN-D70086
        IF SQLCA.sqlcode THEN
        ...
        END IF
        #FUN-D70086---begin
        IF g_ccz.ccz28 = '6' AND g_argv1  = '2'  THEN            
           IF cl_null(l_fiw10) OR l_fiw10 <= 0 THEN
...
FUNCTION t200_g_b_2()
  ...
  DEFINE l_i     LIKE type_file.num5          #No.FUN-680072 SMALLINT
    ...
    FOREACH t200_fiw_b2_cur INTO l_fiw.*
        ...
        #TQC-D70093 ------Begin-----
           CALL s_inv_shrt_by_warehouse(l_ima35,g_plant) RETURNING g_flag
           IF g_flag = 'Y' THEN
        #TQC-D70093 ------End-------
        ...
        #FUN-D70086---begin
        IF g_ccz.ccz28 = '6' AND g_argv1  = '2' THEN
           SELECT cfa12 INTO l_fiw.fiw10 FROM cfa_file
            WHERE cfa01 = l_fiw.fiw03
              AND cfa04 = 1
              AND cfa02 = (SELECT MAX(cfa02) FROM cfa_file WHERE cfa01= l_fiw.fiw03 AND cfa04=1 )
           IF cl_null(l_fiw.fiw10) THEN LET l_fiw.fiw10 = 0 END IF
           LET l_fiw.fiw11 = l_fiw.fiw10 * l_fiw.fiw08
        END IF
        #FUN-D70086---end
        ...
        IF SQLCA.sqlcode =100 THEN
           ...
           VALUES(g_fiv.fiv01,l_i,l_fiw.fiw03,l_ima35,l_ima36,
                  ...
                  l_fiw.fiw10,l_fiw.fiw11,0,0,0,0,0,0,0,  #FUN-D70086
                  g_plant,g_legal) #FUN-980002
           IF SQLCA.sqlcode THEN
        ...
        ELSE
           UPDATE fiw_file SET fiw08=fiw08+l_fiw.fiw08,
                               fiw11=fiw10*(fiw08+l_fiw.fiw08),  #MOD-D70138
...
FUNCTION t200_def_form()
   ...
   IF g_ccz.ccz28 = '6' AND (g_argv1  = '2') THEN 
      CALL cl_set_comp_visible("fiw10,fiw11",TRUE)
      CALL cl_set_comp_required("fiw10",TRUE)
   ELSE 
      CALL cl_set_comp_visible("fiw10,fiw11",FALSE)   
   END IF 
   #FUN-D70086---end
END FUNCTION
