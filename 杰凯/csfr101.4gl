    ...
    #FOREACH csfr101_sr1 INTO sr1.oea01,sr1.muima01,sr1.lt1ima01,sr1.lt2ima01,sr1.yanse,sr1.sfbud07  #mod huxy130820
	 ...
	 # DECLARE csfr101_sr1_01 SCROLL CURSOR FOR
        ...
        LET ll_sql=" SELECT cd,cddw,sum(oeb12),other,sum(sfb08),dbcd,sfbud07,sfbud06,oeb11,sfb01,yanse2,yanse3 ", #mod  huxy130801     #mod huxy130820 #mod huxy130829 # add oeb11 #huxy140227 add yanse2 yanse3
	      ...
	      " AND oea01='",sr1.oea01,"'"
	      #," AND oeb11='",sr1.oeb11,"'" # add by xufeng 130906 # mark by lixwz180912
	      # GROUP BY cd,cddw
	  ...
	  #END IF
	   ...
	   IF sr1.sfbud06 IS NULL THEN
              IF sr1.sfbud07 IS NULL THEN
                 LET ll_sql=ll_sql CLIPPED," AND sfbud06 IS NULL AND sfbud07 IS NULL "
              ELSE
                 LET ll_sql=ll_sql CLIPPED," AND sfbud06 IS NULL AND sfbud07= '",sr1.sfbud07,"'"
              END IF
	   ELSE
              IF sr1.sfbud07 IS NULL THEN
	           LET ll_sql=ll_sql CLIPPED," AND sfbud06='",sr1.sfbud06,"' AND sfbud07 IS NULL "  #mod huxy130801 add--dbcd  #mod huxy130820
              ELSE
                   LET ll_sql=ll_sql CLIPPED," AND sfbud06='",sr1.sfbud06,"' AND sfbud07='",sr1.sfbud07,"' "
              END IF
	   END IF
  	 # add by lixwz 180912 s---
      IF NOT cl_null(sr1.oeb11) THEN
         LET ll_sql=ll_sql CLIPPED," AND oeb11='",sr1.oeb11,"'"
      ELSE
         LET ll_sql=ll_sql CLIPPED," AND (oeb11=' ' OR oeb11 is null) "
      END IF
         LET ll_sql = ll_sql CLIPPED ," GROUP BY cd,cddw,other,dbcd,sfbud07,sfbud06,oeb11,sfb01a,yanse2,yanse3"
     # add by lixwz 180912 e---
