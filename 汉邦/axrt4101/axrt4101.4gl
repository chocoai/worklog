...
# Modify.........: No:FUN-C80021 13/05/27 By apo 新增"退款單身","帳款單身"action
...
# Modify.........: No:CHI-D90008 13/09/04 By apo 借方類別A/F;貸方類別A/C/D/E/Q;限定在azw04為2才顯示
# Modify.........: No.MOD-D10208 13/09/09 By yinhy anms101中“現金流量表來源”為總賬，axrt410單身“現金變動碼”應該允許不錄入
# Modify.........: No:MOD-D60149 13/09/10 By yinhy q_oma4增加币种传参
...
# Modify.........: No:MOD-DC0013 13/12/03 By yuhuabao 退款方式T/T不限定流通行業,并添加相應的邏輯處理
# Modify.........: No:TQC-DC0015 13/12/05 By yuhuabao axrt410 貸方選擇T/T,審核是產生nme_file,匯率nme07現在取ooa24,但是ooa24并無值
# Modify.........: No.FUN-E50028 14/05/30 By Reanna 還原CR
# Modify.........: No.MOD-E70049 14/07/09 By yihsuan after field oob04/oob04_1 時,判斷如為 7 時給予 oob07 為 aza17,匯率為 1
# Modify.........: No.MOD-E70081 14/07/16 By Sabrina 不使用gxrg420改用axrg420
# Modify.........: NO:FUN-E80012 14/08/04 By qiull 修改付款日期之後,tic現金流量明細重複
# Modify.........: NO:CHI-EA0009 14/10/22 By Hungli 資料清單取得資料的時間點，只需在按下【資料清單】頁簽時，不在按上下筆的時候呼叫
# Modify.........: No:MOD-EA0124 14/10/23 By yihsuan 比照 axrt400 於 axr-992 訊息增加排除25 類別 
# Modify.........: No:MOD-EC0079 14/12/18 By yihsuan 當借方類別為 F 時,請預設帶 axri090 的 ool34 科目
# Modify.........: No:MOD-F20005 15/02/04 By yihsuan 調整點選查詢再按放棄，會出現[找不到游標或敘述]的錯誤訊息問題
# Modify.........: No:MOD-F20042 15/02/09 By yihsuan q_oma4 傳遞參數需改為2%
# Modify.........: No:FUN-EC0013 15/04/22 By yihsuan 增加 7.差異視為匯兌損益 處理
# Modify.........: No:MOD-F40074 15/04/22 By yihsuan 相關 axr-992 訊息增加 ooa35 <> '3' 條件
# Modify.........: No:TQC-F40008 15/04/22 By yihsuan 確認與取消確認段,參考 u 段一開始 -400 錯誤訊息查詢
# Modify.........: No:FUN-F50015 15/06/18 By Mio 解決【新增】、【複製】之後無法紀錄key值問題
# Modify.........: No:MOD-F60114 15/06/24 By yihsuan detail action 已經取消,相關給予動作需要再調整
# Modify.........: No:TQC-F80002 15/08/24 By yihsuan 確認段無法累計預收待抵已收金額
# Modify.........: No:CHI-F80014 15/08/27 By fionchen 調整CURSOR在二次查詢顯示異常的問題 
# Modify.........: No:CHI-F30072 15/09/16 By yihsuan 增加更新預收待抵已收金額
# Modify.........: No:CHI-F30039 15/09/24 By doris 貸方單身支付方式D.支票,開放一般行業也可使用
# Modify.........: No:MOD-FA0066 15/10/14 By yihsuan 錯誤訊息顯示錯誤，b_oob.oob06不需要加單引號
# Modify.........: No:MOD-FB0146 15/11/24 By yihsuan 1.調整判斷式為IF diff_flag='7' OR g_ooa.ooa31d = g_ooa.ooa31c THEN
#                                                    2.調整axr-309的判斷式
# Modify.........: No:MOD-FC0028 15/12/04 By yihsuan 第10981行增加IF l_oma00 = '23' THEN 條件 
# Modify.........: No:MOD-G40035 16/04/11 By yihsuan 溢退產生14類單據時，若ooz29為'Y'，需產生axrt300的分錄。
# Modify.........: No:MOD-G80094 16/08/30 By yihsuan 參考MOD-F70121，確認時增加帳款與分錄金額需一致的檢查
# Modify.........: No:MOD-G80158 16/09/01 By yihsuan 調整action(應收票據收票/銀行存款收支)使用條件
# Modify.........: No:MOD-GB0070 16/11/28 By Sabrina 當oob04='3'，AFTER FIELD oob06應帶出oob9,oob10,oob19 
    ...
    IF NOT cl_null(g_argv1) THEN
      CASE g_argv2
         ...
         WHEN "insert"
            ...
            IF cl_chk_act_auth() THEN
               CALL t410_a()
               LET g_data_keyvalue = g_ooa.ooa01  #FUN-F50015 add
            END IF
   #FUN-640246
          WHEN "efconfirm"
             CALL t410_q()
...
DEFINE  lc_qbe_sn       LIKE    gbm_file.gbm01   
   ...
   INITIALIZE g_ooa.* TO NULL 
      ...
      IF INT_FLAG THEN
        #LET INT_FLAG = 0   #MOD-F20005 mark
         RETURN
      END IF
   END IF
...
#       #      CALL t410_b()                  #FUN-A90003 Mark
        ...
        #-FUN-C80021--end--
         ...
         WHEN "exporttoexcel"
             ...
             # (ui.Interface.getRootNode(),base.TypeInfo.create(g_oob),'','')  #FUN-D70109 mark
               (ui.Interface.getRootNode(),base.TypeInfo.create(g_oob),base.TypeInfo.create(g_oob_d),'') #FUN-D70109 add
             END IF
         #--
...
#FUN-580154
               ...
               IF g_success = "Y" THEN
                  CALL t410_y_upd()       #CALL 原確認的 update 段
                 #CALL t410_b_fill_1()   #No.FUN-CB0080   Add #CHI-EA0009 MARK	
               END IF
#FUN-580154 End
            END IF
...
#FUN-580154 End
        ...
        #No.FUN-CB0080 ---start--- Add
         WHEN "item_list"
            IF cl_chk_act_auth() THEN
               CALL t410_b_fill_1() #CHI-EA0009 add
               CALL t410_b_menu()
            END IF
        #No.FUN-CB0080 ---end  --- Add
     END CASE
...
FUNCTION t410_g_b1()
   ...
   DEFINE g_t1             LIKE type_file.chr5       # Prog. Version..: '5.30.26-17.12.13(03)   #MOD-730023
   DEFINE l_ool            RECORD LIKE ool_file.*,
         #l_sql            LIKE type_file.chr1000    #No.FUN-680123 VARCHAR(1300) #MOD-E70049 mark
          l_sql            STRING                    #MOD-E70049 add
...
#--end
       ...
       #No.+009 ...end
        ...
        #No.FUN-740184  --Begin
#FUN-D70121--add--star--
        CALL s_get_bookno(YEAR(g_ooa.ooa02)) RETURNING g_flag1,g_bookno11,g_bookno21
        IF g_flag1= '1' THEN
           CALL cl_err(g_ooa.ooa02,'aoo-081',1)
        END IF
#FUN-D70121--add---end---
       #IF YEAR(g_ooa.ooa02) <> YEAR(l_oma.oma02) THEN           #FUN-D70121--mark-
       #   CALL s_tag(YEAR(g_ooa.ooa02),g_bookno1,b_oob.oob11)   #FUN-D70121--mark-
        IF s_get_aznn(g_plant,g_bookno11,g_ooa.ooa02,1) <> s_get_aznn(g_plant,g_bookno1,l_oma.oma02,1) THEN #FUN-D70121--add-
           CALL s_tag(s_get_aznn(g_plant,g_bookno11,g_ooa.ooa02,1),g_bookno1,b_oob.oob11)  #FUN-D70121--add
                RETURNING l_bookno,b_oob.oob11
        #  CALL s_tag(YEAR(g_ooa.ooa02),g_bookno2,b_oob.oob111)    #FUN-D70121--mark-
           CALL s_tag(s_get_aznn(g_plant,g_bookno11,g_ooa.ooa02,1),g_bookno2,b_oob.oob111)  #FUN-D70121--add
   ...
   #FUN-D70121--add---end---
          #IF YEAR(g_ooa.ooa02) <> YEAR(l_oma.oma02) THEN            #FUN-D70121--mark-
          #   CALL s_tag(YEAR(g_ooa.ooa02),g_bookno1,b_oob.oob11)    #FUN-D70121--mark-
           IF s_get_aznn(g_plant,g_bookno11,g_ooa.ooa02,1) <> s_get_aznn(g_plant,g_bookno1,l_oma.oma02,1) THEN #FUN-D70121--a
              CALL s_tag(s_get_aznn(g_plant,g_bookno11,g_ooa.ooa02,1),g_bookno1,b_oob.oob11)  #FUN-D70121--add
                   RETURNING l_bookno,b_oob.oob11
          #   CALL s_tag(YEAR(g_ooa.ooa02),g_bookno2,b_oob.oob111)    #FUN-D70121--mark-
              CALL s_tag(s_get_aznn(g_plant,g_bookno11,g_ooa.ooa02,1),g_bookno2,b_oob.oob111)  #FUN-D70121--add
...
FUNCTION t410_g_b2()
  ...
  #DEFINE l_sql         LIKE type_file.chr1000            #No.FUN-680123 VARCHAR(300)   #MOD-E70049 mark
   DEFINE l_sql         STRING                            #MOD-E70049 add
             ...
             IF g_ooz.ooz07 = 'Y' THEN
               ...
               #LET l_mm = MONTH(g_ooa.ooa02)
                ...
                IF g_flag1 = '1' THEN
                   CALL cl_err(g_ooa.ooa02,'aoo-081',1)
                END IF
                LET l_yy = s_get_aznn(g_plant,g_bookno11,g_ooa.ooa02,1)
                LET l_mm = s_get_aznn(g_plant,g_bookno11,g_ooa.ooa02,3)
                #FUN-D70121--add---end---
...
# 新增自動確認功能 Modify by Charis 96-09-23
    ...
    ELSE
       ...
       END IF
    END IF
   #CALL t410_b_fill_1()          #No.FUN-CB0080   Add #CHI-EA0009 add
END FUNCTION
...
#                      CONTINUE PROMPT
    ...
    ELSE
       ...
       LET g_data_keyvalue = g_ooa.ooa01  #FUN-DA0126 
       #NO.FUN-730073---begin---                                                                                           
       CALL s_get_bookno(YEAR(g_ooa.ooa02))                                                                               
       RETURNING g_flag,g_bookno1,g_bookno2                                                                          
       IF g_flag = '1' THEN     #抓不到帳別                                                                               
           ...
           IF NOT cl_null(g_oob[l_ac].oob06) THEN
             ...
             #-----------MOD-C70125-------------------mark
              ...
              IF SQLCA.sqlcode THEN
                 ...
                 NEXT FIELD oob06   #MOD-G80158 add
              ELSE
...
#MOD-940420  add --begin
            #IF g_oob[l_ac].oob03='1' AND g_oob[l_ac].oob04 MATCHES "[39]" THEN      #MOD-C70125 mark
             IF g_oob[l_ac].oob03='1' AND g_oob[l_ac].oob04 MATCHES "[3]" THEN       #MOD-C70125 add
               #IF p_cmd= 'a' OR g_oob_t.oob06 != g_oob[l_ac].oob06  THEN           #MOD-GB0070 mark 
                IF p_cmd= 'a' OR (g_oob_t.oob06 != g_oob[l_ac].oob06) OR (cl_null(g_oob[l_ac].oob19) AND NOT cl_null(g_oob[l_ac].oob06))  THEN    #MOD-GB0070 add
                  #IF g_oob[l_ac].oob04 = '3' THEN         #MOD-GB0070 mark 
             ...
             #         IF (l_oma00!='21') AND (l_oma00!='22') AND (l_oma00!='23') AND (l_oma00!='24') AND (l_oma00!='27') THEN    #TQC-AC0397 
                       IF (l_oma00!='21') AND (l_oma00!='22') AND (l_oma00!='23') AND 
                          (l_oma00!='24') AND (l_oma00!='25') AND (l_oma00!='26') AND (l_oma00!='27') AND  #TQC-B1005   #MOD-EA0124 add 25
                         #(l_oma00!='28') THEN  #MOD-B70242 add 28        #MOD-F40074 mark
                          (l_oma00!='28') AND (g_ooa.ooa35 != '3') THEN   #MOD-F40074 add
                         CALL cl_err('','axr-992',0)
                         NEXT FIELD oob06
                      END IF 
                  #END IF           #MOD-GB0070 mark 
                  #MOD-GB0070---add---start---
        ...
        AFTER ROW
            ...
            IF INT_FLAG THEN
               ...
               ELSE
                  ...
                  IF g_rec_b != 0 THEN
                     LET g_b_flag = '1'
                    #LET g_action_choice = "detail"             #MOD-F60114 mark
                     LET g_action_choice = "detail_b1_return"   #MOD-F60114 add
                     LET l_ac = l_ac_t
                  END IF
               #FUN-D30032--add--end--
               END IF
...
#                                    g_ooa.ooa01,g_ooa.ooa03,'2*')                   #No.FUN-670026 mark
                       ...
                       #No.FUN-680022--begin-- add
                         CALL q_oma4(FALSE,TRUE,g_oob[l_ac].oob06,g_oob[l_ac].oob02, 
                                    #g_ooa.ooa01,g_ooa.ooa03,'2*',g_ooa.ooa23)        #MOD-D60149 add ooa23   #MOD-F20042 mark
                                     g_ooa.ooa01,g_ooa.ooa03,'2%',g_ooa.ooa23)                                #MOD-F20042 add
...
#                                        g_ooa.ooa01,g_ooa.ooa03,'1*')   #No.MOD-530346 #No.FUN-670026 mark
                            CALL q_oma4(FALSE,TRUE,g_oob[l_ac].oob06,g_oob[l_ac].oob02, #No.FUN-670026 
                                       #g_ooa.ooa01,g_ooa.ooa03,'1*',g_ooa.ooa23)       #No.FUN-670026   #MOD-D60149 add ooa23   #MOD-F20042 mark
                                        g_ooa.ooa01,g_ooa.ooa03,'1%',g_ooa.ooa23)                                                #MOD-F20042 add
                                 RETURNING b_oob.oob06,b_oob.oob09,  #No.FUN-680022 --add oob19
                                           b_oob.oob10,b_oob.oob19
                         ELSE
...
FUNCTION t410_acct_code()
   ...
   CASE WHEN g_oob[l_ac].oob03 = '1' AND g_oob[l_ac].oob04 = '5'
       ...
       #--MOD-EC0079 mark start--
       WHEN g_oob[l_ac].oob03 = '1' AND g_oob[l_ac].oob04 = 'F'
            LET b_oob.oob11 = l_ool.ool34
            IF g_aza.aza63='Y' THEN
               LET b_oob.oob111 = l_ool.ool341
            END IF
       #--MOD-EC0079 mark end--
...
FUNCTION t410_oob09_11(l_sw,l_cmd)                # 借方檢查 : 支票
   ...
   DEFINE l_nmz59         LIKE nmz_file.nmz59
  #DEFINE l_sql           LIKE type_file.chr1000     #No.FUN-680123 VARCHAR(500)   #TQC-5A0089   #MOD-E70049 mark
   DEFINE l_sql           STRING                     #MOD-E70049 add
...
#FUN-D70121--add--star--
    ...
    END IF
#FUN-D70121--add---end---  
  #IF YEAR(g_ooa.ooa02) <> YEAR(l_nmh.nmh04) THEN                 #FUN-D70121--mark
  #   CALL s_tag(YEAR(g_ooa.ooa02),g_bookno1,g_oob[l_ac].oob11)   #FUN-D70121--mark 
   IF s_get_aznn(g_plant,g_bookno11,g_ooa.ooa02,1) <> s_get_aznn(g_plant,g_bookno1,l_nmh.nmh04,1) THEN #FUN-D70121--add--
      CALL s_tag(s_get_aznn(g_plant,g_bookno11,g_ooa.ooa02,1),g_bookno1,g_oob[l_ac].oob11)  #FUN-D70121--add--
           RETURNING l_bookno,g_oob[l_ac].oob11
   END IF
  #IF YEAR(g_ooa.ooa02) <> YEAR(l_nmh.nmh04) THEN           #FUN-D70121--mark
  #   CALL s_tag(YEAR(g_ooa.ooa02),g_bookno2,g_oob[l_ac].oob111)    #FUN-D70121--mark
   IF s_get_aznn(g_plant,g_bookno11,g_ooa.ooa02,1) <> s_get_aznn(g_plant,g_bookno1,l_nmh.nmh04,1) THEN #FUN-D70121--add--
      CALL s_tag(s_get_aznn(g_plant,g_bookno11,g_ooa.ooa02,1),g_bookno2,g_oob[l_ac].oob111)  #FUN-D70121--add--
...
#FUN-D70121--add--star--
     ...
     IF g_flag = '1' THEN
        CALL cl_err(g_ooa.ooa02,'aoo-081',1)
     END IF
     CALL s_get_bookno(YEAR(l_nmg.nmg01)) RETURNING g_flag1,g_bookno11,g_bookno21
     IF g_flag1 = '1' THEN
        CALL cl_err(l_nmg.nmg01,'aoo-081',1)
     END IF
#FUN-D70121--add---end---  
    #IF YEAR(g_ooa.ooa02) <> YEAR(l_nmg.nmg02) THEN                #FUN-D70121--mark-
    #   CALL s_tag(YEAR(g_ooa.ooa02),g_bookno1,g_oob[l_ac].oob11)  #FUN-D70121--mark-
     IF s_get_aznn(g_plant,g_bookno1,g_ooa.ooa02,1) <> s_get_aznn(g_plant,g_bookno11,l_nmg.nmg01,1) THEN #FUN-D70121--add
        CALL s_tag(s_get_aznn(g_plant,g_bookno1,g_ooa.ooa02,1),g_bookno1,g_oob[l_ac].oob11)  #FUN-D70121--add
             RETURNING l_bookno,g_oob[l_ac].oob11
     END IF
    #IF YEAR(g_ooa.ooa02) <> YEAR(l_nmg.nmg02) THEN                   #FUN-D70121--mark-
    #   CALL s_tag(YEAR(g_ooa.ooa02),g_bookno2,g_oob[l_ac].oob111)     #FUN-D70121--mark-
     IF s_get_aznn(g_plant,g_bookno1,g_ooa.ooa02,1) <> s_get_aznn(g_plant,g_bookno11,l_nmg.nmg01,1) THEN #FUN-D70121--add
        CALL s_tag(s_get_aznn(g_plant,g_bookno1,g_ooa.ooa02,1),g_bookno2,g_oob[l_ac].oob111)  #FUN-D70121--add
             RETURNING l_bookno,g_oob[l_ac].oob111
     END IF
     #No.FUN-740184  --End
...
FUNCTION t410_diff()
   ...
   INITIALIZE b_oob.* TO NULL
   LET b_oob.oob01=g_ooa.ooa01
   #--FUN-EC0013 add start--
   IF diff_flag = '7' THEN
      LET b_oob.oob07= g_aza.aza17
   ELSE
      LET b_oob.oob07=g_ooa.ooa23
   END IF
   #--FUN-EC0013 add end--
  #LET b_oob.oob07=g_ooa.ooa23   #FUN-EC0013 mark
   ...
   END IF
   #--FUN-EC0013 add end--
  #LET b_oob.oob04='A'   #FUN-EC0013 mark
   LET b_oob.oob10= g_ooa.ooa32c - g_ooa.ooa32d
   IF b_oob.oob10<0 THEN LET b_oob.oob10=-b_oob.oob10 END IF
  #IF g_ooa.ooa31d = g_ooa.ooa31c THEN                    #MOD-FB0146 mark
   IF diff_flag='7' OR g_ooa.ooa31d = g_ooa.ooa31c THEN   #MOD-FB0146 add 
      LET b_oob.oob08= 1
      LET b_oob.oob09= 0
...
FUNCTION t410_b_askkey()
  #DEFINE l_wc2   LIKE type_file.chr1000   #No.FUN-680123 VARCHAR(200)   #MOD-E70049 mark
   DEFINE l_wc2   STRING   #MOD-E70049 add     
    CLEAR oob04_d
...
#    #   EXIT DISPLAY                       #FUN-A90003 Mark
     ...
     #-FUN-C80021--mark-- 
     #-FUN-C80021--str-- 
      ON ACTION detail_b1_return
         LET g_action_choice="detail_b1_return"
         EXIT DIALOG
...
FUNCTION t410_out()
   #DEFINE l_wc  LIKE type_file.chr1000   #No.FUN-680123  VARCHAR(100)   #MOD-E70049 mark
    DEFINE l_wc  STRING   #MOD-E70049 add
    IF g_ooa.ooa01 IS NULL THEN RETURN END IF
    MENU ""
       ...
       ON ACTION print_this_pay_slip
         ...
         ##FUN-D10098--add--end--
         #MOD-E70081---mark---end---
            #LET g_msg = "axrg420 '' '' '",g_lang,"' 'Y' '' '' ", #FUN-E50028 mark
             LET g_msg = "axrr420 '' '' '",g_lang,"' 'Y' '' '' ", #FUN-E50028
                         "'ooa01 =\"",g_ooa.ooa01,"\"' '3' '' '' '' '' '",g_ooa.ooa35,"' "
         #END IF    #MOD-E70081 mark
          #TQC-C70127--add--end--
          #-----END TQC-660010-----
 ...
 #MOD-940420  --begin 
   ...
   DEFINE l_oob      RECORD      
             ...
             oob06    LIKE oob_file.oob06
                     END RECORD  
 #MOD-940420  --end
   DEFINE l_npq07 LIKE npq_file.npq07      #MOD-G80094 add   

   LET g_success = 'Y'   
#CHI-C30107 --------------- add ---------------- begin

   #--TQC-F40008 add start--
   IF g_ooa.ooa01 IS NULL THEN 
      CALL cl_err('',-400,0) 
      LET g_success = 'N'
      RETURN 
...
#  END IF
  #END FUN-550049
   ...
   #--MOD-G80094 add start--
   #借方
   SELECT SUM(ABS(npq07))
     INTO l_npq07
     FROM npq_file
   ...
   IF l_npq07 != g_ooa.ooa32d THEN
      CALL s_errmsg("npq07",l_npq07,g_ooa.ooa01,"aap-278",1)
      LET g_success = 'N'
   ELSE
      #貸方
      SELECT SUM(ABS(npq07))
...
#MOD-940420  --begin   
  ...
  #          IF (l_oma00 != '21') AND (l_oma00 != '22') AND (l_oma00 !='23') AND (l_oma00 != '24') THEN   #MOD-9B0043 add 23     #TQC-B10005 mark     
             IF (l_oma00 != '21') AND (l_oma00 != '22') AND (l_oma00 !='23') AND 
                (l_oma00 != '24') AND (l_oma00 != '25') AND (l_oma00 != '26') AND (l_oma00 !='27') AND    #TQC-B10005   #MOD-EA0124 add 25
               #(l_oma00 != '28') THEN  #MOD-B70242 add 28        #MOD-F40074 mark
                (l_oma00 != '28') AND (g_ooa.ooa35 != '3') THEN   #MOD-F40074 add
...
#      CALL s_showmsg()                    #NO.FUN-710050  #No.TQC-740094
  ...
  IF g_ooy.ooydmy1 = 'Y' AND g_ooy.ooyglcr = 'Y' AND g_success = 'Y' THEN
    ...
    #LET g_str="axrp590 '",g_wc_gl CLIPPED,"' '",g_user,"' '",g_user,"' '",g_ooz.ooz02p,"' '",g_ooz.ooz02b,"' '",g_ooy.ooygslp,"' '",g_ooa.ooa02,"' 'Y' '1' 'Y' '",g_ooz.ooz02c,"' '",g_ooy.ooygslp1,"'"   #No.FUN-670047  #No.MOD-860075  #No.MOD-B70162 mark
     LET g_str="axrp590 '",g_wc_gl CLIPPED,"' '",g_ooa.ooauser,"' '",g_ooa.ooauser,"' '",g_ooz.ooz02p,"' '",g_ooz.ooz02b,"' '",g_ooy.ooygslp,"' '",g_ooa.ooa02,"' 'Y' '1' 'Y' '",g_ooz.ooz02c,"' '",g_ooy.ooygslp1,"' 'Y'"  #No.MOD-B70162 add #MOD-DB0002 add 'Y'
...
FUNCTION t410_z()                   # when g_ooa.ooaconf='Y' (Turn to 'N')
 ...
 DEFINE  l_cnt          LIKE type_file.num5   #No.FUN-A40054
   ...
   IF g_ooa.ooa01 IS NULL THEN CALL cl_err('',-400,0) RETURN END IF   #TQC-F40008 add
...
FUNCTION t410_bu_13(p_sw)                  #更新待抵帳款檔 (oma_file)
  ...
  DEFINE l_oma55        LIKE oma_file.oma55      #TQC-F80002 add
  DEFINE l_oma57        LIKE oma_file.oma57      #TQC-F80002 add 
  DEFINE l_oma16        LIKE oma_file.oma16      #CHI-F30072 add
  DEFINE l_oma211       LIKE oma_file.oma211     #CHI-F30072 add
...
# 同參考單號若有一筆以上僅沖款一次即可 --------------
 ...
 #LET g_sql="SELECT oma00,omavoid,omaconf,oma54t,oma56t,oma55,oma57 ",   #TQC-F80002 add oma55,oma57   #CHI-F30072 mark
  LET g_sql="SELECT oma00,omavoid,omaconf,oma54t,oma56t,",          #CHI-F30072 add
            "       oma55,oma57,oma16,oma211",                      #CHI-F30072 add
  ...
  #modify 030226 NO.A048
 #FETCH t410_bu_13_c1 INTO l_oma00,l_omavoid,l_omaconf,un_pay1,un_pay2,l_oma55,l_oma57   #TQC-F80002 add l_oma55,l_oma57  #CHI-F30072 mark 
  FETCH t410_bu_13_c1 INTO l_oma00,l_omavoid,l_omaconf,un_pay1,un_pay2,   #CHI-F30072 add
                           l_oma55,l_oma57,l_oma16,l_oma211               #CHI-F30072 add
    IF p_sw='+' AND l_omavoid='Y' THEN
#      CALL cl_err(b_oob.oob06,'axr-103',0) LET g_success = 'N' RETURN #NO.FUN-710050
      #CALL s_errmsg(' ',' ','b_oob.oob06','axr-103',1) LET g_success = 'N' RETURN   #NO.FUN-710050   #MOD-FA0066 mark
       CALL s_errmsg('','',b_oob.oob06,'axr-103',1)     #MOD-FA0066 add
       LET g_success = 'N'                              #MOD-FA0066 add
       RETURN                                           #MOD-FA0066 add
    END IF
    IF p_sw='+' AND l_omaconf='N' THEN
#      CALL cl_err(b_oob.oob06,'axr-194',1) LET g_success='N' RETURN   #NO.FUN-710050
      #CALL s_errmsg(' ',' ','b_oob.oob06','axr-104',1) LET g_success = 'N' RETURN   #NO.FUN-710050   #MOD-FA0066 mark
       CALL s_errmsg('','',b_oob.oob06,'axr-104',1)     #MOD-FA0066 add
       LET g_success = 'N'                              #MOD-FA0066 add
       RETURN                                           #MOD-FA0066 add
    END IF
...
#      CALL cl_err('un_pay<pay#1','axr-196',1) LET g_success = 'N' RETURN   #NO.FUN-710050
    ...
    IF p_sw='+' THEN
       ...
       IF l_oma00 = '23' THEN   #MOD-FC0028 add 
          LET tot1 = tot1 + l_oma55   #TQC-F80002 add
          LET tot2 = tot2 + l_oma57   #TQC-F80002 add
       END IF   #MOD-FC0028 add
     #--TQC-F80002 add start--
     ELSE
        IF l_oma00 = '23' THEN
   ...
   #END IF
    ...
    CALL cl_digcut(tot2,g_azi04) RETURNING tot2        #No.CHI-6A0004
    #No.TQC-5B0171 --end--
    #--CHI-F30072 add start--
    IF g_ooa.ooa35 = '3' THEN
       IF p_sw = '+' THEN
          UPDATE oma_file
             SET oma55 = oma55 + b_oob.oob09 ,oma57 = oma57 + b_oob.oob10
...
#       CALL cl_err3("del","oma_file",b_oob.oob06,"",STATUS,"","del oma",1)  #No.FUN-660116 #NO.FUN-710050
       #CALL s_errmsg('oma01','b_oob.oob06','del oma',STATUS,1)              #NO.FUN-710050   #MOD-FA0066 mark
        CALL s_errmsg('oma01',b_oob.oob06,'del oma',STATUS,1)                                 #MOD-FA0066 add
        LET g_success = 'N' 
        RETURN 
     END IF
     IF SQLCA.SQLERRD[3]=0 THEN
#       CALL cl_err('del oma','axr-199',1)                                   #NO.FUN-710050
       #CALL s_errmsg('oma01','b_oob.oob06','del oma','axr-199',1)           #NO.FUN-710050   #MOD-FA0066 mark
        CALL s_errmsg('oma01',b_oob.oob06,'del oma','axr-199',1)                              #MOD-FA0066 add
        LET g_success = 'N' RETURN
     END IF
     #No.FUN-680022--begin-- add
...
#       CALL cl_err3("del","oov_file",b_oob.oob06,"",status,"","del oov",1)  #No.FUN-660116 #NO.FUN-710050
       #CALL s_errmsg('oov01','b_oob.oob06','del oov',STATUS,1)              #NO.FUN-710050   #MOD-FA0066 mark
        CALL s_errmsg('oov01',b_oob.oob06,'del oov',STATUS,1)                                 #MOD-FA0066 add
        LET g_success='N'
     END IF
     #FUN-5A0124  --end
...
#       CALL cl_err3("ins","oma_file",l_oma.oma01,"",SQLCA.sqlcode,"","ins oma",1)  #No.FUN-660116 #NO.FUN-710050
       #CALL s_errmsg('oma02','g_ooa.ooa02','ins oma',SQLCA.SQLCODE,1)              #NO.FUN-710050   #MOD-FA0066 mark
        CALL s_errmsg('oma02',g_ooa.ooa02,'ins oma',SQLCA.SQLCODE,1)                                 #MOD-FA0066 add
        LET g_success='N' 
        RETURN
     END IF
...
#       CALL cl_err3("ins","omc_file",l_omc.omc01,l_omc.omc02,SQLCA.sqlcode,"","ins omc",1) #NO.FUN-710050
       #CALL s_errmsg('omc01','l_oma.oma01','ins omc',SQLCA.SQLCODE,1)                      #NO.FUN-710050   #MOD-FA0066 mark
        CALL s_errmsg('omc01',l_oma.oma01,'ins omc',SQLCA.SQLCODE,1)                                         #MOD-FA0066 add
        LET g_success='N'
        RETURN
     END IF
    #No.FUN-680022--end-- add 
...
DEFINE l_oob      RECORD LIKE oob_file.*
   ...
   UPDATE nmh_file SET nmh42 =l_oob.oob09 +l_nmh42
    WHERE nmh01 = l_oob.oob06
     IF STATUS THEN
       #CALL s_errmsg('nmh01','l_oob.oob06','upd nmh42',STATUS,1)              #NO.FUN-710050   #MOD-FA0066 mark
        CALL s_errmsg('nmh01',l_oob.oob06,'upd nmh42',STATUS,1)                                 #MOD-FA0066 add
        LET g_success = 'N'
        RETURN
     END IF
     IF SQLCA.SQLERRD[3]=0 THEN
       #CALL s_errmsg('nmh01','l_oob.oob06','upd nmh42','axr-198',1) LET g_success = 'N' RETURN      #NO.FUN-710050   #MOD-FA0066 mark
        CALL s_errmsg('nmh01',l_oob.oob06,'upd nmh42','axr-198',1)   #MOD-FA0066 add 
        LET g_success = 'N'                                          #MOD-FA0066 add
        RETURN                                                       #MOD-FA0066 add
     END IF
...
FUNCTION t410_x(p_type) #FUN-D20035 add
  ...
  END IF
   ...
   IF g_ooa.ooaconf='X' AND NOT cl_null(g_ooz.ooz09) AND g_ooa.ooa02<= g_ooz.ooz09 THEN
...
#No:FUN-C60006---add--star---
      LET g_ooa.ooamodu = g_user
      LET g_ooa.ooadate = g_today
      DISPLAY BY NAME g_ooa.ooamodu
      DISPLAY BY NAME g_ooa.ooadate
...
#      END INPUT
   ...
   #LET g_str="axrp590 '",g_wc_gl CLIPPED,"' '",g_user,"' '",g_user,"' '",g_ooz.ooz02p,"' '",g_ooz.ooz02b,"' '",l_ooygslp,"' '",g_ooa.ooa02,"' 'Y' '1' 'Y' '",g_ooz.ooz02c,"' '",g_ooy.ooygslp1,"'"  #No.FUN-670047  #No.MOD-860075 #No.MOD-B70162 mark
    LET g_str="axrp590 '",g_wc_gl CLIPPED,"' '",g_ooa.ooauser,"' '",g_ooa.ooauser,"' '",g_ooz.ooz02p,"' '",g_ooz.ooz02b,"' '",l_ooygslp,"' '",g_ooa.ooa02,"' 'Y' '1' 'Y' '",g_ooz.ooz02c,"' '",g_ooy.ooygslp1,"' 'Y'"    #No.MOD-B70162 add #MOD-DB0002 add 'Y'
    CALL cl_cmdrun_wait(g_str)
    SELECT ooa33 INTO g_ooa.ooa33 FROM ooa_file
     WHERE ooa01 = g_ooa.ooa01
    DISPLAY BY NAME g_ooa.ooa33
...
#No.FUN-AB0034 --end
      ...
      #--MOD-G40035 add start--
      IF g_ooz.ooz29 = 'Y' THEN
         DROP TABLE x
         SELECT * FROM npq_file WHERE 1=2 INTO TEMP x   #axrt300產生分錄重排項次時需用到TEMP x
         CALL s_t300_gl(l_oma.oma01,'0')     
         IF g_aza.aza63='Y' AND g_success='Y' THEN
            CALL s_t300_gl(l_oma.oma01,'1') 
         END IF
      END IF
      #--MOD-G40035 add end--
...
#FUN-B30166--add--end
   ...
   IF p_sw = '+' THEN
    ...
    # LET l_nme.nme07 = g_ooa.ooa24 #TQC-DC0015 mark
      LET l_nme.nme07 = b_oob.oob08 #TQC-DC0015 add
...
FUNCTION t410_need_2()
  DEFINE l_nmz70   LIKE nmz_file.nmz70  #MOD-D10208
   IF  g_oob_d[l_ac2].oob03_d = '2'   
      ...
      #No.MOD-D10208  --Begin
      SELECT nmz70 INTO l_nmz70 FROM nmz_file WHERE nmz00 = '0'
      IF l_nmz70 = '2' THEN
         CALL cl_set_comp_entry("oob21_1",FALSE)
         CALL cl_set_comp_required("oob21_1",FALSE)
      END IF
      #No.MOD-D10208  --End
   ELSE
...
FUNCTION t410_oob06_1_12_2()            # 借方檢查 : TT
 ...
 #DEFINE l_sql           LIKE type_file.chr1000   #MOD-E70049 mark
  DEFINE l_sql           STRING                   #MOD-E70049 add     
  DEFINE l_nmz20         LIKE nmz_file.nmz20
...
#FUN-D70121--add---end---   
  #IF YEAR(g_ooa.ooa02) <> YEAR(l_nmh.nmh04) THEN                      #FUN-D70121--mark-
  #   CALL s_tag(YEAR(g_ooa.ooa02),g_bookno1,g_oob_d[l_ac2].oob11_1)   #FUN-D70121--mark-
   IF s_get_aznn(g_plant,g_bookno11,g_ooa.ooa02,1) <> s_get_aznn(g_plant,g_bookno1,l_nmh.nmh04,1) THEN  #FUN-D70121--add
      CALL s_tag(s_get_aznn(g_plant,g_bookno11,g_ooa.ooa02,1),g_bookno1,g_oob_d[l_ac2].oob11_1)  #FUN-D70121--add
           RETURNING l_bookno,g_oob_d[l_ac2].oob11_1
   END IF
  #IF YEAR(g_ooa.ooa02) <> YEAR(l_nmh.nmh04) THEN                          #FUN-D70121--mark-
  #   CALL s_tag(YEAR(g_ooa.ooa02),g_bookno2,g_oob_d[l_ac2].oob111_1)      #FUN-D70121--mark-
   IF s_get_aznn(g_plant,g_bookno11,g_ooa.ooa02,1) <> s_get_aznn(g_plant,g_bookno1,l_nmh.nmh04,1) THEN  #FUN-D70121--add
      CALL s_tag(s_get_aznn(g_plant,g_bookno11,g_ooa.ooa02,1),g_bookno2,g_oob_d[l_ac2].oob111_1)  #FUN-D70121--add
           RETURNING l_bookno,g_oob_d[l_ac2].oob111_1
   END IF
   IF l_nmh.nmh38 = 'N' THEN
...
FUNCTION t410_set_comb_oob04()
  ...
  DEFINE comb_item  LIKE type_file.chr1000    
    ...
    IF g_azw.azw04 = '2' THEN    #CHI-D90008
   ...
   #-CHI-D90008-str--
    ELSE
       SELECT ze03 INTO comb_item FROM ze_file                                                                                      
        WHERE ze01='axr1011' AND ze02=g_lang                                                                                       
    END IF
   #-CHI-D90008-end--
...
FUNCTION t410_set_comb_oob04_1()
  ...
  DEFINE comb_item  LIKE type_file.chr1000    
   ...
   #-CHI-D90008-str--
    ELSE
       LET comb_value = '1,2,3,4,7,A,D,Z'   #MOD-DC0013 add 'A'   #CHI-F30039 add 'D'                                                                                          
    END IF
   #-CHI-D90008-end--
   ...
   #-CHI-D90008-str--
    ELSE
       SELECT ze03 INTO comb_item FROM ze_file                                                                                      
        WHERE ze01='axr1012' AND ze02=g_lang                                                                                       
    END IF
   #-CHI-D90008-end--
      ...
      INPUT ARRAY g_oob_d WITHOUT DEFAULTS FROM s_oob_d.*
           ...
           IF NOT cl_null(g_oob_d[l_ac2].oob04_1) THEN
            ...
            #-------------------MOD-C70125----------------mark
              ...
              IF g_oob_d[l_ac2].oob04_1 ='7' THEN
                 ...
                 LET g_oob_d[l_ac2].oob08_1 = 1 
                 DISPLAY BY NAME g_oob_d[l_ac].oob07_1
                 DISPLAY BY NAME g_oob_d[l_ac].oob08_1
              END IF
              #--MOD-E70049 add end--
         END IF
         CALL t410_set_no_entry_b_2()
        ...
        AFTER FIELD oob06_1
           IF NOT cl_null(g_oob_d[l_ac2].oob06_1) THEN
             ...
             #IF g_oob_d[l_ac2].oob03_d='1' AND g_oob_d[l_ac2].oob04_1='1' THEN   #MOD-G80158 mark
              IF g_oob_d[l_ac2].oob03_d='2' AND g_oob_d[l_ac2].oob04_1='D' THEN   #MOD-G80158 add
                 SELECT nmh04 INTO l_nmh04 FROM nmh_file
                  WHERE nmh01 = g_oob_d[l_ac2].oob06_1
              END IF
             #IF g_oob_d[l_ac2].oob03_d='1' AND g_oob_d[l_ac2].oob04_1='2' THEN   #MOD-G80158 mark
              IF g_oob_d[l_ac2].oob03_d='2' AND g_oob_d[l_ac2].oob04_1='A' THEN   #MOD-G80158 add
                 SELECT nmg01 INTO l_nmh04 FROM nmg_file
                  WHERE nmg00 = g_oob_d[l_ac2].oob06_1
              END IF
              IF g_oob_d[l_ac2].oob03_d='1' AND g_oob_d[l_ac2].oob04_1='3' THEN
             ...
             #------------------------MOD-C70125--------------------mark
              ...
              IF SQLCA.sqlcode THEN
                 CALL cl_err3("sel","nmh_file",g_oob_d[l_ac2].oob06_1,"",SQLCA.sqlcode,"","",0) 
                 NEXT FIELD oob06_1   #MOD-G80158 add
              ELSE
                 IF l_nmh04 > g_ooa.ooa02 THEN
                    CALL cl_err('','axr-371',0)
                    NEXT FIELD oob06_1
            ...
            #IF g_oob_d[l_ac2].oob03_d='1' AND g_oob_d[l_ac2].oob04_1 MATCHES "[39]" THEN       #MOD-C70125 mark
             IF g_oob_d[l_ac2].oob03_d='1' AND g_oob_d[l_ac2].oob04_1 MATCHES "[3]" THEN        #MOD-C70125 add
               #IF p_cmd= 'a' OR g_oob_d_t.oob06_1 != g_oob_d[l_ac2].oob06_1  THEN          #MOD-GB0070 mark 
                IF p_cmd= 'a' OR (g_oob_d_t.oob06_1 != g_oob_d[l_ac2].oob06_1) OR (cl_null(g_oob_d[l_ac2].oob19_1) AND NOT cl_null(g_oob_d[l_ac2].oob06_1)) THEN  #MOD-GB0070 add
                  #IF g_oob_d[l_ac2].oob04_1 = '3' THEN         #MOD-GB0070 mark 
                      SELECT oma00 INTO l_oma00 FROM oma_file
                       WHERE oma01 = g_oob_d[l_ac2].oob06_1
                     #IF (l_oma00!='21') AND (l_oma00!='22') AND                             #MOD-F40074 mark
                      IF (g_ooa.ooa35 != '3') AND (l_oma00!='21') AND (l_oma00!='22') AND    #MOD-F40074 add 
                        #(l_oma00!='23') AND (l_oma00!='24') THEN    #MOD-9B0043 add 23      #MOD-EA0124 mark
                         (l_oma00!='23') AND (l_oma00!='24') AND (l_oma00 != '25') AND       #MOD-EA0124 add
                         (l_oma00!='26') AND (l_oma00 !='27')AND (l_oma00 != '28') THEN      #MOD-EA0124 add 
                         CALL cl_err('','axr-992',0)
                         NEXT FIELD oob06_1
                      END IF 
                  #END IF             #MOD-GB0070 mark 
            ...
            IF INT_FLAG THEN
               ...
               ELSE
                  ...
                  IF g_rec_b2 != 0 THEN
                     LET g_b_flag = '2'
                    #LET g_action_choice = "detail"      #MOD-F60114 mark
                     LET g_action_choice = "detail_b2"   #MOD-F60114 add
                     LET l_ac2 = l_ac2_t
                  END IF
               #FUN-D30032--add--end--
               END IF
...
#MOD-590452 將原本mark的部份取消
                 ...
                 WHEN INFIELD(oob06_1)
                     ...
                     #-------------------------------MOD-C70125------------------------mark
                      IF g_oob_d[l_ac2].oob03_d='2' AND g_oob_d[l_ac2].oob04_1='1' THEN
                         IF g_ooz.ooz62='N' THEN
                            CALL q_oma4(FALSE,TRUE,g_oob_d[l_ac2].oob06_1,g_oob_d[l_ac2].oob02_1, 
                                       #g_ooa.ooa01,g_ooa.ooa03,'1*',g_ooa.ooa23)       #MOD-D60149 add ooa23   #MOD-F20042 mark
                                        g_ooa.ooa01,g_ooa.ooa03,'1%',g_ooa.ooa23)                               #MOD-F20042 add
                                 RETURNING b_oob.oob06,b_oob.oob09,  
                                           b_oob.oob10,b_oob.oob19
                         ELSE
     ...
     ## END FUN-550049 ##
      ...
      IF (g_ooa.ooa23 IS NULL AND g_ooa.ooa32d != g_ooa.ooa32c) OR
         ...
         INPUT BY NAME diff_flag
          AFTER FIELD diff_flag
          #IF diff_flag NOT MATCHES "[90E]" THEN NEXT FIELD diff_flag END IF   #FUN-EC0013 mark
           IF diff_flag NOT MATCHES "[970E]" THEN NEXT FIELD diff_flag END IF  #FUN-EC0013 add
           IF diff_flag MATCHES '[9]'  AND g_ooa.ooa32d > g_ooa.ooa32c THEN
              CALL cl_err('','axr-303',0) NEXT FIELD diff_flag
           END IF
            ON IDLE g_idle_seconds
    ...
    CLOSE t410_bcl1
    COMMIT WORK
   #IF diff_flag MATCHES "[9]" THEN   #FUN-EC0013 mark
    IF diff_flag MATCHES "[79]" THEN  #FUN-EC0013 add
       CALL t410_diff()
       CALL t410_b_fill('1=1')         #FOR GENERO BUG調整
       CALL t410_b_fill_2('1=1') #FUN-A90003 Add
    END IF
...
#      # CALL cl_err('sel ooy_file',STATUS,0)   #No.FUN-660116
    ...
    END IF
    #-----97/05/26 modify 詢問是否產生分錄底稿
   #IF g_ooa.ooa31d>0 AND g_ooa.ooa31d=g_ooa.ooa31c AND g_ooy.ooydmy1='Y' THEN   #MOD-FB0146 mark
    IF g_ooa.ooa32d>0 AND g_ooa.ooa32d=g_ooa.ooa32c AND g_ooy.ooydmy1='Y' THEN   #MOD-FB0146 add
       IF cl_confirm('axr-309') THEN
          CALL t410_v()
       END IF
    END IF
...
FUNCTION t410_b_fill_1()
  DEFINE l_ooa01         LIKE ooa_file.ooa01       #CHI-F80014 add        
  DEFINE l_i             LIKE type_file.num10

    CALL g_ooa_1.clear()
    LET l_i = 1
    #FOREACH axrt410_list_cur INTO g_ooa_1[l_i].*               #CHI-F80014 mark
    FOREACH t410_cs INTO l_ooa01                                #CHI-F80014 add
       IF SQLCA.sqlcode THEN
          CALL cl_err('foreach item_cur',SQLCA.sqlcode,1)
          CONTINUE FOREACH
       END IF
       #CHI-F80014 add start ---------------------------
       SELECT ooa01,ooa02,ooa03,ooa032,ooa14,gen02,ooa15,gem02,
              ooa23,ooa33,ooaconf,ooa34,ooa35,ooa36
         INTO g_ooa_1[l_i].*
         FROM ooa_file
              LEFT OUTER JOIN gem_file ON gem01 = ooa15
              LEFT OUTER JOIN gen_file ON gen01 = ooa14
        WHERE ooa01 = l_ooa01
       #CHI-F80014 add end   ---------------------------
