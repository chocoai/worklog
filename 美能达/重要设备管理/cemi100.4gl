...
DEFINE g_tc_fia_1   DYNAMIC ARRAY OF RECORD
            ...
            tc_fia26 LIKE tc_fia_file.tc_fia26
                    ...
                    END RECORD
DEFINE g_tc_fia_desc RECORD
            tc_fia14_desc   LIKE gem_file.gem02,
            tc_fia15_desc   LIKE gen_file.gen02
                END RECORD
        ...
        ON ACTION controlp
           CASE
              WHEN INFIELD(tc_fia01)
                  ...
                  DISPLAY BY NAME g_tc_fia.tc_fia01
                  NEXT FIELD tc_fia01
              ...
              WHEN INFIELD(tc_fia14)
                  ...
                  DISPLAY BY NAME g_tc_fia.tc_fia14
                  NEXT FIELD tc_fia14
               ...
               WHEN INFIELD(tc_fia15)
                  ...
                  DISPLAY BY NAME g_tc_fia.tc_fia15
                  NEXT FIELD tc_fia15
              ...
              WHEN INFIELD(tc_fia07)
                  ...
                  DISPLAY BY NAME g_tc_fia.tc_fia07
                  NEXT FIELD tc_fia07
    ...
    MENU ""
       ...
       ON ACTION reproduce
        ...
        ON ACTION exporttoexcel
            ...
            IF cl_chk_act_auth() THEN
                CALL cl_export_to_excel(ui.Interface.getRootNode(),base.TypeInfo.create(g_tc_fia_1),'','')
            END IF
...
FUNCTION i100_i(p_cmd)
    ...
    INPUT BY NAME g_tc_fia.tc_fia01,g_tc_fia.tc_fia02,g_tc_fia.tc_fia03,g_tc_fia.tc_fia04,g_tc_fia.tc_fia05,
                  g_tc_fia.tc_fia14,g_tc_fia.tc_fia15,
                  g_tc_fia.tc_fia16,g_tc_fia.tc_fia17,g_tc_fia.tc_fia18,g_tc_fia.tc_fia19,g_tc_fia.tc_fia20,
                  g_tc_fia.tc_fia21,g_tc_fia.tc_fia22,
                  g_tc_fia.tc_fia06,g_tc_fia.tc_fia07,g_tc_fia.tc_fia08,g_tc_fia.tc_fia09,g_tc_fia.tc_fia10,
                  g_tc_fia.tc_fia11,g_tc_fia.tc_fia12,g_tc_fia.tc_fia13,
                  g_tc_fia.tc_fia23,g_tc_fia.tc_fia24,g_tc_fia.tc_fia25
    ...
    AFTER FIELD tc_fia10
      IF NOT cl_null(g_tc_fia.tc_fia10) AND g_tc_fia.tc_fia10 >0 THEN
          IF NOT cl_null(g_tc_fia.tc_fia12) THEN
              CASE g_tc_fia.tc_fia11
                  WHEN '1'
                      LET g_tc_fia.tc_fia13 = g_tc_fia.tc_fia12 + g_tc_fia.tc_fia10*1
                  WHEN '2'
                      LET g_tc_fia.tc_fia13 = g_tc_fia.tc_fia12 + g_tc_fia.tc_fia10*7
                  WHEN '3'
                      SELECT add_months(g_tc_fia.tc_fia12,g_tc_fia.tc_fia10) INTO g_tc_fia.tc_fia13 FROM dual
                      #LET g_tc_fia.tc_fia13 = g_tc_fia.tc_fia12 + g_tc_fia.tc_fia10*30
                  WHEN '4'
                      SELECT add_months(g_tc_fia.tc_fia12,g_tc_fia.tc_fia10*12) INTO g_tc_fia.tc_fia13 FROM dual
                  OTHERWISE EXIT CASE
              END CASE
      ...
      ELSE
          NEXT FIELD tc_fia10
      END IF
      DISPLAY BY NAME g_tc_fia.tc_fia13

    AFTER FIELD tc_fia11
      IF NOT cl_null(g_tc_fia.tc_fia11) THEN
          IF NOT cl_null(g_tc_fia.tc_fia12) AND NOT cl_null(g_tc_fia.tc_fia10) THEN
              CASE g_tc_fia.tc_fia11
                  WHEN '1'
                      LET g_tc_fia.tc_fia13 = g_tc_fia.tc_fia12 + g_tc_fia.tc_fia10*1
                  WHEN '2'
                  ...
                  WHEN '4'
                      SELECT add_months(g_tc_fia.tc_fia12,g_tc_fia.tc_fia10*12) INTO g_tc_fia.tc_fia13 FROM dual
                      #LET g_tc_fia.tc_fia13 = g_tc_fia.tc_fia12 + g_tc_fia.tc_fia10*360
                  OTHERWISE EXIT CASE
              END CASE
    ...
    AFTER FIELD tc_fia12
        IF NOT cl_null(g_tc_fia.tc_fia12) THEN
            IF NOT cl_null(g_tc_fia.tc_fia11) AND NOT cl_null(g_tc_fia.tc_fia10) THEN
                CASE g_tc_fia.tc_fia11
                    WHEN '1'
                        LET g_tc_fia.tc_fia13 = g_tc_fia.tc_fia12 + g_tc_fia.tc_fia10*1
                    WHEN '2'
    ...
    AFTER FIELD tc_fia14
      SELECT gem02 INTO g_tc_fia_desc.tc_fia14_desc FROM gem_file WHERE gem01 = g_tc_fia.tc_fia14
      SELECT gen02 INTO g_tc_fia_desc.tc_fia15_desc FROM gen_file WHERE gen01 = g_tc_fia.tc_fia15
      CALL cl_set_comp_lab_text("tc_fia14_desc",g_tc_fia_desc.tc_fia14_desc)
      CALL cl_set_comp_lab_text("tc_fia15_desc",g_tc_fia_desc.tc_fia15_desc)

    AFTER FIELD tc_fia15
      SELECT gem02 INTO g_tc_fia_desc.tc_fia14_desc FROM gem_file WHERE gem01 = g_tc_fia.tc_fia14
      SELECT gen02 INTO g_tc_fia_desc.tc_fia15_desc FROM gen_file WHERE gen01 = g_tc_fia.tc_fia15
      CALL cl_set_comp_lab_text("tc_fia14_desc",g_tc_fia_desc.tc_fia14_desc)
      CALL cl_set_comp_lab_text("tc_fia15_desc",g_tc_fia_desc.tc_fia15_desc)
...
FUNCTION i100_fetch(p_fltc_fia)
    ...
    ELSE
        SELECT gem02 INTO g_tc_fia_desc.tc_fia14_desc FROM gem_file WHERE gem01 = g_tc_fia.tc_fia14
        SELECT gen02 INTO g_tc_fia_desc.tc_fia15_desc FROM gen_file WHERE gen01 = g_tc_fia.tc_fia15
        IF cl_null(g_tc_fia_desc.tc_fia14_desc) THEN LET g_tc_fia_desc.tc_fia14_desc = ' ' END IF
        IF cl_null(g_tc_fia_desc.tc_fia15_desc) THEN LET g_tc_fia_desc.tc_fia15_desc = ' ' END IF
        CALL cl_set_comp_lab_text("tc_fia14_desc",g_tc_fia_desc.tc_fia14_desc)
        CALL cl_set_comp_lab_text("tc_fia15_desc",g_tc_fia_desc.tc_fia15_desc)
...
FUNCTION i100_show()
    ...
    IF cl_null(g_tc_fia_desc.tc_fia14_desc) THEN LET g_tc_fia_desc.tc_fia14_desc = ' ' END IF
    IF cl_null(g_tc_fia_desc.tc_fia15_desc) THEN LET g_tc_fia_desc.tc_fia15_desc = ' ' END IF
    DISPLAY BY NAME g_tc_fia_desc.*

    CALL cl_set_field_pic(g_tc_fia.tc_fia26,'N','N','N','N','Y')
    CALL cl_show_fld_cont()                   #No.FUN-550037 hmf
END FUNCTION
...
FUNCTION i100_undo_confirm()
  ...
  SELECT COUNT(1)
    INTO l_cnt
    FROM tc_fib_file
    WHERE tc_fib05 = g_tc_fia.tc_fia01
  IF l_cnt > 0 THEN
...
FUNCTION i100_copy()
  ...
  IF NOT cl_null(g_tc_fia.tc_fia01) THEN
      SELECT *
        INTO g_tc_fia.*
        FROM tc_fia_file
       WHERE tc_fia01 = g_tc_fia.tc_fia01

    LET g_tc_fia.tc_fia01 = ''
    LET g_tc_fia.tc_fia26 = 'N'
