...
# Modify.........: NO20141010  by wenny 參照舊程式進行修改
# Modify.........: 20150302 by wenny 更改报表打印模板为：apmr630，apmr630，apmr630
# Modify.........: NO.MOD-D90146 15/04/13 By vivian 打印模板增加料号并显示在品名栏位
# Modify.........:               15/06/06 BY yinghui 打印模板增加倉碼
...
GLOBALS "../4gl/sapmt7201.global"   #add by wenny20141009
GLOBALS
...
DEFINE TempTableName STRING     #add by wenny20141009+-
...
FUNCTION t720(p_argv1,p_argv2,p_argv3,p_argv4,p_argv5)   #No:FUN-630010  #FUN-A60009 add:p_argv5
   ...
   DEFINE _xxsql_a  STRING    #add by wenny20141009+-
   WHENEVER ERROR CONTINUE

   #--start by wenny20141009+-----------------------
   LET _xxsql_a="rvv01.rvv_file.rvv01,",
          ...
          "rvv311.rvv_file.rvv31,",  #add by vivian 150413
          "rvv32.rvv_file.rvv32,",   #add by yinghui 150606
          "pml45.pml_file.pml45,",
          "pml46.pml_file.pml46,",
          "rvu04.rvu_file.rvu04,",
          "rvu05.rvu_file.rvu05,",
          "zcbh.type_file.chr2000,",
          "gem02.gem_file.gem02," ,     # by cjy 111229add
          "pmk13.pmk_file.pmk13 "      # by cjy 111229add
   LET TempTableName=cl_prt_temptable('apmt720_ex',_xxsql_a)
   LET TempTableName=g_cr_db_str CLIPPED,TempTableName CLIPPED
   #---end by wenny20141009--------------------------------------------
        ...
        CASE
          WHEN (g_argv1='1' AND g_argv3 !='SUB' AND g_argv3 !='TAP')
              ...
              # OPEN WINDOW t720_w WITH FORM "apm/42f/apmt720"
                OPEN WINDOW t720_w WITH FORM "cpm/42f/apmt720"   #add by wenny20141009
...
#                 rvuud11,rvuud12,rvuud13,rvuud14,rvuud15
        CONSTRUCT BY NAME g_wc ON              #螢幕上取單頭條件
                  ...
                  rvudate,rvucrat,
                  ta_rvu02,ta_rvu03,ta_rvu04, ta_rvu08,ta_rvu09,ta_rvu10,  #add by wenny20141009
                  rvuud01,rvuud02,rvuud03,rvuud04,rvuud05,
                  rvuud06,rvuud07,rvuud08,rvuud09,rvuud10,
                  rvuud11,rvuud12,rvuud13,rvuud14,rvuud15
#TQC-AB0412 ----------------------End---------------------------------
   ...
   #FUN-B40031 End-----
       ...
       LET g_wc = g_wc CLIPPED,cl_get_extra_cond('rvuuser', 'rvugrup')
        ...
        CONSTRUCT g_wc2 ON rvv02,rvv05,rvv45,rvv46,qcl02,rvv47,rvv31,rvv031, #FUN-BC0104 add rvv45,rvv46,qcl02,rvv47
                          ...
                          rvv930,   #FUN-670051
                          ta_rvv01,ta_rvv02,ta_rvv03 ,         #add by wenny20141009
                     ...
                     FROM s_rvv[1].rvv02, s_rvv[1].rvv05,
                          ...
                          s_rvv[1].ta_rvv01,s_rvv[1].ta_rvv02 ,s_rvv[1].ta_rvv03,  #add by wenny20141009
   ...
   WHILE TRUE
      ...
      CASE g_action_choice
       ...
       #@WHEN "確認"
         WHEN "confirm"
            IF cl_chk_act_auth() THEN
              #-----start by wenny20141215------------------
               IF t720_check_mvjvprice() THEN   # change by zn_zhao131022
                  CONTINUE WHILE
               END IF
              #------end by wenny20141215-------------------
...
DEFINE l_gem02     LIKE  gem_file.gem02   #NO.FUN-960130
  ...
  IF NOT g_argv1 MATCHES '[56Z]' THEN                                     #No.FUN-940083
     DISPLAY BY NAME g_rvu.rvuoriu,g_rvu.rvuorig,
      ...
      g_rvu.ta_rvu02,g_rvu.ta_rvu03,g_rvu.ta_rvu04,g_rvu.ta_rvu08,g_rvu.ta_rvu09,g_rvu.ta_rvu10,  #add by wenny20141009
      g_rvu.rvuud01,g_rvu.rvuud02,g_rvu.rvuud03,g_rvu.rvuud04,
      g_rvu.rvuud05,g_rvu.rvuud06,g_rvu.rvuud07,g_rvu.rvuud08,
      g_rvu.rvuud09,g_rvu.rvuud10,g_rvu.rvuud11,g_rvu.rvuud12,
      g_rvu.rvuud13,g_rvu.rvuud14,g_rvu.rvuud15
...
FUNCTION t720_r()  #刪除
    ...
    DEFINE l_rvv_a   DYNAMIC ARRAY OF RECORD
           ...
           rvv47           LIKE rvv_file.rvv47
                     END RECORD
    DEFINE l_cnt           LIKE type_file.num5    # add by wenny20141009
    #FUN-BC0104---add---end
   ...
   #--start by wenny20141009-------------
      LET l_cnt=0
       SELECT COUNT(*) INTO l_cnt FROM fak_file WHERE fak46=g_rvu.rvu01
     IF   l_cnt>0 THEN
...
DEFINE l_ta_pmn02 LIKE pmn_file.ta_pmn02  #雜項分類 add by wenny20141009
...
#              END IF                    #No.FUN-A50054 Add   #FUN-A60035 ---MARK
        ...
        BEFORE INSERT
            ...
            LET g_rvv[l_ac].ta_rvv02 = 0   #add by wenny20141009
...
#MOD-B70231 -- end --
        ...
        #FUN-BB0001 add END
            ...
            #start by wenny20141009 客供設備單價清零---
            LET l_ta_pmn02 = ''
            SELECT ta_pmn02 INTO l_ta_pmn02 FROM pmn_file WHERE pmn01 = b_rvv.rvv36 and pmn02 =b_rvv.rvv37
            IF l_ta_pmn02 = 'ZK01' OR g_rvv[l_ac].rvv36[1,3] = 'CZS' THEN     #add OR l_ta_pmn02 = 'CZS' by xiaoyan 14/03/03
               LET b_rvv.rvv38=0
               LET b_rvv.rvv38t=0
               LET b_rvv.rvv39=0
               LET b_rvv.rvv39t=0
               ...
               LET g_rvv[l_ac].rvv39 = 0
               LET g_rvv[l_ac].rvv39t= 0
               DISPLAY BY NAME g_rvv[l_ac].rvv38,g_rvv[l_ac].rvv38t,g_rvv[l_ac].rvv39,g_rvv[l_ac].rvv39t
            END IF
            ##--end by wenny20141009 -------
...
#FUN-A60035 ---MARK END
        ...
        AFTER FIELD rvv05             #驗收項次
           IF NOT cl_null(g_rvu.rvu02) AND NOT cl_null(g_rvv[l_ac].rvv05) THEN
              ...
              LET g_rvv[l_ac].ta_rvv02 = g_rvv[l_ac].rvv17 #add by wenny20141009
...
#MOD-B70231 -- end --
         ...
         AFTER FIELD rvv38t
          ...
          #IF g_rvv[l_ac].rvv87>0 THEN #MOD-B30033 mark
           ...
           #--start by wenny20141009 客供設備單價清----------------
            LET l_ta_pmn02 = ''
            SELECT ta_pmn02 INTO l_ta_pmn02 FROM pmn_file WHERE pmn01 = b_rvv.rvv36 and pmn02 =b_rvv.rvv37
            IF l_ta_pmn02 = 'ZK01' OR g_rvv[l_ac].rvv36[1,3] = 'CZS' THEN         #add by xiaoyan 14/03/03
               LET g_rvv[l_ac].rvv38 = 0
               LET g_rvv[l_ac].rvv38t= 0
               LET g_rvv[l_ac].rvv39 = 0
               LET g_rvv[l_ac].rvv39t= 0
...
#FUN-A60035 ---MARK END
               ...
               LET l_ta_pmn02 = ''
               SELECT ta_pmn02 INTO l_ta_pmn02 FROM pmn_file WHERE pmn01 = b_rvv.rvv36 and pmn02 =b_rvv.rvv37
               IF l_ta_pmn02 = 'ZK01' OR g_rvv[l_ac].rvv36[1,3] = 'CZS' THEN    #add OR l_ta_pmn02[1,3] = 'CZS' by xiaoyan 14/03/03
                  LET b_rvv.rvv38=0
                  LET b_rvv.rvv38t=0
                  LET b_rvv.rvv39=0
                  LET b_rvv.rvv39t=0
...
FUNCTION t720_b_move_to()
   ...
   LET g_rvv[l_ac].ta_rvv01    = b_rvv.ta_rvv01  #add by wenny20141009
   LET g_rvv[l_ac].ta_rvv02    = b_rvv.ta_rvv02  #add by wenny20141009
...
DEFINE l_rva113     LIKE rva_file.rva113    #NO.FUN-940083
 DEFINE l_cnt           LIKE type_file.num5  #add by wenny20141009
 DEFINE l_tc_soa43 LIKE tc_soa_file.tc_soa43 #add by wenny20141009
   ...
   LET b_rvv.ta_rvv01 = g_rvv[l_ac].ta_rvv01  #add by wenny20141009
   LET b_rvv.ta_rvv02 = g_rvv[l_ac].ta_rvv02  #add by wenny20141009
...
#FUN-A60035 ---MARK END
    ...
    IF g_prog = 'apmt720' OR g_prog = 'aict042' THEN  #MOD-D30083 add aict042
          ...
          "       rvv930,'', ",  #FUN-670051
          "       ta_rvv02,ta_rvv03,ta_rvv01,",   #add by wenny20141009
          "       rvvud01,rvvud02,rvvud03,rvvud04,rvvud05,",
          "       rvvud06,rvvud07,rvvud08,rvvud09,rvvud10,",
          "       rvvud11,rvvud12,rvvud13,rvvud14,rvvud15 ",
#TQC-A60046 --Begin
...
#@    ON ACTION 产生应付帐款
      ...
      ON ACTION grupo_takes
         ...
         EXIT DIALOG
      #	生成资产标签
	    ON ACTION generate_lable
		     LET g_action_choice="generate_lable"
		  EXIT DIALOG
      #---end by wenny20141009--------------------------
...
FUNCTION t720_z()
   ...
   DEFINE l_dbs        LIKE azp_file.azp03  #add by wenny20141009
   DEFINE l_sql     STRING     #add by wenny20141009
   ...
   IF g_success='Y' THEN   #20131228 add by cathree
      CALL t7201_p3_chk()
   END IF
   #--end by wenny20141009-------------------------
...
FUNCTION t720_out()
   ...
   DEFINE l_cnt        LIKE type_file.num5    #add by wenny20141009
      ...
      #---start by wenny20141009+---------------------
       IF g_rvu.rvu08='EXP' THEN
        LET l_cnt=0
         SELECT COUNT(*) INTO l_cnt FROM fak_file WHERE fak46=g_rvu.rvu01 and (fak02=' ' OR   fak02 is null )

        IF l_cnt>0 THEN

         CALL cl_err(g_rvu.rvu01,'cpm-062',0)
         RETURN
      ...
      #-----add by wenny20150302-------改为CR报表--------------------
      IF g_rvu.rvu00='1' THEN LET l_program='apmr630' END IF
      IF g_rvu.rvu00='2' THEN LET l_program='apmr632' END IF
      IF g_rvu.rvu00='3' THEN LET l_program='apmr631' END IF
      #------end by wenny20150302---------改为CR报表-----------------
...
#FUN-A60035 ---MARK END
   ...
   #FUN-C20002--end add---------------------------------------------
   DEFINE l_ta_pmn02 LIKE pmn_file.ta_pmn02  #雜項分類 add by wenny20141009
   DEFINE l_qcs09    LIKE qcs_file.qcs09    # add by wenny20141009

   IF g_rvu.rvu01 IS NULL THEN RETURN END IF
   IF NOT cl_confirm('apm-255') THEN RETURN
    #--start by wenny20141009+-----------------
    ELSE
           SELECT qcs09 INTO l_qcs09 FROM qcs_file
              WHERE qcs01 = g_rvu.rvu02
                AND qcs14 = 'Y'
           IF l_qcs09 MATCHES '[5]' THEN
           CALL cl_err(l_qcs09,'apm0255',1)
           RETURN
           END IF
    #---end by wenny20141009------------------
    END IF
...
#  OPEN WINDOW t720_exp_w AT p_row,p_col WITH FORM "apm/42f/apmt720g"
   OPEN WINDOW t720_exp_w AT p_row,p_col WITH FORM "cpm/42f/apmt720g"
...
#--start by wenny20141009--------------------------------------
# 生成资产标签
FUNCTION generate_lable()
	DEFINE
		l_finno   LIKE type_file.chr8,
        l_str     LIKE type_file.chr8,
        l_str4    LIKE type_file.chr8,
        l_num     LIKE type_file.num10,
		l_i			LIKE type_file.num5,
		l_gem06		LIKE gem_file.gem06,
		l_flag		LIKE type_file.chr1,
		l_rvv         DYNAMIC ARRAY OF RECORD LIKE rvv_file.*,
		l_a			LIKE type_file.num5,
		l_pmm22   LIKE pmm_file.pmm22          #add by zeliang 20131014

	LET l_flag='Y'
	LET l_i = 1
	DECLARE aa_cs CURSOR FOR SELECT * FROM rvv_file WHERE rvv01=g_rvu.rvu01
	FOREACH aa_cs INTO l_rvv[l_i].*
		LET l_i = l_i + 1
	END FOREACH
	CALL l_rvv.deleteElement(l_i)
	LET l_i = l_i - 1
	IF l_i = 0 THEN RETURN END IF
	BEGIN WORK
	FOR l_i=1 TO l_rvv.getlength()
	##########產生批號，批號廠別+年YY+月MM+日DD+流水號############
            LET l_str=g_today USING 'yyyymm'
            LET l_finno = l_str[3,4]
            LET l_str4=l_str[5,6]
            LET l_num = l_str4
            LET l_str4 = l_num

            IF l_num < 10 THEN LET l_finno = l_finno CLIPPED,l_str4 END IF
            IF l_num = 10 THEN LET l_finno = l_finno CLIPPED,'A' END IF
            IF l_num = 11 THEN LET l_finno = l_finno CLIPPED,'B' END IF
            IF l_num = 12 THEN LET l_finno = l_finno CLIPPED,'C' END IF

            LET l_num = 0
            SELECT max(substr(fak00,4,8) ) INTO l_num
              FROM fak_file
             WHERE substr(fak00,1,3)=l_finno
               AND length(fak00)=8
            IF cl_null(l_num) THEN LET l_num = 0 END IF
            LET l_str = l_num+1 USING '&&&&&'
            LET l_finno = l_finno CLIPPED,l_str

		SELECT COUNT(*) INTO l_a FROM faj_file WHERE faj46 = g_rvu.rvu01
                                             AND faj461= l_rvv[l_i].rvv02
		IF l_a > 0 THEN
		   CONTINUE FOR
		END IF

		CALL s_fanato(l_finno,g_rvu.rvu01,l_rvv[l_i].rvv02)
...
#130910bm
FUNCTION t7201_p2_chk()
 DEFINE l_sql,l_msg LIKE type_file.chr1000
 DEFINE l_cnt LIKE type_file.num5
 DEFINE l_tc_tzp RECORD LIKE tc_tzp_file.*

 INITIALIZE l_tc_tzp.* TO NULL
 SELECT * INTO l_tc_tzp.* FROM tc_tzp_file
  WHERE tc_tzp01 = '1'
    AND tc_tzp02 = g_rvu.rvu04
    AND tc_tzpacti = 'Y'
 IF cl_null(l_tc_tzp.tc_tzp09) THEN  RETURN END IF


 IF NOT cl_null(g_rvu.ta_rvu10) THEN  #代購->出貨
     LET l_cnt = 0
    LET l_sql = "SELECT COUNT(*) FROM ",l_tc_tzp.tc_tzp09 CLIPPED,".oga_file ",
                " WHERE ogaconf != 'X' ",
                "   AND oga01 = '",g_rvu.ta_rvu10 CLIPPED,"'"
    PREPARE ta_rvu10_p1 FROM l_sql
    DECLARE ta_rvu10_c1 CURSOR FOR ta_rvu10_p1
    OPEN  ta_rvu10_c1
    FETCH ta_rvu10_c1 INTO l_cnt
    CLOSE ta_rvu10_c1
    IF l_cnt >0 THEN
       LET l_msg = "營運中心",l_tc_tzp.tc_tzp08 CLIPPED," 存在相關出貨單：",g_rvu.ta_rvu10 CLIPPED," 請確認！"
       CALL cl_err(l_msg,'!',1)
       LET g_success = 'N'
       RETURN
    END IF
 ...
 IF NOT cl_null(g_rvu.ta_rvu09) THEN  #代購->入庫
    LET l_cnt = 0
    LET l_sql = "SELECT COUNT(*) FROM ",l_tc_tzp.tc_tzp09 CLIPPED,".rvu_file ",
                " WHERE rvuconf != 'X' ",
                "   AND rvu01 = '",g_rvu.ta_rvu09 CLIPPED,"'"
    PREPARE ta_rvu09_p1 FROM l_sql
    DECLARE ta_rvu09_c1 CURSOR FOR ta_rvu09_p1
    OPEN  ta_rvu09_c1
    FETCH ta_rvu09_c1 INTO l_cnt
    CLOSE ta_rvu09_c1
    IF l_cnt >0 THEN
       LET l_msg = "營運中心",l_tc_tzp.tc_tzp08 CLIPPED," 存在相關採購入庫單：",g_rvu.ta_rvu09 CLIPPED," 請確認！"
       CALL cl_err(l_msg,'!',1)
       LET g_success = 'N'
       RETURN
    END IF
 ...
 IF NOT cl_null(g_rvu.ta_rvu08) THEN  #代購->收貨
     LET l_cnt = 0
    LET l_sql = "SELECT COUNT(*) FROM ",l_tc_tzp.tc_tzp09 CLIPPED,".rva_file ",
                " WHERE rvaconf != 'X' ",
                "   AND rva01 = '",g_rvu.ta_rvu08 CLIPPED,"'"
    PREPARE ta_rvu08_p1 FROM l_sql
    DECLARE ta_rvu08_c1 CURSOR FOR ta_rvu08_p1
    OPEN  ta_rvu08_c1
    FETCH ta_rvu08_c1 INTO l_cnt
    CLOSE ta_rvu08_c1
    IF l_cnt >0 THEN
       LET l_msg = "營運中心",l_tc_tzp.tc_tzp08 CLIPPED," 存在相關採購驗收單：",g_rvu.ta_rvu08 CLIPPED," 請確認！"
       CALL cl_err(l_msg,'!',1)
       LET g_success = 'N'
       RETURN
    END IF
...
FUNCTION t7201_p3_chk()
 ...
 IF NOT cl_null(g_rvu.ta_rvu10) THEN  #代購->自己出貨
     LET l_cnt = 0
    LET l_sql = "SELECT COUNT(*) FROM oga_file ",
                " WHERE ogaconf != 'X' ",
                "   AND oga01 = '",g_rvu.ta_rvu10 CLIPPED,"'"
    PREPARE ta_rvu10_p2 FROM l_sql
    DECLARE ta_rvu10_c2 CURSOR FOR ta_rvu10_p2
    OPEN  ta_rvu10_c2
    FETCH ta_rvu10_c2 INTO l_cnt
    CLOSE ta_rvu10_c2
    IF l_cnt >0 THEN
       LET l_msg = " 存在對",l_tc_tzp.tc_tzp08 CLIPPED,"相關出貨單：",g_rvu.ta_rvu10 CLIPPED," 請確認！"
       CALL cl_err(l_msg,'!',1)
       LET g_success = 'N'
       RETURN
    END IF
 ...
 IF NOT cl_null(g_rvu.ta_rvu09) THEN  #代購->入庫
    ...
    LET l_sql = "SELECT COUNT(*) FROM ",l_tc_tzp.tc_tzp09 CLIPPED,".rvu_file ",
                " WHERE rvuconf != 'X' ",
                "   AND rvu01 = '",g_rvu.ta_rvu09 CLIPPED,"'"
    PREPARE ta_rvu09_p2 FROM l_sql
    DECLARE ta_rvu09_c2 CURSOR FOR ta_rvu09_p2
    OPEN  ta_rvu09_c2
    FETCH ta_rvu09_c2 INTO l_cnt
    CLOSE ta_rvu09_c2
    IF l_cnt >0 THEN
       LET l_msg = "營運中心",l_tc_tzp.tc_tzp08 CLIPPED," 存在相關採購入庫單：",g_rvu.ta_rvu09 CLIPPED," 請確認！"
       CALL cl_err(l_msg,'!',1)
 ...
 IF NOT cl_null(g_rvu.ta_rvu08) THEN  #代購->收貨
    ...
    LET l_sql = "SELECT COUNT(*) FROM ",l_tc_tzp.tc_tzp09 CLIPPED,".rva_file ",
                " WHERE rvaconf != 'X' ",
                "   AND rva01 = '",g_rvu.ta_rvu08 CLIPPED,"'"
    PREPARE ta_rvu08_p2 FROM l_sql
    DECLARE ta_rvu08_c2 CURSOR FOR ta_rvu08_p2
    OPEN  ta_rvu08_c2
    FETCH ta_rvu08_c2 INTO l_cnt
    CLOSE ta_rvu08_c2
    IF l_cnt >0 THEN
       LET l_msg = "營運中心",l_tc_tzp.tc_tzp08 CLIPPED," 存在相關採購驗收單：",g_rvu.ta_rvu08 CLIPPED," 請確認！"
       CALL cl_err(l_msg,'!',1)
...
FUNCTION t720_print()
  DEFINE CRE_SQL STRING
  DEFINE INS_SQL STRING
  DEFINE DEL_SQL STRING
  DEFINE l_name char(40)
  DEFINE l_table varchar(40)
  DEFINE inser_sql STRING
  DEFINE sel_sql STRING
  DEFINE stat_sql STRING
  DEFINE _xxsql STRING
  DEFINE id INTEGER
  DEFINE sum_id INTEGER
  DEFINE del_sql_a STRING
  ...
  DEFINE sd RECORD
          ...
          rva07 LIKE rva_file.rva07,
          rvv311 LIKE rvv_file.rvv31,  #add by vivian 150413
          rvv32 LIKE rvv_file.rvv32,   #add by yinghui 150606
          pml45 LIKE pml_file.pml45,
          pml46 LIKE pml_file.pml46,
          rvu04 LIKE rvu_file.rvu04,
          rvu05 LIKE rvu_file.rvu05,
          zcbh  LIKE type_file.chr2000,
          gem02 LIKE gem_file.gem02,
          pmk13 LIKE pmk_file.pmk13
     END RECORD
  DEFINE l_faj02 LIKE faj_file.faj02,
         l_pmk13 LIKE pmk_file.pmk13  #  by cjy 111229add

   CALL cl_set_locale_frm_name("apmt720")
   CALL cl_ui_init()

   LET del_sql_a="delete from ",TempTableName
   prepare del_temple from del_sql_a
   EXECUTE del_temple

   LET sel_sql="select rvv01,rvv09,rvv02,rvv35 ,rvv31,nvl(pml07,rvv35),rvv17,rva07 ,rvv31,rvv32,nvl(pml45,rvv031),nvl(pml46,rvv31),rvu04,rvu05,'','',pmk13",  #add rvv31 by vivian 150413  #add rvv32 by yinghui150606
               " from rvu_file, rvv_file,rva_file, pml_file,pmn_file,ima_file,pmk_file",
               " where rvu01=rvv01 and  pmn24=pml01(+) and pmn25=pml02(+) and pmn01=rvv36",
               " and pmn02=rvv37 and rva01=rvv04 and rvv31=ima01 and pml01=pmk01(+) and rvv01='",g_rvu.rvu01 clipped ,"'"
   LET INS_SQL="INSERT INTO ",TempTableName CLIPPED," VALUES(?,?,?,?,?, ?,?,?,?,?, ?,?,?,?,?, ?,?)"
   prepare ins_pre from INS_SQL
   prepare sel_pre from sel_sql
   declare sel_cur cursor for sel_pre
   LET sum_id=0
   FOREACH sel_cur into sd.*
      IF SQLCA.sqlcode THEN
          CALL cl_err('foreach:',SQLCA.sqlcode,1)
          EXIT FOREACH
      END IF

      DECLARE t720_zcbh1 CURSOR FOR
      SELECT fak02 FROM fak_file WHERE fak46 = sd.rvv01 AND fak461 = sd.rvv02
      FOREACH t720_zcbh1 INTO l_faj02
        IF cl_null(sd.zcbh) THEN
           LET sd.zcbh = l_faj02
        ELSE
           LET sd.zcbh = sd.zcbh CLIPPED,',',l_faj02
        END IF
      END FOREACH
      IF cl_null(sd.zcbh) THEN
         DECLARE t720_zcbh2 CURSOR FOR
         SELECT faj02 FROM faj_file WHERE faj46 = sd.rvv01 AND faj461 = sd.rvv02
         FOREACH t720_zcbh2 INTO l_faj02
           IF cl_null(sd.zcbh) THEN
              LET sd.zcbh = l_faj02
           ELSE
              LET sd.zcbh = sd.zcbh CLIPPED,',',l_faj02
      ...
      SELECT  gem04||gem02 INTO sd.gem02 FROM gem_file WHERE gem01=sd.pmk13  ## by cjy 111229add

      EXECUTE ins_pre USING sd.*
      let sum_id=sum_id+1
   END FOREACH
   LET INS_SQL="INSERT INTO ",TempTableName CLIPPED," VALUES(?,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null)"
   prepare ins_sql_a from INS_SQL
   FOR id=sum_id  to 5
     IF SQLCA.sqlcode THEN
          CALL cl_err('foreach:',SQLCA.sqlcode,1)
          EXIT FOR
      END IF
     EXECUTE  ins_sql_a USING g_rvu.rvu01
   END FOR
   LET l_name="apmt720"
   LET sel_sql= "SELECT * FROM ",TempTableName clipped," order by rvv02"
   CALL cl_prt_cs3('apmt720','apmt720',sel_sql,'')
END FUNCTION

##########################################change by zhining 20130912############
FUNCTION t720_check_mvjvprice()
DEFINE l_sql   STRING
DEFINE lt1     LIKE rvv_file.rvv02
DEFINE l_rvv   RECORD
   ...
   END RECORD
       LET lt1 =0
        LET l_sql="select rvu01,rvv31,rvv38,rvv38t",
                 " from rvu_file,rvv_file ",
                 " where rvu01=rvv01 ",
                 "   and rvu01='",g_rvu.rvu01,"'",
                 " order by rvv02"
       PREPARE t720_pre_st1 FROM l_sql
       DECLARE t72_cur_st1 CURSOR FOR t720_pre_st1
       FOREACH t72_cur_st1 INTO l_rvv.*
         IF l_rvv.rvv38=0 or l_rvv.rvv38t=0 THEN
                #SELECT COUNT(*) INTO lt1 FROM ima_file WHERE ima06 in('503N','504N','505N') AND ima01=l_rvv.rvv31
            SELECT count(*)
		          INTO lt1
	            FROM ima_file,tc_pop_file
			       WHERE ima06=tc_pop02
			         AND ima01=l_rvv.rvv31
			         AND tc_pop01='mjzj'
            IF lt1>0 THEN
                  ERROR "单价不允许为空,料件编号：'",l_rvv.rvv31,"' 有问题"
                 # CALL cl_err_msg_log()
                  LET g_msg ="" clipped ,l_rvv.rvv31,  "此料号单价错误，检查模治检具入库单价不允许为0！请在程式cpmt910中补充单价！"
                 call cl_err(g_msg,'!',1)
               EXIT  FOREACH
            END IF
         END IF
...
DEFINE l_msg        STRING
   ...
   FOREACH c_cus INTO l_rvv02,l_rvv38,l_rvv87,l_rvv39,l_rvv36,l_rvv39t,l_rvv38t
      ...
      LET l_rvv39t_t = cl_digcut(l_rvv39t_t,t_azi04)
       ...
       CALL t720_rvv39(l_rvv36,l_rvv39_t,l_rvv39t_t,g_rvu.rvu04,g_rvu.rvu01)
...
FUNCTION t720_rvv39(p_rvv36,p_rvv39,p_rvv39t,p_rvu04,p_rvu01)
