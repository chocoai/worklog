...
# Modify.........: No.CHI-C20040 13/06/24 By Lori 應付類型為預付且付款與請款廠商不同時,當付款廠商為關係人,分錄底稿的貸方科目npq37=apa54,預設異動碼關係人名稱為apa06
# Modify.........: No.FUN-D70028 13/07/08 By zhangweib 新增aapt140程序,產生分錄底稿時,沖帳資料抓取oov_file資料
# Modify.........: No.FUN-D70077 13/07/29 By wangrr aapt121冲抵‘18’预提费用,產生分錄底稿時,沖帳資料抓取api_file資料
# Modify.........: No.FUN-D70132 13/08/09 By Elise 屬於HRM產生的AP資料，需控卡不允許重新產生分錄，若User需異動，可至分錄底稿手動維護
...
# Modify.........: No.MOD-DA0095 13/10/15 By yinhy apa51有科目時，aapt210無法產生貸方科目
# Modify.........: No.MOD-DB0175 13/11/27 By yuhuabao 沖暫估時摘要沒有依據agli121設置正確帶出
# Modify.........: No.CHI-DC0023 13/12/23 By yuhuabao 調整差異處理的的條件判斷
# Modify.........: No.MOD-E20049 14/02/12 By yinhy l_apb02為0時，s_def_npq傳入''
# Modify.........: No.TQC-E20011 14/02/13 By apo 調整t110_gl_c411之g_sql
# Modify.........: No:FUN-E20008 13/03/07 By fengmy 還原FUN-D70077
# Modify.........: No:CHI-E30030 14/03/20 By yihsuan 將api40給 1
# Modify.........: No:TQC-E90013 14/09/18 By doris s_aapt110_gl 中,FUNCTION t110_g_gl_2 判斷 apa33 <> 0 時,抓取 npq03 動作,增加判斷 apa56 為 2 時,改用 apa53/apa531
# Modify.........: No:MOD-EA0019 14/10/03 By yihsuan 產生分錄段 PREPARE t110_papb02_01 組 apb27/apb33 時,判斷若 l_npq04 內容有單引號時,在多組一個單引號,
#                                                    可避掉此特殊符號的限制問題
# Modify.........: No:MOD-EA0054 14/10/08 By yihsuan 產生分錄段中調整上述段落本幣應改用 apb10 決定本幣金額
# Modify.........: No:MOD-F20070 15/02/13 By doris 直接付款段原幣/本幣金額改抓apg05f/apg05
# Modify.........: No:MOD-F30025 15/03/06 By doris 將 MOD-F20070 調整的段落移到 END FOREACH 之後
# Modify.........: No:MOD-F80162 15/08/28 By doris 變數l_npq04 定義改為 LIKE apb_file.apb27
# Modify.........: No:TQC-FA0001 15/10/15 By doris 修正DIFF2沒有匯率的問題
# Modify.........: No:MOD-G10015 16/01/05 By doris LET l_npq.npq37 = l_api.api37之前先判斷api37,有值在給npq37
# Modify.........: No:MOD-G10098 16/01/19 By doris 如為直接付款抓取aph10寫入npq05
# Modify.........: No:MOD-G30026 16/03/07 By doris 參考MOD-D10205,處理紅沖 沖暫估產生分錄底稿問題
# Modify.........: No:MOD-G40018 16/04/11 By doris t110_g_gl_2()函式分錄摘要(npq04)抓取單頭備註(apa25)邏輯,參考t110_g_gl_1()函式處理
# Modify.........: No:MOD-GA0036 16/10/17 By Sabrina 借方科目取抓搞要時應依agli121/aaps100的設定為主 
# Modify.........: No:MOD-GA0042 16/10/19 By Sabrina 將apz54/apz55拿掉，沒有任何程式可以設定這兩個值
# Modify.........: No:MOD-H50015 17/05/11 By yihsuan 將FOREACH t110_gl_c1x中 npq08給予apa66的值
# Modify.........: No:FUN-HB0002 17/12/07 By yihsuan 增加apz75參數：預付沖銷時，是否以歷史匯率確認存貨科目本幣金額
...
#DEFINE g_sql            LIKE type_file.chr1000 #No.FUN-690028 VARCHAR(1000)   #MOD-EA0019 mark
DEFINE g_sql            STRING                                                 #MOD-EA0019 add
#DEFINE l_sql            LIKE type_file.chr1000 #MOD-920100 add   #MOD-EA0019 mark
DEFINE l_sql            STRING                                    #MOD-EA0019 add
...
FUNCTION t110_g_gl(p_aptype,p_apno,p_npptype,p_plant)  #No.FUN-680029 新增p_npptype   #FUN-9C0001 add p_plant
   ...
   DEFINE l_apa79       LIKE apa_file.apa79   #FUN-D70132 add
   ...
   SELECT COUNT(*) INTO l_n FROM npp_file 
    WHERE npp01 = p_apno
     #AND nppglno != ''                 #CHI-D50043 mark
      AND nppglno IS NOT NULL           #CHI-D50043
      AND nppsys = 'AP'
      AND npp00 = 1
      AND npp011 = 1
      AND npptype = p_npptype  #No.FUN-680029 
   ...
   IF p_npptype = '0' THEN
      ...
      IF l_n > 0 THEN
        #FUN-D70132---add---S
         SELECT apa79 INTO l_apa79 FROM apa_file WHERE apa01 = p_apno
         IF l_apa79 = 'N' THEN
            RETURN
         ELSE     
        #FUN-D70132---add---E
...
FUNCTION t110_g_gl_1(p_aptype,p_apno,p_npptype) #No.FUN-680029 新增p_npptype
  ...
  #DEFINE l_npq04       LIKE npq_file.npq04    #CHI-CC0022 add   #MOD-F80162 mark
   DEFINE l_npq04       LIKE apb_file.apb27                      #MOD-F80162 add
   ...
   DEFINE l_apb24_1     LIKE apb_file.apb24   #CHI-A60012 add
   DEFINE l_apb24_3     LIKE apb_file.apb24   #CHI-A60012 add
   DEFINE l_apb10_1     LIKE apb_file.apb10   #MOD-EA0054 add
   ...
   DEFINE l_str         STRING                #MOD-EA0019 add
   DEFINE l_apg05f      LIKE apg_file.apg05f  #MOD-F20070 add
   DEFINE l_apg05       LIKE apg_file.apg05   #MOD-F20070 add
      ...
      IF l_apa.apa51 = 'MISC' OR l_apa.apa51 = 'UNAP' THEN
         ...
         FOREACH t110_gl_c1 INTO l_api.*
           ...
           #LET l_npq.npq04 = l_api.api06          #FUN-D10065  mark
            ...
            CALL s_def_npq(l_npq.npq03,g_prog,l_npq.*,l_npq.npq01,l_api.api03,'',g_bookno)RETURNING l_npq.* #MOD-DB0175 add
           #FUN-D10065---mark--str 
            ...
            IF l_npq.npq07 != 0 THEN 
              ...
              #MOD-GA0036--add--end--
               CALL s_def_npq31_npq34(l_npq.*,g_bookno)  RETURNING l_npq.npq31,l_npq.npq32,l_npq.npq33,l_npq.npq34  #FUN-AA0087
                                                                  ,l_npq.npq11,l_npq.npq12,l_npq.npq13,l_npq.npq14   #FUN-D30095
...
#No.FUN-9A0036 --End
              ...
              #IF l_aag371 MATCHES '[23]' THEN                #FUN-950053 mark
               IF l_aag371 MATCHES '[234]' THEN               #FUN-950053 add 
                  IF NOT cl_null(l_api.api37) THEN         #MOD-G10015 add 
                     LET l_npq.npq37 = l_api.api37         #MOD-A20047 add
                  END IF                                   #MOD-G10015 add 
                  #-->for 合併報表-關係人
          ...
          END IF
            ...
            IF l_npq.npq07!=0 THEN 
              ...
              #---------------------MOD-CC0253--------------------------(S)
               ...
               #--MOD-EA0019 add start--
               LET l_str = l_npq04
               LET l_cnt = l_str.getIndexOf("'",1)
               IF l_cnt <> 0 THEN
                  LET l_npq04 = cl_replace_str(l_npq04,"'","''")
               END IF
               #--MOD-EA0019 add end--
               ...
               ELSE
                  LET l_sql = l_sql CLIPPED,"    AND apb33 = '",l_npq04,"'" 
               END IF
               #MOD-D40069 add end-----
                                                         #MOD-D20101 add
              ...
              #CALL s_def_npq(l_npq.npq03,g_prog,l_npq.*,l_npq.npq01,'','',g_bookno)        #No.FUN-730064 #MOD-CC0253 mark
               #No.MOD-E20049  --Begin
               IF l_apb02 = 0 THEN
               	  CALL s_def_npq(l_npq.npq03,g_prog,l_npq.*,l_npq.npq01,'','',g_bookno)
               	  RETURNING l_npq.* 
               ELSE
               #No.MOD-E20049  --End
                  CALL s_def_npq(l_npq.npq03,g_prog,l_npq.*,l_npq.npq01,l_apb02,'',g_bookno)                  #MOD-CC0253
                  RETURNING l_npq.* 
               END IF  #No.MOD-E20049
              ##FUN-D10065--add--str--
               IF cl_null(l_npq.npq04) THEN
                  LET l_npq.npq04 = l_api.api06
               END IF
         ...
         IF g_aptype <> '13' THEN
           #LET g_sql="SELECT apb29,apb251,apb26,apb27,apb35,apb36,apb31,",  #MOD-C80065 mark
            LET g_sql="SELECT apb29,apb251,apb26,apb35,apb36,apb31,",        #MOD-C80065
                     #"       apb930,apb32,apb33,"                     ,     #TQC-E20011 mark  #MOD-C50236 aad apb32 #CHI-CC0022 add apb33 
                      "       apb930,apb32,apb27,"                     ,     #TQC-E20011
                      "       SUM(apb10),SUM(apb24)",
                     ...
                     #" GROUP BY apb29,apb251,apb26,apb35,apb36,apb31,apb930,apb32,apb33 ", #TQC-E20011 mark  #MOD-C50236 aad apb32  #MOD-C80065 #CHI-CC0022 add apb33
                      " GROUP BY apb29,apb251,apb26,apb35,apb36,apb31,apb930,apb32,apb27 ", #TQC-E20011
...
#No.FUN-AC0001 --end 
   ...
   IF p_npptype = '0' THEN  #No.FUN-680029 
      IF NOT cl_null(l_apa.apa51) AND l_apa.apa51 != 'UNAP' AND
        ...
        #WHERE apb01=l_apa.apa01 AND apb34='Y' 
        #IF NOT(p_aptype = '13' AND l_cnt>0) THEN
        #FUN-E20008--mark--end
         #FUN-D70077--add--end
        ...
        #LET l_npq.npq04 = l_apa.apa25        #FUN-D10065  mark
         ...
         LET l_apb24_1 = 0  
         LET l_apb24_3 = 0
         LET l_apb10_1 = 0   #MOD-EA0054 add
         SELECT SUM(apb10),SUM(apb24),apb29        #MOD-EA0054 add SUM(apb10)
           INTO l_apb10_1,l_apb24_1,l_apb29_1      #MOD-EA0054 add l_apb10_1
           FROM apb_file
         ...
         IF l_apa.apa57=0 AND l_apb29_1='1' AND l_apb29_3='3' AND l_apb24_1+l_apb24_3=0 THEN
           ...
           #LET l_api05 = l_apb24_1  #借(本幣)   #MOD-EA0054 mark
            LET l_api05 = l_apb10_1  #借(本幣)   #MOD-EA0054 add
            LET l_api05f = l_apb24_1 #借(原幣)
           #LET l_apa.apa33 = l_apb24_1 * -1  #貸(本幣)   #MOD-EA0054 mark
            LET l_apa.apa33 = l_apb10_1 * -1  #貸(本幣)   #MOD-EA0054 add
...
#No.FUN-AC0001 --end 
           ...
           #FUN-D40118 ---Add--- End
            ...
            END IF
         END IF
        #END IF #FUN-D70077  #FUN-E20008 mark
         CALL t110_unap_npq2(p_apno,p_aptype,g_bookno,l_apa.*,'0','1')  #No.TQC-7B0083
      END IF
   ELSE
...
#        LET l_npq.npq07 = cl_digcut(l_npq.npq07,g_azi04)         #FUN-A40067
       # IF l_aag371 MATCHES '[23]' THEN                          #FUN-950053 mark
         IF l_aag371 MATCHES '[234]' THEN                         #FUN-950053 add  
            #-->for 合併報表-關係人
            #CHI-C20040 add brgin---
            IF p_aptype = '15' AND l_npq.npq03 = l_apa.apa54 THEN
               SELECT pmc03,pmc903 INTO l_pmc03,l_pmc903
                 FROM pmc_file
            ...
            #CHI-C20040 add end-----
               SELECT pmc03,pmc903 INTO l_pmc03,l_pmc903
                 FROM pmc_file
                WHERE pmc01 = l_apa.apa05
            END IF   #CHI-C20040 add
            IF cl_null(l_npq.npq37) THEN
               IF l_pmc903 = 'Y' THEN
                  #CHI-C20040 add brgin---
                  IF p_aptype = '15' AND l_npq.npq03 = l_apa.apa54 THEN
                     LET l_npq.npq37 = l_apa.apa06 
                  ELSE
                  #CHI-C20040 add end----- 
                     LET l_npq.npq37 = l_apa.apa05 CLIPPED   #No.CHI-830037
                  END IF    #CHI-C20040 add
...
#-----------------------------------( Dr/Cr: Difference  )---------------------
  ...
  #IF l_apa.apa57>0 AND l_apa.apa33 != 0 AND l_apa.apa56 != '3' THEN #CHI-DC0023 mark
  #IF l_apa.apa33 != 0 AND l_apa.apa56 != '3' THEN #CHI-DC0023            #FUN-HB0002 mark 
   IF l_apa.apa33 != 0 AND l_apa.apa56 != '3' AND g_apz.apz75= 'N' THEN   #FUN-HB0002 add
      LET l_npq.npq02 = l_npq.npq02 + 1
...
#                    "   FROM oov_file LEFT OUTER JOIN apa_file ON oov_file.oov03 = apa_file.apa01 ", #FUN-D80049mark
   ...
   FOREACH t110_gl_c3 INTO l_npq.npq04,l_npq.npq07,l_npq.npq07f,l_npq.npq03,
     ...
     IF g_apz.apz75 = 'Y' AND l_npq.npq04 = 'DIFF' THEN
        CONTINUE FOREACH
     END IF
     #--FUN-HB0002 add end--
     LET l_npq.npq02 = l_npq.npq02 + 1
      ...
      IF l_aag05='Y' THEN
         IF g_aaz.aaz90='N' THEN
            IF cl_null(l_npq.npq05) THEN
               LET l_npq.npq05 = l_apa.apa22
              #MOD-G10098---add---str--
               IF l_apa.apa55 = '2' THEN
                  LET l_npq.npq05 = l_aph.aph10
               END IF
              #MOD-G10098---add---end--
            END IF
         ELSE
...
#No.FUN-AC0001 --end 
    ...
    # LET l_apa.apa34f = l_apa.apa34f - l_apg05f
    # LET l_apa.apa34 = l_apa.apa34 - l_apg05
    ##MOD-F20070---add---end--
    ##-MOD-BB0069-add-
...
#-----------------------------------( Cr: ALW            )---------------------
   IF p_npptype = '0' THEN  #No.FUN-680029
      ...
      IF l_apa.apa51 !='STOCK' AND l_apa.apa51 != 'UNAP' AND                                                                     
        ...
        #IF l_npq.npq07 != 0 AND p_aptype <> '21' THEN  #MOD-D40097            #MOD-DA0095 mark
         IF l_npq.npq07!=0 AND l_apa.apa33 = 0 THEN           #MOD-DA0095      
            LET p_prog = g_prog                       #MOD-C30056 add   
            #No.MOD-BC0264  --Begin
            CASE g_prog
                  WHEN 'aapp110' LET g_prog = 'aapt110'
...
FUNCTION t110_stock_act(p_item,p_ware,p_loc,p_npptype,p_plant)  #No.FUN-680029 新增p_npptype   #FUN-9C0041 add p_plant
 ...
 #DEFINE l_sql     LIKE type_file.chr1000 #FUN-9C0041   #MOD-EA0019 mark
  DEFINE l_sql     STRING                               #MOD-EA0019 add
      ...
      IF l_npq.npq07 != 0 THEN 
       ...
       # CALL s_def_npq(l_npq.npq03,g_prog,l_npq.*,l_npq.npq01,'','',g_bookno)       #No.FUN-730064  #No.FUN-A30077
        ...
        #MOD-GA0036--add--str--
         IF cl_null(l_npq.npq04) THEN
            CASE WHEN g_apz.apz43 = '1' 
                      LET l_npq.npq04 = p_apa.apa06 CLIPPED,' ',p_apa.apa07
                 WHEN g_apz.apz43 = '2'
                      IF p_apa.apa08 = 'MISC' THEN
                         LET l_npq.npq04 = p_apa.apa06,' ',p_apa.apa07,' ',
                                           p_apa.apa01
                      ELSE
                         LET l_npq.npq04 = p_apa.apa06,' ',p_apa.apa07,' ',
                                           p_apa.apa08
     ...
     FOREACH t110_gl_c1x INTO l_api.*
       ...
       #FUN-D10065--mark--end--
        ...
        IF l_api.api26 <> 'DIFF' THEN      #TQC-B10104
          #IF p_aptype[1,1] = '1' THEN                                              #MOD-G30026 mark
           IF p_aptype[1,1] = '1' OR (g_aza.aza26='2' AND g_apy.apydmy6='Y') THEN   #MOD-G30026 add
              LET l_npq.npq06 = '1'
           ELSE
              LET l_npq.npq06 = '2'
           END IF
       ...
       #-TQC-B10104-end-
        ...
        IF l_aag23 = 'Y' THEN
          #LET l_npq.npq08 = l_api.api26    # 專案   #MOD-H50015 mark
           LET l_npq.npq08 = p_apa.apa66             #MOD-H50015 add
           LET l_npq.npq35 = l_api.api35    #CHI-A30003 add
        ELSE
           LET l_npq.npq08 = NULL
           LET l_npq.npq35 = NULL           #CHI-A30003 add
