...
#+ Standard Version.....: SD版次:0018(2017-04-17 14:50:21), PR版次:
...
#170828-00014#1   2017/09/21 By 05423     # add by lixwz180115    执行前判断日期是否小于等于成本关账日期，若是，则不可执行。
...
#            INSERT INTO xcbk_t VALUES(l_xcbk.*)  #161124-00048#21 mark
            ...
            #IF l_xcbk.xcbk202 > l_max_amt THEN            #170808-00032#1
            IF s_math_abs(l_xcbk.xcbk202) > s_math_abs(l_max_amt) THEN  #170808-00032#1
...
#处理尾差结束
   ...
   FOREACH axcp202_xcbj_cur3 INTO l_xcbj.xcbjent,l_xcbj.xcbjcomp,l_xcbj.xcbjld,l_xcbj.xcbj001,l_xcbj.xcbj002,l_xcbj.xcbj003,
      ...
      LET l_xcbk.xcbk004 = l_xcbj.xcbj004
      LET l_xcbk.xcbk005 = l_xcbj.xcbj005
      LET l_xcbk.xcbk006 = 'OH+SUB'         #工單單號
      LET l_xcbk.xcbk007 = l_xcbj.xcbj006
...
#               INSERT INTO xcdq_t VALUES(l_xcdq.*)  #161124-00048#21 mark
               ...
               #IF l_xcdq.xcdq202 > l_max_amt THEN            #170808-00032#1
               IF s_math_abs(l_xcdq.xcdq202) > s_math_abs(l_max_amt) THEN  #170808-00032#1
...
#               INSERT INTO xcdq_t VALUES(l_xcdq.*)  #161124-00048#21 mark
   ...
   #处理尾差结束
      ...
      FOREACH axcp202_xcdr_cur3 INTO l_xcdr.xcdrent,l_xcdr.xcdrcomp,l_xcdr.xcdrld,l_xcdr.xcdr001,l_xcdr.xcdr002,l_xcdr.xcdr003,
         ...
         LET l_xcdq.xcdq004 = l_xcdr.xcdr004
         LET l_xcdq.xcdq005 = l_xcdr.xcdr005
         LET l_xcdq.xcdq006 = 'OH+SUB'         #工單單號
         LET l_xcdq.xcdq007 = l_xcdr.xcdr006
...
PRIVATE FUNCTION axcp202_date_chk(p_comp,p_xcbk002,p_xcbk003)
   ...
   IF l_yy > p_xcbk002 THEN
      #      LET g_errno = 'axc-00303'     #170828-00014#1  # add by lixwz180115 mark
      LET g_errno = 'axr-00162'     #170828-00014#1  # add by lixwz180115 add
   END IF

   #IF l_yy <= p_xcbk002 AND l_pp > p_xcbk003 THEN   #161117-00031#1 mark
   IF l_yy = p_xcbk002 AND l_pp > p_xcbk003 THEN   #161117-00031#1
      #      LET g_errno = 'axc-00304'     #170828-00014#1  # add by lixwz180115 mark
      LET g_errno = 'cxc-00883'     #170828-00014#1  # add by lixwz180115 add
   END IF
END FUNCTION
...
#            INSERT INTO xcbs_t VALUES(l_xcbs.*)  #161124-00048#21 mark
            ...
            #IF l_xcbs.xcbs202 > l_max_amt THEN            #170808-00032#1
            IF s_math_abs(l_xcbs.xcbs202) > s_math_abs(l_max_amt) THEN  #170808-00032#1
...
#               INSERT INTO xcdy_t VALUES(l_xcdy.*)  #161124-00048#21 mark
               ...
               #IF l_xcdy.xcdy202 > l_max_amt THEN            #170808-00032#1
               IF s_math_abs(l_xcdy.xcdy202) > s_math_abs(l_max_amt) THEN  #170808-00032#1
...
#                : r_ooaj006      成本單價小數位數
#                : r_ooaj007      成本金額小數位數
# Date & Author..: 18/01/15 By 07423 # add by lixwz180118 (#180105-00029#1 add)
# Modify.........:
################################################################################
