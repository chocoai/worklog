...
#+ Standard Version.....: SD版次:37(2017-08-03 16:37:22), PR版次:0037(2017-11-29 15:20:07)
#+ Customerized Version.: SD版次:(), PR版次:0000(1900-01-01 00:00:00)
#+ Build......: 000102
#+ Filename...: axcq603
#+ Description: 成本勾稽查詢作業
#+ Creator....: 02294(2016-03-21 13:53:53)
#+ Modifier...: 06969 -SD/PR- 05599
 
{</section>}
 
{<section id="axcq603.global" >}
#應用 q01 樣板自動產生(Version:38)
...
#170406-00009#1   2017/04/10  By lixiang   sql中栏位顺序需一致；明细人工制費项抓取数据的sql需关联条件
#170606-00006#1   2017/06/06  By 02295     在制人工費的抓取需排除委外代买
#170608-00002#1   2017/06/08  By lixiang   cs27的sql中关联ent应关联xccient
#170608-00019#1   2017/06/08  By 02295     在制人工费需加上apcadocdt的日期区间
#170607-00049#1   2017/06/12  By 02295     1.在制人工费这一项中的人工制费如果是走工艺成本，明细应该抓xcbs_t每月工艺成本工时费用分摊统计档中的数据
#                                          2.在制调整这一项如果走工艺成本，明细应该抓xccx_t工艺在制成本本期调整档
#170608-00033#1   2017/07/13  By lixiang   1.拆件投入只抓發料，要加上退料資料。
#                                          2.拆件拆出，加上抓xcck020=106.委外拆件入庫
#170421-00028#1   2017/08/01  By zhoumj    成本勾稽自动查询增加4~9 6个页签，以展示成本详细数据
#170803-00001#1   2017/08/03  By 02295     在抓取人工制费的加工费时不需要将交易币别=本位币，故mark掉
#170816-00009#1   2017/08/17  By 02295     期初资料优先抓取开账资料,抓不到再抓取上期期末资料,但库存期初要以料号,在制期初要以工单来区分是否有开账资料 
#170915-00037#1   2017/09/15  By 02295     原料投入当参数当站下线不影响成本时,需加上当站下线的数量
#170918-00014#1   2017/09/19  By 02295     资料抓取不到时变量值给0
#171017-00035#1   2017/10/19  By 00272     工單單別允許事後報工,當月報工,跨月發料時,異常
#171107-00005#1   2017/11/07  By 05599     半成品投入明细部分需要加上xcck055='3011'当站下线的部分
#171129-00005#1   2017/11/29  By 05599     將列印功能取消
...
PRIVATE TYPE type_g_xckk_d RECORD
   ...
   xckk005 LIKE xckk_t.xckk005
       END RECORD
PRIVATE TYPE type_g_xckk10_d RECORD
       billno1 LIKE type_t.chr20, 
   tdate2 LIKE type_t.dat, 
   custom2 LIKE type_t.chr10, 
   custmdesc2 LIKE type_t.chr500, 
   account2 LIKE type_t.chr30, 
   accdesc2 LIKE type_t.chr100, 
   accamt3 LIKE type_t.num20_6, 
   account3 LIKE type_t.chr30, 
   accdesc3 LIKE type_t.chr100, 
   accamt4 LIKE type_t.num20_6, 
   prog2 LIKE type_t.chr500
       END RECORD
...
PRIVATE TYPE type_g_xckk5_d RECORD
       item LIKE type_t.chr5, 
   customcode LIKE type_t.chr10, 
   customdesc LIKE type_t.chr200, 
   trackingno LIKE type_t.chr20, 
   tseq LIKE type_t.num10, 
   tdate LIKE type_t.dat, 
   num LIKE type_t.num20_6, 
   amt LIKE type_t.num26_10, 
   errmsg LIKE type_t.chr500, 
   prgname LIKE type_t.chr10
       END RECORD
 
PRIVATE TYPE type_g_xckk6_d RECORD
       custom1 LIKE type_t.chr10, 
   custmdesc LIKE type_t.chr500, 
   billno LIKE type_t.chr20, 
   tseq1 LIKE type_t.num10, 
   tdate1 LIKE type_t.dat, 
   imal001 LIKE type_t.chr500, 
   imaal001desc LIKE type_t.chr500, 
   account LIKE type_t.chr30, 
   accdesc LIKE type_t.chr100, 
   costcode LIKE type_t.chr10, 
   caccount LIKE type_t.chr30, 
   caccdesc LIKE type_t.chr100, 
   prog1 LIKE type_t.chr500
       END RECORD
 
PRIVATE TYPE type_g_xckk7_d RECORD
       account1 LIKE type_t.chr30, 
   accdesc1 LIKE type_t.chr100, 
   accamt1 LIKE type_t.num20_6, 
   balamt LIKE type_t.num20_6, 
   bdiff LIKE type_t.num20_6
       END RECORD
 
PRIVATE TYPE type_g_xckk8_d RECORD
       item1 LIKE type_t.chr10, 
   trackingno1 LIKE type_t.chr20, 
   tseq2 LIKE type_t.num10, 
   num2 LIKE type_t.num20_6, 
   tprice LIKE type_t.num20_6, 
   tpamt LIKE type_t.num20_6, 
   outnum LIKE type_t.num20_6, 
   tprice2 LIKE type_t.num20_6, 
   tpamt2 LIKE type_t.num20_6, 
   sourceno LIKE type_t.chr20
       END RECORD
 
PRIVATE TYPE type_g_xckk9_d RECORD
       item2 LIKE type_t.chr10, 
   itemdesc2 LIKE type_t.chr100, 
   accamt2 LIKE type_t.num20_6, 
   outamt LIKE type_t.num20_6, 
   aodiff LIKE type_t.num20_6
       END RECORD
...
DEFINE g_sys_6003   LIKE type_t.chr1    #170607-00049#1
#end add-point
 
#模組變數(Module Variables)
DEFINE g_xckk_d            DYNAMIC ARRAY OF type_g_xckk_d
DEFINE g_xckk_d_t          type_g_xckk_d
DEFINE g_xckk10_d     DYNAMIC ARRAY OF type_g_xckk10_d
DEFINE g_xckk10_d_t   type_g_xckk10_d
...
DEFINE g_xckk5_d     DYNAMIC ARRAY OF type_g_xckk5_d
DEFINE g_xckk5_d_t   type_g_xckk5_d
 
DEFINE g_xckk6_d     DYNAMIC ARRAY OF type_g_xckk6_d
DEFINE g_xckk6_d_t   type_g_xckk6_d
 
DEFINE g_xckk7_d     DYNAMIC ARRAY OF type_g_xckk7_d
DEFINE g_xckk7_d_t   type_g_xckk7_d
 
DEFINE g_xckk8_d     DYNAMIC ARRAY OF type_g_xckk8_d
DEFINE g_xckk8_d_t   type_g_xckk8_d
 
DEFINE g_xckk9_d     DYNAMIC ARRAY OF type_g_xckk9_d
DEFINE g_xckk9_d_t   type_g_xckk9_d
...
PRIVATE FUNCTION axcq603_init()
   ...
   ##170421-00028#1 add s
   CALL cl_set_combo_scc_part('b_item','8062','1,2,3,4')
   CALL cl_set_combo_scc_part('b_item1','8062','5,6')
   
   #170421-00028#1 add e
...
PRIVATE FUNCTION axcq603_ui_dialog() 
   ...
   WHILE li_exit = FALSE
      ...
      IF g_action_choice = "logistics" THEN
         ...
         CLEAR FORM
         CALL g_xckk_d.clear()
         CALL g_xckk10_d.clear()
 
         CALL g_xckk3_d.clear()
 
         CALL g_xckk4_d.clear()
 
         CALL g_xckk5_d.clear()
 
         CALL g_xckk6_d.clear()
 
         CALL g_xckk7_d.clear()
 
         CALL g_xckk8_d.clear()
 
         CALL g_xckk9_d.clear()
      ...
      DIALOG ATTRIBUTES(UNBUFFERED,FIELD ORDER FORM)
         ...
         DISPLAY ARRAY g_xckk_d TO s_detail1.* ATTRIBUTE(COUNT=g_detail_cnt)
            ...
            #  CALL axcq603_detail_action_trans()   #(ver:36) mark
               ...
               CALL axcq603_detail_action_trans()   #(ver:36)
         ...
         DISPLAY ARRAY g_xckk10_d TO s_detail10.*
            ...
            #  DISPLAY g_detail_idx2 TO FORMONLY.idx   #(ver:36) mark
               CALL axcq603_detail_action_trans()   #(ver:36)
         ...
         DISPLAY ARRAY g_xckk5_d TO s_detail5.*
            ATTRIBUTES(COUNT=g_detail_cnt)
         ...
         DISPLAY ARRAY g_xckk6_d TO s_detail6.*
            ATTRIBUTES(COUNT=g_detail_cnt)
         ...
         DISPLAY ARRAY g_xckk7_d TO s_detail7.*
            ATTRIBUTES(COUNT=g_detail_cnt)
         ...
         DISPLAY ARRAY g_xckk8_d TO s_detail8.*
            ATTRIBUTES(COUNT=g_detail_cnt)
         ...
         DISPLAY ARRAY g_xckk9_d TO s_detail9.*
            ATTRIBUTES(COUNT=g_detail_cnt)
            ...
            IF cl_auth_chk_act("exporttoexcel") THEN
               ...
               CASE
                  WHEN lb_get_type = "poi"   #使用poi樣板
                     ...
                     LET l_arr_len = g_xckk_d.getLength()
                     LET g_export_tag[1] = rec_arr_type.create(l_arr_len)
                     LET g_export_tabname[1] = "s_detail1"
                     FOR l_arr_cnt = 1 TO l_arr_len
                        LET g_export_tag[1][l_arr_cnt] = g_xckk_d[l_arr_cnt]
                     END FOR
 
                     LET l_arr_len = g_xckk10_d.getLength()
                     LET g_export_tag[2] = rec_arr_type.create(l_arr_len)
                     LET g_export_tabname[2] = "s_detail10"
                     FOR l_arr_cnt = 1 TO l_arr_len
                        LET g_export_tag[2][l_arr_cnt] = g_xckk10_d[l_arr_cnt]
                     END FOR
 
                     LET l_arr_len = g_xckk3_d.getLength()
                     LET g_export_tag[3] = rec_arr_type.create(l_arr_len)
                     LET g_export_tabname[3] = "s_detail3"
                     FOR l_arr_cnt = 1 TO l_arr_len
                        LET g_export_tag[3][l_arr_cnt] = g_xckk3_d[l_arr_cnt]
                     END FOR
 
                     LET l_arr_len = g_xckk4_d.getLength()
                     LET g_export_tag[4] = rec_arr_type.create(l_arr_len)
                     LET g_export_tabname[4] = "s_detail4"
                     FOR l_arr_cnt = 1 TO l_arr_len
                        LET g_export_tag[4][l_arr_cnt] = g_xckk4_d[l_arr_cnt]
                     END FOR
 
                     LET l_arr_len = g_xckk5_d.getLength()
                     LET g_export_tag[5] = rec_arr_type.create(l_arr_len)
                     LET g_export_tabname[5] = "s_detail5"
                     FOR l_arr_cnt = 1 TO l_arr_len
                        LET g_export_tag[5][l_arr_cnt] = g_xckk5_d[l_arr_cnt]
                     END FOR
 
                     LET l_arr_len = g_xckk6_d.getLength()
                     LET g_export_tag[6] = rec_arr_type.create(l_arr_len)
                     LET g_export_tabname[6] = "s_detail6"
                     FOR l_arr_cnt = 1 TO l_arr_len
                        LET g_export_tag[6][l_arr_cnt] = g_xckk6_d[l_arr_cnt]
                     END FOR
 
                     LET l_arr_len = g_xckk7_d.getLength()
                     LET g_export_tag[7] = rec_arr_type.create(l_arr_len)
                     LET g_export_tabname[7] = "s_detail7"
                     FOR l_arr_cnt = 1 TO l_arr_len
                        LET g_export_tag[7][l_arr_cnt] = g_xckk7_d[l_arr_cnt]
                     END FOR
 
                     LET l_arr_len = g_xckk8_d.getLength()
                     LET g_export_tag[8] = rec_arr_type.create(l_arr_len)
                     LET g_export_tabname[8] = "s_detail8"
                     FOR l_arr_cnt = 1 TO l_arr_len
                        LET g_export_tag[8][l_arr_cnt] = g_xckk8_d[l_arr_cnt]
                     END FOR
 
                     LET l_arr_len = g_xckk9_d.getLength()
                     LET g_export_tag[9] = rec_arr_type.create(l_arr_len)
                     LET g_export_tabname[9] = "s_detail9"
                     FOR l_arr_cnt = 1 TO l_arr_len
                        LET g_export_tag[9][l_arr_cnt] = g_xckk9_d[l_arr_cnt]
                     END FOR
               ...
               #(ver:38) --- end ---
                     ...
                     LET g_export_node[2] = base.typeInfo.create(g_xckk10_d)
                     ...
                     LET g_export_node[5] = base.typeInfo.create(g_xckk5_d)
                     LET g_export_id[5]   = "s_detail5"
 
                     LET g_export_node[6] = base.typeInfo.create(g_xckk6_d)
                     LET g_export_id[6]   = "s_detail6"
 
                     LET g_export_node[7] = base.typeInfo.create(g_xckk7_d)
                     LET g_export_id[7]   = "s_detail7"
 
                     LET g_export_node[8] = base.typeInfo.create(g_xckk8_d)
                     LET g_export_id[8]   = "s_detail8"
 
                     LET g_export_node[9] = base.typeInfo.create(g_xckk9_d)
...
PRIVATE FUNCTION axcq603_b_fill()
   ...
   LET ls_sql_rank = "SELECT  UNIQUE '','','',xckk101,xckk102,xckk103,xckk104,xckk105,xckk106,xckk090, 
       ...
       '','','','','','','','','','','','','','','','','','','','',''  ,DENSE_RANK() OVER( ORDER BY xckk_t.xckkld, 
       xckk_t.xckk001,xckk_t.xckk002,xckk_t.xckk003,xckk_t.xckk004,xckk_t.xckk005) AS RANK FROM xckk_t", 
...
#                "                xckk101,xckk102,xckk103,xckk104,xckk105,xckk106,xckk090, ",
   ...
   FOREACH b_fill_curs INTO g_xckk_d[l_ac].sel,g_xckk_d[l_ac].gzcb012,g_xckk_d[l_ac].xckk005_desc,g_xckk_d[l_ac].xckk101, 
       ...
       g_xckk_d[l_ac].xckk106h,g_xckk_d[l_ac].xckk005,g_xckk10_d[l_ac].billno1,g_xckk10_d[l_ac].tdate2, 
       g_xckk10_d[l_ac].custom2,g_xckk10_d[l_ac].custmdesc2,g_xckk10_d[l_ac].account2,g_xckk10_d[l_ac].accdesc2, 
       g_xckk10_d[l_ac].accamt3,g_xckk10_d[l_ac].account3,g_xckk10_d[l_ac].accdesc3,g_xckk10_d[l_ac].accamt4, 
       g_xckk10_d[l_ac].prog2,g_xckk6_d[l_ac].custom1,g_xckk6_d[l_ac].custmdesc,g_xckk6_d[l_ac].billno, 
       g_xckk6_d[l_ac].tseq1,g_xckk6_d[l_ac].tdate1,g_xckk6_d[l_ac].imal001,g_xckk6_d[l_ac].imaal001desc, 
       g_xckk6_d[l_ac].account,g_xckk6_d[l_ac].accdesc,g_xckk6_d[l_ac].costcode,g_xckk6_d[l_ac].caccount, 
       g_xckk6_d[l_ac].caccdesc,g_xckk6_d[l_ac].prog1,g_xckk7_d[l_ac].account1,g_xckk7_d[l_ac].accdesc1, 
       g_xckk7_d[l_ac].accamt1,g_xckk7_d[l_ac].balamt,g_xckk7_d[l_ac].bdiff,g_xckk8_d[l_ac].item1,g_xckk8_d[l_ac].trackingno1, 
       g_xckk8_d[l_ac].tseq2,g_xckk8_d[l_ac].num2,g_xckk8_d[l_ac].tprice,g_xckk8_d[l_ac].tpamt,g_xckk8_d[l_ac].outnum, 
       g_xckk8_d[l_ac].tprice2,g_xckk8_d[l_ac].tpamt2,g_xckk8_d[l_ac].sourceno,g_xckk9_d[l_ac].item2, 
       g_xckk9_d[l_ac].itemdesc2,g_xckk9_d[l_ac].accamt2,g_xckk9_d[l_ac].outamt,g_xckk9_d[l_ac].aodiff 
   ...
   CALL g_xckk10_d.deleteElement(g_xckk10_d.getLength())
 
   CALL g_xckk6_d.deleteElement(g_xckk6_d.getLength())
 
   CALL g_xckk7_d.deleteElement(g_xckk7_d.getLength())
 
   CALL g_xckk8_d.deleteElement(g_xckk8_d.getLength())
 
   CALL g_xckk9_d.deleteElement(g_xckk9_d.getLength())
...
#   
   ...
   CALL axcq603_b_fill_5()  #170421-00028#1 add
...
#                                 ,g_xckk_d[g_detail_idx].xckk005
   ...
   FOREACH b_fill_curs2
      ...
      INTO g_xckk3_d[l_ac].gzcb012,g_xckk3_d[l_ac].xckl005_desc,g_xckk3_d[l_ac].xckl007,g_xckk3_d[l_ac].xckl007_desc, 
          ...
          g_xckk4_d[l_ac].xckl104h,g_xckk4_d[l_ac].xckl106h,g_xckk4_d[l_ac].xckl005,g_xckk5_d[l_ac].item, 
          g_xckk5_d[l_ac].customcode,g_xckk5_d[l_ac].customdesc,g_xckk5_d[l_ac].trackingno,g_xckk5_d[l_ac].tseq, 
          g_xckk5_d[l_ac].tdate,g_xckk5_d[l_ac].num,g_xckk5_d[l_ac].amt,g_xckk5_d[l_ac].errmsg,g_xckk5_d[l_ac].prgname 
...
#Page5
   CALL g_xckk5_d.deleteElement(g_xckk5_d.getLength())
...
PRIVATE FUNCTION axcq603_detail_action_trans()
   ...
   ELSE
      IF g_xckk_d.getLength() > 0 THEN
         DISPLAY g_current_row_tot TO FORMONLY.h_index
         DISPLAY g_xckk_d.getLength() TO FORMONLY.h_count
      ELSE
   ...
   IF g_detail_idx2 > g_xckk3_d.getLength() THEN
      LET g_detail_idx2 = g_xckk3_d.getLength()
   END IF
   IF g_detail_idx2 = 0 AND g_xckk3_d.getLength() <> 0 THEN
      LET g_detail_idx2 = 1
   END IF
   IF g_xckk3_d.getLength() > 0 THEN
      DISPLAY g_detail_idx2 TO FORMONLY.idx
      DISPLAY g_xckk3_d.getLength() TO FORMONLY.cnt
   ELSE
      DISPLAY '' TO FORMONLY.idx
      DISPLAY '' TO FORMONLY.cnt
   END IF
 
   IF g_detail_idx2 > g_xckk4_d.getLength() THEN
      LET g_detail_idx2 = g_xckk4_d.getLength()
   END IF
   IF g_detail_idx2 = 0 AND g_xckk4_d.getLength() <> 0 THEN
      LET g_detail_idx2 = 1
   END IF
   IF g_xckk4_d.getLength() > 0 THEN
      DISPLAY g_detail_idx2 TO FORMONLY.idx
      DISPLAY g_xckk4_d.getLength() TO FORMONLY.cnt
   ELSE
      DISPLAY '' TO FORMONLY.idx
      DISPLAY '' TO FORMONLY.cnt
   END IF
 
   IF g_detail_idx2 > g_xckk5_d.getLength() THEN
      LET g_detail_idx2 = g_xckk5_d.getLength()
   END IF
   IF g_detail_idx2 = 0 AND g_xckk5_d.getLength() <> 0 THEN
      LET g_detail_idx2 = 1
   END IF
   IF g_xckk5_d.getLength() > 0 THEN
      DISPLAY g_detail_idx2 TO FORMONLY.idx
      DISPLAY g_xckk5_d.getLength() TO FORMONLY.cnt
   ELSE
      DISPLAY '' TO FORMONLY.idx
      DISPLAY '' TO FORMONLY.cnt
   END IF
...
#   IF NOT axcq603_ins_xckk(l_xckk.*) THEN   #161109-00085#26-s mark
   ...
   IF SQLCA.sqlcode <> 0 AND SQLCA.sqlcode <> 100 THEN
      ...
      RETURN r_success
   END IF
   #170918-00014#1---add---s
   IF cl_null(l_xckk.xckk103)  THEN LET l_xckk.xckk103 = 0 END IF
   IF cl_null(l_xckk.xckk104)  THEN LET l_xckk.xckk104 = 0 END IF
   IF cl_null(l_xckk.xckk104a) THEN LET l_xckk.xckk104a = 0 END IF
   IF cl_null(l_xckk.xckk104b) THEN LET l_xckk.xckk104b = 0 END IF
   IF cl_null(l_xckk.xckk104c) THEN LET l_xckk.xckk104c = 0 END IF
   IF cl_null(l_xckk.xckk104d) THEN LET l_xckk.xckk104d = 0 END IF
   IF cl_null(l_xckk.xckk104e) THEN LET l_xckk.xckk104e = 0 END IF
   IF cl_null(l_xckk.xckk104f) THEN LET l_xckk.xckk104f = 0 END IF
   IF cl_null(l_xckk.xckk104g) THEN LET l_xckk.xckk104g = 0 END IF
   IF cl_null(l_xckk.xckk104h) THEN LET l_xckk.xckk104h = 0 END IF    
   #170918-00014#1---add---e   
   #170816-00009#1---mark---s
   ##抓不到抓上期的xcca的数据和金额
   ...
   #   LET g_source = 'xcca'      #標記明細表的來源   
   #END IF
   #170816-00009#1---mark---e
   #170816-00009#1---add---s
   SELECT SUM((CASE WHEN xccc901 IS NULL THEN 0 ELSE xccc901 END)),  SUM((CASE WHEN xccc902 IS NULL THEN 0 ELSE xccc902 END)), 
          SUM((CASE WHEN xccc902a IS NULL THEN 0 ELSE xccc902a END)),SUM((CASE WHEN xccc902b IS NULL THEN 0 ELSE xccc902b END)),
          SUM((CASE WHEN xccc902c IS NULL THEN 0 ELSE xccc902c END)),SUM((CASE WHEN xccc902d IS NULL THEN 0 ELSE xccc902d END)),
          SUM((CASE WHEN xccc902e IS NULL THEN 0 ELSE xccc902e END)),SUM((CASE WHEN xccc902f IS NULL THEN 0 ELSE xccc902f END)),
   ...
   WHERE xcccent = g_enterprise AND xcccld = g_master.xckkld AND xccccomp = g_master.xckkcomp
     ...
     AND NOT EXISTS(SELECT 1 FROM xcca_t 
                     WHERE xccaent = g_enterprise AND xccald = g_master.xckkld AND xccacomp = g_master.xckkcomp
                       AND xcca001 = g_master.xckk001 AND xcca003 = g_master.xckk002 
                       AND xcca004 = g_previous_xckk003 AND xcca005 = g_previous_xckk004
                       AND xcca006 = xccc006 AND xcca007 = xcca007 AND xcca008 = xccc008 )
   IF SQLCA.sqlcode <> 0 AND SQLCA.sqlcode <> 100 THEN
      INITIALIZE g_errparam TO NULL 
      LET g_errparam.extend = "xcca_t:2"
      LET g_errparam.code   = SQLCA.sqlcode 
      ...
      RETURN r_success
   END IF   
   IF cl_null(l_xckk103) THEN LET l_xckk103 = 0 END IF
   IF cl_null(l_xckk104) THEN LET l_xckk104 = 0 END IF
   IF cl_null(l_xckk104a) THEN LET l_xckk104a = 0 END IF
   IF cl_null(l_xckk104b) THEN LET l_xckk104b = 0 END IF
   IF cl_null(l_xckk104c) THEN LET l_xckk104c = 0 END IF
   IF cl_null(l_xckk104d) THEN LET l_xckk104d = 0 END IF
   IF cl_null(l_xckk104e) THEN LET l_xckk104e = 0 END IF
   IF cl_null(l_xckk104f) THEN LET l_xckk104f = 0 END IF
   IF cl_null(l_xckk104g) THEN LET l_xckk104g = 0 END IF
   IF cl_null(l_xckk104h) THEN LET l_xckk104h = 0 END IF 
...
#   IF NOT axcq603_ins_xckk(l_xckk.*) THEN   #161109-00085#26-s mark
   ...
   IF cl_null(l_xckk.xckk104g) THEN LET l_xckk.xckk104g = 0 END IF
   IF cl_null(l_xckk.xckk104h) THEN LET l_xckk.xckk104h = 0 END IF
   #170406-00009#1 add ----- (E)
   
   #当站下线是否影响成本，为Y时，加上当站下线的成本
   #IF cl_get_para(g_enterprise,g_site,'S-FIN-6006') = 'Y' THEN  #170406-00009#1 mark
   IF cl_get_para(g_enterprise,g_site,'S-FIN-6016') = 'Y' THEN   #170406-00009#1 add
      #明细表抓xcck的当站下线的数量和金额
...
#   IF NOT axcq603_ins_xckk(l_xckk.*) THEN   #161109-00085#26-s mark
   ...
   SELECT SUM((CASE WHEN xcce901 IS NULL THEN 0 ELSE xcce901 END)),  SUM((CASE WHEN xcce902 IS NULL THEN 0 ELSE xcce902 END)), 
    ...
    WHERE xcceent = g_enterprise AND xcceld = g_master.xckkld AND xccecomp = g_master.xckkcomp
      AND xcce001 = g_master.xckk001 AND xcce003 = g_master.xckk002 
      AND xcce004 = g_previous_xckk003 AND xcce005 = g_previous_xckk004
      AND NOT EXISTS(SELECT 1 FROM xccb_t,sfaa_t 
                     WHERE xccbent = g_enterprise AND xccbld = g_master.xckkld AND xccbcomp = g_master.xckkcomp
                       AND xccb001 = g_master.xckk001 AND xccb003 = g_master.xckk002 
                       AND xccb004 = g_previous_xckk003 AND xccb005 = g_previous_xckk004
                       AND xccbent = sfaaent AND xccb006 = sfaadocno AND sfaa003 <> '3' 
                       AND xccb006 = xcce006 )
   IF SQLCA.sqlcode <> 0 AND SQLCA.sqlcode <> 100 THEN
      INITIALIZE g_errparam TO NULL 
      LET g_errparam.extend = "xcca_t:2"
...
#   IF NOT axcq603_ins_xckk(l_xckk.*) THEN   #161109-00085#26-s mark
   ...
   SELECT SUM(xcce201+xcce205+xcce207+xcce209)*-1,    SUM(xcce202+xcce206+xcce208+xcce210)*-1,
          SUM(xcce202a+xcce206a+xcce208a+xcce210a)*-1,SUM(xcce202b+xcce206b+xcce208b+xcce210b)*-1,
	       SUM(xcce202c+xcce206c+xcce208c+xcce210c)*-1,SUM(xcce202d+xcce206d+xcce208d+xcce210d)*-1,
          SUM(xcce202e+xcce206e+xcce208e+xcce210e)*-1,SUM(xcce202f+xcce206f+xcce208f+xcce210f)*-1,
	       SUM(xcce202g+xcce206g+xcce208g+xcce210g)*-1,SUM(xcce202h+xcce206h+xcce208h+xcce210h)*-1	
   #170406-00009#1--modify---e	       
   #161031-00037#1---e   
      INTO l_xckk.xckk101, l_xckk.xckk102, l_xckk.xckk102a,l_xckk.xckk102b,l_xckk.xckk102c,
           l_xckk.xckk102d,l_xckk.xckk102e,l_xckk.xckk102f,l_xckk.xckk102g,l_xckk.xckk102h
  ...
  #LET l_sql2 = l_sql1 , " AND xcck055 = '3012' AND xcck020 <> '113'"  #xcck里的工单发料，排除拆件  #160531-00032#1 #170216-00080#1 mark 
   LET l_sql2 = l_sql1 , " AND xcck055 IN ('3012','207','3011') AND xcck020 <> '113'"  #xcck里的工单发料，排除拆件 #170216-00080#1 add   #170915-00037#1 add 3011
   ...
   LET l_sql2 = l_sql2 , " AND NOT EXISTS(SELECT 1 FROM sfaa_t WHERE sfaaent = xcckent AND xcck047 = sfaadocno AND sfaa003 ='3' )" #170406-00009#1---add
...
#   IF NOT axcq603_ins_xckk(l_xckk.*) THEN   #161109-00085#26-s mark
   ...
   SELECT SUM(CASE imaa004 WHEN 'A' THEN xcce201+xcce205+xcce207+xcce209 ELSE 0 END)*-1,    SUM(CASE imaa004 WHEN 'A' THEN xcce202+xcce206+xcce208+xcce210 ELSE 0 END)*-1,
          SUM(CASE imaa004 WHEN 'A' THEN xcce202a+xcce206a+xcce208a+xcce210a ELSE 0 END)*-1,SUM(CASE imaa004 WHEN 'A' THEN xcce202b+xcce206b+xcce208b+xcce210b ELSE 0 END)*-1,
	       SUM(CASE imaa004 WHEN 'A' THEN xcce202c+xcce206c+xcce208c+xcce210c ELSE 0 END)*-1,SUM(CASE imaa004 WHEN 'A' THEN xcce202d+xcce206d+xcce208d+xcce210d ELSE 0 END)*-1,
          SUM(CASE imaa004 WHEN 'A' THEN xcce202e+xcce206e+xcce208e+xcce210e ELSE 0 END)*-1,SUM(CASE imaa004 WHEN 'A' THEN xcce202f+xcce206f+xcce208f+xcce210f ELSE 0 END)*-1,
	       SUM(CASE imaa004 WHEN 'A' THEN xcce202g+xcce206g+xcce208g+xcce210g ELSE 0 END)*-1,SUM(CASE imaa004 WHEN 'A' THEN xcce202h+xcce206h+xcce208h+xcce210h ELSE 0 END)*-1
   #170406-00009#1--modify---e    
      INTO l_xckk.xckk101, l_xckk.xckk102, l_xckk.xckk102a,l_xckk.xckk102b,l_xckk.xckk102c,
           l_xckk.xckk102d,l_xckk.xckk102e,l_xckk.xckk102f,l_xckk.xckk102g,l_xckk.xckk102h
   FROM xcce_t,imaa_t  
   ...
   LET l_sql2 = l_sql1 , " AND xcck055 IN ('207','3012','3011') AND xcck020 <> '113'"  #xcck里的工单发料，排除拆件   #160531-00032#1  #161031-00037#1  #171107-00005#1 add 3011
                       ,"  AND NOT EXISTS(SELECT 1 FROM sfaa_t WHERE sfaaent=xcckent AND sfaadocno=xcck047 AND sfaa003 = '3' )" #170406-00009#1---add
...
#   IF NOT axcq603_ins_xckk(l_xckk.*) THEN   #161109-00085#26-s mark
   ...
   #明细表抓xcbk的非拆件工单人工金额
   LET l_xckk.xckk103 = 0
   #170607-00049#1---add---s
   LET g_sys_6003 = cl_get_para(g_enterprise,g_master.xckkcomp,'S-FIN-6003')   #系统参数[S-FIN-6003]:按製程算成本
   IF g_sys_6003 = 'Y' THEN
      CASE g_master.xckk001 
         WHEN '1'  #本位币一
            LET l_sql = " SELECT SUM(xcbs202) "
         WHEN '2'  #本位币二
            LET l_sql = " SELECT SUM(xcbs212) "
         WHEN '3'  #本位币三
            LET l_sql = " SELECT SUM(xcbs222) "
         OTHERWISE
            LET l_sql = " SELECT SUM(xcbs202) "
      END CASE
      LET l_sql = l_sql, " FROM xcbs_t,sfaa_t ",  
                  "   WHERE xcbsent = '",g_enterprise,"' AND xcbsld = '",g_master.xckkld,"' ",
                  "     AND xcbscomp = '",g_master.xckkcomp,"' AND xcbs001 = '",g_master.xckk002,"' ",
                  "     AND xcbs002 = ",g_master.xckk003," AND xcbs003 = ",g_master.xckk004,
                  "     AND xcbsent = sfaaent AND xcbs006 = sfaadocno AND sfaa003 <> '3' ", #非拆件工单  
                  "     AND xcbs005 = ? "      
   ELSE
   #170607-00049#1---add---e    
      CASE g_master.xckk001 
        #171017-00035#1----mark---str---
        #WHEN '1'  #本位币一
        ...
        #OTHERWISE
        #   LET l_sql = " SELECT SUM(xcbk202) "
        #171017-00035#1----mark---end---
        #171017-00035#1----add----str---
         WHEN '1'  #本位币一
            LET l_sql = " SELECT SUM(xcbk202) FROM xcce_t LEFT JOIN (SELECT xcbkent, xcbk006, SUM(xcbk202) xcbk202 "
         WHEN '2'  #本位币二
            LET l_sql = " SELECT SUM(xcbk202) FROM xcce_t LEFT JOIN (SELECT xcbkent, xcbk006, SUM(xcbk212) xcbk202 "
         WHEN '3'  #本位币三
            LET l_sql = " SELECT SUM(xcbk202) FROM xcce_t LEFT JOIN (SELECT xcbkent, xcbk006, SUM(xcbk222) xcbk202 "
         OTHERWISE
            LET l_sql = " SELECT SUM(xcbk202) FROM xcce_t LEFT JOIN (SELECT xcbkent, xcbk006, SUM(xcbk202) xcbk202 "
        #171017-00035#1----add----end---
      END CASE
      LET l_sql = l_sql, " FROM xcbk_t,sfaa_t ",  
                  ...
                  "     AND xcbk005 = ? "
                 #171017-00035#1---add-------str---
                 ,"   GROUP BY xcbkent, xcbk006) ",
                  "   ON xcbkent = xcceent AND xcbk006 = xcce006 ",
  ...
  #170216-00080#1 ---add (s)---
   ...
   LET l_sql = l_sql, " FROM apca_t,apcb_t,pmds_t,pmdt_t,pmdp_t,sfaa_t ", 
                      ...
                      "   AND pmds000 IN ('12','14','20') AND pmds011 = '2'  AND pmdsstus = 'S' ",
                      "   AND pmds001 BETWEEN '",g_bdate,"' AND '",g_edate,"' ",   
                      "   AND apcadocdt BETWEEN '",g_bdate,"' AND '",g_edate,"' ",     #170608-00019#1
                      #"   AND pmds037 = '",g_curr,"'",    #170803-00001#1 mark
                      "   AND pmdt005 <> '8' ", #170606-00006#1                     
                      "   AND apcaent = ",g_enterprise,
                      "   AND apcald = '",g_master.xckkld,"'",
                      "   AND apcastus = 'Y' AND apcb001 IN ('11','21') ",
                      "   AND apcb023 = 'N'AND pmdt001 IS NOT NULL ",
...
#   IF NOT axcq603_ins_xckk(l_xckk.*) THEN   #161109-00085#26-s mark
   ...
   IF g_sys_6003 = 'Y' THEN 
      #明细表抓xccx的非拆件工单的金额   
      SELECT SUM((CASE WHEN xccx101 IS NULL THEN 0  ELSE xccx101 END)), SUM((CASE WHEN xccx102 IS NULL THEN 0  ELSE xccx102 END)), 
             SUM((CASE WHEN xccx102a IS NULL THEN 0 ELSE xccx102a END)),SUM((CASE WHEN xccx102b IS NULL THEN 0 ELSE xccx102b END)),
             SUM((CASE WHEN xccx102c IS NULL THEN 0 ELSE xccx102c END)),SUM((CASE WHEN xccx102d IS NULL THEN 0 ELSE xccx102d END)),
             SUM((CASE WHEN xccx102e IS NULL THEN 0 ELSE xccx102e END)),SUM((CASE WHEN xccx102f IS NULL THEN 0 ELSE xccx102f END)),
             SUM((CASE WHEN xccx102g IS NULL THEN 0 ELSE xccx102g END)),SUM((CASE WHEN xccx102h IS NULL THEN 0 ELSE xccx102h END))
         INTO l_xckk.xckk103, l_xckk.xckk104, l_xckk.xckk104a,l_xckk.xckk104b,l_xckk.xckk104c,
              l_xckk.xckk104d,l_xckk.xckk104e,l_xckk.xckk104f,l_xckk.xckk104g,l_xckk.xckk104h
      FROM xccx_t,sfaa_t
      WHERE xccxent = g_enterprise AND xccxld = g_master.xckkld AND xccxcomp = g_master.xckkcomp
        AND xccx001 = g_master.xckk001 AND xccx003 = g_master.xckk002 
        AND xccx004 = g_master.xckk003 AND xccx005 = g_master.xckk004
        AND xccxent = sfaaent AND xccx007 = sfaadocno AND sfaa003 <> '3'  #非拆件工单   
   ELSE
   #170607-00049#1---add---e   
      #明细表抓xccp的非拆件工单的金额   
...
#   IF NOT axcq603_ins_xckk(l_xckk.*) THEN   #161109-00085#26-s mark
   ...
   #170210-00001#1--add--start--
   #LET l_sql2 = l_sql1 , " AND xcck055 = '207' AND xcck020 = '302' ",   #170608-00033#1 mark
   LET l_sql2 = l_sql1 , " AND xcck055 = '207' AND (xcck020 = '302' OR xcck020 = '303') ",   #170608-00033#1 add #加上退料的部分	 
...
#   IF NOT axcq603_ins_xckk(l_xckk.*) THEN   #161109-00085#26-s mark
   ...
   #LET l_sql2 = l_sql2 , " AND xcck055 = '205' "  #入库  #161031-00037#1
   #LET l_sql2 = l_sql2 , " AND xcck055 = '3012' AND xcck020 = '113' "  #入库  #161031-00037#1 #170608-00033#1 mark
   LET l_sql2 = l_sql2 , " AND xcck055 = '3012' AND (xcck020 = '113' OR xcck020 = '106') "  #入库  #161031-00037#1 #170608-00033#1 add #委外拆件入庫
...
DEFINE l_sql_h      STRING 
   ...
   CASE l_xckl.xckl005 
      ...
      WHEN '216'
         LET l_sql_1 = " INSERT INTO xckl_t (xcklent,xcklcomp,xcklld,             ",
                     ...
                     "        SUM(xckl104a) xckl104a,SUM(xckl104b) xckl104b,SUM(xckl104c) xckl104c,SUM(xckl104d) xckl104d,",
                     "        SUM(xckl104e) xckl104e,SUM(xckl104f) xckl104f,SUM(xckl104g) xckl104g,SUM(xckl104h) xckl104h,",
                     "        (SUM(xckl101)-CASE WHEN SUM(xckl103) < 0 THEN SUM(xckl103) *-1 ELSE SUM(xckl103) END) xckl105,(SUM(xckl102)-CASE WHEN SUM(xckl104) < 0 THEN SUM(xckl104) *-1 ELSE SUM(xckl104) END) xckl106,                    ",
                     "        (SUM(xckl102a)-CASE WHEN SUM(xckl104a) < 0 THEN SUM(xckl104a) ELSE SUM(xckl104a) END) xckl106a,(SUM(xckl102b)-CASE WHEN SUM(xckl104b) < 0 THEN SUM(xckl104b) * -1 ELSE SUM(xckl104b) END) xckl106b,(SUM(xckl102c)-CASE WHEN SUM(xckl104c) < 0 THEN SUM(xckl104c) * -1 ELSE SUM(xckl104c) END) xckl106c,(SUM(xckl102d)- CASE WHEN SUM(xckl104d) < 0 THEN SUM(xckl104d) * -1 ELSE SUM(xckl104d) END) xckl106d, ",
                     "        (SUM(xckl102e)- CASE WHEN SUM(xckl104e)< 0 THEN SUM(xckl104e) * -1 ELSE SUM(xckl104e) END) xckl106e,(SUM(xckl102f)-CASE WHEN SUM(xckl104f) < 0 THEN SUM(xckl104f) * -1 ELSE SUM(xckl104f) END) xckl106f,(SUM(xckl102g)-CASE WHEN SUM(xckl104g) < 0 THEN SUM(xckl104g) * -1 ELSE SUM(xckl104g) END) xckl106g,(SUM(xckl102h)-CASE WHEN SUM(xckl104h) < 0 THEN SUM(xckl104h) * -1 ELSE SUM(xckl104h) END) xckl106h  ",
                     "   FROM  ( "
         LET l_sql_2 = " ) ",                           
   ...
   LET l_sql_3 = " INSERT INTO xckl_t (xcklent,xcklcomp,xcklld,         ",
                 ...
                 " SELECT ",g_enterprise," ,'",g_master.xckkcomp,"', '",g_master.xckkld,"',  ",
                 "       '",g_master.xckk001,"','",g_master.xckk002,"',",g_master.xckk003," , ",g_master.xckk004," , ",
                #"         ? , ",  #l_xckl.xckl005   #170406-00009#1 
                 "        '",l_xckl.xckl005,"', ",  #170406-00009#1 
                 "        (CASE WHEN xckl006 IS NULL THEN ' ' ELSE xckl006 END), xckl007, ",
                 "        (CASE WHEN xckl008 IS NULL THEN ' ' ELSE xckl008 END),(CASE WHEN xckl009  IS NULL THEN ' ' ELSE xckl009 END),",
                 "        (CASE WHEN xckl010  IS NULL THEN ' ' ELSE xckl010 END), ",
                #"         ? , ",  #l_xckl.xckl090   #170406-00009#1
                 "        '",l_xckl.xckl090,"' , ",   #170406-00009#1
                 "      SUM(xckl101) xckl101,SUM(xckl102) xckl102, ",
                 "      SUM(xckl102a) xckl102a,SUM(xckl102b) xckl102b,SUM(xckl102c) xckl102c,SUM(xckl102d) xckl102d,",
                 "      SUM(xckl102e) xckl102e,SUM(xckl102f) xckl102f,SUM(xckl102g) xckl102g,SUM(xckl102h) xckl102h,",
                #"        SUM(xckl101)*(-1) xckl103,SUM(xckl104) xckl104,   ",  #170406-00009#1
                 "       SUM(xckl103) xckl103,SUM(xckl104) xckl104,  ", #170406-00009#1
                 "       SUM(xckl104a) xckl104a,SUM(xckl104b) xckl104b,SUM(xckl104c) xckl104c,SUM(xckl104d) xckl104d,",
                 "       SUM(xckl104e) xckl104e,SUM(xckl104f) xckl104f,SUM(xckl104g) xckl104g,SUM(xckl104h) xckl104h,",
                 "       (SUM(xckl101)-SUM(xckl103)) xckl105,(SUM(xckl102)-SUM(xckl104)) xckl106,  ",
                 "       (SUM(xckl102a)-SUM(xckl104a)) xckl106a,(SUM(xckl102b)-SUM(xckl104b)) xckl106b,(SUM(xckl102c)-SUM(xckl104c)) xckl106c,(SUM(xckl102d)-SUM(xckl104d)) xckl106d, ",
   ...
   CASE l_xckl.xckl005
     ...
     WHEN '101'          #库存期初
         ...
         LET l_sub_sql = l_sub_sql , " SELECT xccc002 xckl010,xccc006 xckl007,xccc007 xckl008,xccc008 xckl009, ' ' xckl006 , ",    
                                     ...
                                     #170816-00009#1---add---e                                     
                                     "   GROUP BY xccc002,xccc006,xccc007,xccc008   "
         #ELSE       #170816-00009#1 mark 
         LET l_sub_sql = l_sub_sql,  " UNION "    #170816-00009#1 add     
      ...
      WHEN '216'         #原料投入
         LET l_sub_sql = " SELECT xcce002 xckl010,xcce006 xckl006,xcce007 xckl007,xcce008 xckl008,xcce009 xckl009,",
                         ...
                         "   GROUP BY xcce002,xcce006,xcce007,xcce008,xcce009   ",
                         "  UNION ",
                         #" SELECT xcck002 xckl010,xcck010 xckl007,xcck011 xckl008,xcck017 xckl009,xcck047 xckl006 , ",    #170406-00009#1
                         " SELECT xcck002 xckl010,xcck047 xckl006,xcck010 xckl007,xcck011 xckl008,xcck017 xckl009 , ",    #170406-00009#1
                         "        0 xckl101,0 xckl102,                                                          ",
                         "        0 xckl102a,0 xckl102b,0 xckl102c,0 xckl102d,                                  ",
                         "        0 xckl102e,0 xckl102f,0 xckl102g,0 xckl102h,                                  ",
                         "        SUM((CASE WHEN xcck201  IS NULL THEN 0 ELSE xcck201  END)* xcck009) xckl103,  ",
                         ...
                         "    AND xcck004 = ",g_master.xckk003,
                         "    AND xcck005 = ",g_master.xckk004,
                         #"    AND xcck055 = '3012' AND xcck020 <> '113' ",   #170406-00009#1
                         "    AND (xcck055 = '3012' OR xcck055 = '207' OR xcck055 = '3011') AND xcck020 <> '113' ",   #170406-00009#1  #170915-00037#1 add 3011
                         "    AND xcck010 IN (SELECT imaa001 FROM imaa_t WHERE imaaent = '",g_enterprise,"' AND imaa004  <> 'A') AND xcck010 <> 'DL+OH+SUB' " ,
                         "    AND NOT EXISTS(SELECT 1 FROM sfaa_t WHERE sfaaent = xcckent AND xcck047 = sfaadocno AND sfaa003 ='3' )",  #170406-00009#1---add
      ...
      WHEN '217'         #半成品投入
         LET l_sub_sql = " SELECT xcce002 xckl010,xcce006 xckl006,xcce007 xckl007,xcce008 xckl008,xcce009 xckl009,",
                         ...
                         "    AND xcck004 = ",g_master.xckk003,
                         "    AND xcck005 = ",g_master.xckk004,
                         "    AND xcck055 IN ('207','3012','3011') AND xcck020 <> '113' ",   #171107-00005#1 add 3011
                         "    AND xcck010 IN (SELECT imaa001 FROM imaa_t WHERE imaaent = '",g_enterprise,"' AND imaa004  = 'A') AND xcck010 <> 'DL+OH+SUB' " ,
                         "  AND NOT EXISTS(SELECT 1 FROM sfaa_t WHERE sfaaent=xcckent AND sfaadocno=xcck047 AND sfaa003 = '3' )",    #170406-00009#1---add
                         "  GROUP BY xcck002,xcck010,xcck011,xcck017,xcck047   "
         LET l_sql = l_sql_1 , l_sub_sql , l_sql_2
      ...
      WHEN '200'         #在制人工费
         ...
         IF g_sys_6003 = 'Y' THEN
            ...
            CASE g_master.xckk001 
               WHEN '1'  #本位币一
                  LET l_sql = " SELECT xcbsent xcbkent,xcbs006 xcbk006,SUM(xcbs202) xcbk202 " 
               WHEN '2'  #本位币二                                              
                  LET l_sql = " SELECT xcbsent xcbkent,xcbs006 xcbk006,SUM(xcbs212) xcbk202 " 
               WHEN '3'  #本位币三                                              
                  LET l_sql = " SELECT xcbsent xcbkent,xcbs006 xcbk006,SUM(xcbs222) xcbk202 " 
               OTHERWISE                                                       
                  LET l_sql = " SELECT xcbsent xcbkent,xcbs006 xcbk006,SUM(xcbs202) xcbk202 " 
            END CASE
            ...
            LET l_sql = l_sql, " FROM xcbs_t,sfaa_t ",  
                        ...
                        "     AND xcbsent = sfaaent AND xcbs006 = sfaadocno AND sfaa003 <> '3' " #非拆件工单  
            #xckk104b  人工
            LET l_sql_b = l_sql, " AND xcbs005 = '1' GROUP BY xcbsent,xcbs006 "  
            #xckk104d  #製費一                                                     
            LET l_sql_d = l_sql, " AND xcbs005 = '2' GROUP BY xcbsent,xcbs006 "  
            #xckk104e  #製費二                                                     
            LET l_sql_e = l_sql, " AND xcbs005 = '3' GROUP BY xcbsent,xcbs006 "  
            #xckk104f  #製費三                                                     
            LET l_sql_f = l_sql, " AND xcbs005 = '4' GROUP BY xcbsent,xcbs006 "  
            #xckk104g  #製費四                                                     
            LET l_sql_g = l_sql, " AND xcbs005 = '5' GROUP BY xcbsent,xcbs006 "  
            #xckk104h  #製費五                                                     
            LET l_sql_h = l_sql, " AND xcbs005 = '6' GROUP BY xcbsent,xcbs006 "       
         ELSE
         #170607-00049#1---add---e       
            #明细表抓xcbk的非拆件工单人工金额
            CASE g_master.xckk001 
               WHEN '1'  #本位币一
                  LET l_sql = " SELECT xcbkent,xcbk006,SUM(xcbk202) xcbk202 "  #170406-00009#1 add xcbkent,xcbk006
               WHEN '2'  #本位币二
                  LET l_sql = " SELECT xcbkent,xcbk006,SUM(xcbk212) xcbk202 "  #170406-00009#1 add xcbkent,xcbk006
               WHEN '3'  #本位币三
                  LET l_sql = " SELECT xcbkent,xcbk006,SUM(xcbk222) xcbk202 "  #170406-00009#1 add xcbkent,xcbk006
               OTHERWISE
                  LET l_sql = " SELECT xcbkent,xcbk006,SUM(xcbk202) xcbk202 "  #170406-00009#1 add xcbkent,xcbk006
            END CASE
            ...
            LET l_sql = l_sql, " FROM xcbk_t,sfaa_t ",  
                        ...
                        "     AND xcbkent = sfaaent AND xcbk006 = sfaadocno AND sfaa003 <> '3' " #非拆件工单  
            #xckk104b  人工
            LET l_sql_b = l_sql, " AND xcbk005 = '1' GROUP BY xcbkent,xcbk006 "  #170406-00009#1 add group by xcbk006
            #xckk104d  #製費一       
            LET l_sql_d = l_sql, " AND xcbk005 = '2' GROUP BY xcbkent,xcbk006 "  #170406-00009#1 add group by xcbk006
            #xckk104e  #製費二       
            LET l_sql_e = l_sql, " AND xcbk005 = '3' GROUP BY xcbkent,xcbk006 "  #170406-00009#1 add group by xcbk006
            #xckk104f  #製費三       
            LET l_sql_f = l_sql, " AND xcbk005 = '4' GROUP BY xcbkent,xcbk006 "  #170406-00009#1 add group by xcbk006
            #xckk104g  #製費四
            LET l_sql_g = l_sql, " AND xcbk005 = '5' GROUP BY xcbkent,xcbk006 "  #170406-00009#1 add group by xcbk006
            #xckk104h  #製費五
            LET l_sql_h = l_sql, " AND xcbk005 = '6' GROUP BY xcbkent,xcbk006 "  #170406-00009#1 add group by xcbk006  
         END IF   #170607-00049#1
  #      xckk104c
         CASE g_master.xckk001
            WHEN '1'  #本位币一
               LET l_sql = " SELECT sfaaent,sfaadocno,SUM(CASE apcb001 WHEN '21' THEN apcb113*(-1) ELSE apcb113 END) apcb113 "  #170406-00009#1 add sfaaent,sfaadocno
            WHEN '2'  #本位币二
               LET l_sql = " SELECT sfaaent,sfaadocno,SUM(CASE apcb001 WHEN '21' THEN apcb123*(-1) ELSE apcb123 END) apcb113 "  #170406-00009#1 add sfaaent,sfaadocno
            WHEN '3'  #本位币三
               LET l_sql = " SELECT sfaaent,sfaadocno,SUM(CASE apcb001 WHEN '21' THEN apcb133*(-1) ELSE apcb133 END) apcb113 "  #170406-00009#1 add sfaaent,sfaadocno
            OTHERWISE
               LET l_sql = " SELECT sfaaent,sfaadocno,SUM(CASE apcb001 WHEN '21' THEN apcb113*(-1) ELSE apcb113 END) apcb113 "  #170406-00009#1 add sfaaent,sfaadocno
         END CASE
         LET l_sql_c = l_sql, " FROM apca_t,apcb_t,pmds_t,pmdt_t,pmdp_t,sfaa_t ", 
                            ...
                            "   AND apcb023 = 'N'AND pmdt001 IS NOT NULL ",
                            "   AND sfaa003 <> '3' " ,
                            "   GROUP BY sfaaent,sfaadocno "   #170406-00009#1 add                             
         ...
         LET l_sub_sql = " SELECT xcce002 xckl010,xcce006 xckl006,xcce007 xckl007,xcce008 xckl008,xcce009 xckl009,",
                         ...
                         "        0 xckl103,(SUM(COALESCE(b.xcbk202,0))+SUM(COALESCE(c.apcb113,0))+SUM(COALESCE(d.xcbk202,0))+SUM(COALESCE(e.xcbk202,0))+SUM(COALESCE(f.xcbk202,0))+SUM(COALESCE(g.xcbk202,0))+SUM(COALESCE(h.xcbk202,0))) xckl104,                         ",
                         "        0 xckl104a,SUM(COALESCE(b.xcbk202,0)) xckl104b,SUM(COALESCE(c.apcb113,0)) xckl104c,SUM(COALESCE(d.xcbk202,0)) xckl104d, ",
                         "        SUM(COALESCE(e.xcbk202,0)) xckl104e,SUM(COALESCE(f.xcbk202,0)) xckl104f,SUM(COALESCE(g.xcbk202,0)) xckl104g,SUM(COALESCE(h.xcbk202,0)) xckl104h  ",                       
                         #170406-00009#1---add---s                          
                         "   FROM xcce_t   ",
                         #170406-00009#1--modify---s
                         #"        (",l_sql_b,") b ,",
                         ...
                         #"        (",l_sql_g,") g ,",
                         #"        (",l_sql_h,") h ",
                         "        LEFT JOIN (",l_sql_b,") b ON b.xcbkent = xcceent AND b.xcbk006 = xcce006 ",
                         "        LEFT JOIN (",l_sql_c,") c ON c.sfaaent = xcceent AND c.sfaadocno = xcce006 ",
                         "        LEFT JOIN (",l_sql_d,") d ON d.xcbkent = xcceent AND d.xcbk006 = xcce006 ",
                         "        LEFT JOIN (",l_sql_e,") e ON e.xcbkent = xcceent AND e.xcbk006 = xcce006 ",
                         "        LEFT JOIN (",l_sql_f,") f ON f.xcbkent = xcceent AND f.xcbk006 = xcce006 ",
                         "        LEFT JOIN (",l_sql_g,") g ON g.xcbkent = xcceent AND g.xcbk006 = xcce006 ",
                         "        LEFT JOIN (",l_sql_h,") h ON h.xcbkent = xcceent AND h.xcbk006 = xcce006 ",
                         #170406-00009#1-modify---e
                         "  WHERE xcceent = ",g_enterprise,
                         "    AND xcceld = '",g_master.xckkld,"' ",
                         "    AND xccecomp = '",g_master.xckkcomp,"' ",
                         ...
                         "    AND xcce004 = ",g_master.xckk003,
                         "    AND xcce005 = ",g_master.xckk004,
                         "    AND xcce007 = 'DL+OH+SUB' ",   #170406-00009#1---add
                         "   GROUP BY xcce002,xcce006,xcce007,xcce008,xcce009   "
         LET l_sql = l_sql_1 , l_sub_sql , l_sql_2
      ...
      WHEN '210'         #在制调整
         ...
         IF g_sys_6003 = 'Y' THEN 
            LET l_sub_sql = " SELECT xcce002 xckl010,xcce006 xckl006,xcce007 xckl007,xcce008 xckl008,xcce009 xckl009,",
                            ...
                            "   GROUP BY xcce002,xcce006,xcce007,xcce008,xcce009   ",
                            "  UNION ",
                            " SELECT xccx002 xckl010,xccx007 xckl006,'ADJUST' xckl007,' ' xckl008,' ' xckl009 , ",   
                            "        0 xckl101,0 xckl102,                           ",
                            "        0 xckl102a,0 xckl102b,0 xckl102c,0 xckl102d,   ",
                            "        0 xckl102e,0 xckl102f,0 xckl102g,0 xckl102h,   ",
                            "        SUM((CASE WHEN xccx101  IS NULL THEN 0 ELSE xccx101  END)) xckl103,  ",
                            "        SUM((CASE WHEN xccx102  IS NULL THEN 0 ELSE xccx102  END)) xckl104,  ",
                            "        SUM((CASE WHEN xccx102a IS NULL THEN 0 ELSE xccx102a END)) xckl104a, ",
                            "        SUM((CASE WHEN xccx102b IS NULL THEN 0 ELSE xccx102b END)) xckl104b, ", 
                            "        SUM((CASE WHEN xccx102c IS NULL THEN 0 ELSE xccx102c END)) xckl104c, ",
                            "        SUM((CASE WHEN xccx102d IS NULL THEN 0 ELSE xccx102d END)) xckl104d, ", 
                            "        SUM((CASE WHEN xccx102e IS NULL THEN 0 ELSE xccx102e END)) xckl104e, ",
                            "        SUM((CASE WHEN xccx102f IS NULL THEN 0 ELSE xccx102f END)) xckl104f, ", 
                            "        SUM((CASE WHEN xccx102g IS NULL THEN 0 ELSE xccx102g END)) xckl104g, ",
                            "        SUM((CASE WHEN xccx102h IS NULL THEN 0 ELSE xccx102h END)) xckl104h  ",
                            "   FROM xccx_t ,sfaa_t  ",
                            "  WHERE xccxent = ",g_enterprise,
                            "    AND xccxld = '",g_master.xckkld,"' ",
                            "    AND xccxcomp = '",g_master.xckkcomp,"' ",
                            "    AND xccx001 = '",g_master.xckk001,"' ",
                            "    AND xccx003 = '",g_master.xckk002,"' ",
                            "    AND xccx004 = ",g_master.xckk003,
                            "    AND xccx005 = ",g_master.xckk004,
                            "    AND xccxent = sfaaent AND xccx007 = sfaadocno AND sfaa003 <> '3' ",
                            "  GROUP BY xccx002,' ',' ',' ',xccx007   "  
         ELSE
         #170607-00049#1---add---e       
            LET l_sub_sql = " SELECT xcce002 xckl010,xcce006 xckl006,xcce007 xckl007,xcce008 xckl008,xcce009 xckl009,",
                            "        SUM(CASE xcce007 WHEN 'ADJUST' THEN xcce201 ELSE 0 END) xckl101,   ",
                            ...
                            "   GROUP BY xcce002,xcce006,xcce007,xcce008,xcce009   ",
                            "  UNION ",
                            #" SELECT xccp002 xckl010,' ' xckl007,' ' xckl008,' ' xckl009,xccp007 xckl006 , ",    #170406-00009#1
                            #" SELECT xccp002 xckl010,xccp007 xckl006,' ' xckl007,' ' xckl008,' ' xckl009 , ",     #170406-00009#1  #170607-00049#1 mark
                            " SELECT xccp002 xckl010,xccp007 xckl006,'ADJUST' xckl007,' ' xckl008,' ' xckl009 , ",     #170607-00049#1 add
                            "        0 xckl101,0 xckl102,                                                          ",
                            "        0 xckl102a,0 xckl102b,0 xckl102c,0 xckl102d,                                  ",
                            "        0 xckl102e,0 xckl102f,0 xckl102g,0 xckl102h,                                  ",
      ...
      #总表抓xcce的非拆件工单的本期转出数量和金额，明细表抓xcck的非拆件工单入库的数量和金额，并写入xckk；有差异的按在制单号(工单)找出差异并写入xckl
      WHEN '211'         #在制转出
         #170406-00027#1---modify---s
         LET l_sub_sql = " SELECT xccd002 xckl010,xccd006 xckl006,xccd007 xckl007,(CASE WHEN xccd008 IS NULL THEN ' ' ELSE xccd008 END) xckl008,xccd009 xckl009,",
                         "        SUM((CASE WHEN xccd301  IS NULL THEN 0 ELSE xccd301  END)) xckl101,   ",
                         "        SUM((CASE WHEN xccd302  IS NULL THEN 0 ELSE xccd302  END)) xckl102,   ",  
                         "        SUM((CASE WHEN xccd302a IS NULL THEN 0 ELSE xccd302a END)) xckl102a,",
                         "        SUM((CASE WHEN xccd302b IS NULL THEN 0 ELSE xccd302b END)) xckl102b,", 
                         "        SUM((CASE WHEN xccd302c IS NULL THEN 0 ELSE xccd302c END)) xckl102c,",
                         "        SUM((CASE WHEN xccd302d IS NULL THEN 0 ELSE xccd302d END)) xckl102d,",   
                         "        SUM((CASE WHEN xccd302e IS NULL THEN 0 ELSE xccd302e END)) xckl102e,",
                         "        SUM((CASE WHEN xccd302f IS NULL THEN 0 ELSE xccd302f END)) xckl102f,", 
                         "        SUM((CASE WHEN xccd302g IS NULL THEN 0 ELSE xccd302g END)) xckl102g,",
                         "        SUM((CASE WHEN xccd302h IS NULL THEN 0 ELSE xccd302h END)) xckl102h,",
                         "        0 xckl103,0 xckl104,                         ",
                         "        0 xckl104a,0 xckl104b,0 xckl104c,0 xckl104d, ",
                         "        0 xckl104e,0 xckl104f,0 xckl104g,0 xckl104h  ",
                         "   FROM xccd_t    ",
                         "  WHERE xccdent = ",g_enterprise,
                         "    AND xccdld = '",g_master.xckkld,"' ",
                         "    AND xccdcomp = '",g_master.xckkcomp,"' ",
                         "    AND xccd001 = '",g_master.xckk001,"' ",
                         "    AND xccd003 = '",g_master.xckk002,"' ",
                         "    AND xccd004 = ",g_master.xckk003,
                         "    AND xccd005 = ",g_master.xckk004,
                         "   GROUP BY xccd002,xccd006,xccd007,xccd008,xccd009   ",
         #LET l_sub_sql = " SELECT xcce002 xckl010,xcce006 xckl006,xcce007 xckl007,xcce008 xckl008,xcce009 xckl009,",
         ...
         #                "    AND xcce005 = ",g_master.xckk004,
         #                "   GROUP BY xcce002,xcce006,xcce007,xcce008,xcce009   ",
         #170406-00027#1---modify---e
                         "  UNION ",
                         #" SELECT xcck002 xckl010,xcck010 xckl007,xcck011 xckl008,xcck017 xckl009,xcck047 xckl006 , ",  #170406-00009#1
                         " SELECT xcck002 xckl010,xcck047 xckl006,(SELECT DISTINCT sfaa010 FROM sfaa_t WHERE sfaaent = '",g_enterprise,"' AND sfaadocno = xcck047 ) xckl007,xcck011 xckl008,xcck017 xckl009 , ",   #170406-00009#1
                         "        0 xckl101,0 xckl102,                                                          ",
                         "        0 xckl102a,0 xckl102b,0 xckl102c,0 xckl102d,                                  ",
                         "        0 xckl102e,0 xckl102f,0 xckl102g,0 xckl102h,                                  ",
                         "        (SUM((CASE WHEN xcck201  IS NULL THEN 0 ELSE xcck201  END)* xcck009)*-1) xckl103,  ", #170406-00009#1 add * -1
                         "        (SUM((CASE WHEN xcck202  IS NULL THEN 0 ELSE xcck202  END)*xcck009) *-1) xckl104,  ", #170406-00009#1 add * -1
                         "        (SUM((CASE WHEN xcck202a IS NULL THEN 0 ELSE xcck202a END)* xcck009)*-1) xckl104a, ", #170406-00009#1 add * -1
                         "        (SUM((CASE WHEN xcck202b IS NULL THEN 0 ELSE xcck202b END)*xcck009) *-1) xckl104b, ", #170406-00009#1 add * -1
                         "        (SUM((CASE WHEN xcck202c IS NULL THEN 0 ELSE xcck202c END)* xcck009)*-1) xckl104c, ", #170406-00009#1 add * -1
                         "        (SUM((CASE WHEN xcck202d IS NULL THEN 0 ELSE xcck202d END)*xcck009) *-1) xckl104d, ", #170406-00009#1 add * -1
                         "        (SUM((CASE WHEN xcck202e IS NULL THEN 0 ELSE xcck202e END)* xcck009)*-1) xckl104e, ", #170406-00009#1 add * -1
                         "        (SUM((CASE WHEN xcck202f IS NULL THEN 0 ELSE xcck202f END)*xcck009) *-1) xckl104f, ", #170406-00009#1 add * -1
                         "        (SUM((CASE WHEN xcck202g IS NULL THEN 0 ELSE xcck202g END)* xcck009)*-1) xckl104g, ", #170406-00009#1 add * -1
                         "        (SUM((CASE WHEN xcck202h IS NULL THEN 0 ELSE xcck202h END)*xcck009) *-1) xckl104h  ", #170406-00009#1 add * -1
                         "   FROM xcck_t              ",
                         "  WHERE xcckent = ",g_enterprise,
                         "    AND xcckld = '",g_master.xckkld,"' ",
                         "    AND xcckcomp = '",g_master.xckkcomp,"' ",
      ...
      WHEN '302'         #拆件投入
         LET l_sub_sql = " SELECT xcci002 xckl010,xcci006 xckl006,xcci007 xckl007,xcci008 xckl008,xcci009 xckl009,",
                         ...
                         "    AND xcck003 = '",g_master.xckk002,"' ",
                         "    AND xcck004 = ",g_master.xckk003,
                         "    AND xcck005 = ",g_master.xckk004,   #170406-00009#1 add
                         #"    AND xcck055 = '207' AND xcck020 = '302' ",   #170608-00033#1 mark
                         "    AND xcck055 = '207' AND (xcck020 = '302' OR xcck020 = '303') ",   #170608-00033#1 add #加上退料的部分
                         "    AND EXISTS (SELECT xcch006 FROM xcch_t ",
                         "                 WHERE xcchent = xcckent AND xcchcomp = xcckcomp AND xcch001 = xcck001 ",
                         "                   AND xcch003 = xcck003 AND xcch004 = xcck004 AND xcch005 = xcck005 ",
                         "                   AND xcch006 = xcck047 )",
      ...
      WHEN '306'         #拆件人工费
        ...
        #xckk104c
         ...
         LET l_sub_sql = " SELECT xcci002 xckl010,xcci006 xckl006,xcci007 xckl007,xcci008 xckl008,xcci009 xckl009,",
                         ...
                         #"        (",l_sql_g,") g ,",
                         #"        (",l_sql_h,") h ",
                         #170608-00002#1--modify---s
                         #"        LEFT JOIN (",l_sql_b,") b ON b.xcbkent = xcceent AND b.xcbk006 = xcci006 ",
                         #"        LEFT JOIN (",l_sql_c,") c ON c.sfaaent = xcceent AND c.sfaadocno = xcci006 ",
                         #"        LEFT JOIN (",l_sql_d,") d ON d.xcbkent = xcceent AND d.xcbk006 = xcci006 ",
                         #"        LEFT JOIN (",l_sql_e,") e ON e.xcbkent = xcceent AND e.xcbk006 = xcci006 ",
                         #"        LEFT JOIN (",l_sql_f,") f ON f.xcbkent = xcceent AND f.xcbk006 = xcci006 ",
                         #"        LEFT JOIN (",l_sql_g,") g ON g.xcbkent = xcceent AND g.xcbk006 = xcci006 ",
                         #"        LEFT JOIN (",l_sql_h,") h ON h.xcbkent = xcceent AND h.xcbk006 = xcci006 ",
                         "        LEFT JOIN (",l_sql_b,") b ON b.xcbkent = xccient AND b.xcbk006 = xcci006 ",
                         "        LEFT JOIN (",l_sql_c,") c ON c.sfaaent = xccient AND c.sfaadocno = xcci006 ",
                         "        LEFT JOIN (",l_sql_d,") d ON d.xcbkent = xccient AND d.xcbk006 = xcci006 ",
                         "        LEFT JOIN (",l_sql_e,") e ON e.xcbkent = xccient AND e.xcbk006 = xcci006 ",
                         "        LEFT JOIN (",l_sql_f,") f ON f.xcbkent = xccient AND f.xcbk006 = xcci006 ",
                         "        LEFT JOIN (",l_sql_g,") g ON g.xcbkent = xccient AND g.xcbk006 = xcci006 ",
                         "        LEFT JOIN (",l_sql_h,") h ON h.xcbkent = xccient AND h.xcbk006 = xcci006 ",
                         #170608-00002#1--modify---e
                         #170406-00009#1--modify---e
                         "  WHERE xccient = ",g_enterprise,
                         "    AND xccild = '",g_master.xckkld,"' ",
                         "    AND xccicomp = '",g_master.xckkcomp,"' ",
         ...
         IF SQLCA.sqlcode  THEN
            INITIALIZE g_errparam TO NULL 
            #LET g_errparam.extend = "axcq603_ins_xckl_cs22:"  #170608-00002#1
            LET g_errparam.extend = "axcq603_ins_xckl_cs27:"   #170608-00002#1
            LET g_errparam.code   = SQLCA.sqlcode 
            LET g_errparam.popup  = TRUE 
            CALL cl_err()                   
            LET r_success = FALSE
      ...
      WHEN '303'         #拆件拆出
         LET l_sub_sql = " SELECT xcci002 xckl010,xcci006 xckl006,xcci007 xckl007,xcci008 xckl008,xcci009 xckl009,",
                         ...
                         #"    AND xcck055 = '3012' AND xcck020 = '113' " ,  #170608-00033#1 mark
                         "    AND xcck055 = '3012' AND (xcck020 = '113' OR xcck020 ='106') " ,  #170608-00033#1 add #委外拆件入庫
                         "  GROUP BY xcck002,xcck010,xcck011,xcck017,xcck047   "
         LET l_sql = l_sql_3 , l_sub_sql , l_sql_2
...
################################################################################
# Descriptions...: 将5~10页签的数据存到数组变量中去
# Memo...........:
# Usage..........: CALL axcq603_b_fill_5()
#                  RETURNING 回传参数
# Input parameter: 传入参数变量1   传入参数变量说明1
#                : 传入参数变量2   传入参数变量说明2
# Return code....: 回传参数变量1   回传参数变量说明1
#                : 回传参数变量2   回传参数变量说明2
# Date & Author..: 17/08/01 by zhoumj
# Modify.........:
################################################################################
PRIVATE FUNCTION axcq603_b_fill_5()
DEFINE l_sql       STRING
   
   CALL s_axcq603_gen_data(g_master.*)
   
   CALL g_xckk5_d.clear()  #page1 应收未立账检核

   LET l_sql = "SELECT * FROM s_axcq603_tmp ORDER BY item "
   LET l_sql = cl_sql_add_mask(l_sql)              #遮蔽特定資料
   PREPARE axcq603_pb6 FROM l_sql
   DECLARE b_fill_curs6 CURSOR FOR axcq603_pb6
   LET l_ac = 1
                             
   FOREACH b_fill_curs6 INTO g_xckk5_d[l_ac].item,g_xckk5_d[l_ac].customcode,g_xckk5_d[l_ac].customdesc,g_xckk5_d[l_ac].trackingno,   #核对项目8062 ,供应商/客户编号,供应商/客户名称,来源单号（入库或者出货单）
                             g_xckk5_d[l_ac].tseq,g_xckk5_d[l_ac].tdate,g_xckk5_d[l_ac].num,g_xckk5_d[l_ac].amt,  #项次,异动日期,未立账数量,未立账金额
                             g_xckk5_d[l_ac].errmsg,g_xckk5_d[l_ac].prgname  #错误讯息,程序编号
   ...
   CALL g_xckk5_d.deleteElement(g_xckk5_d.getLength())   #删除最后一笔空行
   
   CALL g_xckk6_d.clear()  #page2 存货科目检核
   LET l_sql = "SELECT * FROM s_axcq603_tmp1 ORDER BY custom1 "
   LET l_sql = cl_sql_add_mask(l_sql)              #遮蔽特定資料
   PREPARE axcq603_pb7 FROM l_sql
   DECLARE b_fill_curs7 CURSOR FOR axcq603_pb7
   LET l_ac = 1
                             
   FOREACH b_fill_curs7 INTO g_xckk6_d[l_ac].custom1,g_xckk6_d[l_ac].custmdesc,g_xckk6_d[l_ac].billno,g_xckk6_d[l_ac].tseq1,
                             g_xckk6_d[l_ac].tdate1,g_xckk6_d[l_ac].imal001,g_xckk6_d[l_ac].imaal001desc,g_xckk6_d[l_ac].account,
                             g_xckk6_d[l_ac].accdesc,g_xckk6_d[l_ac].costcode,g_xckk6_d[l_ac].caccount,g_xckk6_d[l_ac].caccdesc,g_xckk6_d[l_ac].prog1
   ...
   CALL g_xckk6_d.deleteElement(g_xckk6_d.getLength())   #删除最后一笔空行
   
   CALL g_xckk7_d.clear()  #page3 在制科目余额检核
   LET l_sql = "SELECT * FROM s_axcq603_tmp2 ORDER BY account1 "
   LET l_sql = cl_sql_add_mask(l_sql)              #遮蔽特定資料
   PREPARE axcq603_pb8 FROM l_sql
   DECLARE b_fill_curs8 CURSOR FOR axcq603_pb8
   LET l_ac = 1
                             
   FOREACH b_fill_curs8 INTO g_xckk7_d[l_ac].account1,g_xckk7_d[l_ac].accdesc1,g_xckk7_d[l_ac].accamt1,g_xckk7_d[l_ac].balamt,
                             g_xckk7_d[l_ac].bdiff
   ...
   CALL g_xckk7_d.deleteElement(g_xckk7_d.getLength())   #删除最后一笔空行
   
   CALL g_xckk8_d.clear()  #page4 发出商品数量检核
   LET l_sql = "SELECT * FROM s_axcq603_tmp3 ORDER BY item1 "
   LET l_sql = cl_sql_add_mask(l_sql)              #遮蔽特定資料
   PREPARE axcq603_pb9 FROM l_sql
   DECLARE b_fill_curs9 CURSOR FOR axcq603_pb9
   LET l_ac = 1
                             
   FOREACH b_fill_curs9 INTO g_xckk8_d[l_ac].item1,g_xckk8_d[l_ac].trackingno1,g_xckk8_d[l_ac].tseq2,g_xckk8_d[l_ac].num2,
                             g_xckk8_d[l_ac].tprice,g_xckk8_d[l_ac].tpamt,g_xckk8_d[l_ac].outnum,g_xckk8_d[l_ac].tprice2,g_xckk8_d[l_ac].tpamt2,g_xckk8_d[l_ac].sourceno
   ...
   CALL g_xckk8_d.deleteElement(g_xckk8_d.getLength())   #删除最后一笔空行
   
   CALL g_xckk9_d.clear()  #page5 总账科目余额检核
   LET l_sql = "SELECT * FROM s_axcq603_tmp4 ORDER BY item2 "
   LET l_sql = cl_sql_add_mask(l_sql)              #遮蔽特定資料
   PREPARE axcq603_pb10 FROM l_sql
   DECLARE b_fill_curs10 CURSOR FOR axcq603_pb10
   LET l_ac = 1
                             
   FOREACH b_fill_curs10 INTO g_xckk9_d[l_ac].item2,g_xckk9_d[l_ac].itemdesc2,g_xckk9_d[l_ac].accamt2,g_xckk9_d[l_ac].outamt,g_xckk9_d[l_ac].aodiff
   ...
   CALL g_xckk9_d.deleteElement(g_xckk9_d.getLength())   #删除最后一笔空行
   
   CALL g_xckk10_d.clear() #page6 应付单身与底稿检核
   LET l_sql = "SELECT * FROM s_axcq603_tmp5 ORDER BY billno1 "
   LET l_sql = cl_sql_add_mask(l_sql)              #遮蔽特定資料
   PREPARE axcq603_pb11 FROM l_sql
   DECLARE b_fill_curs11 CURSOR FOR axcq603_pb11
   LET l_ac = 1
                             
   FOREACH b_fill_curs11 INTO g_xckk10_d[l_ac].billno1,g_xckk10_d[l_ac].tdate2,g_xckk10_d[l_ac].custom2,g_xckk10_d[l_ac].custmdesc2,g_xckk10_d[l_ac].account2,
                              g_xckk10_d[l_ac].accdesc2,g_xckk10_d[l_ac].accamt3,g_xckk10_d[l_ac].account3,g_xckk10_d[l_ac].accdesc3,g_xckk10_d[l_ac].accamt4,
                              g_xckk10_d[l_ac].prog2
   ...
   CALL g_xckk10_d.deleteElement(g_xckk10_d.getLength())   #删除最后一笔空行
