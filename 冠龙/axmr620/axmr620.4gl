...
MAIN
   ...
   LET g_sql = "oga01.oga_file.oga01,",
               ...
               " ogaconf.oga_file.ogaconf,",      #add by lidj160330
               ...
               " oea10.oea_file.oea10,",  #add by zhaoxiangb 151026
               " ogb32.ogb_file.ogb32,", #151027wudj
               ...
               " ogb14t.ogb_file.ogb14t,",                     #add by lidj160330
               " ogb14c.ogb_file.ogb14t,",                     #add by lidj160330
               ...
               "oga01a.oga_file.oga01,",  #add by jixf 160623
               # add by lixwz 171204 s
               "ta_ogb01.ogb_file.ta_ogb01,",
               "ta_ogb02.ogb_file.ta_ogb02,",
               "ta_ogb03.ogb_file.ta_ogb03,",
               "ta_ogb04.ogb_file.ta_ogb04,",
               "oap041.oap_file.oap041"
               # add by lixwz 171204 e

   LET l_table = cl_prt_temptable('axmr620',g_sql) CLIPPED
   IF l_table = -1 THEN EXIT PROGRAM END IF
   LET g_sql = " INSERT INTO ",g_cr_db_str CLIPPED,l_table clipped,
               " VALUES(?,?,?,?,?, ?,?,?,?,?, ?,?,?,?,?, ?,?,?,?,?,",  #151027wudj add ?
               #"        ?,?,?,?,?, ?,?,?,?,?, ?,?,?,?,?, ?,?,?,?,?,? )"  #FUN-8B0025 add?  #add 1 ? by zhaoxiangb 151026     #add 3 ? by lidj160330 #mod by jixf add ?
               # add by lixwz 171204 s
               "        ?,?,?,?,?, ?,?,?,?,?, ?,?,?,?,?, ?,?,?,?,?,",
               "        ?,?,?,?,?, ?)"
               # add by lixwz 171204 e
...
#FUN-A70084--add--str--
   CONSTRUCT BY NAME g_wc ON azw01
      ...
      BEFORE CONSTRUCT
          CALL cl_qbe_init()
          DISPLAY g_plant TO azw01    #add by jixf 20160328
...
FUNCTION axmr620()
   DEFINE l_name    LIKE type_file.chr20,      # External(Disk) file name        #No.FUN-680137 VARCHAR(20)
         ...
         sr               RECORD order1 LIKE oea_file.oea01,     # No.FUN-680137  VARCHAR(16)
                                 ...
                                 order3 LIKE oea_file.oea01,     # No.FUN-680137  VARCHAR(16)
                                  ...
                                  ogaconf LIKE oga_file.ogaconf,         #add by lidj160330
                                  ...
                                  oea10 LIKE oea_file.oea10,   #add by zhaoxiangb 151026
                                  ogb32 LIKE ogb_file.ogb32, #151027wudj
                                  ...
                                  ogb14t LIKE ogb_file.ogb14t,   #add by lidj160330
                                  ogb14c LIKE ogb_file.ogb14,    #add by lidj160330
          ...
          oga01a   LIKE oga_file.oga01,   #add by jixf 160623
          # add by lixwz 171204 s
          ta_ogb01 LIKE ogb_file.ta_ogb01,
          ta_ogb02 LIKE ogb_file.ta_ogb02,
          ta_ogb03 LIKE ogb_file.ta_ogb03,
          ta_ogb04 LIKE ogb_file.ta_ogb04,
 ...
 DEFINE
     ...
     DEFINE     l_oga01a   LIKE oga_file.oga01   #add by jixf 160623
...
#FUN-A70084--mod--end
     ...
     LET l_sql = "SELECT '','','',",
                 "       oga01,oga02,oga03,ogaconf,oga032,oga04,occ02,oga14, ",       #add ogaconf by lidj160330
		 "       oga15,ogb03,ogb31,'',ogb32,ogb04,ogb06,ogb05, ", #151027wudj add ogb32
		 "       ogb13,ogb12,ogb14,ogb14t,ogb14t-ogb14,oga10, ",                      #add ogb14t,ogb14t-ogb14 by lidj160330
                 "       azi03,azi04,azi05,oga23,oga24, ",
                 "       ogb910,ogb912,ogb913,ogb915,ogb916,ogb917,''  ", #No.FUN-580004  #mod by jixf 160623 add''
                 "       occ37",                                        #NO.FUN-8B0025
                 "       ,NVL(ta_ogb01,0),NVL(ta_ogb02,0),NVL(ta_ogb03,0),NVL(ta_ogb04,0),oap041 ",         # add by lixwz 171204
    ...
    #CALL cl_parse_qry_sql(l_sql,m_dbs[l_i]) RETURNING l_sql   #NO.FUN-A10056  #FUN-A70084
     ...
     FOREACH axmr620_curs1 INTO sr.*,l_occ37                          #FUN-8B0025 Add l_occ37
       ...
       END IF
        ...
        END IF
        SELECT oea10 INTO sr.oea10 FROM oea_file WHERE oea01 = sr.ogb31   #add by zhaoxiangb 151026

        #str---add by jixf 160623
        LET l_sql=" SELECT oga01 FROM oga_file WHERE oga011='",sr.oga01,"'",
                  " AND oga09='8' AND ogaconf<>'X' "
        PREPARE l_pre22 FROM l_sql
        DECLARE l_cur22 CURSOR FOR l_pre22
        FOREACH l_cur22 INTO l_oga01a
           IF cl_null(sr.oga01a) THEN
               LET sr.oga01a=l_oga01a
           ELSE
               LET sr.oga01a=sr.oga01a CLIPPED,'|',l_oga01a
           END IF
        END FOREACH
        #end---add by jixf 160623
...
#            #            "  FROM ",l_dbs CLIPPED,"ima_file",
            ...
            EXECUTE insert_prept111 USING sr.oga01,sr.oga02,
                                sr.oga03,sr.ogaconf,sr.oga032,sr.oga04,sr.occ02,sr.oga14,      #add sr.ogaconf by lidj160330
                               l_gen02,sr.oga15,l_gem02,sr.ogb03,sr.ogb31,sr.oea10,sr.ogb32,sr.ogb04,   #add oea10 by zhaoxiangb 151026 #151027wudj add ogb32
                               sr.ogb06,l_ima021,l_str2,sr.ogb05,sr.oga23,
                               sr.ogb13,sr.ogb12,sr.ogb916,sr.ogb917,sr.ogb14,sr.ogb14t,sr.ogb14c,     #add sr.ogb14t,sr.ogb14c, by lidj160330
                              sr.oga10,tm.y,
                             ...
                             #g_ogc.ogc12,sr.azi03, sr.azi04, sr.azi05, m_dbs[l_i]     #FUN-8B0025 mod   #FUN-A70084
                              ...
                              ,sr.oga01a  #add by jixf 160623
                              ,sr.ta_ogb01,sr.ta_ogb02,sr.ta_ogb03,sr.ta_ogb04,sr.oap041    # add by lixwz 171204
         END FOREACH
      END IF
      IF l_flag != 'Y' THEN
          EXECUTE insert_prept111 USING sr.oga01,sr.oga02,sr.oga03,sr.ogaconf,sr.oga032,
                                        sr.oga04,sr.occ02,sr.oga14,               #add sr.ogaconf by lidj160330
                               l_gen02,sr.oga15,l_gem02,sr.ogb03,sr.ogb31,sr.oea10,sr.ogb32,sr.ogb04,   #add oea10 by zhaoxiangb 151026 #151027wudj add ogb32
                               sr.ogb06,l_ima021,l_str2,sr.ogb05,sr.oga23,
                               sr.ogb13,sr.ogb12,sr.ogb916,sr.ogb917,sr.ogb14,sr.ogb14t,sr.ogb14c,     #add sr.ogb14t,sr.ogb14c, by lidj160330
