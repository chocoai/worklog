...
#FUN-A10044  ---begin---
   ...
   #No.FUN-A60011  --End
               ...
               "imaud02.ima_file.imaud02,",                         # add by shids 150409
               "sfbud03.sfb_file.sfbud03,sfbud10.sfb_file.sfbud10,sfb08.sfb_file.sfb08,sfb96.sfb_file.sfb96"  #add by zhaoxiangb 151006
               ,",tc_ima02.tc_ima_file.tc_ima02,tc_ima04.tc_ima_file.tc_ima04" #  add by lixwz 171204
...
FUNCTION i700_out()
  ...
  DEFINE sr         RECORD
        ...
        #   ecu014   LIKE ecu_file.ecu014,  #FUN-B10056  mark
           ...
           imaud02  LIKE ima_file.imaud02,    # add by shids 150409
           sfbud03  LIKE sfb_file.sfbud03,    #add by zhaoxiangb 151006
           sfbud10  LIKE sfb_file.sfbud10,    #add by zhaoxiangb 151006
           sfb08    LIKE sfb_file.sfb08,       #add by zhaoxiangb 151006
           sfb96    LIKE sfb_file.sfb96       #add by zhaoxiangb 151006
                    END RECORD
  DEFINE l_ecm59    LIKE ecm_file.ecm59 #CHI-A70026 add
    #add by zhaoxiangb 151004
    DEFINE cho LIKE type_file.chr1

    DEFINE l_tc_ima02 LIKE tc_ima_file.tc_ima02 #add by wy20171201
    DEFINE l_tc_ima04 LIKE tc_ima_file.tc_ima04 #add by wy20171201
    DEFINE l_sfb05 LIKE sfb_file.sfb05 #add by wy20171201
    OPEN WINDOW r700_cw AT p_row,p_col WITH FORM "aec/42f/aecr700_cw" ATTRIBUTE (STYLE = g_win_style CLIPPED)
    CALL cl_ui_init()
    INPUT cho FROM a
    BEFORE INPUT
           LET cho = 1
    ...
    AFTER INPUT
           IF cho <>'1' THEN
               ...
               LET g_wc = ' 1=1'
               LET g_wc2 = ' 1=1'
               CONSTRUCT BY NAME g_wc ON sfb01
               ON ACTION CONTROLP
             CASE
                 WHEN INFIELD(sfb01)
                       CALL cl_init_qry_var()
    ...
    LET g_sql = "INSERT INTO ",g_cr_db_str CLIPPED,l_table CLIPPED,
                ...
                " ?,?,?,?,?,  ?,?,?,?,?,  ?,?,?,?,?,  ?,?,?,?,?, ",
    #            " ? )"     #FUN-B10056 mark
                #" ?,?,?,?,?,?,? )"    #FUN-B10056 add ?         add by shids 150409  #add 4 ? by zhaoxiangb 151006 # mark by lixwz 171204
                " ?,?,?,?,?,?,? ,?,?)" # add by lixwz 171204
    #CHI-A70026 mod --end--
   ...
   LET g_sql = "SELECT sfb01,'',sfb05,ima02,ima021,sfb06,ima55,sfb02,'',sfb81,sfb82,'',sfb22,",
               ...
               #No.FUN-A60011  --End
               ",'',ecm301,ecm302,ecm303,ecm311,ecm312,ecm316,ecm313,ecm314,ecm315,ecm322,ecm291,ecm292,imaud02,sfbud03,sfbud10,sfb08,sfb96,ecm59  ", #CHI-A70026 add      add imaud02 by shids 150409  #add ud03,ud10,08,96 by zhaoxiangb 151006
  ...
  #FOREACH i700_curs INTO sr.*          #CHI-A70026 mark
   FOREACH i700_curs INTO sr.*,l_ecm59  #CHI-A70026
    ...
    #  CALL s_schdat_ecu014(sr.sfb01,sr.ecm012) RETURNING sr.ecu014  #TQC-AC0374   #FUN-B10056 mark
      ...
      LET l_sfb05=sr.sfb05 #add by wy20171201
      # add by lixwz 171204 s
      SELECT tc_ima02,tc_ima04 INTO l_tc_ima02,l_tc_ima04
        FROM tc_ima_file
       WHERE tc_ima01=l_sfb05
      IF cl_null(l_tc_ima02) THEN LET l_tc_ima02 = 0 END IF
      IF cl_null(l_tc_ima04) THEN LET l_tc_ima04 = 0 END IF
      # add by lixwz 171204 e
      # EXECUTE insert_prep USING sr.* mark by lixwz 171204
      EXECUTE insert_prep USING sr.*,l_tc_ima02,l_tc_ima04 # add by lixwz 171204
   END FOREACH
   CALL  cl_wcchp(g_wc,'sfb01,sfb05,sfbuser,sfbgrup,sfbmodu,sfbdate,sfbacti')
         RETURNING g_wc
   LET g_sql = "SELECT * FROM ", g_cr_db_str CLIPPED, l_table CLIPPED
   SELECT zo02 INTO l_str FROM zo_file WHERE zo01 = g_rlang
   ...
   WHERE tc_ima01=l_sfb05
   #add by wy20171201 e
   LET g_str = g_wc CLIPPED,";",l_str CLIPPED
   # add by lixwz 171204 s
   #No.FUN-A60011  --Begin
