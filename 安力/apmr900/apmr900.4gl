...
# Modify.........: No:MOD-B30618 12/08/28 By Chales 增加備註
# Modify.........: No:MOD-130111 13/01/11 By Chales 带出委外工单号码(pmn41)
# Modify.........: ANLIA-1312010 13/12/16 By Alan l_ima021資料來源，由ima_file.ima021改為pmn_file.pmnud01
# Modify.........: ANLIA-1401002 14/01/01 By vincent 增加聯絡人(l_pmd02)顯示
# Modify.........: ANLIA-1402008 14/02/15 By vincent 報表增加採購部門顯示
# Modify.........: ANLIA-1402017 14/02/25 By vincent 增加貿易條件(pmmud02)顯示
# Modify.........: ANLIA-1405005 15/05/26 By Persephone 增加資料所有者(pmm_file.pmmuser)姓名(查gen_file.gen02)
...
MAIN
  ...
  #LET g_xml.recipient = ARG_VAL(17)
   ...
   LET g_sql = "pmm01.pmm_file.pmm01,",
               ...
               "wsc06.wsc_file.wsc06,", # add by lixwz180122
               "wsc11.wsc_file.wsc11,", # add by lixwz180122
               "wsc14.wsc_file.wsc14,", # add by lixwz180122
               "wsc06_1.wsc_file.wsc06,", # add by lixwz180122
               "wsc11_1.wsc_file.wsc11,", # add by lixwz180122
               "wsc14_1.wsc_file.wsc14,", # add by lixwz180122
               ...
               "pmmud01.pmm_file.pmmud01,",    #By Chales----20120828備註欄位
               "pmnud02.pmn_file.pmnud02,pmnud03.pmn_file.pmnud03,", #huaichang -151207 add
               "pmn41.pmn_file.pmn41,",        #MOD-130111
               "pme031.pme_file.pme031,",
               "l_pmd02.pmd_file.pmd02,",    #ANLIA-1401002
               ...
               "l_gem02.gem_file.gem02,",      #ANLIA-1402008
               "l_pmmud02.pmm_file.pmmud02,",  #ANLIA-1402017
               "l_pmmusername.pmm_file.pmmuser"
...
FUNCTION apmr900()
   DEFINE l_name	LIKE type_file.chr20, 	# External(Disk) file name        #No.FUN-680136 VARCHAR(20)
          ...
          sr   RECORD
                     ...
                     wsc06     LIKE wsc_file.wsc06,    # add by lixwz180122
                     wsc11     LIKE wsc_file.wsc11,    # add by lixwz180122
                     wsc14     LIKE wsc_file.wsc14,    # add by lixwz180122
                     wsc06_1   LIKE wsc_file.wsc06,    # add by lixwz180122
                     wsc11_1   LIKE wsc_file.wsc11,    # add by lixwz180122
                     wsc14_1   LIKE wsc_file.wsc14,    # add by lixwz180122
                     ...
                     pmmud01   LIKE pmm_file.pmmud01,   #By Chales----20120828備註欄位
                     pmnud02   LIKE pmn_file.pmnud02,   #huaicahng-151207 add
                     pmnud03   LIKE pmn_file.pmnud03,   #huaicahng-151207 add
                     pmn41     LIKE pmn_file.pmn41        #MOD-130111
               END RECORD,
          sr1  RECORD
     ...
     DEFINE l_pmd02            LIKE pmd_file.pmd02      #ANLIA-1401002
     ...
     DEFINE l_gem02            LIKE gem_file.gem02     #ANLIA-1402008
     DEFINE l_pmmud02          LIkE pmm_file.pmmud02   #ANLIA-1402017
     DEFINE l_pmmusername      LIKE pmm_file.pmmuser   #ANLIA-1505005
     DEFINE sr2  RECORD
   ...
   LET g_sql = "INSERT INTO ",g_cr_db_str CLIPPED,l_table CLIPPED,
              ...
              #"        ?,?,?,?,?, ?,?,?,?,?, ?)" #FUN-7B0142 拿掉一個?  #FUN-770064 mod #CHI-A80047 mark
               "        ?,?,?,?,?, ?,?,?,?,?, ?,?,?,?,?, ?,?,?,?,?,", #CHI-A80047#By Chales----20120828備註欄位 #MOD-130111 #ANLIA-1401002 add ?*1
              # "        ?,?,?)"  #ANLIA-1402008 ?*1 #ANLIA-1402017 ?*1  #ANLIA-1505005 ?*1
              #  "        ?,?,?,?,?)"  #hauichang 151207 增加两个栏位 #　mark by lixwz180122
                 "      ?,?,?,?,?, ?,?,?,?,?, ?)"  # add by lixwz180122  增加六个栏位
   ...
   LET l_sql = "SELECT pmm01,smydesc,pmm04,pmc081,pmc091,pmc10,pmc11,",
               ...
               #"       pmn86,pmn87,pmmud01,pmn41",   #FUN-560229#By Chales----20120828備註欄位  #MOD-130111
               "       pmn86,pmn87,pmmud01,pmnud02,pmnud03,pmn41",   #huaichang-151207 add pmnud02和pmnud03
               #No.MOD-A60083  --Begin
   ...
   FOREACH r900_cs1 INTO sr.*
      ...
      END IF
      #CHI-A80047 mod --end--
      # add by lixwz180122 s
      # 签核人，审核人及时间
      LET l_cnt = 1
      SELECT count(*)
        INTO l_cnt
        FROM wsc_file
       WHERE wsc01 = sr.pmm01

      CASE l_cnt
         WHEN 1
            SELECT UNIQUE wsc06,wsc11,wsc14
              INTO sr.wsc06,sr.wsc11,sr.wsc14
              FROM wsc_file
             WHERE wsc01 = sr.pmm01
         WHEN 2
            SELECT UNIQUE wsc06,wsc11,wsc14
             ...
             WHERE wsc01 = sr.pmm01
               AND wsc04 = 'ACT02'
            SELECT UNIQUE wsc06,wsc11,wsc14
              INTO sr.wsc06_1,sr.wsc11_1,sr.wsc14_1
              FROM wsc_file
             WHERE wsc01 = sr.pmm01
               AND wsc04 = 'ACT03'
         WHEN 3
         ...
         OTHERWISE
      END CASE
      IF cl_null(sr.wsc06) THEN LET sr.wsc06 = ' ' END IF
      IF cl_null(sr.wsc11) THEN LET sr.wsc11 = ' ' END IF
      IF cl_null(sr.wsc14) THEN LET sr.wsc14 = ' ' ELSE LET sr.wsc14 = sr.wsc14[1,5] END IF
      IF cl_null(sr.wsc06_1) THEN LET sr.wsc06_1 = ' '  END IF
      IF cl_null(sr.wsc11_1) THEN LET sr.wsc11_1 = ' ' END IF
      IF cl_null(sr.wsc14_1) THEN LET sr.wsc14_1 = ' ' ELSE LET sr.wsc14_1 = sr.wsc14_1[1,5] END IF
      IF cl_null(sr.pmn09) THEN LET sr.pmn09 = 0 END IF
      IF cl_null(sr.pmn80) THEN LET sr.pmn80 = 0 END IF
      IF cl_null(sr.pmn82) THEN LET sr.pmn82 = 0 END IF
      IF cl_null(sr.pmn83) THEN LET sr.pmn83 = 0 END IF
      IF cl_null(sr.pmn85) THEN LET sr.pmn85 = 0 END IF
      IF cl_null(sr.pmmud01) THEN LET sr.pmmud01 = 0 END IF
      IF cl_null(sr.pmnud02) THEN LET sr.pmnud02 = 0 END IF
      IF cl_null(sr.pmnud03) THEN LET sr.pmnud03 = 0 END IF
      IF cl_null(sr.pmn041) THEN LET sr.pmn041 = 0 END IF
      IF cl_null(sr.pmn06) THEN LET sr.pmn06 = ' ' END IF
      IF cl_null(sr.pmn41) THEN LET sr.pmn41 = ' ' END IF

      IF cl_null(sr.pmm10) THEN LET sr.pmm10 = ' ' END IF
      IF cl_null(sr.pmm11) THEN LET sr.pmm11 = ' ' END IF

      # add by lixwz180122 e
      #帳單地址
      #CHI-A80047 mod --start--
      ...
      SELECT pmnud01 INTO l_ima021 FROM pmn_file where pmn01 = sr.pmm01 and pmn02=sr.pmn02 #ANLIA-1312010
   ...
   SELECT pmd02 INTO l_pmd02 FROM pmd_file WHERE pmd01=sr.pmm09         #ANLIA-1401002
   SELECT gem02 INTO l_gem02 FROM pmm_file LEFT OUTER JOIN gem_file ON pmm13=gem01   #ANLIA-1402008
   WHERE pmm01=sr.pmm01                 #ANLIA-1402008

   SELECT pmmud02 INTO l_pmmud02 FROM pmm_file WHERE pmm01=sr.pmm01     #ANLIA-1402017

   SELECT gen02 INTO l_pmmusername  FROM pmm_file LEFT OUTER JOIN gen_file ON pmmuser=gen01 WHERE pmm01=sr.pmm01   #ANLI-1505005

      EXECUTE insert_prep USING
         sr.*,
         l_pme031,l_pmd02,l_pme032,l_pme033,l_pme034,l_pme035, #CHI-A80047 add l_pme033,l_pme034,l_pme035 #ANLIA-1401002 add l_pmd02
         ...
         l_gem02,                          #ANLIA-1402008
         l_pmmud02,                        #ANLIA-1402017
         l_pmmusername                     #ANLIA-1505005
