...
# Modify.........: No:TQC-D40067 13/04/23 By lixiang 單頭的自動編號放到單身新增前，避免同時錄入編號重複
# Modify.........: No:TQC-D40078 13/04/27 By fengrui 負庫存函数添加营运中心参数
# Modify.........: No:FUN-D50006 13/05/03 By lixiang omf17增加開窗挑選
# Modify.........: No:FUN-D50009 13/05/03 By lixiang 增加狀態頁簽
# Modify.........: No:FUN-D50008 13/05/08 By lixiang 原開票日期改欄位名改為錄入日期，增加發票日期，發票日期与相關關賬日期都不關聯，拋轉應收時拋到oma09字段
# Modify.........: No:FUN-D50007 13/05/08 By lixiang 增加開票人，開票部門
# Modify.........: No:MOD-D50076 13/05/10 By suncx 進單身修改時未鎖住單頭資料，導致一個用戶在修改單身，另一個用戶卻能做審核等動作
# Modify.........: No:TQC-D50063 13/05/10 By lujh 單身單據類型錄入9.其他時，料件編號也要開啟可以錄入，保證雜項可以直接錄入料件MISC*
# Modify.........: No:FUN-D40106 13/05/13 By lixiang 增加出貨客戶編號，原客戶編號名稱改為立賬客戶編號
# Modify.........: No:MOD-D40221 13/05/20 By SunLM 是否,單價為零，是否立賬
# Modify.........: No:FUN-D50050 13/05/22 By lixh1 串接axrp304時增加折讓單別參數
# Modify.........: No:CHI-D50042 13/05/28 By yinhy 開票單號開窗修改
# Modify.........: No:TQC-D50126 13/06/05 By lixiang 新增時點退出，畫面檔清空
# Modify.........: No:MOD-D60035 13/06/05 By SunLM 出貨/銷退單單據日期年月大於發票日期年月，不可開票！
# Modify.........: No:FUN-D60075 13/06/18 By zhuhao 審核多窗口問題處理
...
# Modify.........: No:MOD-D60162 13/07/03 By SunLM 單价為零可以正常生成應收賬款。
# Modify.........: No:MOD-D60160 13/07/03 By SunLM  omf31日期不做管控,扣账日期年月与开票录入日期年月不一致检查
# Modify.........: No:MOD-D60161 13/07/03 By SunLM   金额显示与axrt300有尾差
# Modify.........: No:MOD-D60152 13/07/03 By SunLM 調整刪除后的異常顯示問題
...
# Modify.........: NO:MOD-DA0012 13/10/03 By yinhy 調整axrp304傳參
# Modify.........: NO:FUN-DA0084 13/10/21 By wangrr 取消MOD-CA0160中ooz32=Y的mark
# Modify.........: NO:FUN-DB0007 13/11/06 By wangrr【發票補登】【拋轉應收】增加邏輯寫入ome_file
...
# Modify.........: No:FUN-DA0127 13/12/18 By joyce 新增發票用途(ome83)
# Modify.........: No:MOD-E20059 14/02/13 By SunLM 調整畫面下方的金額匯總顯示方式
...
# Modify.........: No:FUN-I40010 18/04/16 By yihsuan 功能回追,如果滿足aooi151 稅別差異不報錯
# Modify.........: No:TQC-I40002 18/04/19 By yihsuan axm-142 判斷調整
...
DEFINE   g_omf_1         RECORD
	                       ...
	                       omf22        LIKE     omf_file.omf22,
                               omf27        LIKE     omf_file.omf27,   #FUN-D40106 add
                               omf271       LIKE     omf_file.omf271,  #FUN-D40106 add
...
MAIN
  ...
  #IF g_oaz.oaz92 = 'N' THEN   #CHI-EC0033 mark
   IF g_oaz.oaz92 = 'N' OR cl_null(g_oaz.oaz92) THEN   #CHI-EC0033 add 
   ...
   #                    "  FROM omf_file WHERE omf01=? AND omf02=? FOR UPDATE" 
    LET g_forupd_sql = "SELECT omf00,omf01,omf02,omf03,omf05,omf06,omf07,omf22,omf27,omf30,",   #No.FUN-D10103   Add omf30  #FUN-D40106 add omf27
  ...
  #IF g_oaz.oaz93 = 'N' THEN  #CHI-EC0033 mark 
   IF g_oaz.oaz93 = 'N' OR cl_null(g_oaz.oaz93) THEN  #CHI-EC0033 add  
...
DEFINE  lc_qbe_sn       LIKE    gbm_file.gbm01
   ...
   #FUN-C60036--add--end
     ...
     #CONSTRUCT BY NAME g_wc ON omf00,omf03,omf01,omf02,omf05,omf06,omf07,omf22,omf08,omf30,omf24,omfpost   #FUN-C60036  #No.FUN-D10103   Add omf30#FUN-D20003 mark
      CONSTRUCT BY NAME g_wc ON omf00,omf03,omf01,omf02,
                                omf31,omf32,omf33,       #FUN-D50008 add #FUN-D50007 add omf32,omf33 
                                omf05,omf06,omf07,omf22,omf27,omf08, #FUN-D40106 add omf27
                                omf24,omfpost,omf04,#FUN-D20003 add
	    ...
	    WHEN INFIELD(omf07)
          ...
          #FUN-D50007--add--begin---
            ...
            WHEN INFIELD(omf33)
               ...
               NEXT FIELD omf33
          #FUN-D50007--add--end---
          #FUN-D40106--add---begin---
            WHEN INFIELD(omf27)
               CALL cl_init_qry_var()
               LET g_qryparam.form ="q_occ"
               LET g_qryparam.state = "c"
               CALL cl_create_qry() RETURNING g_qryparam.multiret
               DISPLAY g_qryparam.multiret TO  omf27
               NEXT FIELD omf27
          #FUN-D40106--add---end---
    ...
    #                   s_omf[1].omf29,s_omf[1].omf29x,s_omf[1].omf29t,s_omf[1].omf19,s_omf[1].omf19x,s_omf[1].omf19t,s_omf[1].omf04 # FUN-C60036 add omf04                  
	 ...
	 CASE
        ...
        #FUN-D10082--add--str--
            WHEN INFIELD(omf25)
               CALL cl_init_qry_var()
               #LET g_qryparam.form ="q_oea01_2"    #TQC-D50063 mark
               LET g_qryparam.form ="q_oea01_3"     #TQC-D50063 add
	       LET g_qryparam.state = "c"
               CALL cl_create_qry() RETURNING g_qryparam.multiret
...
FUNCTION t670_menu()
   ...
   WHILE TRUE
     ...
     #      SELECT omf_file.* INTO g_omf_1.*
            SELECT omf_file.* INTO g_omf_l[l_ac1].*
              FROM omf_file
        ...
        #FUN-D20003--add--end
         ...
         WHEN "exporttoexcel"     #FUN-4B0025
            IF cl_chk_act_auth() THEN
             ...
             #CALL cl_export_to_excel(ui.Interface.getRootNode(),base.TypeInfo.create(g_omf),'','')  #MOD-CA0160 add
              #FUN-D70109--mark-----
              #FUN-D70109-----add---str---
...
FUNCTION t670_a()
   ...
   WHILE TRUE
      ...
      IF cl_null(g_omf_1.omf00) THEN
         CONTINUE WHILE
      END IF
     #CALL s_auto_assign_no("axm",g_omf_1.omf00,g_omf_1.omf03,"","omf_file","omf00","","","") #TQC-D40067 mark 
     #     RETURNING li_result,g_omf_1.omf00     #TQC-D40067 mark
...
DEFINE l_flag       LIKE type_file.chr1  #MOD-D60035
  ...
  END IF 
  INPUT BY NAME g_omf_1.omf00,g_omf_1.omf03,g_omf_1.omf01,g_omf_1.omf02,
                g_omf_1.omf31,g_omf_1.omf32,g_omf_1.omf33,   #FUN-D50008 add #FUN-D50007 add
                g_omf_1.omf05,g_omf_1.omf06,  #FUN-C60033 ADD-omf00
      ...
      AFTER FIELD omf03
         IF NOT cl_null(g_omf_1.omf03) THEN 
            ...
            IF p_cmd = 'u' THEN 
               ...
               IF l_flag ='N' THEN 
                  CALL cl_err(g_omf_1.omf03,'axm-779',1)
                  NEXT FIELD omf03
               END IF    
            END IF 
            #MOD-D60035 add end-------------            
...
FUNCTION t670_q()
   ...
   ELSE
     ...
     #CALL t670_list_fill()   #No.FUN-D10091 #CHI-EA0009 mark
...
DEFINE
   ...
   ELSE
      ...
      SELECT UNIQUE omf00,omf01,omf02,omf03,omf05,omf051,omf06,omf061,omf07,omf08,omf22,
                    omf27,omf271,        #FUN-D40106 add omf27,omf271
    ...
    #   AND omf02 = g_omf_1.omf02   #FUN-C60033
      WHERE omf00 = g_omf_1.omf00   #FUN-C60033
      #CAll t670_upd_show_diff()  #MOD-D60161 add ##MOD-E20059 mark
      #FUN-C60036--add--str
    ...
    # FETCH t670_cl INTO g_omf_1.omf01,g_omf_1.omf02,g_omf_1.omf03,g_omf_1.omf05,g_omf_1.omf06,g_omf_1.omf07,g_omf_1.omf22   #FUN-C60033
     ...
     #No.FUN-D10103 ---start--- Add
      FETCH t670_cl INTO g_omf_1.omf00,g_omf_1.omf01,g_omf_1.omf02,
                         ...
                         g_omf_1.omf07,g_omf_1.omf22,g_omf_1.omf27, #FUN-D40106 add omf27
                         g_omf_1.omf30,
   ...
   WHILE TRUE
     ...
     #LET g_omf02_t = g_omf_1.omf02   #FUN-C60033
      ...
      UPDATE omf_file SET omf_file.omf00 = g_omf_1.omf00,  #FUN-C60033
                          ...
                          omf_file.omf05 = g_omf_1.omf05,  #FUN-D40106 add
                          omf_file.omf051= g_omf_1.omf051, #FUN-D40106 add
                          omf_file.omf06 = g_omf_1.omf06,  #FUN-D40106 add
                          omf_file.omf061= g_omf_1.omf061, #FUN-D40106 add
                          omf_file.omf07 = g_omf_1.omf07,  #FUN-D40106 add 
                          omf_file.omf27 = g_omf_1.omf27,  #FUN-D40106 add
                          omf_file.omf271= g_omf_1.omf271, #FUN-D40106 add
       ...
       ELSE
          ...
          IF g_omf_1.omf22 <> g_omf_1_t.omf22 THEN 
             ...
             IF g_success = 'N' THEN 
                ...
                CONTINUE WHILE
             ELSE 
               #CALL t670_list_fill() #CHI-EA0009 mark
                COMMIT WORK                
             END IF     
          ELSE 
          ##MOD-D40035 add end------------                
   ...
   ELSE
    ...
    # FETCH t670_cl INTO g_omf_1.omf00,g_omf_1.omf01,g_omf_1.omf02,g_omf_1.omf03,g_omf_1.omf05,g_omf_1.omf06,g_omf_1.omf07,g_omf_1.omf22   #FUN-C60033   #No.FUN-D10103   Mark
     ...
     # DELETE FROM omf_file WHERE omf01 = g_omf_1.omf01 AND omf02 = g_omf_1.omf02   #FUN-C60033
      ...
      #CALL t670_list_fill()   #No.FUN-D10091--add-- #CHI-EA0009 mark
       CALL g_omf.clear()
       MESSAGE ""
...
FUNCTION t670_list_fill()
  ...
  DEFINE l_omf00_t       LIKE omf_file.omf00
    ...
    LET m = 1
    #FOREACH t670_cs1 INTO l_omf00,l_omf21            #CHI-F80014 mark
    FOREACH t670_b_curs INTO l_omf00                  #CHI-F80014 add 
       IF SQLCA.sqlcode THEN
       ...
       ELSE
          LET l_omf00_t = l_omf00
       END IF
       SELECT '',omf00,omf03,omf01,omf02,omf05,omf051,omf06,omf07,omf22,
              omf10,omf11,omf12,omf13,omf14,omf15,omf16,omf17,
              omf29,omf19,omf04

         INTO g_omf_l[l_i].*
         FROM omf_file
        WHERE omf00=l_omf00
       #   AND omf21=l_omf21                          #CHI-F80014 mark
       LET g_omf_l[l_i].m = m
       LET l_i = l_i + 1
       ...
       END IF
    END FOREACH
    OPEN t670_b_curs                          #CHI-F80014 add
    LET g_rec_b1 = l_i - 1
...
DEFINE
    ...
    DEFINE l_occ41  LIKE occ_file.occ41   #FUN-D40106 add
    DEFINE l_occ42  LIKE occ_file.occ42   #FUN-D40106 add
   ...
   #IF g_omf_1.omf01 IS NULL THEN
    ...
    LET g_forupd_sql = "SELECT omf21,omf09,omf10,omf11,omf12,omf25,omf26,omf13,omf14,", #FUN-D10082 add omf25,omf26
        ...
        AFTER FIELD omf16
          ...
          #IF cl_null(g_omf[l_ac].omf16) THEN#MOD-CA0092 mark
           ...
           ELSE         
            ...
            #FUN-D10082--add--str--
             IF g_omf[l_ac].omf10 = '9' THEN 
                IF NOT cl_null(g_omf[l_ac].omf25) THEN  #TQC-D50063 add
      ...
      #FUN-C60036--mark--end
        ...
        AFTER INSERT
         ...
         #TQC-D40067--add--end----
           ...
           LET l_omf.omf27=g_omf_1.omf27   #FUN-D40106 add
           LET l_omf.omf271=g_omf_1.omf271 #FUN-D40106 add
	         ...
	         LET g_qryparam.default1 = g_omf[l_ac].omf25
              ...
              END IF    
               ...
               WHEN INFIELD(omf13)
                  CALL cl_init_qry_var()
                  LET g_qryparam.form ="q_ima"
                  LET g_qryparam.default1 = g_omf[l_ac].omf13
                  CALL cl_create_qry() RETURNING g_omf[l_ac].omf13
...
DEFINE p_wc   STRING   #MOD-8B0084
   ...
   LET g_sql = "SELECT omf21,omf09,omf10,omf11,omf12,omf25,omf26,omf13,omf14,'',", #FUN-D10082 add  omf25,omf26
...
FUNCTION t670_set_no_entry(p_cmd)
   ...
   IF p_cmd = 'u' AND g_chkey = 'N' AND ( NOT g_before_input_done ) THEN
      CALL cl_set_comp_entry("omf00,omf05,omf06,omf07,omf22,omf27",FALSE) #FUN-D40106 add omf27 
   END IF
   CALL cl_set_comp_entry("omf20,omf201",FALSE)
END FUNCTION
...
FUNCTION t670_omf11()
   ...
   #  CALL s_yp(g_omf_1.omf03) RETURNING l_yy2,l_mm2  #MOD-CC0049 add   #TQC-D20046 cj mark
      CASE
        ...
        #WHEN l_oga21 != g_omf_1.omf06    LET g_errno = 'axm-142'   #FUN-I40010 mark
         WHEN l_oga21 != g_omf_1.omf06    #TQC-I40002 add
        #--FUN-I40010 add start--
              LET l_n  = 0 
              SELECT COUNT(1) INTO l_n FROM hsc_file 
               WHERE hsc01 = l_oga21
                 AND hsc02 = g_omf_1.omf06  
                 AND hsc03 <= g_omf_1.omf31 
              IF l_n > 0 THEN
              ELSE                  
               LET g_errno = 'axm-142'
              END IF 
  ...
  #   CALL s_yp(g_omf_1.omf03) RETURNING l_yy2,l_mm2  #MOD-CC0049 add  #TQC-D20046 cj add
      CASE
        ...
        #WHEN l_oha21 != g_omf_1.omf06    LET g_errno = 'axm-142'   #FUN-I40010 mark
         WHEN l_oha21 != g_omf_1.omf06    #TQC-I40002 add
        #--FUN-I40010 add start--
         LET l_n  = 0 
         SELECT COUNT(1) INTO l_n FROM hsc_file 
          WHERE hsc01 = l_oha21
...
#MOD-D10266  add begin--------
     ...
     #IF g_oaz.oaz93 = 'N' THEN #CHI-EC0033 mark 
      ...
      END IF 
      IF STATUS OR SQLCA.SQLERRD[3]=0 THEN
         CALL cl_err3("upd","omf_file",l_omf.omf11,l_omf.omf12,STATUS,"","upd omf24",1)
         LET g_success = 'N'
         ROLLBACK WORK
         RETURN
      END IF
...
FUNCTION t670_w() 			
  ...
  #FUN-D40106--add---begin---
   SELECT DISTINCT omf05,omf27 INTO g_omf_1.omf05,g_omf_1.omf27 FROM omf_file 
    WHERE omf00 = g_omf_1.omf00
    
   IF g_omf_1.omf05 <> g_omf_1.omf27 THEN 
      CALL cl_err(g_omf_1.omf00,'mfg-124',1)
      RETURN 
   END IF 
  #FUN-D40106--add---end---
   ...
   FOREACH omf_curs4 INTO l_omf.*
   	  ...
   	  IF NOT cl_null(l_omf.omf11) AND NOT cl_null(l_omf.omf12) THEN
            ...
            ELSE
               ...
               SELECT img10 INTO li_img10 FROM img_file
                WHERE img01 = l_omf.omf13
                 ...
                 #AND img03 = l_omf.omf05  #FUN-D40106 mark
                  AND img03 = l_omf.omf27  #FUN-D40106 add
                  AND img04 = l_omf.omf202
                  IF SQLCA.sqlcode THEN
                    #CALL s_add_img(l_omf.omf13,l_omf.omf20,l_omf.omf05,l_omf.omf202,l_omf.omf00,l_omf.omf21,l_omf.omf24)#FUN-D40106 mark
                     CALL s_add_img(l_omf.omf13,l_omf.omf20,l_omf.omf27,l_omf.omf202,l_omf.omf00,l_omf.omf21,l_omf.omf24)#FUN-D40106 omf05->omf27
                  END IF
               END IF
            ...
            #FUN-C60036--add--end
                 ...
                 #CALL s_upimg(l_omf.omf13,l_omf.omf20,l_omf.omf05,l_omf.omf202,  #FUN-D40106 mark
                  CALL s_upimg(l_omf.omf13,l_omf.omf20,l_omf.omf27,l_omf.omf202,  #FUN-D40106 add
                  #No.MOD-CB0192  --End
                 ...
                 #CALL t670_tlf(l_omf.omf13,l_omf.omf20,l_omf.omf05,l_omf.omf202,l_omf.omf16,l_omf.omf10,l_omf.omf00,l_omf.omf21,  #FUN-D40106 mark
                  CALL t670_tlf(l_omf.omf13,l_omf.omf20,l_omf.omf27,l_omf.omf202,l_omf.omf16,l_omf.omf10,l_omf.omf00,l_omf.omf21,  #FUN-D40106 add
            ...
            #FUN-C60036-add--str
               ELSE
                ...
                #CALL t670_tlf(l_omf.omf13,l_omf.omf20,l_omf.omf05,l_omf.omf202,l_omf.omf917,l_omf.omf10,l_omf.omf00,l_omf.omf21,  #FUN-D40106 mark
                 CALL t670_tlf(l_omf.omf13,l_omf.omf20,l_omf.omf27,l_omf.omf202,l_omf.omf917,l_omf.omf10,l_omf.omf00,l_omf.omf21,  #FUN-D40106 add
                 ...
                 SELECT ima906 INTO l_ima906 FROM ima_file
                   WHERE ima01=l_omf.omf13
                     IF l_ima906 = '1' THEN
                        CALL s_upimg_imgs(
                            ...
                            #l_omf.omf13,l_omf.omf20,l_omf.omf05,l_omf.omf202,l_type,  #FUN-D40106 mark
                             l_omf.omf13,l_omf.omf20,l_omf.omf27,l_omf.omf202,l_type,  #FUN-D40106 add
                             #No.MOD-CB0192  --End
		            	...
		            	CALL s_upimg_imgs(
                            ...
                            #l_omf.omf13,l_omf.omf20,l_omf.omf05,l_omf.omf202,l_type,
                             l_omf.omf13,l_omf.omf20,l_omf.omf27,l_omf.omf202,l_type,
                             #No.MOD-CB0192  --End
                     ...
                     IF l_ima906 = '2' THEN
                        IF NOT cl_null(l_omf.omf912) THEN
                             CALL t670sub_upd_imgg(
                                       ...
                                       #'1',l_omf.omf13,l_omf.omf20,l_omf.omf05,l_omf.omf202,  #FUN-D40106 mark
                                        '1',l_omf.omf13,l_omf.omf20,l_omf.omf27,l_omf.omf202,  #FUN-D40106 add
                                       #No.MOD-CB0192  --End
                          ...
                          #CALL s_upimg_imgs(l_omf.omf13,l_omf.omf20,l_omf.omf05,l_omf.omf202,l_type,  #FUN-D40106 mark
                           CALL s_upimg_imgs(l_omf.omf13,l_omf.omf20,l_omf.omf27,l_omf.omf202,l_type,  #FUN-D40106 add
                           #No.MOD-CB0192  --End
                    ...
                    IF l_ima906 = '3' THEN
                       CALL t670sub_upd_imgg(
                           ...
                           #'2',l_omf.omf13,l_omf.omf20,l_omf.omf05,l_omf.omf202,  #FUN-D40106 mark
                            '2',l_omf.omf13,l_omf.omf20,l_omf.omf27,l_omf.omf202,  #FUN-D40106 add
                           #No.MOD-CB0192  --End
                  ...
                  #  END IF 
	                #CALL t670sub_tlff('2',l_omf.omf13,l_omf.omf20,l_omf.omf05,l_omf.omf202,  #FUN-D40106 mark
	                 CALL t670sub_tlff('2',l_omf.omf13,l_omf.omf20,l_omf.omf27,l_omf.omf202,  #FUN-D40106 add
                                       l_omf.omf913,l_omf.omf914,l_omf.omf915,l_omf.*,l_type,l_omf.omf03,l_tlf14)  #TQC-C80042 add tlf14 
                  END IF #MOD-CC0206 add
                  IF l_ima906 = '2' THEN #FUN-C60033 add
                    #CALL t670sub_tlff('2',l_omf.omf13,l_omf.omf20,l_omf.omf05,l_omf.omf202,#TQC-D20046 addxuxz #FUN-D40106 mark
                     CALL t670sub_tlff('2',l_omf.omf13,l_omf.omf20,l_omf.omf27,l_omf.omf202,#TQC-D20046 addxuxz #FUN-D40106 add
                                          l_omf.omf913,l_omf.omf914,l_omf.omf915,l_omf.*,l_type,l_omf.omf03,l_tlf14)#TQC-D20046 addxuxz
                    #CALL t670sub_tlff('1',l_omf.omf13,l_omf.omf20,l_omf.omf05,l_omf.omf202,  #FUN-D40106 mark
                     CALL t670sub_tlff('1',l_omf.omf13,l_omf.omf20,l_omf.omf27,l_omf.omf202,  #FUN-D40106 add
            ...
            IF g_sma.sma115 = 'Y' THEN
                      IF l_ima906 = '1' THEN
                         IF g_sma.sma115='Y' THEN
                           ...
                           #CALL s_upimg_imgs(l_omf.omf13,l_omf.omf20,l_omf.omf05,l_omf.omf202,1,l_omf.omf00,l_omf.omf21,l_omf.omf916,'2') #FUN-D40106 mark
                            CALL s_upimg_imgs(l_omf.omf13,l_omf.omf20,l_omf.omf27,l_omf.omf202,1,l_omf.omf00,l_omf.omf21,l_omf.omf916,'2') #FUN-D40106 add
                            #No.MOD-CB0192  --End
                         END IF
                      END IF
                      IF l_ima906 = '2' THEN
                           ...
                           #CALL t670_du(l_omf.omf20,l_omf.omf05,l_omf.omf202,  #FUN-D40106 mark
                            CALL t670_du(l_omf.omf20,l_omf.omf27,l_omf.omf202,  #FUN-D40106 add
                            #No.MOD-CB0192  --End
                      ...
                      IF l_ima906 = '3' THEN
                         ...
                         IF g_sma.sma115='Y' THEN
                           ...
                           #CALL s_upimg_imgs(l_omf.omf13,l_omf.omf20,l_omf.omf05,l_omf.omf202,1,l_omf.omf00,l_omf.omf21,l_omf.omf913,'2') #FUN-D40106 mark
                            CALL s_upimg_imgs(l_omf.omf13,l_omf.omf20,l_omf.omf27,l_omf.omf202,1,l_omf.omf00,l_omf.omf21,l_omf.omf913,'2') #FUN-D40106 add
                            #No.MOD-CB0192  --End
                         END IF
                      END IF
               END IF
...
#MOD-D10265 add end--------------------------------      
   ELSE
      ...
      PREPARE sel_oha09_pre FROM li_sql
      EXECUTE sel_oha09_pre INTO l_oha09
   #  LET l_str="axrp304 '",g_omf[l_ac].omf11,"' '",l_oha09,"' '",g_omf[l_ac].omf09,"' '' '",g_omf_1.omf03,"' '' '' '' 'N' '' '",l_wc,"' 'axmt670'"#FUN-CA0084 mod ''-->omf03   #FUN-D50050 mark
   #FUN-D50050 ------Begin------
      SELECT oaz109 INTO g_oaz.oaz109 FROM oaz_file
      #LET l_str="axrp304 '",g_omf[l_ac].omf11,"' '",l_oha09,"' '",g_omf[l_ac].omf09,"' '' '",g_omf_1.omf03,"' '",g_oaz.oaz109,"' '' '' 'N' '' '",l_wc,"' 'axmt670'"
      LET l_str="axrp304 '",g_omf[l_ac].omf11,"' '",l_oha09,"' '",g_omf[l_ac].omf09,"' '' '",g_omf_1.omf03,"' '",g_oaz.oaz109,"' '' '' 'N' '' '' '",l_wc,"' 'axmt670'"  #MOD-DA0012
   #FUN-D50050 ------End--------
   END IF 
  ...
  #END FOREACH
   ...
   #FUN-DB0007--add--str--
   IF NOT cl_null(g_omf_1.omf01) AND NOT cl_null(g_omf_1.omf02)
      AND NOT cl_null(g_omf_1.omf04) THEN
      CALL t670_ins_upd_ome()
      IF g_success='N' THEN
         ROLLBACK WORK
      ELSE
         COMMIT WORK 
...
FUNCTION t670_chk_omf05(p_cmd)
   ...
   IF NOT cl_null(g_omf_1.omf05) THEN     
    ...
    #FUN-D40106--add---begin--
      LET g_omf_1.omf27 = g_omf_1.omf05
      SELECT occ02 INTO g_omf_1.omf271 FROM occ_file WHERE occ01 = g_omf_1.omf27
      DISPLAY BY NAME g_omf_1.omf27,g_omf_1.omf271
    #FUN-D40106--add---end---
   ...
   #BEGIN WORK
    ...
    LET l_count = g_cnt - 1
      ...
      ELSE        
        ...
        #   VALUES ('axmt670',g_user,g_today,g_msg,l_oma.oma01,'delete',g_plant,g_legal)  #FUN-DA0126
...
FUNCTION t670_fresh()
   ...
   SELECT UNIQUE omf00,omf01,omf02,omf03,omf05,omf051,omf06,omf061,omf07,omf08,omf22,omf27,omf271,   #FUN-D40103 add omf27,omf271
                 omf30,omf24,omfpost,omf04,'','','', '','','',   #MOD-D10128 add 3个'' #No.FUN-D10103  Add omf30#FUN-D20003 add omf04
                 omf31,omf32,omf33,omfuser,omfgrup,omforiu,omforig,omfmodu,omfdate  #FUN-D50007 ADD    
     INTO g_omf_1.*
     FROM omf_file
    WHERE omf00 = g_omf_1.omf00 
...
FUNCTION t670_set_no_entry_b(p_cmd)
   ...
   IF l_ac>0 THEN
      IF g_omf[l_ac].omf10 = '9' THEN
         ...
         #CALL cl_set_comp_entry('omf13,omf14,omf15,omf17',FALSE)        #FUN-D10082 add #TQC-D50063 mark
         CALL cl_set_comp_entry('omf14,omf15,omf17',FALSE)      #TQC-D50063 add
      ELSE
...
DEFINE l_occ02    LIKE occ_file.occ02
    ...
    IF g_omf_1.omf08 != 'Y' THEN 
       CALL cl_err(g_omf_1.omf00,'mfg-125',0) 
       RETURN 
    END IF
    
    IF g_omf_1.omfpost = 'Y' THEN 
       CALL cl_err(g_omf_1.omf00,'mfg-126',0) 
       RETURN 
    END IF     
...
#sunlm add end------------------
#FUN-DB0007--add--str--
FUNCTION t670_ins_upd_ome()
DEFINE l_n       LIKE type_file.num5,
       l_gec06   LIKE gec_file.gec06,
       l_gec08   LIKE gec_file.gec08,
       l_omf19   LIKE omf_file.omf19,
       l_omf19x  LIKE omf_file.omf19x,
       l_omf19t  LIKE omf_file.omf19t
DEFINE l_ome     RECORD LIKE ome_file.*,
       l_omee    RECORD LIKE omee_file.*,
       l_oma     RECORD LIKE oma_file.*

   LET g_success='Y'
   SELECT COUNT(*) INTO l_n FROM ome_file
   WHERE ome00='1' AND ome16=g_omf_1.omf04
   IF l_n>0 THEN
      UPDATE ome_file SET ome01=g_omf_1.omf01,
                          ome02=g_omf_1.omf03,
                          ome03=g_omf_1.omf02
       WHERE ome00='1' AND ome16=g_omf_1.omf04
      IF SQLCA.sqlcode OR SQLCA.sqlerrd[3] = 0 THEN
         CALL cl_err3("upd","ome_file",g_omf_1.omf04,"",SQLCA.sqlcode,"","",1)
         LET g_success='N'
         RETURN
      END IF
   ELSE
      ...
      LET l_ome.ome00='1'
      LET l_ome.ome01=g_omf_1.omf01
      LET l_ome.ome02=g_omf_1.omf03
      LET l_ome.ome04=g_omf_1.omf05
      SELECT * INTO l_oma.* FROM oma_file WHERE oma01=g_omf_1.omf04
      LET l_ome.ome042=l_oma.oma042
      LET l_ome.ome043=l_oma.oma043
      LET l_ome.ome044=l_oma.oma044
      LET l_ome.ome05=l_oma.oma05
      LET l_ome.ome08=l_oma.oma08
      LET l_ome.ome16=l_oma.oma01
      SELECT gec06,gec08 INTO l_gec06,l_gec08 FROM gec_file
      WHERE gec01 = g_omf_1.omf06
      LET l_ome.ome171=l_gec08
      LET l_ome.ome172=l_gec06
      LET l_ome.ome21=l_oma.oma21
      LET l_ome.ome211=l_oma.oma211
      LET l_ome.ome212=l_oma.oma212
      LET l_ome.ome213=l_oma.oma213
      SELECT SUM(omf19),SUM(omf19x),SUM(omf19t) INTO l_omf19,l_omf19x,l_omf19t
      FROM omf_file WHERE omf00=g_omf_1.omf00
      IF cl_null(l_omf19) THEN LET l_omf19=0 END IF
      IF cl_null(l_omf19x) THEN LET l_omf19x=0 END IF
      IF cl_null(l_omf19t) THEN LET l_omf19t=0 END IF
      LET l_ome.ome59=l_omf19
      LET l_ome.ome59x=l_omf19x
      LET l_ome.ome59t=l_omf19t
      LET l_ome.omevoid='N'
      LET l_ome.omeprsw=0
      LET l_ome.omeuser=g_user
      LET l_ome.omegrup=g_plant
      LET l_ome.omedate=g_today
      LET l_ome.omelegal=g_legal
      LET l_ome.omeoriu=g_user
      LET l_ome.omeorig=g_grup
      LET l_ome.ome70='N'
      LET l_ome.ome74=0
      LET l_ome.ome75=0
      LET l_ome.ome76=0
      ...
      LET l_ome.ome79=0
      LET l_ome.ome80=0
      LET l_ome.ome03=g_omf_1.omf02
      LET l_ome.ome22='N'
      LET l_ome.omecncl='N'
      LET l_ome.ome81=' '
      LET l_ome.ome82=TIME  #FUN-DA0127
      LET l_ome.ome83='0'   #FUN-DA0127
      LET l_ome.ome84 = 1   #FUN-F60042 add
      INSERT INTO ome_file VALUES(l_ome.*)
      IF SQLCA.sqlcode OR SQLCA.SQLERRD[3] = 0 THEN
         CALL cl_err3("ins","ome_file","","",SQLCA.sqlcode,"","",1)
         LET g_success='N'
         RETURN
      END IF
   END IF
   
   SELECT COUNT(*) INTO l_n FROM omee_file WHERE omee02=g_omf_1.omf04
   IF l_n>0 THEN
      UPDATE omee_file SET omee01=g_omf_1.omf01,
                           omee03=g_omf_1.omf02
       WHERE omee02=g_omf_1.omf04
      IF SQLCA.sqlcode OR SQLCA.sqlerrd[3] = 0 THEN
         CALL cl_err3("upd","ome_file",g_omf_1.omf04,"",SQLCA.sqlcode,"","",1)
         LET g_success='N'
         RETURN
   ...
   ELSE
      ...
      LET l_omee.omee01=g_omf_1.omf01
      LET l_omee.omee02=g_omf_1.omf04
      ...
      LET l_omee.omee03=g_omf_1.omf02
      LET l_omee.omee84 = 1            #FUN-F60042 add
      INSERT INTO omee_file VALUES(l_omee.*)
      IF SQLCA.sqlcode OR SQLCA.SQLERRD[3] = 0 THEN
         CALL cl_err3("ins","omee_file","","",SQLCA.sqlcode,"","",1)
         LET g_success='N'
         RETURN
      END IF
   END IF
