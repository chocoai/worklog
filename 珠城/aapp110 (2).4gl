...
# Modify.........: No.MOD-DC0168 13/12/18 By yinhy 沖銷待抵單時抓取重估匯率
              ...
              #大陸版應增加卡關,判斷若入庫單當月沒先立暫估帳款,不可跨月產生帳款!
               IF YEAR(g_rvv09)  < YEAR(g_apa02) OR
                 (YEAR(g_rvv09)  = YEAR(g_apa02) AND 
                  ...
                  #IF l_cnt = 0 THEN #FUN-D70021 mark
                  IF g_apb.apb12[1,4] != 'MISC' AND l_cnt = 0 THEN #FUN-D70021
...
FUNCTION p110_prepaid_off()
   ...
   IF prepaid_off_sw = 'Y' THEN            # 若要自動將預付款依 P/O# 帶出沖銷
      ...
      FOREACH p110_kkk_c0 INTO l_apa.*,l_apc.*  #No.FUN-680027 新增l_apc
          LET l_n2 = 0
         SELECT COUNT(*) INTO l_n2 FROM apb_file WHERE  apb01= l_apa.apa08
               AND apb06 IN ( select distinct rvv36 from rvv_file,rvw_file where rvv01=rvw08 and  rvw08 in (select rvw08 from rvw_file WHERE rvw01= g_rvb22 ) )
        ...
        #IF l_apv.apv04f > g_apa.apa34f + l_apk08f_s THEN                #MOD-AC0230 #MOD-C30800 mark
         IF l_apv.apv04f > l_apa34f + l_apk08f_s -l_apv04f_z THEN    #MOD-C30800 add   #150909 renjj mod g_apa.apa34f to l_apa34f
           #LET l_apv.apv04f= g_apa.apa34f                      #MOD-AC0230 mark 
           #LET l_apv.apv04f= g_apa.apa34f + l_apk08f_s                  #MOD-AC0230 #MOD-C30800 mark
            LET l_apv.apv04f= l_apa34f+ l_apk08f_s - l_apv04f_z     #MOD-C30800 add  #150909 renjj mod g_apa.apa34f to l_apa34f     
        ...
        #IF l_apa.apa34f > 0 AND g_apa.apa34f = 0 THEN       #MOD-A70131 add            #MOD-D30007 mark
         IF l_apa.apa34f > 0 AND (l_apa34f + l_apk08f_s -l_apv04f_z) = 0 AND l_apv.apv04f > l_apa.apa34f THEN  #MOD-D30007 #150909 renjj mod g_apa.apa34f to (l_apa34f + l_apk08f_s -l_apv04f_z)
        ...
        #IF l_apv.apv04f > g_apa.apa34f AND l_apv.apv04f > g_apa.apa57f THEN                        #MOD-D30007 mark
         IF l_apv.apv04f >(l_apa34f + l_apk08f_s -l_apv04f_z) AND l_apv.apv04f > g_apa.apa57f AND (l_apa34f + l_apk08f_s -l_apv04f_z) <> 0 THEN  #MOD-D30007)#150909 renjj mod g_apa.apa34f to (l_apa34f + l_apk08f_s -l_apv04f_z)
            #LET l_apv.apv04f= g_apa.apa57f - g_apa.apa34f  #MOD-C30592 mark
            LET l_apv.apv04f= l_apa34f + l_apk08f_s -l_apv04f_z                 #MOD-C30592 #150909 renjj mod g_apa.apa34f to (l_apa34f + l_apk08f_s -l_apv04f_z)                 #MOD-C30592
            LET l_apv.apv04 = l_apv.apv04f * l_apa.apa14
            #No.MOD-DC0168  --Begin
            IF g_apz.apz27 = 'Y' AND l_apa.apa13 !=g_aza.aza17 THEN
               LET l_apv.apv04 = l_apv.apv04f * l_apa.apa72  
...
#-------------------------------No.MOD-B60198------------------------end
     ...
     #-----------------------MOD-C70248---------------(E)
      ...
      #No.MOD-DC0168  --Begin
      IF g_apz.apz27 = 'Y' AND l_apa.apa13 !=g_aza.aza17 THEN
         IF l_apv04_sum != cl_digcut(l_apv04f_sum*g_apa.apa72,g_azi04) THEN
            LET l_diff_apv04 = cl_digcut(l_apv04f_sum*g_apa.apa72,g_azi04) - l_apv04_sum
         END IF
      ELSE
      #No.MOD-DC0168  --End
...
#        SELECT apb10,apb24 INTO l_apb10,l_apb24 FROM apb_file WHERE apb01=p_api.api26 AND apb02=l_apb02
        ...
        #-MOD-C50137-end- 
         ...
         #LET p_api.api40 = 1         #CHI-E30030 mark
         LET p_api.api40 = l_apb02   #CHI-E30030 add 
