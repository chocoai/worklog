...
# Modify.........: No.MOD-180925 18/09/25 By lixwz 修复多笔预付时,冲待抵账款时,有一笔为负数的情况.
DATABASE ds
   ...
   IF prepaid_off_sw = 'Y' THEN            # 若要自動將預付款依 P/O# 帶出沖銷
      ...
      FOREACH p110_kkk_c0 INTO l_apa.*,l_apc.*  #No.FUN-680027 新增l_apc
        ...
        #IF l_apv.apv04f > g_apa.apa34f + l_apk08f_s THEN                #MOD-AC0230 #MOD-C30800 mark
         IF l_apv.apv04f > l_apa34f + l_apk08f_s -l_apv04f_z THEN    #MOD-C30800 add   #MOD-180925 mod g_apa.apa34f to l_apa34f
           #LET l_apv.apv04f= g_apa.apa34f                      #MOD-AC0230 mark
           #LET l_apv.apv04f= g_apa.apa34f + l_apk08f_s                  #MOD-AC0230 #MOD-C30800 mark
            LET l_apv.apv04f= l_apa34f+ l_apk08f_s - l_apv04f_z     #MOD-C30800 add  #MOD-180925 mod g_apa.apa34f to l_apa34f
        ...
        #IF l_apa.apa34f > 0 AND g_apa.apa34f = 0 THEN       #MOD-A70131 add            #MOD-D30007 mark
         IF l_apa.apa34f > 0 AND (l_apa34f + l_apk08f_s -l_apv04f_z) = 0 AND l_apv.apv04f > l_apa.apa34f THEN  #MOD-D30007 #MOD-180925 mod g_apa.apa34f to (l_apa34f + l_apk08f_s -l_apv04f_z)
        ...
        #IF l_apv.apv04f > g_apa.apa34f AND l_apv.apv04f > g_apa.apa57f THEN                        #MOD-D30007 mark
         IF l_apv.apv04f >(l_apa34f + l_apk08f_s -l_apv04f_z) AND l_apv.apv04f > g_apa.apa57f AND (l_apa34f + l_apk08f_s -l_apv04f_z) <> 0 THEN  #MOD-D30007)#MOD-180925 mod g_apa.apa34f to (l_apa34f + l_apk08f_s -l_apv04f_z)
            #LET l_apv.apv04f= g_apa.apa57f - g_apa.apa34f  #MOD-C30592 mark
            LET l_apv.apv04f= l_apa34f + l_apk08f_s -l_apv04f_z                 #MOD-C30592 #MOD-180925 mod g_apa.apa34f to (l_apa34f + l_apk08f_s -l_apv04f_z)                 #MOD-C30592
            LET l_apv.apv04 = l_apv.apv04f * l_apa.apa14
            #No.MOD-DC0168  --Begin
            IF g_apz.apz27 = 'Y' AND l_apa.apa13 !=g_aza.aza17 THEN
               LET l_apv.apv04 = l_apv.apv04f * l_apa.apa72
