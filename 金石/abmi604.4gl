...
DEFINE
    ...
    g_bmd           DYNAMIC ARRAY OF RECORD    #程式變數(Program Variables)
        ...
        bmd07       LIKE type_file.num20_6,  # mod by lixwz 180416   #QPA
...
MAIN
    ...
    LET g_sql = "l_order1.bmd_file.bmd01,",
                ...
                "bmd07.type_file.num20_6" # mod by lixwz 180416
...
DEFINE  l_i         LIKE type_file.num5,     #TQC-B90236 add
        l_sum_bmd07 LIKE type_file.num20_6      #TQC-B90236 add # mod by lixwz 180416
...
DEFINE  l_i         LIKE type_file.num5,     #No.TQC-B90236
        l_sum_bmd07 LIKE type_file.num20_6      #No.TQC-B90236 # mod by lixwz 180416
...
DEFINE
    ...
    sr              RECORD
        ...
        bmd07       LIKE type_file.num20_6  # mod by lixwz 180416
                    END RECORD,
