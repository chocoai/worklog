...
#No.MOD-9B0115 --begin
      ...
      LET l_sql = "SELECT apa00,apa01,apa02,apa06,apa07,apc12,apa58,apc02,apc04,apa13,apa25,",   #MOD-880086 add apa08,apa58 #CHI-AB0019 add apc04 #CHI-AB0004 add apc02
                 ...
                 # " WHERE apa42 = 'N' ",                      #zhouxm160217         #非作廢&外購付款  #MOD-CA0154 add
                 # "   AND (apa75 = 'N' OR apa75 IS NULL) ",    #zhouxm160217        #非作廢&外購付款  #MOD-CA0154 add
                  "   AND apa02 <='",tm.e_date,"'",
                 ...
                 # "                   WHERE apf01=apg01 AND (apf00 LIKE '3%') ",   #zhouxm160217                         #MOD-C70238 add
                  "                     AND apf41 = 'Y' ",
      ...
      LET l_sql = l_sql," UNION ALL ",   #MOD-B50196 add ALL
                 ...
                 # "       alk25 ,'O' ",         #MOD-C50072  #zhouxm160217
      ...
      LET l_sql = l_sql," UNION ALL ",
                  ...
                  "   AND apf41 ='Y' AND apf00 = '36' AND apf02 > '",tm.e_date,"')"
...
#----------------------#MOD-B60199 end-----------------------------------
      ...
      #CHI-850030 add --start--
         ...
         IF sr.apa74='O' THEN  #外購
            SELECT alh14,alh16 INTO alh.*
             ...
             WHERE alh30 = sr.apa01
              # AND alhfirm = 'Y'     #TQC-C50219   add  #zhouxm160217
              # AND alh02 <= tm.e_date                    #zhouxm160217           #MOD-CA0051 add
         ...
         IF sr.apa74='R' THEN  #預購
            ...
            IF ala.ala86 !="" OR (NOT cl_null(ala.ala86)) THEN
              ...
              #MOD-C50072---S---
           #    LET l_alk02=0   LET l_alk26=0  #zhouxm160217
           #--------------------------MOD-D10055-----------------------(S)
           #--MOD-D10055--mark
      ...
      #IF sr.apa34f =0 THEN CONTINUE FOREACH END IF  #CHI-850030 add        #zhouxm160217
      IF sr.apa34 =0 THEN CONTINUE FOREACH END IF  #CHI-850030 add        #zhouxm160217
      ...
      #CALL r150_apa44_ref(sr.*) RETURNING sr.apa44   #MOD-880086 add  #zhouxm160217
      ...
      CALL cl_digcut(sr.apa34,t_azi04) RETURNING sr.apa34   #zhouxm160217 add
