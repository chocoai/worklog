...
# Modify.........: 17/02/23 By shijl 170223 单身添加显示字段imaud01
...
DEFINE   g_omf_1         RECORD
         ...
         g_omf           DYNAMIC ARRAY OF RECORD    #程式變數(Program Variables)
                         ...
                         imaud01     LIKE ima_file.imaud01, #add by shijl 170223
                         ...
                         # add by lixwz180123 s
                         obk03       LIKE obk_file.obk03,
                         ta_omf001   LIKE omf_file.ta_omf001,
                         ta_omf002   LIKE omf_file.ta_omf002
                         # add by lixwz180123 e
...
DEFINE g_omf_l           DYNAMIC ARRAY OF RECORD
                         ...
                         omf11       LIKE omf_file.omf11,
                         omf12       LIKE omf_file.omf12,
                         omf25       LIKE omf_file.omf25,  #add by dengsy161109
                         omf26       LIKE omf_file.omf26,  #add by dengsy161109
                         omf13       LIKE omf_file.omf13,
                         omf14       LIKE omf_file.omf14,
                         imaud01     LIKE ima_file.imaud01, #add by shijl 170223
                         omf15       LIKE omf_file.omf15,
                         ...
                         omf17       LIKE omf_file.omf17,
                         omf29       LIKE omf_file.omf29,
                         omf29t       LIKE omf_file.omf29t,  #add by dengsy161109
                         omf29x       LIKE omf_file.omf29x,  #add by dengsy161109
                         omf19       LIKE omf_file.omf19,
                         omf19t       LIKE omf_file.omf19t,  #add by dengsy161109
                         omf19x       LIKE omf_file.omf19x,  #add by dengsy161109
...
MAIN
   ...
   #add by shijl 170223--str--
   IF g_plant='DPM'  THEN
     CALL cl_set_comp_visible("imaud01",TRUE)
     CALL cl_set_comp_visible("imaud01_l_1",TRUE)
     CALL cl_getmsg('cxm-001',g_lang) RETURNING g_msg
     CALL cl_set_comp_att_text("omf14,omf14_l_1",g_msg CLIPPED)
     CALL cl_getmsg('cxm-002',g_lang) RETURNING g_msg
     CALL cl_set_comp_att_text("omf15,omf15_l_1",g_msg CLIPPED)
   ELSE
     CALL cl_set_comp_visible("imaud01",FALSE)
     CALL cl_set_comp_visible("imaud01_l_1",FALSE)
   END IF
   #add by shijl 170223--end--
   # add by lixwz180123 s
   IF g_plant = 'DPM' THEN
      CALL cl_set_comp_visible('obk03',TRUE)
   ELSE
      CAll cl_set_comp_visible('obk03',FALSE)
   END IF
   IF g_plant = 'SWAP' THEN
      CALL cl_set_comp_visible('ta_omf001,ta_omf002',TRUE)
   ELSE
      CALL cl_set_comp_visible('ta_omf001,ta_omf002',FALSE)
   END IF
   # add by lixwz180123 e
...
FUNCTION t670_menu()
   ...
   WHILE TRUE
     ...
     #      SELECT omf_file.* INTO g_omf_1.*
            #SELECT omf_file.*  #mark by dengsy161109
           SELECT '',omf00,omf03,omf01,omf02,omf05,omf051,omf06,omf07,omf22,omf10,omf11,omf12,omf25,omf26,omf13,omf14,imaud01,omf15,omf16,omf17, #add by dengsy161109 #add imaud01 by shijl 170223
              omf29,omf29t,omf29x,omf19,omf19t,omf19x,omf04   #add by dengsy161109
            INTO g_omf_l[l_ac1].*
              FROM omf_file
               LEFT join ima_file ON ima01 = omf13  #add by shijl 170223
      ...
      CASE g_action_choice
        ...
        #FUN-D20003--add--end
         ...
         WHEN "exporttoexcel"     #FUN-4B0025
            IF cl_chk_act_auth() THEN
             #CALL cl_export_to_excel(ui.Interface.getRootNode(),base.TypeInfo.create(g_omf_l),'','')  #MOD-CA0160 mark #xueyh160728 cancel mark #mark by dengsy161109
             #str------- add by dengsy161109
             ...
             END IF
              #end------- add by dengsy161109
             # CALL cl_export_to_excel(ui.Interface.getRootNode(),base.TypeInfo.create(g_omf),'','')  #MOD-CA0160 add #xueyh160728 mark
            END IF
...
FUNCTION t670_a()
   ...
   WHILE TRUE
      ...
      IF cl_null(g_omf_1.omf00) THEN
         CONTINUE WHILE
      END IF
       CALL s_auto_assign_no("axm",g_omf_1.omf00,g_omf_1.omf03,"","omf_file","omf00","","","") RETURNING li_result,g_omf_1.omf00 #TQC-D40067 mark #remark by liufang161226
      IF (NOT li_result) THEN #TQC-D40067 mark #remark by liufang161226
         CONTINUE WHILE #TQC-D40067 mark #remark by liufang161226
      END IF #TQC-D40067 mark #remark by liufang161226
...
# DEFINE l_omf00      LIKE omf_file.omf00   #TQC-D40067 add #mark by liufang161226

   LET g_ss='Y'

   CALL cl_set_head_visible("","YES")           #No.FUN-6B0032
   CALL cl_set_comp_required('omf25',TRUE) #add muping151217
  ...
  INPUT BY NAME g_omf_1.omf00,g_omf_1.omf03,g_omf_1.omf01,g_omf_1.omf02,   #FUN-C60033 ADD-omf00
     ...
     #    CALL cl_set_docno_format("omf00")  #TQC-D40067 add #mark by liufang161226
     #FUN-C60033---ADD---STR
      AFTER FIELD omf00
         IF (p_cmd = 'a') OR
            (p_cmd = 'u' AND g_omf_1_t.omf00 != g_omf_1.omf00) THEN
            IF NOT cl_null(g_omf_1.omf00) AND NOT cl_null(g_omf_1.omf00) THEN
       #        CALL s_get_doc_no(g_omf_1.omf00) RETURNING l_omf00 #TQC-D40067 add #mark by liufang161226
               CALL t670_oay_chk(g_omf_1.omf00)  #TQC-D40067 mark #remark by liufang161226
           #    CALL t670_oay_chk(l_omf00)         #TQC-D40067 add #mark by liufang161226
...
DEFINE
   ...
   ELSE
    ...
    #   AND omf02 = g_omf_1.omf02   #FUN-C60033
      ...
      SELECT azi04 INTO t_azi04 FROM azi_file
             WHERE azi01 = g_omf_1.omf07
      #CAll t670_upd_show_diff()  #MOD-D60161 add#yaotg160701 mark
      #FUN-C60036--add--str
  ...
  DEFINE l_omf00_t       LIKE omf_file.omf00
    ...
    FOREACH t670_cs1 INTO l_omf00,l_omf21
       ...
       ELSE
          LET l_omf00_t = l_omf00
       END IF
       SELECT '',omf00,omf03,omf01,omf02,omf05,omf051,omf06,omf07,omf22,omf10,omf11,omf12,omf25,omf26,omf13,omf14,imaud01,omf15,omf16,omf17, #add omf25,omf26, by dengsy161109 #add imaud01 by shijl 170223
              #omf29,omf19,omf04  #mark by dengsy161109
              omf29,omf29t,omf29x,omf19,omf19t,omf19x,omf04  #add by dengsy161109
...
DEFINE
   ...
   # DEFINE li_result   LIKE type_file.chr1    #TQC-D40067 add #mark by liufang161226
    DEFINE l_flag  LIKE type_file.chr1 #MOD-DC0091
    DEFINE l_ima01 LIKE ima_file.ima01 #yaotg160630 add
   ...
   #IF g_omf_1.omf01 IS NULL THEN
    ...
    LET g_forupd_sql = "SELECT omf21,omf09,omf10,omf11,omf12,omf25,omf26,omf13,omf14,'',", #FUN-D10082 add omf25,omf26
                      ...
                      #"       omf18,omf19,omf19x,omf19t,omf04 FROM omf_file",#FUN-C60036 add omf04#FUN-D20003 mark
                       #"       omf18,omf19,omf19x,omf19t FROM omf_file",#FUN-D20003 add  # mark by lixwz180123
                       "       omf18,omf19,omf19x,omf19t,'',ta_omf001,ta_omf002 FROM omf_file",#FUN-D20003 add   # add by lixwz180123
...
#                    END IF
        ...
        AFTER FIELD omf25
           ...
           END IF
           #add muping151217 s
           IF cl_null(g_omf[l_ac].omf25) THEN
              NEXT FIELD omf25
           END IF
           #add muping151217 e
           #zhouxm160115 add start
            IF NOT cl_null(g_omf[l_ac].omf25) THEN
              LET l_oea03= ''
              SELECT oea03 INTO l_oea03
                FROM oea_file
               WHERE oea01=g_omf[l_ac].omf25
              IF l_oea03 <> g_omf_1.omf05 THEN
                 CALL cl_err('','cxm-528',0)
                 NEXT FIELD omf25
              END IF
           END IF
           #zhouxm160115 add end

        AFTER FIELD omf26
           IF NOT cl_null(g_omf[l_ac].omf25) THEN
              IF (p_cmd = 'a') OR
                 (p_cmd = 'u' AND (g_omf_t.omf26 != g_omf[l_ac].omf26 OR g_omf_t.omf25 != g_omf[l_ac].omf25))
                 OR  (g_omf_t.omf26 IS NULL  OR g_omf_t.omf25 IS NULL) THEN
                 LET l_n = 0
                 SELECT COUNT(*) INTO l_n FROM oeb_file
                  WHERE oeb01 = g_omf[l_ac].omf25
                    AND oeb03 = g_omf[l_ac].omf26
...
#MOD-DB0059 add end---------
        ...
        AFTER FIELD omf13
           ...
           IF g_omf[l_ac].omf10 = '9' THEN
              ...
              #yinhy130510  --Begin
              IF NOT cl_null(g_omf[l_ac].omf13) THEN
                 LET l_sql = "SELECT ima02,imaud01,ima021,ima44 FROM ",cl_get_target_table(g_omf[l_ac].omf09,'ima_file'),  #add imaud01 by shijl 170223
                 ...
                 OPEN ima_cs
                 FETCH ima_cs INTO g_omf[l_ac].omf14,g_omf[l_ac].imaud01,g_omf[l_ac].omf15,g_omf[l_ac].omf17
              END IF
              #yinhy130510  --End
           END IF
           END IF
           #yaotg160630 add str
        IF g_omf[l_ac].omf10='9' THEN
           IF cl_null(g_omf[l_ac].omf13) THEN NEXT FIELD omf13 END IF
           IF g_omf[l_ac].omf13[1,4]<>'MISC' THEN NEXT FIELD omf13 END IF
           IF g_omf[l_ac].omf13[1,4]='MISC' THEN
              LET l_ima01 = cl_replace_str(g_omf[l_ac].omf13,"MISC","")
              #SELECT ima02,imao21 INTO g_omf[l_ac].omf14,g_omf[l_ac].omf15 #marked by shijl 170223
              SELECT ima02,imaud01,ima021 INTO g_omf[l_ac].omf14,g_omf[l_ac].imaud01,g_omf[l_ac].omf15 #add by shijl 170223
              FROM ima_file
              WHERE ima01=l_ima01
              DISPLAY BY NAME g_omf[l_ac].omf14
              DISPLAY BY NAME g_omf[l_ac].imaud01 #add by shijl 170223
        ...
        IF NOT cl_null(g_omf[l_ac].omf12) THEN
            ...
            END IF
             ...
             IF (p_cmd = 'a') OR   #add by cjy 20170801
                (p_cmd = 'u' AND (g_omf_t.omf12 != g_omf[l_ac].omf12 OR g_omf_t.omf11 != g_omf[l_ac].omf11)) THEN   #20170801
                 CALL t670_omf12()
             END IF   #add by cjy 20170801
      ...
      #FUN-C60036--mark--end
        ...
        AFTER INSERT
           ...
           IF (g_omf[l_ac].omf19 + g_omf[l_ac].omf19x <> g_omf[l_ac].omf19t) OR
                   ...
                   END IF
                END IF
#         #TQC-D40067--add--begin--- #mark by liufang161226
#           LET l_n = 0
#           SELECT COUNT(*) INTO l_n FROM omf_file
#            WHERE omf00 = g_omf_1.omf00
...
#              DISPLAY BY NAME g_omf_1.omf00
#           END IF
#         #TQC-D40067--add--end----  #mark by liufang161226
           ...
           #FUN-C60036--add--end
           # add by lixwz180123 s
           LET l_omf.ta_omf001 = g_omf[l_ac].ta_omf001
           LET l_omf.ta_omf002 = g_omf[l_ac].ta_omf002
           IF cl_null(l_omf.ta_omf001) THEN LET l_omf.ta_omf001 = ' ' END IF
           IF cl_null(l_omf.ta_omf002) THEN LET l_omf.ta_omf002 = ' ' END IF
           # add by lixwz180123 e
      ...
      #  IF NOT cl_null(g_omf_t.omf12) AND NOT cl_null(g_omf_t.omf11)THEN
        ...
        #      AND omf02 = g_omf_1.omf02   #FUN-C60033
            ...
            #FUN-C60036--add--str
            #CALL t670_upd_show_diff() #MOD-D60161 add##MOD-E20059 markzhouxm160701
            LET g_omf_1.omf19_sum = cl_digcut(g_omf_1.omf19_sum,g_azi04)
            LET g_omf_1.omf19x_sum = cl_digcut(g_omf_1.omf19x_sum,g_azi04)
            LET g_omf_1.omf19t_sum = cl_digcut(g_omf_1.omf19t_sum,g_azi04)
            LET g_omf_1.omf29_sum = cl_digcut(g_omf_1.omf29_sum,t_azi04)
...
#            #MOD-DC0096 add begin--------- #mark by liufang161227
#            SELECT COUNT(*) INTO l_cnt FROM omf_file WHERE omf00 = g_omf_1.omf00
#            IF l_cnt = 0 THEN
#               LET g_omf_1.omf00 = s_get_doc_no(g_omf_1.omf00)
#               DISPLAY BY NAME g_omf_1.omf00
#            END IF
#            #MOD-DC0096 add end----------- #mark by liufang161227
         END IF
        ...
        ON ROW CHANGE
           ...
           ELSE
            ...
            #FUN-C60036--mark--end
                ...
                END IF
                # add by lixwz180123 s
                IF cl_null( g_omf[l_ac].ta_omf001) THEN
                 LET g_omf[l_ac].ta_omf001 =' ' END IF
                IF cl_null( g_omf[l_ac].ta_omf002) THEN
                 LET g_omf[l_ac].ta_omf002 =' ' END IF
                # add by lixwz180123 e
               ...
               #   AND omf02=g_omf_1_t.omf02   #FUN-C60033
                                    # add by lixwz180123 s
                                    ta_omf001 = g_omf[l_ac].ta_omf001,
                                    ta_omf002 = g_omf[l_ac].ta_omf002
                                    # add by lixwz180123 e
                 WHERE omf00=g_omf_1.omf00   #FUN-C60033
           ...
           IF INT_FLAG THEN
              ...
              ELSE
                 ...
                 IF g_rec_b != 0 THEN
                    LET g_action_choice = "detail"
                    LET l_ac = l_ac_t
#                 ELSE                   #TQC-D40067 add #mark by liufang161226
#                    CLEAR FORM          #TQC-D40067 add #mark by liufang161226
#                    CALL g_omf.clear()  #TQC-D40067 add #mark by liufang161226
                 END IF
              #FUN-D30034--add--end--
              END IF
              CLOSE t670_bcl
        ...
        #  END IF
        #  #FUN-C60036--add--end
           #CALL t670_upd_show_diff() #MOD-D60161 add ##MOD-E20059 mark  zhouxm160701
           #FUN-C60036--add--str
            LET g_omf_1.omf19_sum = cl_digcut(g_omf_1.omf19_sum,g_azi04)
            LET g_omf_1.omf19x_sum = cl_digcut(g_omf_1.omf19x_sum,g_azi04)
            LET g_omf_1.omf19t_sum = cl_digcut(g_omf_1.omf19t_sum,g_azi04)
...
DEFINE l_ima01 LIKE ima_file.ima01 #yaotg160630 add
   ...
   #LET g_sql = "SELECT omf21,omf09,omf10,omf11,omf12,omf25,omf26,omf13,omf14,'',", #FUN-D10082 add  omf25,omf26
    LET g_sql = "SELECT omf21,omf09,omf10,omf11,omf12,omf25,omf26,omf13,omf14,imaud01,omf15,",  #zhouxm160630 add #add imaud01 by shijl 170223
              ...
              #"       '',omf28,omf29,omf29x,omf29t,omf18,omf19,omf19x,omf19t,omf04 ",#FUN-C60036 add omf04#FUN-D20003 mark
               #"       '',omf28,omf29,omf29x,omf29t,omf18,omf19,omf19x,omf19t",#FUN-D20003 add # mark by lixwz180123
               "       '',omf28,omf29,omf29x,omf29t,omf18,omf19,omf19x,omf19t,'',ta_omf001,ta_omf002",#FUN-D20003 add  # add by lixwz180123
               " FROM omf_file ",
               "  left join ima_file on ima01= omf13  ", #add by shijl 170223
             # " WHERE omf01 = '",g_omf_1.omf01,"'",   #FUN-C60033
             # "   AND omf02 = '",g_omf_1.omf02,"'",   #FUN-C60033
   ...
   FOREACH omf_curs INTO g_omf[g_cnt].*   #單身 ARRAY 填充
      ...
      # add by lixwz180123 s
      SELECT UNIQUE obk03
        INTO g_omf[g_cnt].obk03
        FROM obk_file
       WHERE obk02 = g_omf_1.omf05
         AND obk01 = g_omf[g_cnt].omf13
      IF cl_null (g_omf[g_cnt].omf13) THEN LET g_omf[g_cnt].omf13 = ' ' END IF
      # add by lixwz180123 e
...
FUNCTION t670_set_no_entry(p_cmd)
   ...
   IF p_cmd = 'u' AND g_chkey = 'N' AND ( NOT g_before_input_done ) THEN
      ...
      call cl_set_comp_entry("omf18,omf28",FALSE) #xueyh160728 add
   END IF
   CALL cl_set_comp_entry("omf20,omf201",FALSE)
END FUNCTION
...
#MOD-CB0050 add end-----------------
   IF g_omf[l_ac].omf10 = '1' THEN
      LET g_sql = "SELECT ogb04,ogb06,imaud01,ogb12,ogb05,ogb14,ogb13,gec04,gec05,oga24,",#FUN-C60036 add , #add imaud01 by shijl 170223
                  " ogb092,ogb17,ogb913,ogb914,ogb910,ogb911,ogb915,ogb912,ogb917,ogb916 ", #FUN-C60036 add
                   "  FROM ",cl_get_target_table(g_plant_new,'ogb_file'),",",
                       ...
                       ",",  cl_get_target_table(g_plant_new,'ima_file'),  #add by shijl 170223
                   " WHERE oga01 = ogb01 AND ogb01 = '",g_omf[l_ac].omf11,"' ",
                   "   AND ogb03 = '",g_omf[l_ac].omf12,"' ",
                   "   AND ima01 = ogb04  ", #add by shijl 170223
   ...
   ELSE
     ...
     #MOD-CA0092--add--end--20121106
 	  # LET g_sql = "SELECT ohb04,ohb06,imaud01,ohb12,ohb05,ohb14,ohb13,gec04,gec05,oha24,",#FUN-C60036 add ,#add imaud01 by shijl 170223
 	  LET g_sql = "SELECT ohb04,ohb06,'',ohb12,ohb05,ohb14,ohb13,gec04,gec05,oha24,", #mod by cjy 20170412
                   " ohb092,'',ohb913,ohb914,ohb910,ohb911,ohb915,ohb912,ohb917,ohb916", #FUN-C60036 add
                   "  FROM ",cl_get_target_table(g_plant_new,'ohb_file'),",",
                             cl_get_target_table(g_plant_new,'oha_file'),",",
                             cl_get_target_table(g_plant_new,'gec_file'),
                  #    ",",  cl_get_target_table(g_plant_new,'ima_file'),  #add by shijl 170223  #mark by cjy 21070412
                   " WHERE oha01 = ohb01 AND ohb01 = '",g_omf[l_ac].omf11,"' ",
                   "   AND ohb03 = '",g_omf[l_ac].omf12,"' ",
                   "   AND gec01 = oha21 ", #MOD-D40039 add ,
                   #"   AND ima01 = ohb04  ", #add by shijl 170223#mark by cjy 20170413
                   "   AND gec011 = '2' "   #MOD-D40039 add
   END IF
   CALL cl_replace_sqldb(g_sql) RETURNING g_sql
	 CALL cl_parse_qry_sql(g_sql,g_plant_new) RETURNING g_sql
   PREPARE sel_ogb_pre FROM g_sql
   EXECUTE sel_ogb_pre INTO g_omf[l_ac].omf13,g_omf[l_ac].omf14,g_omf[l_ac].imaud01,g_omf[l_ac].omf16,g_omf[l_ac].omf17, #add g_omf[l_ac].imaud01 by shijl 170223
    ...
    #TQC-D20009--cj--add--
      ...
      END IF
    #add by cjy 20170412
    IF g_omf[l_ac].omf13 LIKE 'MISC%' THEN
    	 SELECT imaud01 INTO g_omf[l_ac].imaud01 FROM ima_file WHERE ima01 LIKE 'MISC%'
    ELSE
       SELECT imaud01 INTO g_omf[l_ac].imaud01 FROM ima_file WHERE ima01=g_omf[l_ac].omf13
    END IF
    #end add by cjy 20170412
    # add by lixwz180123 s
    ...
    SELECT SUM(omf915),SUM(omf912),SUM(omf917) INTO l_omf915,l_omf912,l_omf917
     ...
     AND omf00 <> g_omf_1.omf00 #add by liufang16228
  ...
  # #FUN-C60036 --add--end
    IF STATUS OR (g_omf[l_ac].omf917 = 0 AND l_oha09 !='5') OR (g_omf[l_ac].omf10 = '1' AND g_omf[l_ac].omf917 <= 0) THEN#MOD-CA0092 add OR g_omf[l_ac].omf917...
       IF g_omf[l_ac].omf10 = '1' THEN
          ...
          LET g_omf[l_ac].imaud01 = '' #add by shijl 170223
...
FUNCTION t670_omf25()
   DEFINE l_cnt    LIKE type_file.num5
   DEFINE l_sql    STRING
   DEFINE l_oha09  LIKE oha_file.oha09     #add by xuanjha 151109
   ...
   END IF
   #end add
   LET g_sql = " SELECT oeb04,oeb06,imaud01,oeb092,oeb12,oeb05,oeb13" , #add by shijl imaud01 170223
               "   FROM ",cl_get_target_table(g_plant_new,'oeb_file') ,
               #"   FROM ",cl_get_target_table(g_plant_new,'ima_file') ,#add by shijl 170223
               " ,",cl_get_target_table(g_plant_new,'ima_file') ,#add by shijl 170223  #mod by cjy 20170411
               "  WHERE oeb01 = '",g_omf[l_ac].omf25,"'",
               "    AND ima01 = oeb04  ",#add by shijl 170223
               "    AND oeb03 = '",g_omf[l_ac].omf26,"'"
   CALL cl_replace_sqldb(g_sql) RETURNING g_sql
   CALL cl_parse_qry_sql(g_sql,g_plant_new) RETURNING g_sql
   PREPARE sel_oeb_pre FROM g_sql
   EXECUTE sel_oeb_pre INTO g_omf[l_ac].omf13,g_omf[l_ac].omf14,g_omf[l_ac].imaud01,#add by shijl imaud01 170223
   ...
   #            "    AND omf25 = '",g_omf[l_ac].omf25,"'",
   #            "    AND omf26 = '",g_omf[l_ac].omf26,"'"
   #add by zhaoxiangb 151112
   IF g_omf[l_ac].omf10 = '9' THEN
   LET l_sql = " SELECT abs(SUM(omf16)) ",
               "   FROM omf_file ",
               " WHERE omf09 = '",g_omf[l_ac].omf09,"'",
               "    AND omf25 = '",g_omf[l_ac].omf25,"'",
               "    AND omf26 = '",g_omf[l_ac].omf26,"'"
   ELSE
   LET l_sql = " SELECT abs(SUM(omf16)) ",
   ...
   LET g_omf[l_ac].omf16 = g_omf[l_ac].omf16 - g_omf16
   LET g_omf[l_ac].omf18 = g_omf[l_ac].omf28 * g_omf_1.omf22
   #LET g_omf[l_ac].omf29 = g_omf[l_ac].omf16 * g_omf[l_ac].omf28 #mark by xuanjha 151109
   #add by xuanjha 151109 ----s-----
   IF g_omf[l_ac].omf10 = '2' THEN
       LET l_oha09 = ''
       LET g_sql = " SELECT oha09 FROM ",cl_get_target_table(g_plant_new,'oha_file'),
                   "  WHERE oha01 = '",g_omf[l_ac].omf11,"'"
       CALL cl_replace_sqldb(g_sql) RETURNING g_sql
       CALL cl_parse_qry_sql(g_sql,g_plant_new) RETURNING g_sql
       PREPARE sel_oha09_pre_4 FROM g_sql
       EXECUTE sel_oha09_pre_4 INTO l_oha09
       CALL cl_set_comp_entry('omf16,omf912,omf915,omf917',l_oha09 != '5')
    END IF
    LET g_sql = " SELECT gec05,gec07,gec04 FROM ",cl_get_target_table(g_plant_new,'gec_file'),
                           "  WHERE gec01='",g_omf_1.omf06,"' ",
               ...
               CALL cl_replace_sqldb(g_sql) RETURNING g_sql
		           CALL cl_parse_qry_sql(g_sql,g_plant_new) RETURNING g_sql
               PREPARE sel_gec07_pre2 FROM g_sql
               EXECUTE sel_gec07_pre2 INTO g_gec05,g_gec07,g_omf_1.omf061
               IF g_gec07 = 'Y' THEN    #含稅
                  #未稅金額=(含稅單價*數量)/(1+稅率/100)
                  IF g_omf[l_ac].omf16 <> 0 THEN
                     LET g_omf[l_ac].omf29 = cl_digcut((g_omf[l_ac].omf28*g_omf[l_ac].omf16),t_azi04)/(1+g_omf_1.omf061/100)
               ...
               ELSE                     #不含稅
                 ...
                 #MOD-CA0092--add--end
                  END IF
               END IF
   #add by xuanjha 151109 ----e-----
   LET g_omf[l_ac].omf29 = cl_digcut(g_omf[l_ac].omf29,t_azi04)
   #LET g_omf[l_ac].omf29t = g_omf[l_ac].omf29 * (1+g_omf_1.omf061/100) #mark by xuanjha 151109
   LET g_omf[l_ac].omf29t = cl_digcut(g_omf[l_ac].omf29t,t_azi04)
   LET g_omf[l_ac].omf29x = g_omf[l_ac].omf29t - g_omf[l_ac].omf29
   LET g_omf[l_ac].omf29x = cl_digcut(g_omf[l_ac].omf29x,t_azi04)
   LET g_omf[l_ac].omf19 = g_omf[l_ac].omf29 * g_omf_1.omf22
...
#add TQC-D10102 ---end---
   ...
   ELSE
      ...
      LET li_sql = " SELECT ogc092,SUM(ogc12),ogc15,ogc15_fac,SUM(ogc16), ",
                  " ogc17,ogcplant,ogclegal,SUM(ogc13),ogc09 FROM ogc_file", #zhouxm160726 add ogc09#出貨簽收沒有完成故mark
                  # " ogc17,ogcplant,ogclegal FROM ogc_file",
                   "  WHERE ogc01 = '",g_omf[l_ac].omf11,"'",
                   "    AND ogc03 = '",g_omf[l_ac].omf12,"'",
                   "  GROUP BY ogc092,ogc15,ogc15_fac,ogc17,ogcplant,ogclegal,ogc09" #zhouxm160726 ad ogc09
      ...
      FOREACH t670_ogc_cs INTO li_ogc.ogc092,li_ogc.ogc12,li_ogc.ogc15,
                               ...
                               li_ogc.ogcplant,li_ogc.ogclegal ,li_ogc.ogc13,li_ogc.ogc09 #zhouxm169726 add li_ogc.ogc09 #出貨簽收沒有完成故mark
         LET li_ogc12 = 0
